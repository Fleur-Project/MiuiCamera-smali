...
.method static constructor <clinit>()V
    ...
    sput-object v0, LA/h;->a:Landroid/graphics/PathMeasure;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    sput-object v0, LA/h;->b:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    sput-object v0, LA/h;->c:Landroid/graphics/Path;

    const/4 v0, 0x4

    new-array v0, v0, [F

    sput-object v0, LA/h;->d:[F
...
.method public static a(Landroid/graphics/Path;FFF)V
    ...
    sget-object v0, LA/h;->a:Landroid/graphics/PathMeasure;
    ...
    invoke-static {v2, v1}, LA/g;->c(FF)I

    move-result p2

    int-to-float v2, p2

    invoke-static {p1, v1}, LA/g;->c(FF)I
    ...
    :cond_6
    sget-object p2, LA/h;->b:Landroid/graphics/Path;
    ...
    sget-object v5, LA/h;->c:Landroid/graphics/Path;
