...
.field public static volatile s:LC/H2;
...
.method static constructor <clinit>()V
    ...
    sget v0, Lv9/b;->camera_click_default_cv:I

    sget v2, Lv9/b;->camera_focus_cv:I

    sget v3, Lv9/b;->video_record_start_cv:I

    sget v4, Lv9/b;->video_record_end_cv:I

    sget v5, Lv9/b;->camera_fast_burst_cv:I

    sget v6, Lv9/b;->camera_fast_burst_end_cv:I
    ...
    sput-object v0, LC/H2;->l:[I

    sget v1, Lv9/b;->camera_click_cv:I

    sget v7, Lv9/b;->camera_click_motor_cv:I

    filled-new-array/range {v1 .. v7}, [I

    move-result-object v0

    sput-object v0, LC/H2;->m:[I

    sget v1, Lv9/b;->camera_click_classical_cv:I
    ...
    sput-object v0, LC/H2;->n:[I

    sget v1, Lv9/b;->camera_click_advanced_cv:I

    filled-new-array/range {v1 .. v7}, [I

    move-result-object v0

    sput-object v0, LC/H2;->o:[I
    ...
    sput-object v0, LC/H2;->p:[Ljava/lang/String;
    ...
    sput-object v1, LC/H2;->q:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, LC/H2;->a:[I

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, LC/H2;->k:Ljava/util/ArrayList;
    ...
    iput-object v3, p0, LC/H2;->j:Landroid/media/AudioManager;

    sget-boolean v3, Lw7/b;->i:Z

    sget-object v3, Lw7/b$b;->a:Lw7/b;

    invoke-virtual {v3}, Lw7/b;->x()Z

    move-result v3

    iput-boolean v3, p0, LC/H2;->i:Z

    const/4 v4, -0x1

    invoke-static {v1, v4}, Ljava/util/Arrays;->fill([II)V

    new-instance v1, LC/D2;

    invoke-direct {v1, p0}, LC/D2;-><init>(LC/H2;)V

    invoke-static {v0, v0, v1}, LC/H2;->b(IILC/D2;)Landroid/media/SoundPool;

    move-result-object v5

    iput-object v5, p0, LC/H2;->b:Landroid/media/SoundPool;
    ...
    invoke-static {v3, v5, v1}, LC/H2;->b(IILC/D2;)Landroid/media/SoundPool;
    ...
    :cond_0
    iput v4, p0, LC/H2;->d:I

    new-instance v1, LBd/a;

    invoke-direct {v1, p0, v0}, LBd/a;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance v3, LC/F2;

    invoke-direct {v3, v2}, LC/F2;-><init>(I)V
    ...
    iput-object v0, p0, LC/H2;->f:Lio/reactivex/disposables/Disposable;

    return-void
.end method

.method public static a()LC/H2;
    .locals 2

    sget-object v0, LC/H2;->s:LC/H2;

    if-nez v0, :cond_1

    const-class v0, LC/H2;

    monitor-enter v0

    :try_start_0
    sget-object v1, LC/H2;->s:LC/H2;

    if-nez v1, :cond_0

    new-instance v1, LC/H2;

    invoke-direct {v1}, LC/H2;-><init>()V
...
.method public static b(IILC/D2;)Landroid/media/SoundPool;
    .locals 1
...
.method public final varargs d([I)V
    ...
    invoke-virtual {p0}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->c()J

    move-result-wide p0

    invoke-static {v0, v1, p0, p1}, LYi/b;->H(Lio/reactivex/Scheduler;Ljava/lang/Runnable;J)Lio/reactivex/disposables/Disposable;
...
.method public final g(ILandroid/media/SoundPool;)I
    ...
    sget-object v4, LC/H2;->q:[Ljava/lang/String;
    ...
    invoke-static {v0, p2}, LC/H2;->e(Ljava/lang/String;Landroid/media/SoundPool;)I
    ...
    :cond_3
    sget-object v0, LC/H2;->p:[Ljava/lang/String;
    ...
    iget-object v2, v4, La0/b;->b:Ljava/lang/String;
    ...
    sget-object v0, LC/H2;->l:[I

    aget v0, v0, p1

    invoke-static {v0, p2}, LC/H2;->f(ILandroid/media/SoundPool;)I
...
.method public final declared-synchronized h(ILandroid/media/SoundPool;F)V
    ...
    iget-object v0, p0, LC/H2;->k:Ljava/util/ArrayList;

    invoke-virtual {p0, p1, p2, p3, v0}, LC/H2;->k(ILandroid/media/SoundPool;FLjava/util/ArrayList;)I
...
.method public final i(FI)V
    ...
    iget-object v0, p0, LC/H2;->h:Lio/reactivex/FlowableEmitter;
    ...
    :cond_0
    new-instance v0, LC/H2$b;

    invoke-direct {v0}, LC/H2$b;-><init>()V

    iput p2, v0, LC/H2$b;->a:I

    iput p1, v0, LC/H2$b;->b:F

    iget-object p0, p0, LC/H2;->h:Lio/reactivex/FlowableEmitter;
...
.method public final j(I)V
    ...
    invoke-virtual {p0, v0, p1}, LC/H2;->i(FI)V
...
.method public final k(ILandroid/media/SoundPool;FLjava/util/ArrayList;)I
    ...
    invoke-virtual {p0, p1, p2}, LC/H2;->g(ILandroid/media/SoundPool;)I
    ...
    invoke-static {p1, p2, p3}, LA2/l;->j(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
