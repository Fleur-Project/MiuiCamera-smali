...
.method static constructor <clinit>()V
    ...
    sput-object v0, LC/X2;->A:Landroid/os/Bundle;
    ...
    sput-object v0, LC/X2;->C:Landroid/os/Bundle;
    ...
    sput-object v0, LC/X2;->H:Landroid/net/Uri;
...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    invoke-direct {p0, p1}, LC/i3;-><init>(Lcom/android/camera/ActivityBase;)V

    const/4 p1, 0x2

    new-array p1, p1, [F

    iput-object p1, p0, LC/X2;->s:[F

    const/16 p1, 0xa0

    iput p1, p0, LC/X2;->t:I

    const/4 p1, -0x1

    iput p1, p0, LC/X2;->u:I

    const/4 p1, 0x0

    iput p1, p0, LC/X2;->w:I

    const/high16 p1, 0x3f800000    # 1.0f

    iput p1, p0, LC/X2;->x:F
...
.method public final A0(ILandroid/os/Bundle;)V
    ...
    invoke-virtual/range {v0 .. v5}, LC/X2;->C0(ILandroid/os/Bundle;JZ)V

    return-void
.end method

.method public final C0(ILandroid/os/Bundle;JZ)V
    .locals 4
    .param p2    # Landroid/os/Bundle;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget-object p0, p0, LC/X2;->y:Landroid/os/Handler;
...
.method public final H1(I)V
    ...
    invoke-virtual {p0, p1, v0}, LC/X2;->A0(ILandroid/os/Bundle;)V
...
.method public final R7()V
    ...
    invoke-virtual {p0, v1, v0}, LC/X2;->A0(ILandroid/os/Bundle;)V
...
.method public final T(I)V
    ...
    invoke-virtual {p0, v0}, LC/X2;->X(Landroid/view/KeyEvent;)V
...
.method public final X(Landroid/view/KeyEvent;)V
    ...
    iget-object v2, p0, Lrb/g;->a:Ljava/lang/String;
    ...
    invoke-interface {v2, p0, p1}, Lrb/b;->h0(Lrb/c;Landroid/view/KeyEvent;)V
...
.method public final e0(IJFFF)V
    .locals 14
    ...
    const-string p0, "injectMotionEvent: not initialized"
    ...
    invoke-interface {v0, p0, p1}, Lrb/b;->w(Lrb/c;Landroid/view/MotionEvent;)V
    ...
    :catch_1
    const-string p0, "injectMotionEvent failed"
...
.method public final g0()V
    ...
    iget v0, p0, LC/X2;->t:I

    invoke-virtual {p0, v0}, LC/X2;->e1(I)V

    iget v0, p0, LC/X2;->u:I

    invoke-virtual {p0, v0}, LC/X2;->b1(I)V

    iget v0, p0, LC/X2;->w:I

    invoke-virtual {p0, v0}, LC/X2;->H1(I)V

    iget v0, p0, LC/X2;->x:F

    invoke-virtual {p0, v0}, LC/X2;->setZoomRatio(F)V
    ...
    invoke-direct {v2, v0}, LC/W2;-><init>(I)V
    ...
    invoke-virtual {p0, v0}, LC/X2;->j1(Ljava/lang/String;)V
    ...
    new-instance v3, LC/V2;

    const/4 v4, 0x0

    invoke-direct {v3, v0, v4}, LC/V2;-><init>(II)V
    ...
    invoke-virtual {p0, v0}, LC/X2;->y2(Ljava/lang/String;)V
...
.method public final handleMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2, v4, p1}, LC/H;->i(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-interface {p0, v0, p1}, Lrb/b;->A(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/Bundle;
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catch Lrb/g$e; {:try_start_1 .. :try_end_1} :catch_1
...
.method public final m(ILandroid/os/Bundle;)V
    ...
    invoke-super {p0, p1, p2}, LC/i3;->m(ILandroid/os/Bundle;)V
...
.method public final n()V
    ...
    invoke-super {p0}, LC/i3;->n()V

    iget-object v0, p0, LC/i3;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, LC/X2;->y:Landroid/os/Handler;
    ...
    iput-object v2, p0, LC/X2;->y:Landroid/os/Handler;
...
.method public final n0(Lcom/android/camera/provider/CameraAgentProvider$FunctionInput;)V
    ...
    invoke-static {v1, v0, v2}, LC/E1;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v3, p0, LC/X2;->t:I

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, LC/X2;->u:I
    ...
    :cond_0
    iget p0, p0, LC/X2;->t:I

    invoke-static {}, Lb0/a;->i()Lh0/s0;

    move-result-object v0

    const-class v6, Lh0/k0;

    invoke-virtual {v0, v6}, LW9/b;->t(Ljava/lang/Class;)Ljava/util/Optional;

    move-result-object v0

    new-instance v6, LC/V2;

    invoke-direct {v6, p0, v2}, LC/V2;-><init>(II)V
    ...
    invoke-static {v0, p1, v3, p0}, LQ1/t;->k(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v6, LC/W2;

    invoke-direct {v6, p0}, LC/W2;-><init>(I)V
...
.method public final setZoomRatio(F)V
    ...
    invoke-virtual/range {v4 .. v9}, LC/X2;->C0(ILandroid/os/Bundle;JZ)V
...
.method public final t()V
    ...
    iput-object v1, p0, LC/X2;->y:Landroid/os/Handler;
...
.method public final y2(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p1}, LC/X2;->A0(ILandroid/os/Bundle;)V
