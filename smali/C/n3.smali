...
.method static constructor <clinit>()V
    ...
    sput-object v0, LC/n3;->p:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public static b(Landroid/database/Cursor;)LC/n3$a;
    .locals 20
    ...
    invoke-static {v2, v10}, LB2/p;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v4 .. v16}, LC/n3$a;-><init>(JIJLjava/lang/String;IIZZJ)V
    :try_end_1
    ...
    invoke-static {v0, v10}, LB2/p;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LC/n3;
    .locals 11
    ...
    :cond_0
    new-instance v3, LC/n3;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-boolean v1, v3, LC/n3;->c:Z

    iput-boolean v1, v3, LC/n3;->d:Z

    iput-boolean v1, v3, LC/n3;->e:Z

    iput-boolean v1, v3, LC/n3;->h:Z

    const/4 v4, -0x1

    iput v4, v3, LC/n3;->i:I

    iput v4, v3, LC/n3;->j:I

    const-wide/16 v4, -0x1

    iput-wide v4, v3, LC/n3;->k:J

    iput-boolean v1, v3, LC/n3;->l:Z

    iput-object v0, v3, LC/n3;->n:Ljava/lang/Boolean;

    const/4 v4, 0x1

    iput-boolean v4, v3, LC/n3;->o:Z

    iput-object p0, v3, LC/n3;->a:Landroid/net/Uri;
    ...
    :goto_2
    iput-object p1, v3, LC/n3;->b:Landroid/graphics/Bitmap;

    return-object v3
.end method

.method public static d([BIILandroid/net/Uri;)LC/n3;
    .locals 4
    ...
    :cond_2
    invoke-static {p3, v0, p1, v1}, LC/n3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LC/n3;
...
.method public static e(Landroid/content/Context;Landroid/net/Uri;)LC/n3;
    .locals 26
    ...
    invoke-static {v2, v1}, LC/F;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v4, v11, v5}, LC/n3;->k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v12, v13, v11, v5}, LC/n3;->m(IIILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v19 .. v25}, LC/n3;->f(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/app/Application;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    :goto_e
    invoke-static {v2, v0, v1, v1}, LC/n3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LC/n3;

    move-result-object v0

    if-eqz v0, :cond_11

    invoke-virtual {v0, v14, v15}, LC/n3;->o(J)V
...
.method public static f(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/app/Application;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    :try_start_2
    invoke-static/range {p1 .. p6}, LC/n3;->g(Landroid/media/MediaMetadataRetriever;IIIILandroid/media/MediaMetadataRetriever$BitmapParams;)Landroid/graphics/Bitmap;
...
.method public static h(Landroid/content/ContentResolver;)LC/n3$a;
    .locals 10
    ...
    invoke-static {v3, v4}, LC/F;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v5}, LC/F;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, LC/R1;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget-object v4, Ln4/z;->c:Ljava/lang/String;
    ...
    invoke-static {v6}, LC/n3;->b(Landroid/database/Cursor;)LC/n3$a;
    ...
    invoke-static {p0}, LC/n3;->b(Landroid/database/Cursor;)LC/n3$a;
...
.method public static i(Landroid/content/Context;Landroid/content/ContentResolver;)LC/n3;
    .locals 22
    ...
    sget-object v2, LC/n3;->p:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-static {v15}, Lbc/J;->a(Ljava/io/Closeable;)V

    invoke-static {v12}, Lbc/J;->a(Ljava/io/Closeable;)V

    invoke-static {v14}, Lbc/J;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v1, v6}, Lbc/J;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z

    move-result v1

    if-eqz v1, :cond_7

    invoke-static {v0, v6}, Ln4/k;->c(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static/range {v17 .. v17}, Lbc/J;->a(Ljava/io/Closeable;)V

    invoke-static/range {v21 .. v21}, Lbc/J;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v6, v0, v10, v10}, LC/n3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LC/n3;

    move-result-object v0

    if-eqz v0, :cond_b

    iput-boolean v11, v0, LC/n3;->e:Z

    iput v2, v0, LC/n3;->i:I

    iput v9, v0, LC/n3;->j:I

    const/4 v1, 0x1

    iput-boolean v1, v0, LC/n3;->c:Z

    iput-boolean v7, v0, LC/n3;->h:Z

    invoke-virtual {v0, v13, v14}, LC/n3;->o(J)V

    sget v1, LC/n3;->r:I

    iput v1, v0, LC/n3;->m:I
...
.method public static j(J)LC/n3;
    .locals 18
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-static {v1, v2, v0}, LM/a;->g(JLjava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {}, LA6/a;->w()LMe/Z2;

    move-result-object v0

    iget-object v0, v0, LMe/Z2;->a:Ljava/lang/Object;

    check-cast v0, Lcom/android/camera/db/greendao/SaveTaskDao;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v10, Lnj/d;

    invoke-direct {v10, v0}, Lnj/d;-><init>(Ljj/a;)V

    invoke-static {v7}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    iput-object v0, v10, Lnj/d;->f:Ljava/lang/Integer;

    sget-object v0, Lcom/android/camera/db/greendao/SaveTaskDao$Properties;->Id:Ljj/c;

    filled-new-array {v0}, [Ljj/c;

    move-result-object v0

    invoke-virtual {v10, v0}, Lnj/d;->b([Ljj/c;)V

    invoke-virtual {v10}, Lnj/d;->a()Lnj/c;
    ...
    iget-object v11, v0, Lnj/a;->e:Ljava/lang/Thread;

    if-ne v10, v11, :cond_0

    iget-object v10, v0, Lnj/a;->a:Ljj/a;

    iget-object v10, v10, Ljj/a;->b:Lgc/b;

    iget-object v10, v10, Lgc/b;->a:Ljava/lang/Object;

    check-cast v10, Landroid/database/sqlite/SQLiteDatabase;

    iget-object v11, v0, Lnj/a;->c:Ljava/lang/String;

    iget-object v12, v0, Lnj/a;->d:[Ljava/lang/String;
    ...
    iget-object v0, v0, Lnj/a;->b:LI1/l;

    iget-object v0, v0, LI1/l;->a:Ljava/lang/Object;
    ...
    :try_start_1
    invoke-virtual {v0, v10}, Ljj/a;->h(Landroid/database/Cursor;)Ljava/util/ArrayList;
    ...
    invoke-static {v1, v0}, Ln4/z;->w(Landroid/content/ContextWrapper;Landroid/net/Uri;)Z
    ...
    invoke-static {v0, v1, v2, v6}, LC/n3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LC/n3;
    ...
    invoke-virtual {v0, v1, v2}, LC/n3;->o(J)V
...
.method public static k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {p0 .. p4}, LC/n3;->l(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
...
.method public static l(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p4, v8}, Ln4/z;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
...
.method public final o(J)V
    ...
    iput-wide p1, p0, LC/n3;->k:J

    const-string/jumbo v0, "setFileSize: "

    const-string v1, ", mUri: "

    invoke-static {p1, p2, v0, v1}, LC/u3;->e(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-object p2, p0, LC/n3;->a:Landroid/net/Uri;
...
.method public final p(J)V
    ...
    iput-object v0, p0, LC/n3;->f:Ljava/lang/String;
    ...
    iput-object p1, p0, LC/n3;->g:Ljava/lang/String;
...
.method public final q(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, LC/n3;->a:Landroid/net/Uri;
    ...
    iput-object p1, p0, LC/n3;->a:Landroid/net/Uri;

    iput-boolean v2, p0, LC/n3;->d:Z
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, LC/n3;->a:Landroid/net/Uri;
    ...
    iget-object v1, p0, LC/n3;->b:Landroid/graphics/Bitmap;
    ...
    iget-boolean p0, p0, LC/n3;->l:Z

    const/16 v1, 0x7d

    invoke-static {v0, p0, v1}, LD8/a;->g(Ljava/lang/StringBuilder;ZC)Ljava/lang/String;
