...
.method public final run()V
    ...
    :pswitch_0
    iget-object v4, p0, LC/q0;->b:Lcom/android/camera/Camera;

    iget v5, p0, LC/q0;->c:I
    ...
    invoke-interface {p0, v0}, Lcom/android/camera/module/M;->release(Z)V

    :cond_0
    new-instance v3, LH3/n;

    iget-object v7, v4, Lcom/android/camera/ActivityBase;->j0:Lq5/g;
    ...
    invoke-direct/range {v3 .. v8}, LH3/n;-><init>(Landroid/content/Context;IILq5/g;Landroid/content/Intent;)V
    ...
    invoke-direct {v3, v5, v2}, LG3/k;-><init>(ILcom/android/camera/module/M;)V
    ...
    invoke-direct {v5, v4, v0}, LC/D0;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v2, v5}, Lio/reactivex/Single;->map(Lio/reactivex/functions/Function;)Lio/reactivex/Single;

    move-result-object v2

    iget-object v5, v4, Lcom/android/camera/Camera;->q1:LH3/k;
    ...
    iput-object v6, v5, LH3/k;->d:Lcom/android/camera/module/M;
    ...
    iget-object v5, v4, Lcom/android/camera/Camera;->V0:Ljava/lang/String;
    ...
    new-instance v5, LC/B1;

    invoke-direct {v5, v4, v0}, LC/B1;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v4, v1}, LB8/j;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, v4, v1}, LB8/f;-><init>(Ljava/lang/Object;I)V

    new-instance v2, LC/Z;

    invoke-direct {v2, v4, v1}, LC/Z;-><init>(Ljava/lang/Object;I)V
    ...
    iput-object p0, v4, Lcom/android/camera/Camera;->k1:Lio/reactivex/disposables/Disposable;
