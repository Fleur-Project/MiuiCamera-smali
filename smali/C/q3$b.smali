...
# direct methods
.method public constructor <init>(ZZLjava/lang/ref/WeakReference;LC/q3;LC/n3;)V
    .locals 1
    ...
    iput v0, p0, LC/q3$b;->n:I

    iput-boolean p1, p0, LC/q3$b;->h:Z

    iput-boolean p2, p0, LC/q3$b;->i:Z

    iput-object p3, p0, LC/q3$b;->k:Ljava/lang/ref/WeakReference;

    new-instance p1, Ljava/lang/ref/WeakReference;

    invoke-direct {p1, p4}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, LC/q3$b;->l:Ljava/lang/ref/WeakReference;

    new-instance p1, Ljava/lang/ref/WeakReference;

    invoke-direct {p1, p5}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, LC/q3$b;->m:Ljava/lang/ref/WeakReference;
...
.method public final e([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-boolean v3, v1, LC/q3$b;->h:Z
    ...
    iget-object v2, v1, LC/q3$b;->k:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v6}, LC/n3;->h(Landroid/content/ContentResolver;)LC/n3$a;
    ...
    :cond_2
    iget-object v8, v7, LC/n3$a;->d:Landroid/net/Uri;

    :goto_0
    const-string v9, "LoadThumbnailTask: lastUri = "

    invoke-static {v8, v9}, LC/F;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, v1, LC/q3$b;->m:Ljava/lang/ref/WeakReference;
    ...
    iget-object v12, v9, LC/n3;->a:Landroid/net/Uri;

    const-string v13, "LoadThumbnailTask: thumbnailUri = "

    invoke-static {v12, v13}, LC/F;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v12}, Lbc/J;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    :cond_3
    iget-wide v14, v7, LC/n3$a;->j:J

    :goto_1
    invoke-virtual {v9, v14, v15}, LC/n3;->o(J)V
    ...
    invoke-static {v2, v12}, Ln4/k;->c(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    :cond_6
    :goto_2
    iput-boolean v11, v1, LC/q3$b;->h:Z
    ...
    invoke-static {v12}, Lq0/b;->K(Ljava/lang/Long;)Lo0/b;
    ...
    iget-boolean v0, v1, LC/q3$b;->h:Z

    if-eqz v0, :cond_e

    invoke-static {v2, v6}, LC/n3;->i(Landroid/content/Context;Landroid/content/ContentResolver;)LC/n3;
    ...
    iget-object v6, v0, LC/n3;->a:Landroid/net/Uri;
    ...
    :cond_d
    iput-boolean v11, v1, LC/q3$b;->i:Z
    ...
    :cond_f
    new-array v8, v11, [LC/n3;

    const/4 v9, 0x2

    iput v9, v1, LC/q3$b;->n:I
    ...
    invoke-static {v12}, LC/n3;->h(Landroid/content/ContentResolver;)LC/n3$a;
    ...
    invoke-static/range {v16 .. v17}, LC/n3;->j(J)LC/n3;
    ...
    :cond_14
    iget-boolean v13, v9, LC/n3$a;->i:Z
    ...
    iget-wide v10, v4, LC/n3$a;->c:J

    invoke-static {v10, v11}, LC/n3;->j(J)LC/n3;
    ...
    iget-object v2, v10, LC/n3;->a:Landroid/net/Uri;
    ...
    iget-object v10, v4, LC/n3$a;->d:Landroid/net/Uri;
    ...
    invoke-static {v10, v0}, LC/F;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v10, v4, LC/n3$a;->e:Ljava/lang/String;
    ...
    iget v13, v4, LC/n3$a;->b:I

    move-object/from16 v22, v6

    move-object/from16 v21, v7

    iget-wide v6, v4, LC/n3$a;->a:J
    ...
    invoke-static {v2, v6, v7, v13, v10}, LC/n3;->l(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2, v6, v7, v13, v10}, LC/n3;->k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget v0, v4, LC/n3$a;->f:I

    iget v2, v4, LC/n3$a;->g:I

    invoke-static {v0, v2, v13, v10}, LC/n3;->m(IIILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v9, LC/n3$a;->d:Landroid/net/Uri;
    ...
    iget-object v2, v9, LC/n3$a;->d:Landroid/net/Uri;
    ...
    :cond_1d
    iget-object v0, v9, LC/n3$a;->e:Ljava/lang/String;
    ...
    invoke-static {v2, v3}, LC/n3;->e(Landroid/content/Context;Landroid/net/Uri;)LC/n3;

    move-result-object v2

    if-eqz v2, :cond_1f

    iget-object v0, v2, LC/n3;->b:Landroid/graphics/Bitmap;
    ...
    :cond_20
    :goto_d
    iget-object v0, v4, LC/n3$a;->d:Landroid/net/Uri;

    invoke-static {v12, v0}, Lbc/J;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {v0, v3}, LC/F;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v2, v6, v6}, LC/n3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LC/n3;
    ...
    iget-boolean v2, v4, LC/n3$a;->h:Z

    if-eqz v2, :cond_21

    const/4 v3, 0x1

    iput-boolean v3, v0, LC/n3;->e:Z

    iget v2, v4, LC/n3$a;->f:I

    iput v2, v0, LC/n3;->i:I

    iget v2, v4, LC/n3$a;->g:I

    iput v2, v0, LC/n3;->j:I

    :cond_21
    iget-wide v2, v4, LC/n3$a;->j:J

    invoke-virtual {v0, v2, v3}, LC/n3;->o(J)V
    ...
    invoke-static {v3, v0, v14}, LA2/l;->j(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :goto_11
    iput-boolean v3, v1, LC/q3$b;->i:Z
    ...
    invoke-static {v7, v3}, Lbc/J;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    :cond_2c
    iput-boolean v2, v1, LC/q3$b;->j:Z
    ...
    iget-wide v2, v1, LC/n3$a;->c:J

    goto :goto_18

    :goto_19
    invoke-virtual {v4, v2, v3}, LC/n3;->p(J)V
    ...
    :cond_30
    iget-boolean v3, v1, LC/n3$a;->i:Z

    :goto_1a
    iput-boolean v3, v4, LC/n3;->h:Z
...
.method public final h(Ljava/lang/Object;)V
    ...
    iget-boolean v2, p0, LC/q3$b;->j:Z
    ...
    iget-object v0, p0, LC/q3$b;->l:Ljava/lang/ref/WeakReference;
    ...
    iget-boolean v1, p0, LC/q3$b;->j:Z
    ...
    :cond_1
    iget-object v1, v0, LC/q3;->a:LC/n3;
    ...
    iget-boolean p0, p0, LC/q3$b;->i:Z

    const/4 v1, 0x1

    invoke-virtual {v0, p1, v1, v2, p0}, LC/q3;->g(LC/n3;ZZZ)V
