...
.field public final f:LC/t2$a;

.field public final g:LBh/c;

.field public final h:LA9/c;
...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-boolean v0, p0, LC/t2;->c:Z

    new-instance v0, LC/t2$a;

    invoke-direct {v0, p0}, LC/t2$a;-><init>(LC/t2;)V

    iput-object v0, p0, LC/t2;->f:LC/t2$a;
    ...
    iput-object v0, p0, LC/t2;->g:LBh/c;
    ...
    iput-object v0, p0, LC/t2;->h:LA9/c;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, LC/t2;->a:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static a(Lcom/android/camera/Camera;LC/n3;Landroid/net/Uri;Landroid/graphics/Rect;F)Landroid/content/Intent;
    .locals 8
    ...
    invoke-virtual {v6, v1}, Ldc/a;->a(LFf/k;)Ljava/lang/Object;
    ...
    sget-object p2, LC/X1$a;->a:LC/X1;

    iget p2, p2, LC/X1;->g:F
    ...
    iget-boolean p2, p1, LC/n3;->e:Z

    if-eqz p2, :cond_e

    iget p2, p1, LC/n3;->i:I
    ...
    invoke-static {p3, p2}, LC/G;->g(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->d2()Z
...
.method public static b(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-static {v2}, Lq0/b;->K(Ljava/lang/Long;)Lo0/b;
    ...
    invoke-static {p0, p1}, Ln4/z;->w(Landroid/content/ContextWrapper;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p1}, Lbc/J;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {p1, v2, v0, p0}, LC/F;->f(Ljava/lang/String;Ljava/lang/String;ZZ)Ljava/lang/String;
...
.method public static d(Lcom/android/camera/Camera;LC/n3;Landroid/net/Uri;)Z
    .locals 7
    ...
    invoke-virtual {p0, v2}, LC/q3;->d(Z)V
    ...
    invoke-static {p2, v3}, LC/F;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, v3, LC/q3;->k:Landroid/net/Uri;
    ...
    iget-object v3, v3, LC/q3;->k:Landroid/net/Uri;
    ...
    invoke-static {v4}, Lq0/b;->K(Ljava/lang/Long;)Lo0/b;
    ...
    invoke-static {v3, p2}, Lbc/J;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p2}, Lbc/J;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
...
# virtual methods
.method public final c(LC/n3;Lcom/android/camera/Camera;)V
    .locals 8
    .param p1    # LC/n3;
    ...
    iget-object v3, p2, Lcom/android/camera/ActivityBase;->j0:Lq5/g;
    ...
    invoke-virtual {v4}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->z5()Z
    ...
    invoke-virtual {v3, v4, p2}, Lq5/g;->z(LQe/a;Z)V
    ...
    invoke-virtual {v3, p2}, Lq5/g;->y(LQe/a;)V
    ...
    :cond_4
    :goto_1
    iget-object p2, p0, LC/t2;->b:Landroid/os/Messenger;
    ...
    invoke-virtual {p2}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->d2()Z

    move-result p2

    if-eqz p2, :cond_7

    iget p2, p1, LC/n3;->m:I
    ...
    :cond_7
    :goto_2
    sget-object p2, LC/e3;->f:LC/e3$a;
    ...
    :try_start_0
    iget-object v4, p1, LC/n3;->a:Landroid/net/Uri;

    iget-object v5, p1, LC/n3;->b:Landroid/graphics/Bitmap;

    invoke-virtual {p2, v4, v5}, LC/e3;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    :cond_8
    :try_start_1
    invoke-virtual {p2}, LC/e3;->c()Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v2, p0, LC/t2;->b:Landroid/os/Messenger;
    ...
    :try_start_3
    iget-object v7, p2, LC/e3;->e:Landroid/net/Uri;
    :try_end_3
    ...
    iget-object p1, p1, LC/n3;->n:Ljava/lang/Boolean;
    ...
    iget-object p1, p0, LC/t2;->b:Landroid/os/Messenger;
    ...
    iget-object p0, p0, LC/t2;->b:Landroid/os/Messenger;
