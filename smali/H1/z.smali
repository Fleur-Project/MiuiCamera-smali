...
.field public final e:LH1/w;

.field public final f:LH1/w;

.field public final g:LH1/w;

.field public final h:LH1/w;
...
.field public final m:LH1/s;

.field public final n:LH1/s;

.field public final o:LH1/s;

.field public final p:LH1/s;

.field public final q:LH1/s;

.field public final r:LH1/s;

.field public final s:LH1/s;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LH1/z;->a:Ljava/lang/String;

    new-instance v0, LH1/w;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, LH1/w;-><init>(I)V

    iput-object v0, p0, LH1/z;->c:LH1/w;

    iput-object v0, p0, LH1/z;->d:LH1/w;

    iput-object v0, p0, LH1/z;->e:LH1/w;

    iput-object v0, p0, LH1/z;->f:LH1/w;

    iput-object v0, p0, LH1/z;->g:LH1/w;

    iput-object v0, p0, LH1/z;->h:LH1/w;

    iput-object v0, p0, LH1/z;->i:LH1/w;

    const-string v0, "idle"

    iput-object v0, p0, LH1/z;->j:Ljava/lang/String;

    const/4 v0, 0x1

    iput v0, p0, LH1/z;->k:I

    new-instance v2, LH1/s;

    invoke-direct {v2, v1}, LH1/s;-><init>(I)V

    iput-object v2, p0, LH1/z;->m:LH1/s;

    iput-object v2, p0, LH1/z;->n:LH1/s;

    iput-object v2, p0, LH1/z;->o:LH1/s;

    iput-object v2, p0, LH1/z;->p:LH1/s;

    iput-object v2, p0, LH1/z;->q:LH1/s;

    iput-object v2, p0, LH1/z;->r:LH1/s;

    iput-object v2, p0, LH1/z;->s:LH1/s;
    ...
    invoke-direct {v2, p0, v3}, LH1/x;-><init>(Ljava/lang/Object;I)V

    new-instance v3, LH1/y;

    const/4 v4, 0x0

    invoke-direct {v3, v2, v4}, LH1/y;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v3}, Lio/reactivex/Observable;->subscribe(Lio/reactivex/functions/Consumer;)Lio/reactivex/disposables/Disposable;

    iput-object v1, p0, LH1/z;->t:Lcom/android/camera/data/observeable/RxData;
...
.method public static b(LH1/z;Lcom/xiaomi/camera/image_printer/hannto/bean/StatusBean$Result;[II)LH1/F;
    .locals 9
    ...
    :cond_2
    iget-object p3, p0, LH1/z;->a:Ljava/lang/String;
    ...
    :cond_8
    invoke-virtual {p0, p2, v2}, LH1/z;->h(IZ)V

    :cond_9
    const/4 p1, 0x2

    invoke-virtual {p0, p1, v1}, LH1/z;->h(IZ)V

    new-instance p0, LH1/F;

    sget-object p1, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    invoke-direct {p0, p1}, LH1/F;-><init>(Ljava/lang/Boolean;)V
    ...
    const-string/jumbo v6, "printerStatusError: "
    ...
    invoke-virtual {p0, v1}, LH1/z;->f(I)V
    ...
    :goto_6
    invoke-static {p1, v7}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2, p1}, Lkf/m;->P([II)Z
    ...
    :cond_16
    invoke-virtual {p0, p1, p2}, LH1/z;->h(IZ)V
    ...
    invoke-direct {p0, v4}, LH1/F;-><init>(Ljava/lang/Boolean;)V
...
.method public final c()I
    ...
    iget-object p0, p0, LH1/z;->t:Lcom/android/camera/data/observeable/RxData;
...
.method public final e()V
    ...
    invoke-virtual {p0, v0}, LH1/z;->f(I)V
...
.method public final f(I)V
    ...
    iget-object v1, p0, LH1/z;->t:Lcom/android/camera/data/observeable/RxData;
    ...
    invoke-static {v0, p1, v1, v2}, LM4/u;->g(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, LH1/z;->a:Ljava/lang/String;
...
.method public final g(Landroid/graphics/Bitmap;)V
    ...
    iget-object v0, p0, LH1/z;->c:LH1/w;

    iget v0, v0, LH1/w;->a:I

    iget-object p0, p0, LH1/z;->m:LH1/s;

    if-eqz p1, :cond_0

    invoke-static {v0}, Lu0/e;->k(I)I

    move-result v0

    const/high16 v1, 0x3f800000    # 1.0f

    invoke-static {p1, v0, v1}, Lbc/g;->h(Landroid/graphics/Bitmap;IF)Landroid/graphics/Bitmap;
    ...
    :goto_0
    iput-object p1, p0, LH1/s;->h:Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1}, Lbc/g;->l(Landroid/graphics/Bitmap;Landroid/graphics/ColorSpace;)V
...
.method public final h(IZ)V
    ...
    iget-object p2, p0, LH1/z;->t:Lcom/android/camera/data/observeable/RxData;
    ...
    :cond_0
    invoke-virtual {p0, p1}, LH1/z;->f(I)V
