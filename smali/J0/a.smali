...
# direct methods
.method public constructor <init>(ILandroid/location/Location;JILJ0/a$c;Landroid/util/Size;)V
    .locals 16
    ...
    iput v0, v1, LJ0/a;->a:I

    iput-object v2, v1, LJ0/a;->g:Landroid/location/Location;

    move-object/from16 v5, p6

    iput-object v5, v1, LJ0/a;->h:LJ0/a$c;
    ...
    invoke-virtual {v5}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->K4()Z
    ...
    invoke-direct {v5}, Lzb/t;-><init>()V

    iput-object v5, v1, LJ0/a;->b:Lzb/o;

    goto :goto_0

    :cond_0
    new-instance v5, Lzb/w;

    invoke-direct {v5}, Lzb/w;-><init>()V
    ...
    iput-object v5, v1, LJ0/a;->c:Landroid/view/Surface;
    ...
    iput-object v5, v1, LJ0/a;->d:Landroid/media/CamcorderProfile;
    ...
    iget-object v5, v1, LJ0/a;->d:Landroid/media/CamcorderProfile;
    ...
    invoke-static {v0, v8}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v7, v0}, LC/F;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7}, Ln4/z;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    const-string v9, "genContentValues: path="

    invoke-static {v9, v8}, LB2/p;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v9, v1, LJ0/a;->f:Landroid/content/ContentValues;

    invoke-virtual {v9, v0}, Landroid/content/ContentValues;->getAsString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, LJ0/a;->e:Ljava/lang/String;
    ...
    invoke-direct {v0, v7}, Lr4/a;-><init>(Landroid/content/Context;)V

    iput-object v0, v1, LJ0/a;->m:Lr4/a;

    invoke-virtual {v0}, Lr4/a;->a()V

    iget-object v0, v1, LJ0/a;->m:Lr4/a;

    iget-object v7, v1, LJ0/a;->f:Landroid/content/ContentValues;

    iput-object v7, v0, Lr4/a;->d:Landroid/content/ContentValues;
    ...
    invoke-direct {v10}, Lzb/p;-><init>()V

    new-instance v12, Ljava/util/ArrayList;

    invoke-direct {v12}, Ljava/util/ArrayList;-><init>()V

    iput-boolean v5, v10, Lzb/p;->a:Z

    iput v5, v10, Lzb/p;->f:I

    iget-object v13, v1, LJ0/a;->d:Landroid/media/CamcorderProfile;

    iget v14, v13, Landroid/media/CamcorderProfile;->fileFormat:I

    iput v14, v10, Lzb/p;->l:I

    iget v14, v13, Landroid/media/CamcorderProfile;->videoCodec:I

    iput v14, v10, Lzb/p;->g:I
    ...
    iput-object v15, v10, Lzb/p;->k:Landroid/util/Size;

    iget-object v13, v1, LJ0/a;->d:Landroid/media/CamcorderProfile;

    iget v13, v13, Landroid/media/CamcorderProfile;->videoFrameRate:I

    iput v13, v10, Lzb/p;->j:I

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13, v9}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v9, v1, LJ0/a;->d:Landroid/media/CamcorderProfile;
    ...
    :goto_1
    iput v7, v10, Lzb/p;->h:I

    const v7, 0x4e200

    iput v7, v10, Lzb/p;->d:I

    iget-object v7, v1, LJ0/a;->d:Landroid/media/CamcorderProfile;

    iget v8, v7, Landroid/media/CamcorderProfile;->audioChannels:I

    iput v8, v10, Lzb/p;->b:I

    iget v8, v7, Landroid/media/CamcorderProfile;->audioSampleRate:I

    iput v8, v10, Lzb/p;->e:I

    iget v7, v7, Landroid/media/CamcorderProfile;->audioCodec:I

    iput v7, v10, Lzb/p;->c:I

    iput v6, v10, Lzb/p;->o:I
    ...
    iput-object v7, v10, Lzb/p;->n:Landroid/util/Pair;
    ...
    iget-object v0, v1, LJ0/a;->b:Lzb/o;

    invoke-interface {v0, v3, v4}, Lzb/o;->g(J)V
    ...
    iput v0, v10, Lzb/p;->q:I

    iput-object v12, v10, Lzb/p;->r:Ljava/util/ArrayList;

    iget-object v0, v1, LJ0/a;->m:Lr4/a;

    iget-object v2, v1, LJ0/a;->b:Lzb/o;

    invoke-virtual {v0, v2, v5}, Lr4/a;->k(Lzb/o;Z)V

    iget-object v0, v1, LJ0/a;->b:Lzb/o;

    iget-object v2, v1, LJ0/a;->c:Landroid/view/Surface;

    invoke-interface {v0, v2}, Lzb/o;->e(Landroid/view/Surface;)V

    iget-object v0, v1, LJ0/a;->b:Lzb/o;

    invoke-interface {v0, v10}, Lzb/o;->u(Lzb/p;)V

    iget-object v0, v1, LJ0/a;->b:Lzb/o;

    invoke-interface {v0}, Lzb/o;->prepare()V

    iget-object v0, v1, LJ0/a;->b:Lzb/o;

    new-instance v2, LJ0/a$a;

    invoke-direct {v2, v1}, LJ0/a$a;-><init>(LJ0/a;)V

    invoke-interface {v0, v2}, Lzb/o;->d(Lzb/o$a;)V

    iget-object v0, v1, LJ0/a;->b:Lzb/o;

    new-instance v2, LJ0/a$b;

    invoke-direct {v2, v1}, LJ0/a$b;-><init>(LJ0/a;)V

    invoke-interface {v0, v2}, Lzb/o;->y(Lzb/o$c;)V
    :try_end_0
    ...
    iget-object v3, v1, LJ0/a;->e:Ljava/lang/String;
...
.method public final a()V
    ...
    iget-object v0, p0, LJ0/a;->e:Ljava/lang/String;
    ...
    iput-object v2, p0, LJ0/a;->e:Ljava/lang/String;
...
.method public final b()V
    ...
    iget-object v3, p0, LJ0/a;->b:Lzb/o;

    invoke-interface {v3}, Lzb/o;->reset()V
    ...
    invoke-interface {v1}, Lzb/o;->release()V
    ...
    iget-object v0, p0, LJ0/a;->c:Landroid/view/Surface;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object p0, p0, LJ0/a;->e:Ljava/lang/String;
