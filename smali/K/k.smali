...
.method public final a()LJ/m;
    ...
    sget-object v2, LK/c;->c:Ljava/lang/Boolean;
    ...
    sput-object v2, LK/c;->c:Ljava/lang/Boolean;
    ...
    invoke-virtual {v0, v2, v3}, LW9/a;->h(Ljava/lang/String;F)F
    ...
    invoke-virtual {v0, v6, v15}, LW9/a;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    :goto_2
    iget-object v0, v8, LK/g;->d:Landroid/content/Context;
    ...
    invoke-direct/range {v7 .. v14}, LK/e;-><init>(LK/g;DDJ)V

    invoke-static {v0, v7}, LYi/b;->G(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-static {v0}, LJ/b;->c(I)Ljava/util/ArrayList;
    ...
    iget-object v5, v2, LJ/m;->a:Ljava/lang/String;
