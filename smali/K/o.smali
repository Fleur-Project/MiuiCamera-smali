...
.method public final a()LJ/m;
    ...
    sget-object v4, LK/c;->c:Ljava/lang/Boolean;

    if-nez v4, :cond_0

    const-string v4, "cam.app.use.debug.gps"

    invoke-static {v4, v3}, Lac/f;->c(Ljava/lang/String;Z)Z
    ...
    sput-object v4, LK/c;->c:Ljava/lang/Boolean;
    ...
    :goto_0
    invoke-virtual/range {p0 .. p0}, LK/o;->c()Ljava/util/HashMap;
    ...
    iget-wide v11, v10, LJ/h;->a:D

    iget-wide v13, v10, LJ/h;->b:D
    ...
    :goto_1
    iget-wide v12, v10, LJ/h;->c:D

    iget-wide v14, v10, LJ/h;->d:D
    ...
    invoke-virtual/range {p0 .. p0}, LK/o;->d()Ljava/util/ArrayList;
    ...
    iget-object v3, v1, LJ/m;->a:Ljava/lang/String;
