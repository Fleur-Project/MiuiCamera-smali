...
.field public final e:Lrb/a;

.field public final f:Landroid/net/ConnectivityManager;

.field public final g:LK0/d$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LK0/d;->m:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-boolean v0, p0, LK0/d;->j:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, LK0/d;->c:Ljava/util/HashMap;

    new-instance v0, LL0/a;

    invoke-direct {v0, p1}, LL0/a;-><init>(Lcom/android/camera/ActivityBase;)V

    iput-object v0, p0, LK0/d;->l:LL0/a;

    new-instance v0, Lrb/a;

    new-instance v1, LK0/d$a;

    invoke-direct {v1, p0}, LK0/d$a;-><init>(LK0/d;)V

    invoke-direct {v0, p1, v1}, Lrb/a;-><init>(Landroid/content/ContextWrapper;Lrb/a$b$a;)V

    iput-object v0, p0, LK0/d;->e:Lrb/a;
    ...
    iput-object v0, p0, LK0/d;->f:Landroid/net/ConnectivityManager;

    new-instance v0, LK0/d$b;

    invoke-direct {v0}, Landroid/net/ConnectivityManager$NetworkCallback;-><init>()V

    iput-object v0, p0, LK0/d;->g:LK0/d$b;

    const/4 v0, 0x2

    invoke-static {p1, v0}, Lub/c;->q(Landroid/content/ContextWrapper;I)Lub/c;

    move-result-object p1

    iput-object p1, p0, LK0/d;->d:Lub/c;
...
.method public final declared-synchronized B(Ljava/util/HashSet;)I
    ...
    iget-object v0, p0, LK0/d;->c:Ljava/util/HashMap;
    ...
    iget v4, v3, LK0/c;->h:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_0

    sget-object v4, LK0/d;->m:Ljava/lang/String;

    invoke-virtual {v3}, LK0/c;->toString()Ljava/lang/String;
...
.method public final declared-synchronized H(LK0/c;Z)V
    .locals 1
    .param p1    # LK0/c;
    ...
    :try_start_0
    iget-boolean v0, p0, LK0/d;->j:Z

    if-eq v0, p2, :cond_0

    iput-boolean p2, p0, LK0/d;->j:Z

    if-nez p2, :cond_0

    if-eqz p1, :cond_0

    iget-object p2, p0, LK0/d;->b:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz p2, :cond_0

    invoke-interface {p2, p1}, LK0/b;->onConnectivityStateChanged(LK0/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized T()V
    ...
    :try_start_0
    iget-object v0, p0, LK0/d;->d:Lub/c;
...
.method public final declared-synchronized X(Ljava/lang/String;Landroid/view/Surface;)V
    ...
    sget-object v1, LN0/d0;->e:Landroid/util/Size;
    ...
    sget-object v1, LK0/d;->m:Ljava/lang/String;
    ...
    iput-object v0, p0, LK0/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iget-object v0, p0, LK0/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iget-object p2, p0, LK0/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iput p1, p0, LK0/d;->k:I

    iput-boolean v6, p0, LK0/d;->i:Z
    :try_end_2
    ...
    :try_start_3
    sget-object p2, LK0/d;->m:Ljava/lang/String;

    const-string/jumbo v0, "startStreaming failed: "

    invoke-static {v2, p2, v0, p1}, Lxb/b;->e(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    :try_end_3
...
.method public final declared-synchronized g0()V
    ...
    invoke-static {v2, v1, v3, v0}, Lxb/b;->e(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public final declared-synchronized m(I)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, LK0/d;->t(I)LK0/c;
    ...
    iput v2, v1, LK0/c;->i:I

    iget-object v2, p0, LK0/d;->b:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz v2, :cond_0

    invoke-interface {v2, v1}, LK0/b;->onConnectivityStateChanged(LK0/c;)V
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, LK0/d;->d:Lub/c;
    ...
    invoke-virtual {v0, v1, p1}, Lac/e;->f(II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized n(I)V
    ...
    iput v1, v0, LK0/c;->i:I

    iget-object v1, p0, LK0/d;->b:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz v1, :cond_0

    invoke-interface {v1, v0}, LK0/b;->onConnectivityStateChanged(LK0/c;)V
...
.method public final declared-synchronized onConnectionResult(IILjava/lang/String;I)V
    ...
    invoke-static {p3}, LK0/c;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object p2, p0, LK0/d;->c:Ljava/util/HashMap;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p2}, LK0/d;->t(I)LK0/c;
    ...
    sget-object p3, LK0/c;->j:Ljava/lang/String;

    invoke-static {v1, p3, p2}, Landroid/util/Log;->println(ILjava/lang/String;Ljava/lang/String;)I

    :goto_2
    iput-object v4, p1, LK0/c;->e:Ljava/lang/String;

    iput v3, p1, LK0/c;->f:I
...
.method public final declared-synchronized onDisconnection(II)V
    ...
    iput-object p2, p1, LK0/c;->e:Ljava/lang/String;

    const/4 p2, -0x1

    iput p2, p1, LK0/c;->f:I
...
.method public final declared-synchronized onEndpointFound(IILjava/lang/String;[B)V
    ...
    :cond_0
    iget-object p4, p0, LK0/d;->c:Ljava/util/HashMap;
    ...
    invoke-direct {p4, p2, p3}, LK0/c;-><init>(ILjava/lang/String;)V
    ...
    :cond_1
    invoke-static {p3}, LK0/c;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p4, LK0/c;->d:Ljava/lang/String;
    ...
    iput-wide p1, p4, LK0/c;->g:J

    const/4 p1, 0x1

    iput p1, p4, LK0/c;->h:I

    iget-object p1, p0, LK0/d;->a:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz p1, :cond_2

    invoke-interface {p1, p4}, LK0/a;->onAvailabilityStateChanged(LK0/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized onEndpointLost(IILjava/lang/String;)V
    ...
    invoke-direct {v0, p2, p3}, LK0/c;-><init>(ILjava/lang/String;)V
    ...
    iput-wide p1, v0, LK0/c;->g:J

    const/4 p1, 0x2

    iput p1, v0, LK0/c;->h:I

    iget-object p1, p0, LK0/d;->a:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz p1, :cond_2

    invoke-interface {p1, v0}, LK0/a;->onAvailabilityStateChanged(LK0/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final registerProtocol()V
    ...
    iget-object v0, p0, LK0/d;->e:Lrb/a;

    invoke-virtual {v0}, Lrb/a;->a()V

    iget-object v0, p0, LK0/d;->f:Landroid/net/ConnectivityManager;
    ...
    iget-object v2, p0, LK0/d;->g:LK0/d$b;
    ...
    invoke-virtual {v0, p0}, Lub/c;->o(Lub/b;)V

    iget-object v0, p0, LK0/d;->d:Lub/c;

    invoke-virtual {v0}, Lub/c;->i()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized t(I)LK0/c;
    .locals 3
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public final unRegisterProtocol()V
    ...
    invoke-virtual {p0}, LK0/d;->g0()V

    invoke-virtual {p0}, LK0/d;->e0()V
    ...
    iget-object v1, v0, Lrb/a;->c:Lrb/a$a;

    if-eqz v1, :cond_0

    iget-object v2, v0, Lrb/a;->a:Landroid/content/Context;

    invoke-virtual {v2, v1}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    const/4 v1, 0x0

    iput-object v1, v0, Lrb/a;->c:Lrb/a$a;
    ...
    iget-object v1, p0, LK0/d;->g:LK0/d$b;
    ...
    iget-object v1, v0, Lub/c;->l:Ljava/util/LinkedList;
