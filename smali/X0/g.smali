...
.method public final a()LVe/b;
    ...
    iget-object v0, p0, LX0/g;->a:LVe/b;
    ...
    invoke-direct {v0, v1, v2}, LVe/b;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, LX0/g;->a:LVe/b;
    ...
    :cond_1
    :goto_2
    iget-object p0, p0, LX0/g;->a:LVe/b;
...
.method public final b(LX0/d;)V
    ...
    iget-object v1, p1, LX0/d;->g:Landroid/util/Size;
    ...
    iget-object v0, p1, LX0/d;->c:Landroid/hardware/HardwareBuffer;
    ...
    invoke-direct {v2, v6, p0, p1}, LC/A1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-direct {v0, v2}, LAc/a;-><init>(Ljava/lang/Runnable;)V

    invoke-virtual {p0}, LX0/g;->a()LVe/b;

    move-result-object p0

    iget-object p0, p0, LVe/b;->b:LTe/k;
    ...
    :cond_1
    iget-object p0, p0, LTe/k;->b:Landroid/os/Handler;

    if-eqz p0, :cond_2

    const-wide/16 v6, 0x0

    invoke-virtual {v0, p0, v6, v7}, LAc/a;->a(Landroid/os/Handler;J)Z

    :cond_2
    :goto_0
    iget-object p0, p1, LX0/d;->b:LX0/e;

    iget-boolean p0, p0, LX0/e;->u:Z

    if-eqz p0, :cond_3

    iget-object p0, p1, LX0/d;->c:Landroid/hardware/HardwareBuffer;
    ...
    invoke-static {v4, v5, p1, p0}, LC/L;->d(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
