...
# virtual methods
.method public final Fe(Lcom/android/camera/module/BaseModule;)V
    .locals 5
    ...
    invoke-interface {v0}, LX3/M0;->B3()V
...
.method public final J4(Lcom/android/camera/ui/i0;)V
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/effect/EffectController;->T(Lcom/android/camera/ui/i0;)V

    return-void
.end method

.method public final Ke(Lcom/android/camera/module/BaseModule;)V
    .locals 4
    ...
    invoke-interface {p1}, Lu3/k;->z()Z

    move-result p1

    xor-int/2addr p1, v1

    invoke-static {p0, v0, p1}, Lcom/android/camera/fragment/dialog/CameraExitHintDialogFragment;->Qb(Landroidx/fragment/app/FragmentManager;IZ)V
...
.method public final c4(Lcom/android/camera/module/BaseModule;)Z
    ...
    invoke-direct {v1, v0, v2}, LC3/W;-><init>(Ljava/lang/Object;I)V
    ...
    const-string/jumbo p0, "needBypassData: focus view visible"
    ...
    const-string/jumbo p0, "needBypassData: shot in progress"
    ...
    const-string/jumbo p1, "needBypassData: manual module, non-autofocus, value: "
    ...
    invoke-static {p0}, Lac/f;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public final clear()V
    ...
    sget-object p0, Ln6/b$a;->a:Ln6/b;

    iget-object p0, p0, Ln6/b;->f:Ljava/util/HashMap;
...
.method public final ie(Lcom/android/camera/module/BaseModule;)Lu4/j;
    .locals 0

    new-instance p0, Lu4/j;

    invoke-direct {p0, p1}, Lu4/j;-><init>(Lcom/android/camera/module/BaseModule;)V
...
.method public final m2(Lcom/android/camera/module/BaseModule;)Lu3/e;
    .locals 0
...
.method public final ub(Lcom/android/camera/module/BaseModule;)Z
    .locals 3
    ...
    invoke-interface {p0, p1}, Lcom/android/camera/module/N;->Gf(Ljava/lang/String;)V
    ...
    invoke-direct {p1, v1}, LM4/t;-><init>(I)V

    new-instance v1, LC3/a2;

    const/4 v2, 0x6

    invoke-direct {v1, p1, v2}, LC3/a2;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {p1, v1, v2, p0}, LI4/a;->h(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p0}, Lg0/s;->w(I)Z
    ...
    :cond_3
    invoke-interface {v1}, LX3/A0;->ci()V
