...
.method public constructor <init>(Landroidx/fragment/app/FragmentActivity;)V
    ...
    iput-object p1, p0, LZ0/g;->a:Landroidx/fragment/app/FragmentActivity;
...
.method public final a(Z)V
    ...
    sget v0, LWa/h;->msg_install_success:I

    goto :goto_0

    :cond_0
    sget v0, LWa/h;->msg_install_fail:I

    :goto_0
    iget-object v1, p0, LZ0/g;->a:Landroidx/fragment/app/FragmentActivity;
    ...
    invoke-static {v1, v0, v2}, LC/s3;->e(Landroid/content/Context;Ljava/lang/String;Z)V

    iget-object v0, p0, LZ0/g;->c:Lmiuix/appcompat/app/ProgressDialog;
    ...
    :cond_1
    iget-object v0, p0, LZ0/g;->e:LZ0/h;

    if-eqz v0, :cond_2

    invoke-interface {v0, p1}, LZ0/h;->c(Z)V
    ...
    iput-object p1, p0, LZ0/g;->c:Lmiuix/appcompat/app/ProgressDialog;
...
.method public final b(LZ0/h;)V
    ...
    iget-object p1, p0, LZ0/g;->a:Landroidx/fragment/app/FragmentActivity;

    const-string v0, "context"

    invoke-static {p1, v0}, Lkotlin/jvm/internal/k;->f(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {p1}, Lgb/b;->a(Landroid/app/Activity;)Z
    ...
    invoke-static {p1, v0}, Lfc/f;->x(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, p0}, LZ0/a;-><init>(LZ0/g;)V

    sget v1, LWa/h;->app_name_media_editor:I
    ...
    sget v3, LWa/h;->confirm_install_app_title:I
    ...
    sget v3, LWa/h;->confirm_install_app_message:I
    ...
    sget p1, LWa/h;->install_confirmed:I
    ...
    invoke-direct {p1, p0}, LZ0/b;-><init>(LZ0/g;)V
    ...
    invoke-direct {p1, p0}, LZ0/c;-><init>(LZ0/g;)V
