...
# direct methods
.method public constructor <init>(Landroidx/appfunctions/internal/AppSearchAppFunctionReader$AppSearchChannelObserver;LTg/u;Landroidx/appfunctions/internal/AppSearchAppFunctionReader;Landroidx/appsearch/app/GlobalSearchSession;Landroidx/appfunctions/AppFunctionSearchSpec;Lnf/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Landroidx/appfunctions/internal/AppSearchAppFunctionReader$searchAppFunctions$2$observerJob$1;->$$this$callbackFlow:LTg/u;
...
.method public final create(Ljava/lang/Object;Lnf/d;)Lnf/d;
    ...
    iget-object v2, p0, Landroidx/appfunctions/internal/AppSearchAppFunctionReader$searchAppFunctions$2$observerJob$1;->$$this$callbackFlow:LTg/u;
...
.method public final invoke(LRg/D;Lnf/d;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/appfunctions/internal/AppSearchAppFunctionReader$searchAppFunctions$2$observerJob$1;->create(Ljava/lang/Object;Lnf/d;)Lnf/d;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/appfunctions/internal/AppSearchAppFunctionReader$searchAppFunctions$2$observerJob$1;->invoke(LRg/D;Lnf/d;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v2}, Landroidx/appfunctions/internal/AppSearchAppFunctionReader$AppSearchChannelObserver;->observe()LUg/f;
    ...
    sget-object v8, LQg/c;->b:LQg/c;

    const-wide/32 v10, 0xf423f

    invoke-static {v10, v11, v8}, LAc/i;->w(JLQg/c;)J

    move-result-wide v10

    invoke-static {v4, v5}, LQg/a;->b(J)Z

    move-result v12

    if-eqz v12, :cond_4

    invoke-static {v10, v11}, LQg/a;->b(J)Z
    ...
    invoke-static {v13, v14}, LAc/i;->g(J)J
    ...
    invoke-static/range {v13 .. v18}, LEf/f;->H(JJJ)J

    move-result-wide v4

    invoke-static {v4, v5}, LAc/i;->g(J)J
    ...
    invoke-static {v4, v5, v9, v10}, LQg/a;->a(JJ)J
    ...
    invoke-static {v9, v10, v4, v5}, LQg/a;->a(JJ)J
    ...
    iget-object v9, v10, LQg/c;->a:Ljava/util/concurrent/TimeUnit;

    iget-object v8, v8, LQg/c;->a:Ljava/util/concurrent/TimeUnit;
    ...
    :cond_12
    new-instance v6, LUg/j;

    invoke-direct {v6, v4, v5}, LUg/j;-><init>(J)V

    new-instance v4, LUg/k;

    const/4 v5, 0x0

    invoke-direct {v4, v6, v2, v5}, LUg/k;-><init>(LUg/j;LUg/f;Lnf/d;)V

    new-instance v2, LVg/m;

    invoke-direct {v2, v4}, LVg/m;-><init>(LUg/k;)V

    :goto_4
    new-instance v4, Landroidx/appfunctions/internal/AppSearchAppFunctionReader$searchAppFunctions$2$observerJob$1$1;

    iget-object v5, v0, Landroidx/appfunctions/internal/AppSearchAppFunctionReader$searchAppFunctions$2$observerJob$1;->$$this$callbackFlow:LTg/u;
    ...
    invoke-direct {v4, v5, v6, v7, v8}, Landroidx/appfunctions/internal/AppSearchAppFunctionReader$searchAppFunctions$2$observerJob$1$1;-><init>(LTg/u;Landroidx/appfunctions/internal/AppSearchAppFunctionReader;Landroidx/appsearch/app/GlobalSearchSession;Landroidx/appfunctions/AppFunctionSearchSpec;)V

    iput v3, v0, Landroidx/appfunctions/internal/AppSearchAppFunctionReader$searchAppFunctions$2$observerJob$1;->label:I

    invoke-interface {v2, v4, v0}, LUg/f;->collect(LUg/g;Lnf/d;)Ljava/lang/Object;
