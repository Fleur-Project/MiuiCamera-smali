...
.method private static toJetpackProperty(Landroid/app/appsearch/AppSearchSchema$PropertyConfig;)Landroidx/appsearch/app/AppSearchSchema$PropertyConfig;
    ...
    invoke-static {p0}, Landroidx/appfunctions/o;->m(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Landroidx/appsearch/platformstorage/i;->f(Landroid/app/appsearch/AppSearchSchema$StringPropertyConfig;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroidx/appsearch/platformstorage/s;->a(Landroid/app/appsearch/AppSearchSchema$StringPropertyConfig;)I
    ...
    invoke-static {p0}, Landroidx/appsearch/platformstorage/u;->e(Landroid/app/appsearch/AppSearchSchema$LongPropertyConfig;)Ljava/lang/String;

    move-result-object v2

    invoke-direct {v0, v2}, Landroidx/appsearch/app/AppSearchSchema$LongPropertyConfig$Builder;-><init>(Ljava/lang/String;)V

    invoke-static {p0}, Landroidx/appsearch/platformstorage/v;->b(Landroid/app/appsearch/AppSearchSchema$LongPropertyConfig;)I
    ...
    :cond_3
    invoke-static {p0}, Landroidx/appfunctions/d;->m(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Landroidx/appfunctions/l;->e(Landroid/app/appsearch/AppSearchSchema$PropertyConfig;)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p0}, Landroidx/appfunctions/n;->m(Ljava/lang/Object;)Z
    ...
    :cond_5
    invoke-static {p0}, Landroidx/appfunctions/o;->n(Ljava/lang/Object;)Z
    ...
    :cond_6
    invoke-static {p0}, Landroidx/appfunctions/p;->k(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Landroidx/appfunctions/g;->d(Landroid/app/appsearch/AppSearchSchema$DocumentPropertyConfig;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0}, Landroidx/appfunctions/h;->g(Landroid/app/appsearch/AppSearchSchema$DocumentPropertyConfig;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroidx/appsearch/platformstorage/w;->a(Landroid/app/appsearch/AppSearchSchema$DocumentPropertyConfig;)I
    ...
    invoke-static {p0}, Landroidx/appfunctions/j;->l(Landroid/app/appsearch/AppSearchSchema$DocumentPropertyConfig;)Z
...
.method public static toJetpackSchema(Landroid/app/appsearch/AppSearchSchema;)Landroidx/appsearch/app/AppSearchSchema;
    ...
    invoke-static {p0}, Landroidx/appfunctions/o;->i(Landroid/app/appsearch/AppSearchSchema;)Ljava/util/List;
...
.method public static toPlatformSchema(Landroidx/appsearch/app/AppSearchSchema;)Landroid/app/appsearch/AppSearchSchema;
    ...
    invoke-static {}, Landroidx/appsearch/platformstorage/u;->g()V
    ...
    invoke-static {v0, v1}, Landroidx/appsearch/platformstorage/n;->j(Landroid/app/appsearch/AppSearchSchema$Builder;Landroid/app/appsearch/AppSearchSchema$PropertyConfig;)V
    ...
    :cond_2
    invoke-static {v0}, Landroidx/appfunctions/a;->d(Landroid/app/appsearch/AppSearchSchema$Builder;)Landroid/app/appsearch/AppSearchSchema;
