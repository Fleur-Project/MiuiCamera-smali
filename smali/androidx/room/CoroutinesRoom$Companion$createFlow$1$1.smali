...
# instance fields
.field final synthetic $$this$flow:LUg/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LUg/g<",
            "TR;>;"
...
# direct methods
.method public constructor <init>(ZLandroidx/room/RoomDatabase;LUg/g;[Ljava/lang/String;Ljava/util/concurrent/Callable;Lnf/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    iput-object p3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:LUg/g;
...
.method public final create(Ljava/lang/Object;Lnf/d;)Lnf/d;
    ...
    iget-object v3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:LUg/g;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;-><init>(ZLandroidx/room/RoomDatabase;LUg/g;[Ljava/lang/String;Ljava/util/concurrent/Callable;Lnf/d;)V
...
.method public final invoke(LRg/D;Lnf/d;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->create(Ljava/lang/Object;Lnf/d;)Lnf/d;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->invoke(LRg/D;Lnf/d;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v7, v1, v8}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;-><init>([Ljava/lang/String;LTg/h;)V

    sget-object v1, Ljf/z;->a:Ljf/z;

    invoke-interface {v8, v1}, LTg/x;->i(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v5}, Lnf/g;->get(Lnf/g$b;)Lnf/g$a;
    ...
    invoke-virtual {v3}, Landroidx/room/TransactionElement;->getTransactionDispatcher$room_ktx_release()Lnf/e;
    ...
    invoke-static {v3}, Landroidx/room/CoroutinesRoomKt;->getTransactionDispatcher(Landroidx/room/RoomDatabase;)LRg/A;
    ...
    invoke-static {v3}, Landroidx/room/CoroutinesRoomKt;->getQueryDispatcher(Landroidx/room/RoomDatabase;)LRg/A;
    ...
    invoke-static {v5, v4, v6}, LTg/k;->a(ILTg/a;I)LTg/c;
    ...
    invoke-direct/range {v5 .. v11}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;-><init>(Landroidx/room/RoomDatabase;Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;LTg/h;Ljava/util/concurrent/Callable;LTg/h;Lnf/d;)V

    const/4 v6, 0x2

    invoke-static {p1, v3, v4, v5, v6}, LRg/f;->a(LRg/D;Lnf/e;LRg/F;Lyf/p;I)LRg/B0;

    iget-object p1, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:LUg/g;

    iput v2, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->label:I

    invoke-static {p1, v10, v2, p0}, LUg/h;->a(LUg/g;LTg/w;ZLnf/d;)Ljava/lang/Object;
