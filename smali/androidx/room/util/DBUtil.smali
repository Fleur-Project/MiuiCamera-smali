...
.method public static final dropFtsSyncTriggers(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    invoke-virtual {v0, v3}, Llf/b;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v2}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    invoke-static {v0}, LEf/e;->k(Ljava/util/List;)Llf/b;

    move-result-object v0

    invoke-virtual {v0, v4}, Llf/b;->listIterator(I)Ljava/util/ListIterator;
    ...
    check-cast v1, Llf/b$b;

    invoke-virtual {v1}, Llf/b$b;->hasNext()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1}, Llf/b$b;->next()Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v4}, LPg/m;->M(Ljava/lang/String;Ljava/lang/String;Z)Z
