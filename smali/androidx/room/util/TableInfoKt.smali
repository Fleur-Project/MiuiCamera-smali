...
.method private static final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v2, v5}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v10}, Llf/c;-><init>()V
    ...
    invoke-virtual {v10, v13, v12}, Llf/c;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_2
    invoke-virtual {v10}, Llf/c;->c()Llf/c;
    ...
    invoke-static {v2, v1}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readForeignKeyFieldMappings(Landroid/database/Cursor;)Ljava/util/List;
    ...
    invoke-virtual {v4, v5}, Llf/b;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Lkf/v;->t0(Ljava/util/AbstractList;)Ljava/util/List;
...
.method private static final readForeignKeys(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v6, v8}, Llf/g;->add(Ljava/lang/Object;)Z

    goto/16 :goto_0

    :cond_4
    invoke-static {v6}, LC5/b;->c(Llf/g;)Llf/g;
    ...
    invoke-static {p0, v0}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readIndex(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;Z)Landroidx/room/util/TableInfo$Index;
    ...
    invoke-static {p0, v5}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readIndices(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    :cond_0
    new-instance v5, Llf/g;

    invoke-direct {v5}, Llf/g;-><init>()V
    ...
    invoke-static {p1, v6}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    return-object v6

    :cond_3
    :try_start_1
    invoke-virtual {v5, v7}, Llf/g;->add(Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-static {v5}, LC5/b;->c(Llf/g;)Llf/g;
