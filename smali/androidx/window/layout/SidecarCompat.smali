...
.method public validateExtensionInterface()Z
    ...
    :cond_1
    const-string/jumbo v3, "setSidecarCallback"
    ...
    :cond_c
    const-string/jumbo v1, "onWindowLayoutChangeListenerRemoved"
    ...
    const-string/jumbo v1, "null cannot be cast to non-null type kotlin.collections.List<androidx.window.sidecar.SidecarDisplayFeature>"
    ...
    invoke-static {v1, v2}, Lkotlin/jvm/internal/k;->k(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
