...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(LRg/D;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V",
        "",
        "TAG",
        "Ljava/lang/String;",
        "",
...
.method public static final maybeLaunchUnfinishedWorkListener(LRg/D;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V
    .locals 7
    ...
    invoke-interface {p2}, Landroidx/work/impl/model/WorkSpecDao;->hasUnfinishedWorkFlow()LUg/f;
    ...
    invoke-direct {p3, v0}, Landroidx/work/impl/UnfinishedWorkListenerKt$maybeLaunchUnfinishedWorkListener$1;-><init>(Lnf/d;)V

    new-instance v2, LUg/n;

    invoke-direct {v2, p2, p3}, LUg/n;-><init>(LUg/f;Lyf/r;)V

    sget-object v5, LTg/a;->b:LTg/a;

    instance-of p2, v2, LVg/o;
    ...
    invoke-static {v2, v0, v4, v5, p2}, LVg/o$a;->a(LVg/o;LRg/A;ILTg/a;I)LUg/f;
    ...
    invoke-direct/range {v1 .. v6}, LVg/i;-><init>(LUg/f;LRg/A;ILTg/a;I)V

    move-object p2, v1

    :goto_0
    invoke-static {p2}, LEg/x;->k(LUg/f;)LUg/f;

    move-result-object p2

    new-instance p3, Landroidx/work/impl/UnfinishedWorkListenerKt$maybeLaunchUnfinishedWorkListener$2;

    invoke-direct {p3, p1, v0}, Landroidx/work/impl/UnfinishedWorkListenerKt$maybeLaunchUnfinishedWorkListener$2;-><init>(Landroid/content/Context;Lnf/d;)V

    new-instance p1, LUg/q;

    invoke-direct {p1, p2, p3}, LUg/q;-><init>(LUg/f;Lyf/p;)V

    new-instance p2, LUg/i;

    invoke-direct {p2, p1, v0}, LUg/i;-><init>(LUg/q;Lnf/d;)V

    const/4 p1, 0x3

    invoke-static {p0, v0, v0, p2, p1}, LRg/f;->a(LRg/D;Lnf/e;LRg/F;Lyf/p;I)LRg/B0;
