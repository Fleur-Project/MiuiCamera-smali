...
.field private final workerJob:LRg/r;
...
.method public constructor <init>(Landroidx/work/impl/WorkerWrapper$Builder;)V
    ...
    iput-object p1, p0, Landroidx/work/impl/WorkerWrapper;->workerJob:LRg/r;
...
.method public static final synthetic access$getWorkerJob$p(Landroidx/work/impl/WorkerWrapper;)LRg/r;
    .locals 0

    iget-object p0, p0, Landroidx/work/impl/WorkerWrapper;->workerJob:LRg/r;
...
.method public static final synthetic access$runWorker(Landroidx/work/impl/WorkerWrapper;Lnf/d;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/work/impl/WorkerWrapper;->runWorker(Lnf/d;)Ljava/lang/Object;
...
.method private final iterativelyFailWorkAndDependents(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lkf/o;->K([Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-static {p1}, Lkf/s;->S(Ljava/util/List;)Ljava/lang/Object;
...
.method private final runWorker(Lnf/d;)Ljava/lang/Object;
    .locals 22
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, v1, v0}, Landroidx/work/impl/WorkerWrapper$runWorker$1;-><init>(Landroidx/work/impl/WorkerWrapper;Lnf/d;)V
    ...
    invoke-direct {v8, v1}, Landroidx/work/impl/i;-><init>(Landroidx/work/impl/WorkerWrapper;)V
    ...
    invoke-static {v9}, LEf/e;->y(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v9, v10}, Lkf/v;->o0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v7}, Landroidx/work/Configuration;->getWorkerCoroutineContext()Lnf/g;
    ...
    invoke-direct/range {v9 .. v21}, Landroidx/work/WorkerParameters;-><init>(Ljava/util/UUID;Landroidx/work/Data;Ljava/util/Collection;Landroidx/work/WorkerParameters$RuntimeExtras;IILjava/util/concurrent/Executor;Lnf/g;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/WorkerFactory;Landroidx/work/ProgressUpdater;Landroidx/work/ForegroundUpdater;)V
    ...
    invoke-interface {v2}, Lnf/d;->getContext()Lnf/g;

    move-result-object v6

    sget-object v7, LRg/m0$a;->a:LRg/m0$a;

    invoke-interface {v6, v7}, Lnf/g;->get(Lnf/g$b;)Lnf/g$a;

    move-result-object v6

    invoke-static {v6}, Lkotlin/jvm/internal/k;->c(Ljava/lang/Object;)V

    check-cast v6, LRg/m0;
    ...
    invoke-interface {v6, v7}, LRg/m0;->k(Lyf/l;)LRg/W;
    ...
    invoke-interface {v6}, LRg/m0;->isCancelled()Z
    ...
    invoke-static {v4}, LMe/Z;->u(Ljava/util/concurrent/Executor;)LRg/A;
    ...
    invoke-direct {v6, v1, v5, v0, v7}, Landroidx/work/impl/WorkerWrapper$runWorker$result$1;-><init>(Landroidx/work/impl/WorkerWrapper;Landroidx/work/ListenableWorker;Landroidx/work/ForegroundUpdater;Lnf/d;)V
    ...
    invoke-static {v4, v6, v2}, LRg/f;->d(Lnf/g;Lyf/p;Lnf/d;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v7, v1, v7}, Landroidx/work/impl/WorkerWrapper$Resolution$Failed;-><init>(Landroidx/work/ListenableWorker$Result;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    invoke-static {v4, v1, v5}, LC/f2;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private final trySetRunning()Z
    ...
    invoke-direct {v1, p0}, Landroidx/work/impl/j;-><init>(Landroidx/work/impl/WorkerWrapper;)V
...
.method public final launch()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-interface {v0}, Landroidx/work/impl/utils/taskexecutor/TaskExecutor;->getTaskCoroutineDispatcher()LRg/A;
    ...
    invoke-virtual {v0, v1}, Lnf/a;->plus(Lnf/g;)Lnf/g;
    ...
    invoke-direct {v1, p0, v2}, Landroidx/work/impl/WorkerWrapper$launch$1;-><init>(Landroidx/work/impl/WorkerWrapper;Lnf/d;)V

    const/4 p0, 0x2

    invoke-static {v0, v2, v1, p0, v2}, Landroidx/work/ListenableFutureKt;->launchFuture$default(Lnf/g;LRg/F;Lyf/p;ILjava/lang/Object;)Lcom/google/common/util/concurrent/ListenableFuture;
