...
.field private final mCoroutineDispatcher:LRg/A;
...
.field private volatile mJob:LRg/m0;
...
.method public constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;Landroidx/work/impl/StartStopToken;)V
    ...
    invoke-interface {p2}, Landroidx/work/impl/utils/taskexecutor/TaskExecutor;->getTaskCoroutineDispatcher()LRg/A;

    move-result-object p2

    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/DelayMetCommandHandler;->mCoroutineDispatcher:LRg/A;
...
.method private cleanUp()V
    ...
    :try_start_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/DelayMetCommandHandler;->mJob:LRg/m0;
    ...
    invoke-interface {v2, v3}, LRg/m0;->a(Ljava/util/concurrent/CancellationException;)V
...
.method public handleProcessWork()V
    ...
    invoke-static {v0, v2}, LC/R1;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/DelayMetCommandHandler;->mCoroutineDispatcher:LRg/A;

    invoke-static {v0, v1, v2, p0}, Landroidx/work/impl/constraints/WorkConstraintsTrackerKt;->listen(Landroidx/work/impl/constraints/WorkConstraintsTracker;Landroidx/work/impl/model/WorkSpec;LRg/A;Landroidx/work/impl/constraints/OnConstraintsStateChangedListener;)LRg/m0;

    move-result-object v0

    iput-object v0, p0, Landroidx/work/impl/background/systemalarm/DelayMetCommandHandler;->mJob:LRg/m0;
...
.method public onConstraintsStateChanged(Landroidx/work/impl/model/WorkSpec;Landroidx/work/impl/constraints/ConstraintsState;)V
    ...
    invoke-direct {p2, p0, v0}, LC/x1;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {p2, p0, v0}, LA9/i;-><init>(Ljava/lang/Object;I)V
