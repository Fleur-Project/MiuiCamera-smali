...
.method static constructor <clinit>()V
    ...
    const-class v44, Lcom/android/camera/features/mode/more/film/MoreFilmModuleEntry;

    const-class v45, Lcom/android/camera/features/mode/more/clone/MoreCloneModuleEntry;
    ...
    const-class v3, Lcom/android/camera/features/mode/pro/photo/ProModuleEntry;

    const-class v4, Lcom/android/camera/features/mode/pro/video/ProVideoModuleEntry;

    const-class v5, Lcom/android/camera/features/mode/pro/rec/ProRecModuleEntry;

    const-class v6, Lcom/android/camera/features/mode/portrait/PortraitModuleEntry;

    const-class v7, Lcom/android/camera/features/mode/night/photo/NightModuleEntry;

    const-class v8, Lcom/android/camera/features/mode/night/video/NightVideoModuleEntry;

    const-class v9, Lcom/android/camera/features/mode/pixel/PixelModuleEntry;

    const-class v10, Lcom/xiaomi/microfilm/milive/mode/MiLiveModuleEntry;

    const-class v11, Lcom/xiaomi/milive/mode/MiLiveMasterModuleEntry;

    const-class v12, Lcom/android/camera/features/mode/fun/FunModuleEntry;

    const-class v13, Lcom/android/camera/features/mode/pano/pano3/PanoModuleEntry;
    ...
    const-class v36, Lcom/android/camera/features/mode/shothelper/FriendModuleEntry;

    const-class v37, Lcom/android/camera/features/mode/film/delay/LongExpModuleEntry;

    const-class v38, Lcom/android/camera/features/mode/film/dollyzoom/DollyZoomModuleEntry;

    const-class v39, Lcom/android/camera/features/mode/film/dream/DreamModuleEntry;

    const-class v40, Lcom/android/camera/features/mode/film/slowshutter/SlowShutterModuleEntry;

    const-class v41, Lcom/android/camera/features/mode/film/timefreeze/TimeFreezeModuleEntry;

    const-class v42, Lcom/android/camera/features/mode/film/timebackflow/TimeBackflowModuleEntry;

    const-class v43, Lcom/android/camera/features/mode/more/MoreModuleEntry;

    const-class v46, Lcom/android/camera/features/mode/more/vlog/MoreVVModuleEntry;

    const-class v47, Lcom/android/camera/features/mode/more/uninstall/MoreUnInstallModuleEntry;

    filled-new-array/range {v1 .. v47}, [Ljava/lang/Class;

    move-result-object v0

    sput-object v0, Lc1/a;->a:[Ljava/lang/Class;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    sput-object v0, Lc1/a;->b:Landroid/util/SparseArray;
...
.method public static a(Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    invoke-interface {v3}, Le1/h;->getModuleId()I
    ...
    invoke-virtual {v4, v5}, Lw7/b;->V0(I)Z
    ...
    invoke-virtual {v4}, Lw7/b;->c1()Z

    :goto_1
    invoke-interface {v3}, Lcom/android/camera/module/entry/a;->getModeItem()Lq2/a;
    ...
    iget-boolean v7, v4, Lq2/a;->b:Z

    iget-object v4, v4, Lq2/a;->a:Lcom/android/camera/data/data/d;

    invoke-direct {v5, v6, v3, v7, v4}, Lg0/s$a;-><init>(I[IZLcom/android/camera/data/data/d;)V
...
.method public static declared-synchronized b()Landroid/util/SparseArray;
    ...
    :try_start_0
    sget-object v1, Lc1/a;->b:Landroid/util/SparseArray;
    ...
    invoke-static {}, Lc1/a;->d()Landroid/util/SparseArray;

    move-result-object v1

    sput-object v1, Lc1/a;->b:Landroid/util/SparseArray;
...
.method public static d()Landroid/util/SparseArray;
    ...
    invoke-interface {v5}, Le1/h;->getModuleId()I
