...
.method public static synthetic bj(Lcom/android/camera/features/mode/idcard/IdCardModule;ILX3/A0;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/features/mode/idcard/IdCardModule;->lambda$callGalleryIDCardPage$7(ILX3/A0;)V
...
.method private callGalleryIDCardPage([Ljava/lang/String;Lcom/android/camera/module/N;)V
    ...
    invoke-static {v7}, Lgb/a;->c(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {v3}, Lgb/b;->a(Landroid/app/Activity;)Z
    ...
    const-string/jumbo v6, "saveIDCard: use mediaEditor."
    ...
    :cond_6
    const-string/jumbo v6, "saveIDCard: use extraPhoto."
    ...
    invoke-static {v4}, Lcom/android/camera/data/data/r;->z(Z)Ljava/lang/String;
    ...
    invoke-static {v3, v5}, Lgb/a;->b(Landroid/app/Activity;Landroid/content/Intent;)V

    const p1, 0x8c35

    invoke-static {v3, v5, p1}, Lbc/d;->b(Landroid/app/Activity;Landroid/content/Intent;I)Z
    ...
    :cond_7
    sget-object p1, LP9/c;->f:LP9/c;

    invoke-interface {p2, p1}, Lcom/android/camera/module/N;->Z4(LP9/c;)V
    ...
    invoke-direct {p2, p0, v2, v0}, Lcom/android/camera/fragment/B;-><init>(Ljava/lang/Object;II)V
...
.method private checkHandleSaveFinish(Lcom/android/camera/module/N;Landroid/net/Uri;Ljava/lang/String;)Z
    ...
    new-instance p1, Lcom/android/camera2/compat/theme/custom/mm/aid/d;

    const/16 p3, 0xd

    invoke-direct {p1, p2, p3}, Lcom/android/camera2/compat/theme/custom/mm/aid/d;-><init>(Ljava/lang/Object;I)V
...
.method public static synthetic cj(Landroid/net/Uri;Landroid/net/Uri;)V
    .locals 0
...
.method private clearPrevPictures()V
    ...
    invoke-direct {v2, v3, v0, v1}, LA2/h;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public static synthetic fj(Lcom/android/camera/features/mode/idcard/IdCardModule;I)V
    .locals 0
...
.method public static synthetic gj(Lcom/android/camera/features/mode/idcard/IdCardModule;Lob/a;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/features/mode/idcard/IdCardModule;->lambda$generatePhotoTitle$0(Lob/a;)Ljava/lang/String;
...
.method private handleSaveFinishIfNeed(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-static {p2}, Ln4/z;->o(Ljava/lang/String;)Z
    ...
    invoke-static {p2, v1}, Ln4/z;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p2}, Ln4/z;->p(Ljava/lang/String;)Z
    ...
    invoke-direct {p1, p2}, Lu4/e;-><init>(I)V
...
.method public static synthetic hj(LX3/d;)V
    ...
    invoke-static {p0}, Lcom/android/camera/features/mode/idcard/IdCardModule;->lambda$handleSaveFinishIfNeed$5(LX3/d;)V

    return-void
.end method

.method private synthetic lambda$callGalleryIDCardPage$7(ILX3/A0;)V
    .locals 0

    invoke-interface {p2, p1}, LX3/A0;->V6(I)V
...
.method private synthetic lambda$callGalleryIDCardPage$8(I)V
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/android/camera/fragment/top/w;-><init>(Ljava/lang/Object;II)V
...
.method private synthetic lambda$generatePhotoTitle$0(Lob/a;)Ljava/lang/String;
    .locals 3
    ...
    invoke-interface {p1}, Lob/a;->Yd()Ljava/lang/String;
...
.method private static synthetic lambda$handleSaveFinishIfNeed$5(LX3/d;)V
    .locals 1
...
.method private static synthetic lambda$handleSaveFinishIfNeed$6()V
    ...
    invoke-direct {v1, v2}, Lu5/f;-><init>(I)V
...
.method private static lambda$notifyGalleryContainerManager$2(Landroid/net/Uri;LC/n3;)Z
    .locals 0

    iget-object p1, p1, LC/n3;->a:Landroid/net/Uri;
...
.method public onActivityResult(Lcom/android/camera/module/N;IILandroid/content/Intent;)V
    ...
    invoke-interface {p1, p2, p3}, Lcom/android/camera/module/N;->fa(Landroid/net/Uri;Z)V
...
.method public onInactive()V
    ...
    const-string/jumbo v2, "onInactive: do clearPrevPictures"
...
.method public updateEnablePreviewThumbnail(Z)V
    ...
    invoke-interface {p0, p1}, Lcom/android/camera/module/N;->ah(Z)V
