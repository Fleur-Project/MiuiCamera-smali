...
.method public final d(Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Ld0/d;->l:Lb6/c;
    ...
    :goto_0
    iput-boolean p1, p0, Ld0/d;->j:Z

    invoke-virtual {p0, v0}, Ld0/d;->isSupportMode(I)Z

    move-result p1

    if-eqz p1, :cond_7

    invoke-virtual {p0}, Ld0/d;->initItems()Ljava/util/List;
    ...
    iget-object p1, p0, Ld0/d;->l:Lb6/c;
    ...
    invoke-static {v0, v2}, Lcom/android/camera/data/data/h;->q0(ILcom/android/camera/fragment/beauty/n;)Z
    ...
    :cond_4
    invoke-static {v1}, Lcom/android/camera/data/data/x;->q(I)Z
    ...
    :cond_5
    invoke-static {v1, p1}, Lcom/android/camera/data/data/k;->g0(ILb6/c;)Z

    :cond_6
    :goto_1
    invoke-static {}, Ll4/a;->j()Z
...
.method public final getDisplayTitleString()I
    ...
    :cond_0
    sget p0, LR9/f;->dir_audio_type_audio_track:I

    return p0

    :cond_1
    :goto_0
    sget p0, LR9/f;->pref_dir_audio_type:I
...
.method public final getValueSelectedShadowDrawable(I)I
    ...
    iget-boolean v1, p0, Ld0/d;->k:Z

    if-eqz v1, :cond_0

    sget p0, LR9/c;->dir_audio_type_all:I
    ...
    :pswitch_6
    sget p0, LR9/c;->dir_audio_type_dual:I

    return p0

    :pswitch_7
    sget p0, LR9/c;->dir_audio_type_back:I

    return p0

    :pswitch_8
    sget p0, LR9/c;->dir_audio_type_front:I

    return p0

    :pswitch_9
    sget p0, LR9/c;->dir_audio_type_zoom:I
...
.method public final h(Landroid/content/Context;ZIZI)V
    ...
    iput p4, p0, Ld0/d;->b:I

    const/4 v0, 0x4

    iput v0, p0, Ld0/d;->c:I

    iput p4, p0, Ld0/d;->a:I

    const/4 v1, 0x0

    iput-boolean v1, p0, Ld0/d;->d:Z

    invoke-static {p3}, Lcom/android/camera/data/data/h;->d0(I)Z
    ...
    iput v3, p0, Ld0/d;->a:I

    :cond_0
    invoke-static {p3}, Lcom/android/camera/data/data/r;->B(I)Z
    ...
    invoke-static {p3}, Lcom/android/camera/data/data/k;->G(I)Z
    ...
    invoke-virtual {v2, v5, v1}, LW9/a;->g(Ljava/lang/String;Z)Z
    ...
    invoke-static {p3}, Lcom/android/camera/data/data/x;->p(I)Z
    ...
    :goto_1
    iput v5, p0, Ld0/d;->a:I

    goto :goto_2

    :cond_7
    invoke-virtual {p0, p3}, Ld0/d;->isSwitchOn(I)Z
    ...
    invoke-static {p2}, Lcom/android/camera/data/data/r;->C(I)Z
    ...
    iget-boolean p2, p0, Ld0/d;->j:Z

    if-eqz p2, :cond_14

    invoke-static {p3}, Lcom/android/camera/data/data/h;->B0(I)Z
...
.method public final initItems()Ljava/util/List;
    ...
    sget v4, LR9/c;->dir_audio_type_front:I

    iput v4, v1, Lcom/android/camera/data/data/d;->c:I

    iput v4, v1, Lcom/android/camera/data/data/d;->f:I

    sget v4, LR9/f;->dir_audio_type_front:I
    ...
    sget v4, LR9/c;->dir_audio_type_back:I

    iput v4, v1, Lcom/android/camera/data/data/d;->c:I

    iput v4, v1, Lcom/android/camera/data/data/d;->f:I

    sget v4, LR9/f;->dir_audio_type_back:I
    ...
    sget v4, LR9/c;->dir_audio_type_dual:I

    iput v4, v1, Lcom/android/camera/data/data/d;->c:I

    iput v4, v1, Lcom/android/camera/data/data/d;->f:I

    sget v4, LR9/f;->dir_audio_type_dual:I
...
.method public final j(DD)D
    ...
    iget-wide v1, v0, Ld0/d;->g:D

    iget-wide v3, v0, Ld0/d;->f:D

    sub-double v1, v3, v1

    iget-wide v5, v0, Ld0/d;->e:D
...
.method public final k()I
    ...
    sget p0, LR9/c;->dir_audio_type_all_shadow:I
    ...
    :pswitch_6
    sget p0, LR9/c;->dir_audio_type_dual_shadow:I

    return p0

    :pswitch_7
    sget p0, LR9/c;->dir_audio_type_back_shadow:I

    return p0

    :pswitch_8
    sget p0, LR9/c;->dir_audio_type_front_shadow:I

    return p0

    :pswitch_9
    sget p0, LR9/c;->dir_audio_type_zoom_shadow:I
...
.method public final n(I)V
    ...
    iput-object p1, p0, Ld0/d;->i:Lcom/android/camera/data/data/d;
