...
.method public static i(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v3, v4, v5}, Le4/i;->P(Ljava/lang/String;Z)I
    ...
    invoke-interface {v3, v4, v2}, Le4/i;->P(Ljava/lang/String;Z)I

    move-result v2

    iput v2, v1, Lcom/android/camera/data/data/d;->g:I

    sget v2, LR9/f;->pref_menu_ultra_pixel_photography:I

    sget v3, LR9/f;->tip_ultra_pixel_12_5M:I
    ...
    sget v2, LR9/f;->accessibility_ultra_pixel_12_5mp:I
...
.method public static j(Ljava/util/ArrayList;)V
    ...
    sget v3, LR9/f;->tip_ultra_pixel_12M:I
    ...
    sget v2, LR9/f;->accessibility_ultra_pixel_12mp:I
...
.method public static k(Ljava/util/ArrayList;)V
    ...
    sget v3, LR9/f;->tip_ultra_pixel_16M:I
    ...
    sget v2, LR9/f;->accessibility_ultra_pixel_16mp:I
...
.method public static p(Ljava/util/ArrayList;)V
    ...
    sget v3, LR9/f;->tip_ultra_pixel_8M:I
    ...
    sget v2, LR9/f;->accessibility_ultra_pixel_8mp:I
...
.method public final A(I)Z
    ...
    invoke-static {p1}, Lb6/d;->h0(Lb6/c;)Landroid/util/Size;

    move-result-object v0

    invoke-static {p1, v0}, Lb6/d;->u3(Lb6/c;Landroid/util/Size;)Z
    ...
    iget-object p0, p0, Lcom/android/camera/data/data/c;->mCapabilities:Lb6/c;
...
.method public final B()Z
    ...
    invoke-virtual {p0, v0}, Ld0/h0;->getComponentValue(I)Ljava/lang/String;
...
.method public final D()Z
    ...
    :cond_1
    invoke-virtual {p0}, Ld0/h0;->B()Z

    move-result v0

    if-nez v0, :cond_3

    invoke-virtual {p0}, Ld0/h0;->E()Z
...
.method public final F()Z
    ...
    invoke-virtual {v0, v2}, LH3/e;->Q(I)Lb6/c;
    ...
    iput-object v0, p0, Ld0/h0;->l:Ljava/lang/Boolean;

    :cond_3
    iget-object p0, p0, Ld0/h0;->l:Ljava/lang/Boolean;
...
.method public final H(IILb6/c;)V
    .locals 12

    invoke-static {p3}, Lb6/d;->q0(Lb6/c;)Z

    move-result v0

    iput-boolean v0, p0, Ld0/h0;->m:Z
    ...
    invoke-virtual {p2}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->J0()Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p3}, Lb6/d;->p2(Lb6/c;)Z
    ...
    :cond_4
    invoke-virtual {p0, v0}, Ld0/h0;->l(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_5
    invoke-virtual {p0, v0}, Ld0/h0;->n(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_6
    invoke-virtual {p0, v0}, Ld0/h0;->h(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_7
    invoke-virtual {p0, v0}, Ld0/h0;->o(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_8
    invoke-virtual {p0, v0}, Ld0/h0;->m(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_9
    invoke-static {p3}, Lb6/d;->R(Lb6/c;)I

    move-result p2

    invoke-static {p3}, Lb6/d;->h0(Lb6/c;)Landroid/util/Size;

    move-result-object v4

    invoke-static {p3, v4}, Lb6/d;->u3(Lb6/c;Landroid/util/Size;)Z
    ...
    check-cast v10, Lh0/S;

    invoke-virtual {v10, p1}, Lh0/S;->isSwitchOn(I)Z
    ...
    invoke-virtual {v9, v10}, LH3/e;->Q(I)Lb6/c;

    move-result-object v9

    invoke-static {v9, v4}, Lb6/d;->u3(Lb6/c;Landroid/util/Size;)Z
    ...
    invoke-static {v0}, Ld0/h0;->p(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v5, v3, v2}, Le4/i;->P(Ljava/lang/String;Z)I

    move-result v6

    iput v6, v4, Lcom/android/camera/data/data/d;->c:I

    invoke-interface {v5, v3, v1}, Le4/i;->P(Ljava/lang/String;Z)I
    ...
    sget v5, LR9/f;->pref_menu_ultra_pixel_photography:I

    sget v6, LR9/f;->tip_ultra_pixel_32M:I
    ...
    sget v5, LR9/f;->accessibility_ultra_pixel_32mp:I
    ...
    invoke-virtual {p0, v3}, Ld0/h0;->v(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Ld0/h0;->i(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v6, v5, v1}, Le4/i;->P(Ljava/lang/String;Z)I
    ...
    invoke-interface {v6, v5, v2}, Le4/i;->P(Ljava/lang/String;Z)I

    move-result v7

    iput v7, v4, Lcom/android/camera/data/data/d;->g:I

    sget v7, LR9/f;->pref_menu_ultra_pixel_photography:I

    sget v8, LR9/f;->tip_ultra_pixel_50M:I
    ...
    sget v8, LR9/f;->accessibility_ultra_pixel_50mp:I
    ...
    invoke-static {v0, v4}, LG5/a;->c(Ljava/util/ArrayList;Lcom/android/camera/data/data/d;)Lcom/android/camera/data/data/d;
    ...
    invoke-interface {v6, v3, v1}, Le4/i;->P(Ljava/lang/String;Z)I
    ...
    invoke-interface {v6, v3, v2}, Le4/i;->P(Ljava/lang/String;Z)I
    ...
    sget v3, LR9/f;->tip_ultra_pixel_XXXM:I
    ...
    sget v3, LR9/f;->accessibility_ultra_pixel_xxxmp:I
    ...
    invoke-virtual {p0, v5}, Ld0/h0;->v(Ljava/lang/String;)V
    ...
    :cond_12
    invoke-virtual {p0, p1}, Ld0/h0;->A(I)Z
    ...
    invoke-virtual {v9, p2}, LH3/e;->Q(I)Lb6/c;

    move-result-object p2

    invoke-static {p2}, Lb6/d;->R(Lb6/c;)I

    move-result v9

    invoke-static {p2}, Lb6/d;->h0(Lb6/c;)Landroid/util/Size;

    move-result-object v10

    invoke-static {p2, v10}, Lb6/d;->u3(Lb6/c;Landroid/util/Size;)Z
    ...
    :cond_15
    invoke-static {v0}, Ld0/h0;->k(Ljava/util/ArrayList;)V

    goto :goto_1

    :cond_16
    invoke-static {v0}, Ld0/h0;->j(Ljava/util/ArrayList;)V
    ...
    :goto_2
    iput-boolean p2, p0, Ld0/h0;->f:Z

    :cond_1a
    iget-boolean p2, p0, Ld0/h0;->f:Z
    ...
    iget-object v4, p3, Lb6/c;->w:Lq6/y;
    ...
    sget-object v4, Lp6/j;->P3:Lp6/M;

    sget v5, Lp6/N;->a:I

    iget-object v6, p3, Lb6/c;->d:Landroid/hardware/camera2/CameraCharacteristics;
    ...
    invoke-static {v4}, Lq6/y;->a([I)Ljava/util/ArrayList;
    ...
    :cond_1f
    iput-object v3, p3, Lb6/c;->w:Lq6/y;

    goto :goto_3

    :cond_20
    iget-object v1, p3, Lb6/c;->E6:Lq6/y;

    if-nez v1, :cond_21

    new-instance v1, Lq6/y;

    invoke-direct {v1}, Lq6/y;-><init>()V

    iput-object v1, p3, Lb6/c;->E6:Lq6/y;

    iput v2, v1, Lq6/y;->a:I

    iput v0, v1, Lq6/y;->b:I

    iput p2, v1, Lq6/y;->c:I

    :cond_21
    iget-object v1, p3, Lb6/c;->E6:Lq6/y;

    iput-object v1, p3, Lb6/c;->w:Lq6/y;
    ...
    :cond_24
    :goto_3
    iget-object v3, p3, Lb6/c;->w:Lq6/y;
    ...
    invoke-direct {v3}, Lq6/y;-><init>()V

    iput v2, v3, Lq6/y;->a:I

    iput v0, v3, Lq6/y;->b:I

    iput p2, v3, Lq6/y;->c:I

    :cond_26
    const-string p2, "camera.debug.test.duration"

    iget p3, v3, Lq6/y;->b:I

    invoke-static {p2, p3}, Lac/f;->e(Ljava/lang/String;I)I

    move-result p2

    iput p2, v3, Lq6/y;->b:I

    const-string p2, "camera.debug.test.duration_save"

    iget p3, v3, Lq6/y;->c:I
    ...
    iput-object v3, p0, Ld0/h0;->n:Lq6/y;
...
.method public final I(I)V
    ...
    invoke-virtual {p0}, Ld0/h0;->r()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lh0/s0;->G(Z)V
...
.method public final L(ILb6/c;)V
    .locals 3
    ...
    :cond_0
    invoke-virtual {p0, v1, p1, p2}, Ld0/h0;->H(IILb6/c;)V
...
.method public final d(Ljava/lang/Object;)V
    ...
    iput-object v1, p0, Lcom/android/camera/data/data/c;->mCapabilities:Lb6/c;

    invoke-static {v1}, Lb6/d;->Q0(Lb6/c;)Z

    move-result v1

    iput-boolean v1, p0, Ld0/h0;->g:Z

    const/4 v1, 0x0

    iput-object v1, p0, Ld0/h0;->h:Ljava/lang/Boolean;

    iput-object v1, p0, Ld0/h0;->i:Ljava/lang/Boolean;

    iput-object v1, p0, Ld0/h0;->k:Ljava/lang/Boolean;

    iput-object v1, p0, Ld0/h0;->l:Ljava/lang/Boolean;

    sget-object v2, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object v2, p0, Lcom/android/camera/data/data/c;->mItems:Ljava/util/List;

    iput-boolean v0, p0, Ld0/h0;->f:Z

    iput-object v1, p0, Ld0/h0;->n:Lq6/y;
    ...
    iput-object v0, p0, Ld0/h0;->e:Lb6/c;

    :cond_0
    iget v0, p1, Lcom/android/camera/data/data/w;->a:I

    invoke-virtual {p0, v0}, Ld0/h0;->isSupportMode(I)Z
    ...
    invoke-virtual {p0, v0, v1, p1}, Ld0/h0;->H(IILb6/c;)V
...
.method public final h(Ljava/util/ArrayList;)V
    ...
    invoke-static {p1}, Ld0/h0;->j(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v4, v3, v5}, Le4/i;->P(Ljava/lang/String;Z)I
    ...
    invoke-interface {v4, v3, v2}, Le4/i;->P(Ljava/lang/String;Z)I
    ...
    sget v4, LR9/f;->tip_ultra_pixel_108M:I
    ...
    sget v2, LR9/f;->accessibility_ultra_pixel_108mp:I
...
.method public final isSwitchOn(I)Z
    ...
    invoke-virtual {p0, p1}, Ld0/h0;->getComponentValue(I)Ljava/lang/String;
...
.method public final l(Ljava/util/ArrayList;)V
    ...
    invoke-static {p1}, Ld0/h0;->i(Ljava/util/ArrayList;)V
    ...
    sget v4, LR9/f;->tip_ultra_pixel_XXXM:I
    ...
    sget v2, LR9/f;->accessibility_ultra_pixel_xxxmp:I
...
.method public final m(Ljava/util/ArrayList;)V
    ...
    sget v4, LR9/f;->tip_ultra_pixel_48M:I
    ...
    sget v2, LR9/f;->accessibility_ultra_pixel_48mp:I
...
.method public final n(Ljava/util/ArrayList;)V
    ...
    sget v4, LR9/f;->tip_ultra_pixel_50M:I
    ...
    sget v2, LR9/f;->accessibility_ultra_pixel_50mp:I
...
.method public final o(Ljava/util/ArrayList;)V
    ...
    invoke-static {p1}, Ld0/h0;->k(Ljava/util/ArrayList;)V
    ...
    sget v4, LR9/f;->tip_ultra_pixel_64M:I
    ...
    sget v2, LR9/f;->accessibility_ultra_pixel_64mp:I
...
.method public final s()Ljava/lang/String;
    ...
    iget-object v0, p0, Ld0/h0;->e:Lb6/c;

    invoke-static {v0}, Lb6/d;->R(Lb6/c;)I

    move-result v0

    iget-object v1, p0, Ld0/h0;->e:Lb6/c;
    ...
    sget p0, LR9/f;->tip_ultra_pixel_50M_off:I

    invoke-virtual {v1, p0}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object p0

    sget v0, LR9/f;->tip_ultra_pixel_32M:I
    ...
    :cond_2
    sget p0, LR9/f;->tip_ultra_pixel_50M_format:I
    ...
    sget v0, LR9/f;->tip_ultra_pixel_XXXM:I
    ...
    sget v0, LR9/f;->tip_ultra_pixel_100M:I
    ...
    sget v0, LR9/f;->tip_ultra_pixel_50M:I
    ...
    sget v0, LR9/f;->tip_ultra_pixel_108M:I
    ...
    sget v0, LR9/f;->tip_ultra_pixel_64M:I
    ...
    sget v0, LR9/f;->tip_ultra_pixel_48M:I
...
.method public final t()[I
    ...
    invoke-interface {v1, v2, v3}, Le4/i;->P(Ljava/lang/String;Z)I
    ...
    invoke-interface {v1, v0, p0}, Le4/i;->P(Ljava/lang/String;Z)I
    ...
    invoke-interface {v1, v0, v3}, Le4/i;->P(Ljava/lang/String;Z)I
    ...
    invoke-interface {v1, p0, v3}, Le4/i;->P(Ljava/lang/String;Z)I
...
.method public final u()Z
    ...
    iget-object v0, p0, Ld0/h0;->h:Ljava/lang/Boolean;
    ...
    iput-object v0, p0, Ld0/h0;->h:Ljava/lang/Boolean;

    :cond_2
    iget-boolean v0, p0, Ld0/h0;->g:Z

    if-eqz v0, :cond_3

    iget-object p0, p0, Ld0/h0;->h:Ljava/lang/Boolean;
...
.method public final v(Ljava/lang/String;)V
    ...
    sget v7, LR9/f;->module_name_pixel:I

    iput v7, p0, Ld0/h0;->d:I
    ...
    invoke-interface {p1, v0, v8}, Le4/i;->P(Ljava/lang/String;Z)I

    const-string p1, ""

    iput-object p1, p0, Ld0/h0;->a:Ljava/lang/String;

    iput-object p1, p0, Ld0/h0;->b:Ljava/lang/String;
    ...
    invoke-interface {p1, v0, v7}, Le4/i;->P(Ljava/lang/String;Z)I

    sget p1, LR9/f;->ultra_pixel_photography_open_tip:I

    sget v0, LR9/f;->ultra_pixel_32mp:I
    ...
    sget p1, LR9/f;->ultra_pixel_photography_close_tip:I
    ...
    invoke-interface {p1, v1, v8}, Le4/i;->P(Ljava/lang/String;Z)I

    sget p1, LR9/f;->ultra_pixel_photography_open_tip:I

    sget v0, LR9/f;->ultra_pixel_xxxmp:I
    ...
    invoke-interface {p1, v2, v8}, Le4/i;->P(Ljava/lang/String;Z)I

    sget p1, LR9/f;->ultra_pixel_photography_open_tip:I

    sget v0, LR9/f;->ultra_pixel_50mp:I
    ...
    invoke-interface {p1, v3, v8}, Le4/i;->P(Ljava/lang/String;Z)I

    sget p1, LR9/f;->ultra_pixel_photography_open_tip:I

    sget v0, LR9/f;->ultra_pixel_108mp:I
    ...
    invoke-interface {p1, v4, v8}, Le4/i;->P(Ljava/lang/String;Z)I

    sget p1, LR9/f;->ultra_pixel_photography_open_tip:I

    sget v0, LR9/f;->ultra_pixel_48mp:I
    ...
    invoke-interface {p1, v5, v7}, Le4/i;->P(Ljava/lang/String;Z)I

    sget p1, LR9/f;->ultra_pixel_photography_open_tip:I

    sget v0, LR9/f;->ultra_pixel_64mp:I
...
.method public final x()Z
    ...
    iget-object v0, p0, Ld0/h0;->j:Ljava/lang/Boolean;

    if-nez v0, :cond_0

    sget-object v0, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    iput-object v0, p0, Ld0/h0;->j:Ljava/lang/Boolean;
    ...
    :cond_0
    iget-object p0, p0, Ld0/h0;->j:Ljava/lang/Boolean;
...
.method public final y()Z
    ...
    iput-object v0, p0, Ld0/h0;->k:Ljava/lang/Boolean;
    ...
    :cond_0
    iget-object p0, p0, Ld0/h0;->k:Ljava/lang/Boolean;
...
.method public final z()Z
    ...
    iget-object v0, p0, Ld0/h0;->i:Ljava/lang/Boolean;

    if-nez v0, :cond_0

    sget-object v0, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    iput-object v0, p0, Ld0/h0;->i:Ljava/lang/Boolean;
    ...
    :cond_0
    iget-object p0, p0, Ld0/h0;->i:Ljava/lang/Boolean;
