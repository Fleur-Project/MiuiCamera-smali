...
.method public final C(Ljava/lang/Integer;)Ljava/util/List;
    ...
    const-class v11, Lh0/F;

    const-class v12, Lh0/G;

    const-class v13, Lh0/I;

    const-class v14, Lh0/K;

    const-class v15, Lh0/o;

    const-class v16, Lh0/V;

    const-class v17, Lh0/t;
    ...
    const-class v23, Lh0/m;

    const-class v24, Lh0/X;

    const-class v25, Lh0/D;

    const-class v26, Lh0/f;

    const-class v27, Lh0/w;

    const-class v28, Lh0/k0;

    const-class v29, Lh0/l0;

    const-class v30, Lh0/Q;

    const-class v31, Lh0/B;

    const-class v32, Lh0/p;

    const-class v33, Lh0/q;

    const-class v34, Lh0/r;

    const-class v35, Lh0/u;

    const-class v36, Lh0/W;

    const-class v37, Lh0/j0;

    const-class v38, Lh0/n;

    const-class v39, Lh0/O;
...
.method public final o(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Lh0/c0;-><init>(Lh0/s0;)V
...
.method public final p(Ljava/lang/Class;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p2, v0, Lh0/F;->a:Ljava/util/ArrayList;

    invoke-static {v2}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object p2

    iput-object p2, v0, Lh0/F;->b:Ljava/lang/String;
    ...
    invoke-direct {p0, p2}, Lh0/K;-><init>(Lh0/s0;)V
    ...
    invoke-direct {p0, p2}, Lh0/M;-><init>(Lh0/s0;)V
    ...
    invoke-direct {p0, p2}, Lh0/V;-><init>(Lh0/s0;)V
    ...
    new-instance p0, Lh0/t;

    invoke-direct {p0, p2}, Lh0/t;-><init>(Lh0/s0;)V
    ...
    invoke-direct {p0, p2}, Lh0/q0;-><init>(Lh0/s0;)V
    ...
    iput-object p2, p0, Lh0/p0;->c:Lh0/s0;
    ...
    invoke-direct {p0, p2}, Lh0/c;-><init>(Lh0/s0;)V
    ...
    invoke-direct {p0, p2}, Lh0/X;-><init>(Lh0/s0;)V
    ...
    iput-object p2, p0, Lh0/D;->c:Ljava/lang/String;
    ...
    invoke-direct {p0, p2}, Lh0/w;-><init>(Lh0/s0;)V
    ...
    invoke-direct {p0, p2}, Lh0/l0;-><init>(Lh0/s0;)V
    ...
    invoke-direct {p0, p2}, Lh0/Q;-><init>(Lh0/s0;)V
    ...
    invoke-direct {p0, p2}, Lh0/B;-><init>(Lh0/s0;)V
    ...
    invoke-direct {p0, p2}, Lh0/j0;-><init>(Lh0/s0;)V
    ...
    invoke-direct {p0, p2}, Lh0/A;-><init>(Lh0/s0;)V
    ...
    iput-object p2, p0, Lh0/H;->a:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p2}, Lh0/e0;-><init>(Lh0/s0;)V
    ...
    iput v1, p0, Lh0/E;->a:I

    iput v1, p0, Lh0/E;->b:I
    ...
    invoke-direct {p0, p2}, Lcom/android/camera/data/data/runing/ComponentRunningTiltValue;-><init>(Lh0/s0;)V
    ...
    iget v5, v0, Lg0/t;->s:I

    invoke-virtual {v0, v5}, Lg0/t;->B(I)I
    ...
    invoke-virtual {v4}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->d1()I
    ...
    invoke-direct {p0, p2}, Lh0/O;-><init>(Lh0/s0;)V
    ...
    new-instance p0, Lh0/u0;

    invoke-direct {p0}, Lh0/u0;-><init>()V
    ...
    invoke-direct {p0, p2}, Lcom/android/camera/data/data/runing/ComponentRunningWatermarkStyleSample;-><init>(Lh0/s0;)V
