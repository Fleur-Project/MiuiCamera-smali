...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-object v0, p0, LC3/g2;->a:Ljava/lang/ref/WeakReference;
...
.method public final Ha(Z)V
    ...
    invoke-virtual {p0}, LC3/g2;->m()Lcom/android/camera/module/M;
    ...
    invoke-static {v3}, Lcom/android/camera/data/data/x;->b(I)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/camera/data/data/x;->l0(Z)V
    ...
    invoke-direct {p1, v0, v1}, LC/l3;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p0, p1}, LC3/g2;->n(Ljava/lang/Runnable;)V

    goto :goto_2

    :cond_3
    invoke-static {v7}, Lcom/android/camera/data/data/x;->l0(Z)V
    ...
    invoke-static {p1, v3}, Lcom/android/camera/data/data/k;->t0(ILjava/lang/String;)V

    new-instance p1, LC3/D0;

    const/4 v3, 0x1

    invoke-direct {p1, v0, v3}, LC3/D0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-interface {v1, v0, p1}, LX3/B;->Ac(Ljava/lang/String;[I)V
    ...
    invoke-static {v0, v4, v4, v4, v4}, La0/a;->n(IZZZZ)V
    ...
    invoke-direct {p1, v0}, LC3/f2;-><init>(I)V
...
.method public final m()Lcom/android/camera/module/M;
    ...
    iget-object p0, p0, LC3/g2;->a:Ljava/lang/ref/WeakReference;
...
.method public final yf(IZ)V
    ...
    :cond_2
    iget-boolean v2, v1, Lh0/c0;->f:Z

    invoke-virtual {v1, v0}, Lh0/c0;->j(I)Z
    ...
    new-instance v0, LC3/e2;

    invoke-direct {v0, v3}, LC3/e2;-><init>(Z)V

    invoke-virtual {p0, v0}, LC3/g2;->n(Ljava/lang/Runnable;)V

    :cond_3
    if-nez p2, :cond_4

    invoke-virtual {p0, p1}, LC3/g2;->P2(I)V
