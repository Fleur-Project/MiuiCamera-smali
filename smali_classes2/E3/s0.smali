...
.method public final a()V
    ...
    iget-object v0, p0, LE3/s0;->l:Ljava/lang/Integer;

    const-string v1, "SuperMoonMultipleASD"

    sget-boolean v2, LE3/s0;->q:Z
    ...
    iget-object v6, p0, LE3/s0;->l:Ljava/lang/Integer;
    ...
    iget-object v5, p0, LE3/s0;->l:Ljava/lang/Integer;
    ...
    :cond_9
    iget-boolean v1, p0, LE3/s0;->g:Z

    if-ne v0, v1, :cond_a

    iget-boolean v1, p0, LE3/s0;->j:Z
    ...
    iget-boolean v0, p0, LE3/s0;->j:Z

    if-eqz v0, :cond_b

    iput-boolean v4, p0, LE3/s0;->i:Z

    :cond_b
    iput-boolean v3, p0, LE3/s0;->j:Z

    iput-boolean v4, p0, LE3/s0;->h:Z
...
.method public final b()V
    ...
    :goto_0
    iget-boolean v5, p0, LE3/s0;->k:Z

    iget-boolean v6, p0, LE3/s0;->j:Z

    if-eq v5, v6, :cond_3

    iget v5, p0, LE3/s0;->o:I
    ...
    invoke-direct {v2, v5}, LA2/a;-><init>(I)V

    invoke-virtual {v1, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iput-boolean v3, p0, LE3/s0;->p:Z

    goto :goto_1

    :cond_3
    iget-boolean v2, p0, LE3/s0;->p:Z
    ...
    iput-boolean v4, p0, LE3/s0;->p:Z

    :cond_4
    :goto_1
    iput v0, p0, LE3/s0;->o:I

    iget-boolean v0, p0, LE3/s0;->j:Z

    iput-boolean v0, p0, LE3/s0;->k:Z
    ...
    invoke-direct {v2, v0, v5}, LC3/M;-><init>(ZI)V

    invoke-virtual {v1, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iget-boolean v0, p0, LE3/s0;->h:Z
    ...
    invoke-direct {v2, v5}, LC/O2;-><init>(I)V
    ...
    invoke-direct {v6, v1, v7}, LC3/E;-><init>(ZI)V

    invoke-virtual {v5, v6}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    :cond_8
    :goto_4
    iget-boolean v1, p0, LE3/s0;->m:Z
    ...
    iput-boolean v4, p0, LE3/s0;->m:Z

    iput-boolean v3, p0, LE3/s0;->n:Z
    ...
    invoke-direct {v3, v5}, LB2/j;-><init>(I)V
    ...
    invoke-direct {v3, v5}, LC/w;-><init>(I)V
    ...
    invoke-direct {v3, v0, v5}, LC/I0;-><init>(ZI)V
    ...
    invoke-direct {v3, v0, v5}, LE3/q0;-><init>(ZI)V
...
.method public final s()V
    ...
    iput-object v0, p0, LE3/s0;->l:Ljava/lang/Integer;
