...
.method public final apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v1, v0}, LG3/k;-><init>(ILcom/android/camera/module/M;)V
    :try_end_1
    ...
    invoke-interface {v4}, Lcom/android/camera/module/N;->B()LC/b2;

    move-result-object v4

    if-eqz v4, :cond_4

    iget-object v5, v4, LC/b2;->y:LC/k2;

    if-eqz v5, :cond_4

    iget-boolean v5, v4, LC/b2;->z:Z

    if-eqz v5, :cond_3

    iput-object v3, v4, LC/b2;->A:Landroid/graphics/Rect;
    ...
    iput-object v5, v4, LC/b2;->A:Landroid/graphics/Rect;
    ...
    :cond_5
    iget-object v4, v6, Lh0/u0;->a:Lh0/v0;
    ...
    invoke-interface {v2, v1, v3, v7}, Lu3/j;->setRectAndUIStyle(Landroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    invoke-interface {v2, v1, v3}, Lu3/j;->onPreviewLayoutChanged(Landroid/graphics/Rect;I)V
    ...
    invoke-static {v3, v1, v0}, Lcom/android/camera/data/data/h;->J(IILb6/c;)F
