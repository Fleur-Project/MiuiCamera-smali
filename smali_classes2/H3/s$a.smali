...
# instance fields
.field public final synthetic a:LH3/s;
...
.method public constructor <init>(LH3/s;)V
    ...
    iput-object p1, p0, LH3/s$a;->a:LH3/s;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object v2, v0, LH3/s$a;->a:LH3/s;

    iget-object v2, v2, LH3/s;->q:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, v0, LH3/s$a;->a:LH3/s;

    iget-boolean v3, v3, LH3/s;->T:Z
    ...
    iget-object v4, v0, LH3/s$a;->a:LH3/s;

    iget v4, v4, LC/l2;->j:I
    ...
    iget v4, v2, LC/l2;->j:I

    if-eq v4, v5, :cond_4

    iget-boolean v5, v2, LH3/s;->C:Z
    ...
    :cond_3
    invoke-virtual {v2, v8}, LH3/s;->s(I)V

    iget-object v2, v0, LH3/s$a;->a:LH3/s;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-boolean v6, v2, LC/l2;->i:Z

    goto :goto_1

    :cond_4
    :goto_0
    iput-boolean v3, v2, LH3/s;->C:Z

    invoke-virtual {v2, v7}, LH3/s;->s(I)V

    iget-object v2, v0, LH3/s$a;->a:LH3/s;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {v2}, LH3/s;->v()V

    iget-object v2, v0, LH3/s$a;->a:LH3/s;

    iget-object v2, v2, LH3/s;->z:LH3/s$c;
    ...
    iget-boolean v3, v2, LH3/s;->B:Z

    if-eqz v3, :cond_5

    invoke-virtual {v2, v4, v7}, LH3/s;->p(II)V

    iget-object v2, v0, LH3/s$a;->a:LH3/s;

    invoke-virtual {v2}, LH3/s;->n()V

    goto :goto_1

    :cond_5
    invoke-virtual {v2}, LH3/s;->g()V

    :goto_1
    iget-object v0, v0, LH3/s$a;->a:LH3/s;

    invoke-static {v0, v1}, LH3/s;->d(LH3/s;Lcom/android/camera/module/loader/camera2/FocusTask;)V
    ...
    :cond_7
    invoke-virtual {v2, v4}, LH3/s;->s(I)V
    ...
    invoke-virtual {v2, v5, v4}, LH3/s;->p(II)V
    ...
    iget-object v9, v0, LH3/s$a;->a:LH3/s;

    iget v9, v9, LC/l2;->j:I
    ...
    iget-object v11, v0, LH3/s;->A:Ljava/lang/ref/WeakReference;

    invoke-virtual {v11}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v11

    check-cast v11, LH3/s$b;
    ...
    invoke-interface {v11}, LH3/s$b;->showFocusViewWhenCaf()Z
    ...
    invoke-interface {v9}, LX3/o0;->ef()Z

    move-result v11

    if-eqz v11, :cond_11

    invoke-interface {v9, v7}, LX3/o0;->rf(I)V
    ...
    invoke-virtual {v0}, LH3/s;->getFocusMode()I
    ...
    iget-object v11, v0, LH3/s;->N:Landroid/graphics/Rect;
    ...
    invoke-interface {v9, v3}, LX3/o0;->S9(Z)V

    :cond_13
    iget-object v11, v0, LH3/s;->z:LH3/s$c;

    if-eqz v2, :cond_16

    iget v2, v0, LC/l2;->j:I

    if-eq v2, v5, :cond_15

    invoke-virtual {v0, v6}, LH3/s;->s(I)V

    invoke-virtual {v11, v3}, Landroid/os/Handler;->removeMessages(I)V

    invoke-virtual {v11, v6}, Landroid/os/Handler;->removeMessages(I)V

    iget-boolean v2, v0, LH3/s;->U:Z
    ...
    invoke-virtual {v2}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->t()I
    ...
    iget-wide v5, v0, LH3/s;->x:J

    invoke-static {v13, v14, v5, v6, v12}, LC/H;->e(JJLjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v7}, LH3/s;->s(I)V

    goto :goto_9

    :cond_17
    invoke-virtual {v0, v4}, LH3/s;->s(I)V
    ...
    iget-boolean v1, v0, LH3/s;->B:Z

    if-eqz v1, :cond_1a

    invoke-virtual {v0, v15, v7}, LH3/s;->p(II)V

    invoke-virtual {v0}, LH3/s;->n()V

    return-void

    :cond_1a
    invoke-virtual {v0}, LH3/s;->g()V
