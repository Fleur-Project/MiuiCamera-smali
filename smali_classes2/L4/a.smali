...
.method public final b(Ljava/lang/Object;LMb/f;)V
    ...
    :cond_4
    sget-object v7, Lp6/L;->L:Lp6/M;

    const v8, 0xdead

    invoke-static {v2, v7, v8}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    iget-object v5, v1, LS9/q;->s0:LS9/v;

    if-nez v5, :cond_a

    new-instance v11, LS9/v;
    ...
    invoke-direct/range {v11 .. v23}, LS9/v;-><init>(Ljava/lang/Boolean;ZILjava/lang/String;ZZZZIZZI)V

    iput-object v11, v1, LS9/q;->s0:LS9/v;
    ...
    iget v12, v5, LS9/v;->i:I

    if-eqz v12, :cond_15

    sget-boolean v13, Lw7/c;->j:Z

    iget-boolean v14, v5, LS9/v;->g:Z

    if-eqz v13, :cond_d

    sget-object v13, Lp6/L;->y1:Lp6/M;

    invoke-static {v2, v13, v8}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    :goto_5
    sget-object v13, Lp6/L;->x1:Lp6/M;
    ...
    :cond_e
    :goto_6
    sget-object v13, Lp6/L;->v1:Lp6/M;
    ...
    sget-object v15, Lp6/L;->w1:Lp6/M;

    invoke-static {v2, v15, v8}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    sget-object v3, Lp6/L;->z1:Lp6/M;

    invoke-static {v2, v3, v8}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    sget-object v4, Lp6/L;->p2:Lp6/M;

    invoke-static {v2, v4, v8}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    sget-object v3, Lp6/L;->V1:Lp6/M;

    const v4, 0xbabe

    invoke-static {v2, v3, v4}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    invoke-static {v2, v7, v14}, Lb6/J;->a(Landroid/hardware/camera2/CaptureResult;II)Lq6/a;
    ...
    iget-boolean v7, v5, LS9/v;->e:Z

    const-string v14, "attr_wide_ldc_status"

    if-eqz v7, :cond_24

    iget-boolean v7, v5, LS9/v;->f:Z
    ...
    :goto_14
    sget-object v7, Lp6/L;->Z0:Lp6/M;

    invoke-static {v2, v7, v4}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    :goto_17
    iget-object v7, v5, LS9/v;->a:Ljava/lang/Boolean;
    ...
    :cond_30
    iget-boolean v7, v5, LS9/v;->b:Z

    if-eqz v7, :cond_31

    iget v7, v5, LS9/v;->c:I

    invoke-static {v7}, LEf/e;->h(I)Ljava/lang/String;
    ...
    iget-object v5, v5, LS9/v;->d:Ljava/lang/String;
    ...
    invoke-static {v2, v5, v4}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    sget-object v8, Lp6/L;->r0:Lp6/M;

    invoke-static {v2, v8, v4}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
