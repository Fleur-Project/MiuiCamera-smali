...
.method public final apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->Lf(Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;Ljava/lang/Throwable;)Le4/f;
    ...
    iget-object v3, p0, Lcd/j;->n:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcd/j;->c:Landroid/content/Context;

    iget-object p0, p0, Lcd/j;->n:Ljava/lang/String;

    invoke-static {v5, v4, p0}, Lbc/J;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z

    const-wide/16 v4, 0x0

    invoke-static {v4, v5}, Lcom/android/camera/data/data/v;->g(J)V

    :cond_0
    invoke-static {v3}, Lbc/A;->m(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v5, v6, v8}, LC/f2;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v8, v9}, LC/f2;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v4, Lcd/r;->c:Ljava/lang/String;

    const-string v6, "others/controller_config.bundle"

    invoke-static {v0, v4, v6}, LC/f2;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    invoke-static {v1, p0, v7}, Lbc/A;->a(Ljava/io/File;Ljava/io/File;Z)V

    new-instance p0, Ljava/io/File;

    const-string v0, "others/controller_config_for_icon_scene.bundle"

    invoke-static {v4, v0}, LC/F;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    invoke-static {v5, p0, v7}, Lbc/A;->a(Ljava/io/File;Ljava/io/File;Z)V
    ...
    invoke-interface {p0}, Lhd/b;->eg()V
    ...
    iget-object p1, p0, Lad/d;->a:Lcom/android/camera/ActivityBase;
    ...
    invoke-direct {v0, v1}, LAc/a;-><init>(Ljava/lang/Runnable;)V

    iget-object p0, p1, Lq5/g;->p:LOe/g;

    const-wide/16 v1, 0x0

    invoke-virtual {p0, v0, v1, v2}, LOe/g;->l(LAc/a;J)Z
