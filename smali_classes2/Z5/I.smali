...
.method public T4()Landroid/util/Range;
    ...
    invoke-static {p0, v2}, LY5/e;->T(ILb6/c;)Landroid/util/Range;
    ...
    invoke-direct {v8, v4, v9}, LZ5/G;-><init>(FI)V
    ...
    iget-object v0, v6, Lw7/b;->e:L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;
...
.method public W(I)V
    ...
    invoke-static {p1}, Lfc/f;->D(I)Ljava/lang/String;
    ...
    invoke-interface {p1}, LH3/t;->d0()Z
    ...
    invoke-interface {p1}, LH3/t;->R0()Z
    ...
    iget-object p1, p0, LY5/e;->b:Ljava/lang/ref/WeakReference;
...
.method public final X4()Landroid/util/Range;
    ...
    invoke-super {p0}, LY5/e;->X4()Landroid/util/Range;
...
.method public e0()Landroid/util/Range;
    ...
    invoke-super {p0}, LY5/e;->e0()Landroid/util/Range;

    move-result-object v0

    iget-object v1, p0, LY5/e;->b:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v5, v1}, LQ1/t;->f(ILjava/util/List;)Ljava/lang/Object;
    ...
    :cond_5
    invoke-static {p0, v2}, Lcom/android/camera/data/data/h;->e(IZ)Z
...
.method public g0()Landroid/util/Range;
    ...
    invoke-direct {v7, v5, v8}, LZ5/E;-><init>(FI)V
    ...
    invoke-direct {v5, v4, v6}, LZ5/F;-><init>(FI)V
    ...
    invoke-static {v3, v1}, LQ1/t;->f(ILjava/util/List;)Ljava/lang/Object;
...
.method public p7(FFI)Z
    ...
    invoke-interface {v2}, LH3/t;->d0()Z
    ...
    invoke-interface {v2}, LH3/t;->R0()Z
    ...
    invoke-interface {v2, v3}, LH3/t;->v0(Z)V
    ...
    iget v4, p0, LY5/e;->c:I

    invoke-virtual {v3, v4}, Ld0/j0;->getPreferComponentValue(I)Ljava/lang/String;

    move-result-object v3

    invoke-static {v4, v3}, Lcom/android/camera/data/data/h;->y1(ILjava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_8

    invoke-static {v4, v1}, Lcom/android/camera/data/data/h;->e(IZ)Z
    ...
    :cond_6
    invoke-static {v4}, Lcom/android/camera/data/data/h;->C0(I)Z

    move-result v3

    if-eqz v3, :cond_7

    invoke-virtual {v2, v4}, Lh0/C;->l(I)Z
    ...
    :cond_7
    invoke-static {v4}, Lcom/android/camera/data/data/x;->P(I)Z
    ...
    :cond_8
    invoke-super {p0, p1, p2, p3}, LY5/e;->p7(FFI)Z
...
.method public s3(I)F
    ...
    invoke-static {p0, p1}, LC5/b;->p(Ljava/lang/String;F)F
    ...
    :cond_1
    invoke-super {p0, p1}, LY5/e;->s3(I)F
...
.method public setZoomRatio(F)V
    ...
    invoke-super {p0, p1}, LY5/e;->setZoomRatio(F)V
...
.method public t(FFLjava/lang/String;Lb6/c;)F
    ...
    invoke-virtual {p2}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->X2()Z
    ...
    invoke-static {p0, p1}, Lcom/android/camera/data/data/h;->Q(IZ)[F
...
.method public final w8()Z
    ...
    invoke-direct {v1, p0}, LZ5/D;-><init>(I)V
...
.method public y7(Landroid/util/Range;)V
    ...
    invoke-super {p0, p1}, LY5/e;->y7(Landroid/util/Range;)V
