...
.method public constructor <init>(Landroid/view/View;Landroid/util/Size;Z)V
    ...
    iput-object v0, p0, La6/c;->l:Lmiuix/animation/utils/VelocityMonitor;

    iput-object p1, p0, La6/c;->i:Landroid/view/View;

    iput-object p2, p0, La6/c;->h:Landroid/util/Size;

    iput-boolean p3, p0, La6/c;->k:Z
...
.method public final a()V
    ...
    iget-object v0, p0, La6/c;->j:Landroid/graphics/Rect;

    invoke-virtual {v0}, Landroid/graphics/Rect;->width()I

    move-result v0

    iget-object v1, p0, La6/c;->h:Landroid/util/Size;
    ...
    iput v0, p0, La6/c;->e:I

    div-int/lit8 v0, v0, 0x2

    iput v0, p0, La6/c;->f:I
...
.method public final b()Landroid/graphics/Rect;
    ...
    iget-object v3, p0, La6/c;->h:Landroid/util/Size;
    ...
    iget-object v1, p0, La6/c;->j:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->top:I

    add-int/2addr v1, v2

    iget-boolean p0, p0, La6/c;->k:Z

    if-eqz p0, :cond_0

    const/4 p0, 0x0

    invoke-static {p0}, Lu0/b;->m(Z)I
...
.method public final c()V
    ...
    iput-object v0, p0, La6/c;->j:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, La6/c;->i:Landroid/view/View;
    ...
    sget v4, LFa/a;->pad_portrait_zoom_map_drag_rect_margin:I
    ...
    sget v4, LFa/a;->pad_portrait_zoom_map_drag_rect_bottom_margin:I
    ...
    iput-object v1, p0, La6/c;->j:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, La6/c;->j:Landroid/graphics/Rect;
    ...
    sget v4, LFa/a;->pad_landscape_zoom_map_full_drag_rect_left_margin:I
    ...
    sget v4, LFa/a;->pad_landscape_zoom_map_full_drag_rect_right_margin:I
    ...
    sget v4, LFa/a;->pad_landscape_zoom_map_drag_rect_left_margin:I
    ...
    invoke-static {v4, v5, v1}, LC/G;->c(ILandroid/view/View;I)I
    ...
    iget-object p0, p0, La6/c;->j:Landroid/graphics/Rect;
