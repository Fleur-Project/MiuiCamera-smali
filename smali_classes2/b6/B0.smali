...
.method public final j(Landroid/media/Image;I)V
    ...
    iget-object v3, p0, Lb6/B0;->v:LS9/q;
    ...
    invoke-virtual {v4, p0, v6}, Lb6/Z;->y2(Lb6/i0;Z)V

    :cond_2
    iget-object v3, p0, Lb6/B0;->x:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    iget-object p0, p0, Lb6/B0;->v:LS9/q;
    ...
    iget-object v5, p0, Lb6/B0;->v:LS9/q;
    ...
    iget-object v8, p0, Lb6/B0;->v:LS9/q;

    sget-object v3, LX0/c$a;->a:LX0/c;

    invoke-virtual {v3}, LX0/c;->a()LX0/g;

    move-result-object v12

    iget-object v7, p0, Lb6/B0;->B:LS9/i;
    ...
    iget-object v1, p0, Lb6/B0;->v:LS9/q;

    invoke-virtual {v1, p2, p1}, LS9/q;->a(I[B)V

    iget-boolean p1, p0, Lb6/B0;->y:Z

    const/16 p2, 0xe

    if-eqz p1, :cond_f

    iget-object p1, p0, Lb6/B0;->v:LS9/q;
    ...
    iget-object p1, p0, Lb6/B0;->x:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    invoke-virtual {p0, p1, v1, v1}, Lb6/B0;->p(LS9/q;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
    ...
    iget-object p2, p0, Lb6/B0;->x:Landroid/hardware/camera2/TotalCaptureResult;

    iget-object v0, v4, Lb6/Z;->E:Lb6/c;
    ...
    :goto_6
    invoke-virtual {p0, p1, p2, v1}, Lb6/B0;->p(LS9/q;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
...
.method public final k()V
    ...
    iget-object v3, v2, Lb6/E;->h:Landroid/util/Size;

    iput-object v3, p0, Lb6/i0;->o:Landroid/util/Size;
    ...
    invoke-virtual {v1, v3}, Lb6/D;->i(Z)V
    ...
    iget-boolean v1, p0, Lb6/B0;->C:Z

    if-eqz v1, :cond_1

    iput-boolean v3, p0, Lb6/B0;->y:Z
    ...
    iput-boolean v3, p0, Lb6/B0;->z:Z

    goto :goto_0

    :cond_4
    iput-boolean v3, p0, Lb6/B0;->w:Z
...
.method public final m()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lb6/i0;->a()LS9/q;

    move-result-object v4

    iput-object v4, p0, Lb6/B0;->v:LS9/q;
    ...
    invoke-static {v4}, Ln4/z;->t(Ljava/lang/String;)Z
    ...
    invoke-direct {v4, p0}, Lb6/A0;-><init>(Lb6/B0;)V
...
.method public final o()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :cond_2
    invoke-virtual {v4, v7}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    :cond_5
    iget-object v5, v4, Lb6/F0;->n:Landroid/view/Surface;

    invoke-virtual {v1, v5}, Landroid/hardware/camera2/CaptureRequest$Builder;->addTarget(Landroid/view/Surface;)V

    :cond_6
    iget v5, v0, Lb6/Z;->I:I

    and-int/2addr v5, v7

    if-eqz v5, :cond_7

    iget-object v5, v4, Lb6/F0;->l:Landroid/media/ImageReader;
    ...
    :cond_7
    iget-boolean v5, p0, Lb6/B0;->u:Z

    if-eqz v5, :cond_8

    iget-object v5, v4, Lb6/F0;->p:Landroid/media/ImageReader;
    ...
    iget-object v4, v4, Lb6/F0;->q:Landroid/media/ImageReader;
    ...
    invoke-static {v1, v4}, Lb6/H;->h(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    invoke-virtual {v0, v1, v9}, Lb6/Z;->C1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object p0, p0, Lb6/B0;->A:Landroid/hardware/camera2/CaptureResult;
    ...
    invoke-static {p0, v4, v2}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
...
.method public final p(LS9/q;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)V
    ...
    invoke-static {p0, p1, p2, p3}, LC/Q;->e(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
