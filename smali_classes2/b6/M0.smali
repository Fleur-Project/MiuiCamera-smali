...
# direct methods
.method public constructor <init>(Lb6/Z;ZLandroid/view/Surface;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lb6/I0;-><init>(Lb6/Z;Lx9/a;)V

    iput-object p3, p0, Lb6/M0;->S:Landroid/view/Surface;

    iput-boolean p2, p0, Lb6/M0;->U:Z

    return-void
.end method

.method public static J(Lb6/M0;ZI)V
    .locals 4
    ...
    invoke-virtual {v2, v3}, Lb6/D;->i(Z)V

    invoke-virtual {v0}, Lb6/Z;->p0()I

    const/4 v2, -0x1

    if-eq v2, p2, :cond_1

    iget-object p2, p0, Lb6/i0;->g:Lb6/a$i;
    ...
    :goto_0
    invoke-virtual {v0, p0, p1}, Lb6/Z;->z2(Lb6/i0;Z)V

    new-instance p1, LBh/c;

    const/16 p2, 0x11

    invoke-direct {p1, p0, p2}, LBh/c;-><init>(Ljava/lang/Object;I)V
...
.method public final K()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-boolean v2, p0, Lb6/M0;->V:Z

    iget-object v4, v0, Lb6/Z;->D:Lb6/F0;
    ...
    iget-object v8, v4, Lb6/F0;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v8, p0, Lb6/n0;->u:Landroid/util/Size;

    iget-object v9, v0, Lb6/Z;->F:Lb6/D;

    iget-object v9, v9, Lb6/D;->a:Lb6/E;

    invoke-virtual {v9, v8}, Lb6/E;->e(Landroid/util/Size;)V

    goto :goto_0

    :cond_0
    iget-object v2, v4, Lb6/F0;->c:Landroid/media/ImageReader;
    ...
    invoke-static {v2}, Lbc/M;->a(Landroid/view/Surface;)Ljava/lang/String;
    ...
    iget-object v8, v4, Lb6/F0;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    iget-object v2, v4, Lb6/F0;->a:Landroid/media/ImageReader;
    ...
    iget-object v2, v4, Lb6/F0;->e:Landroid/media/ImageReader;
    ...
    :goto_2
    iget-object v2, v4, Lb6/F0;->n:Landroid/view/Surface;
    ...
    iget-boolean v4, v2, Lb6/E;->z1:Z

    if-eqz v4, :cond_4

    iput-boolean v7, v2, Lb6/E;->z1:Z

    :cond_4
    new-instance v2, Lcom/android/camera/fragment/beauty/n;

    invoke-direct {v2}, Lcom/android/camera/fragment/beauty/n;-><init>()V

    const-string v4, "i:0"

    iput-object v4, v2, Lcom/android/camera/fragment/beauty/n;->a:Ljava/lang/String;
    ...
    invoke-virtual {v4, v1, v5, v8, v2}, Lcom/android/camera2/compat/MiCameraCompatBaseImpl;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/n;)V
    ...
    sget-object v2, Lp6/p;->J3:Lp6/M;

    invoke-static {v4}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v4

    invoke-static {v1, v2, v4}, Lp6/N;->e(Landroid/hardware/camera2/CaptureRequest$Builder;Lp6/M;Ljava/lang/Object;)V
    ...
    :cond_5
    iget-object v2, p0, Lb6/i0;->g:Lb6/a$i;

    iget-object v4, p0, Lb6/M0;->T:Ljava/lang/String;

    if-nez v4, :cond_6

    if-eqz v2, :cond_6

    instance-of v4, v2, Lx3/r$b;

    if-eqz v4, :cond_6

    check-cast v2, Lx3/r$b;

    invoke-virtual {v2}, Lx3/r$b;->a()Ljava/lang/String;
    ...
    iput-object v2, p0, Lb6/M0;->T:Ljava/lang/String;
    ...
    iget-object p0, p0, Lb6/M0;->T:Ljava/lang/String;
    ...
    invoke-static {v1, p0, v0}, Lp6/N;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Lp6/M;Ljava/lang/Object;)V
...
.method public final L(LS9/q;)V
    ...
    invoke-virtual {p0, v0, p1}, Lb6/I0;->I(Landroid/hardware/camera2/TotalCaptureResult;LS9/q;)V
...
.method public final j(Landroid/media/Image;I)V
    ...
    iget-boolean v0, p0, Lb6/M0;->V:Z

    if-nez v0, :cond_0

    invoke-super {p0, p1, p2}, Lb6/I0;->j(Landroid/media/Image;I)V
    ...
    :cond_3
    invoke-virtual {p0, v0}, Lb6/M0;->L(LS9/q;)V
...
.method public final k()V
    ...
    iget-boolean v2, v1, Lb6/E;->H0:Z

    const/4 v3, 0x1

    if-eq v2, v3, :cond_0

    iput-boolean v3, v1, Lb6/E;->H0:Z
...
.method public final m()V
    ...
    invoke-virtual {v3}, Lb6/Z;->i0()V

    :try_start_0
    new-instance v4, Lb6/L0;

    invoke-direct {v4, p0}, Lb6/L0;-><init>(Lb6/M0;)V

    invoke-virtual {p0}, Lb6/M0;->K()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v6

    iget-object v7, p0, Lb6/M0;->S:Landroid/view/Surface;
    ...
    :cond_0
    :goto_0
    iget-object v7, v3, Lb6/Z;->v:Lz9/b;
    ...
    invoke-virtual {v3}, Lb6/Z;->q()Landroid/hardware/camera2/CameraCaptureSession;
