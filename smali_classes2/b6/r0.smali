...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->P0()I
...
.method public constructor <init>(Lb6/Z;ILandroid/view/Surface;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lb6/n0;-><init>(Lb6/Z;Lx9/a;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lb6/r0;->C:Z

    iput p2, p0, Lb6/r0;->F:I

    sget-object p1, Lx9/d;->b:Lx9/d;

    iput-object p1, p0, Lb6/r0;->H:Lx9/d;

    iput-object p3, p0, Lb6/r0;->I:Landroid/view/Surface;

    return-void
.end method

.method public static w(Lb6/r0;ZI)V
    .locals 5
...
.method public final k()V
    ...
    iget-boolean v0, p0, Lb6/E;->H0:Z

    const/4 v1, 0x1

    if-eq v0, v1, :cond_0

    iput-boolean v1, p0, Lb6/E;->H0:Z
...
.method public final m()V
    ...
    iget v0, p0, Lb6/r0;->G:I

    iget v1, p0, Lb6/r0;->F:I
    ...
    iget-object v3, v2, Lb6/Z;->E:Lb6/c;

    invoke-static {v3}, Lb6/d;->n2(Lb6/c;)Z
    ...
    invoke-virtual {v0, v4}, LN3/l;->c(Ljava/lang/String;)J
    ...
    invoke-virtual {v2}, Lb6/Z;->i0()V

    :cond_2
    :try_start_0
    new-instance v0, Lb6/q0;

    invoke-direct {v0, p0}, Lb6/q0;-><init>(Lb6/r0;)V

    invoke-virtual {p0}, Lb6/r0;->x()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, Lb6/r0;->I:Landroid/view/Surface;
    ...
    iget-object v11, p0, Lb6/i0;->c:Landroid/os/Handler;
    ...
    iget v10, p0, Lb6/r0;->G:I

    add-int/2addr v10, v6

    iput v10, p0, Lb6/r0;->G:I

    iput v9, p0, Lb6/r0;->D:I

    if-ne v10, v1, :cond_5

    iput v9, p0, Lb6/r0;->E:I
...
.method public final x()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v8, p0, Lb6/i0;->a:Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v4}, Lb6/F0;->m()Landroid/util/SparseArray;
    ...
    invoke-virtual {v4, v11}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v4, v6}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v4, v2, v10}, Lb6/F0;->k(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v4, v9}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v10, v5, v2}, Lb6/n0;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    :goto_3
    iget-object p0, v0, Lb6/Z;->E:Lb6/c;

    invoke-static {p0}, Lb6/d;->n2(Lb6/c;)Z
    ...
    iput-boolean v9, v2, Lb6/E;->z1:Z

    :cond_9
    invoke-static {v7, v1, p0, v2}, Lb6/H;->N(ILandroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Lb6/E;)V
    ...
    iget-object v6, p0, Lb6/c;->f:Ljava/util/HashSet;

    invoke-virtual {v4, v1, v5, v6, v2}, Lcom/android/camera2/compat/MiCameraCompatBaseImpl;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/n;)V
    ...
    invoke-static {v1, p0, v9}, Lb6/H;->x0(Landroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Z)V

    invoke-static {v1, p0, v9}, Lb6/H;->q0(Landroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Z)V
