...
.field public O:LS9/q;


# direct methods
.method public constructor <init>(Lb6/Z;Landroid/hardware/camera2/CaptureResult;Lx9/a;)V
    .locals 0

    invoke-direct {p0, p1, p3}, Lb6/n0;-><init>(Lb6/Z;Lx9/a;)V

    const/16 p3, 0xb

    iput p3, p0, Lb6/t0;->I:I

    const/4 p3, -0x1

    iput p3, p0, Lb6/t0;->N:I

    iput-object p2, p0, Lb6/n0;->w:Landroid/hardware/camera2/CaptureResult;

    iget-object p1, p1, Lb6/Z;->m0:Lb6/Y0;

    iput-object p1, p0, Lb6/t0;->B:Lb6/Y0;
...
.method public final k()V
    ...
    iget-boolean v1, p0, Lb6/t0;->H:Z

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lb6/t0;->x()V

    :cond_0
    iput-boolean v0, p0, Lb6/n0;->y:Z

    iget-object v1, p0, Lb6/t0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    invoke-virtual {v1}, Lcom/xiaomi/camera/imagecodec/FeatureSetting;->getFrameCount()I

    move-result v1

    iput v1, p0, Lb6/t0;->D:I
    ...
    iget-boolean v3, v2, Lb6/E;->C2:Z

    const/4 v4, 0x0

    iget-object v5, p0, Lb6/i0;->a:Ljava/lang/String;
    ...
    :cond_1
    iget-object v3, v1, Lb6/Z;->E:Lb6/c;
    ...
    invoke-virtual {v2}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->z8()Z
    ...
    iget-boolean v6, p0, Lb6/t0;->C:Z

    if-eqz v6, :cond_4

    const/16 v2, 0x9

    invoke-static {v0, v2, v3}, Lb6/d;->B0(IILb6/c;)Z
    ...
    :goto_2
    iput-boolean v0, p0, Lb6/i0;->m:Z

    iget v0, p0, Lb6/t0;->I:I
    ...
    iget-object v0, v1, Lb6/Z;->F:Lb6/D;
...
.method public final m()V
    ...
    :try_start_0
    new-instance v3, Lb6/s0;

    invoke-direct {v3, p0}, Lb6/s0;-><init>(Lb6/t0;)V

    invoke-virtual {p0}, Lb6/t0;->w()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, Lb6/t0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    :cond_2
    iget-object v5, v1, Lb6/Z;->E:Lb6/c;

    invoke-static {v5}, Lb6/d;->i(Lb6/c;)I

    move-result v5

    iget-object v7, v1, Lb6/Z;->F:Lb6/D;
    ...
    iget-object v9, p0, Lb6/t0;->M:Landroid/util/Size;

    invoke-virtual {v9}, Landroid/util/Size;->getWidth()I

    move-result v9

    iget-object v10, p0, Lb6/t0;->M:Landroid/util/Size;
    ...
    invoke-virtual {p0, v4, v8, v5}, Lb6/n0;->r(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object v4

    if-eqz v4, :cond_4

    invoke-virtual {p0, v4}, Lb6/n0;->u(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    invoke-static {v4, v5}, LQ0/a;->a(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest;)V

    invoke-virtual {v1}, Lb6/Z;->q()Landroid/hardware/camera2/CameraCaptureSession;

    move-result-object v4

    iget-object v5, p0, Lb6/i0;->c:Landroid/os/Handler;
    ...
    iput-object v3, p0, Lb6/n0;->x:Ljava/lang/String;

    invoke-virtual {v1}, Ljava/lang/Object;->hashCode()I

    move-result v3

    iget p0, p0, Lb6/t0;->D:I

    invoke-static {v3, p0}, LC/y2;->a(II)V
    :try_end_0
...
.method public final w()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v8, v2, Lb6/c;->u4:Ljava/lang/Boolean;

    if-nez v8, :cond_2

    sget-object v8, Lp6/j;->b3:Lp6/M;

    invoke-virtual {v8}, Lp6/M;->b()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v2, v9}, Lb6/c;->B0(Ljava/lang/String;)Z
    ...
    invoke-static {v9, v8, v4}, Lp6/N;->g(Landroid/hardware/camera2/CameraCharacteristics;Lp6/M;I)Ljava/lang/Object;
    ...
    iput-object v8, v2, Lb6/c;->u4:Ljava/lang/Boolean;
    ...
    invoke-virtual {v8}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->h8()Z
    ...
    iget-object v8, p0, Lb6/t0;->J:Landroid/view/Surface;

    invoke-virtual {v3, v7}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-static {v9, v8}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v13, p0, Lb6/t0;->L:Landroid/util/Size;

    invoke-virtual {p0, v8, v13, v10, v9}, Lb6/n0;->o(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v8

    iput-object v8, p0, Lb6/n0;->A:Lcom/xiaomi/engine/BufferFormat;

    goto :goto_5

    :cond_8
    iget-object v8, p0, Lb6/t0;->L:Landroid/util/Size;

    invoke-virtual {p0, v8, v10, v9}, Lb6/n0;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v3, v9}, Lb6/F0;->n(I)Landroid/view/Surface;

    move-result-object v10

    if-eqz v10, :cond_9

    invoke-static {v10}, Lbc/M;->d(Landroid/view/Surface;)Landroid/util/Size;
    ...
    :cond_9
    iget-boolean v10, p0, Lb6/i0;->m:Z

    if-eqz v10, :cond_a

    iget-object v10, v0, Lb6/Z;->F:Lb6/D;

    iget-object v10, v10, Lb6/D;->a:Lb6/E;

    iget-boolean v10, v10, Lb6/E;->Z:Z
    ...
    invoke-static {v1, v12, v3}, Lb6/H;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILb6/E;)V

    invoke-virtual {v0, v1, v12}, Lb6/Z;->C1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget v3, v3, Lb6/E;->Z2:I

    if-eq v3, v12, :cond_d

    if-eq v3, v11, :cond_c

    iget-boolean v9, p0, Lb6/t0;->C:Z
    ...
    invoke-static {v3, v9, v10, v11}, LM4/u;->g(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v10, p0, Lb6/n0;->w:Landroid/hardware/camera2/CaptureResult;
    ...
    iget-object v9, v2, Lb6/c;->n4:Ljava/lang/Boolean;

    if-nez v9, :cond_11

    sget-object v9, Lp6/j;->Y2:Lp6/M;

    invoke-virtual {v9}, Lp6/M;->b()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v2, v10}, Lb6/c;->B0(Ljava/lang/String;)Z

    move-result v10

    if-eqz v10, :cond_10

    iget-object v10, v2, Lb6/c;->d:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v10, v9, v4}, Lp6/N;->g(Landroid/hardware/camera2/CameraCharacteristics;Lp6/M;I)Ljava/lang/Object;
    ...
    iput-object v4, v2, Lb6/c;->n4:Ljava/lang/Boolean;
    ...
    :cond_11
    :goto_8
    iget-object v4, v2, Lb6/c;->n4:Ljava/lang/Boolean;
    ...
    :cond_14
    iget-object v4, p0, Lb6/t0;->B:Lb6/Y0;

    if-eqz v4, :cond_16

    iget-object v4, v4, Lb6/Y0;->g:Lb6/Y0$a;

    iget-boolean v4, v4, Lb6/Y0$a;->a:Z
    ...
    iget-object v4, p0, Lb6/n0;->v:Landroid/graphics/Rect;

    invoke-static {v4, v3}, LHg/n;->q(Landroid/graphics/Rect;F)Landroid/graphics/Rect;

    move-result-object v3

    const-string v4, "sr set mtkCrop = "

    invoke-static {v3, v4}, LC/G;->g(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lb6/E;->a()Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Lb6/i0;->l:Ljava/lang/String;

    sget-object v3, Lp6/p;->q3:Lp6/M;

    iget-object v0, v0, Lb6/Z;->F:Lb6/D;

    iget-object v0, v0, Lb6/D;->a:Lb6/E;

    iget v0, v0, Lb6/E;->a3:I

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    invoke-static {v1, v3, v0}, Lp6/N;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Lp6/M;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v2, p0}, Lb6/H;->n0(Landroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Ljava/lang/String;)V
...
.method public final x()V
    ...
    :try_start_0
    iget-object v3, v1, Lb6/Z;->D:Lb6/F0;

    const/16 v4, 0xf

    invoke-virtual {v3, v4}, Lb6/F0;->n(I)Landroid/view/Surface;

    move-result-object v3

    iput-object v3, v0, Lb6/t0;->K:Landroid/view/Surface;
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    iget-object v3, v0, Lb6/t0;->K:Landroid/view/Surface;

    const/4 v4, 0x1

    if-nez v3, :cond_0

    iput-boolean v4, v0, Lb6/t0;->H:Z
    ...
    iget-object v6, v1, Lb6/Z;->F:Lb6/D;
    ...
    :cond_2
    invoke-virtual {v1}, Lb6/Z;->p2()Z

    move-result v7

    if-nez v7, :cond_4

    invoke-virtual {v1}, Lb6/Z;->T()Z
    ...
    :cond_3
    iget v7, v1, Lb6/a;->a:I

    goto :goto_2

    :cond_4
    :goto_1
    invoke-virtual {v1}, Lb6/Z;->G()I
    ...
    invoke-virtual {v1}, Lb6/Z;->q2()Z

    move-result v8

    iget-object v9, v1, Lb6/Z;->D:Lb6/F0;

    invoke-virtual {v9, v7, v8}, Lb6/F0;->k(IZ)Landroid/view/Surface;

    move-result-object v8

    iput-object v8, v0, Lb6/t0;->J:Landroid/view/Surface;
    ...
    iget-object v8, v6, Lb6/E;->M:Landroid/util/Size;

    goto :goto_3

    :cond_6
    iget-object v8, v6, Lb6/E;->O:Landroid/util/Size;

    goto :goto_3

    :cond_7
    iget-object v8, v6, Lb6/E;->N:Landroid/util/Size;
    ...
    :cond_9
    iget-object v8, v6, Lb6/E;->L:Landroid/util/Size;
    ...
    invoke-static {v13, v8}, LB8/h;->g(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    :goto_4
    iput-object v8, v0, Lb6/t0;->M:Landroid/util/Size;

    iget-object v8, v0, Lb6/t0;->J:Landroid/view/Surface;

    invoke-static {v8}, Lbc/M;->d(Landroid/view/Surface;)Landroid/util/Size;

    move-result-object v8

    iput-object v8, v0, Lb6/t0;->L:Landroid/util/Size;
    ...
    iget-object v12, v0, Lb6/t0;->M:Landroid/util/Size;
    ...
    iget-object v12, v0, Lb6/t0;->L:Landroid/util/Size;
    ...
    iget-object v8, v6, Lb6/E;->j:Landroid/util/Size;
    ...
    iget-object v13, v0, Lb6/t0;->L:Landroid/util/Size;
    ...
    :goto_6
    iget-object v14, v0, Lb6/t0;->L:Landroid/util/Size;
    ...
    invoke-static {v14, v8}, LB8/h;->g(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    iget v13, v6, Lb6/E;->Z2:I

    if-eq v13, v10, :cond_13

    if-eq v13, v9, :cond_12

    invoke-static {v12}, Lb6/J;->l(Landroid/hardware/camera2/CaptureResult;)Ljava/lang/Integer;

    move-result-object v3

    iget v14, v6, Lb6/E;->h0:I
    ...
    :cond_f
    iget-boolean v14, v6, Lb6/E;->g3:Z
    ...
    :goto_7
    iput-boolean v14, v0, Lb6/t0;->C:Z
    ...
    invoke-static {v13, v11, v14, v15, v4}, LQ1/t;->l(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v12}, Lt9/a;->b(Landroid/hardware/camera2/CaptureResult;)Landroid/os/Parcelable;

    move-result-object v3

    iget-wide v14, v6, Lb6/E;->s0:J

    const-string v4, "default exposureTime: "

    invoke-static {v14, v15, v4}, LM/a;->g(JLjava/lang/String;)Ljava/lang/String;
    ...
    sget-object v9, Lp6/L;->r1:Lp6/M;

    const v10, 0xbabe

    invoke-static {v4, v9, v10}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    :goto_a
    iget-object v13, v0, Lb6/n0;->w:Landroid/hardware/camera2/CaptureResult;

    sget-object v2, Lp6/L;->q1:Lp6/M;

    invoke-static {v13, v2, v10}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    invoke-static {v14, v15, v2}, LM/a;->g(JLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lb6/d;->D1(Lb6/c;)Z
    ...
    iget-object v2, v0, Lb6/t0;->L:Landroid/util/Size;

    iget-object v4, v0, Lb6/t0;->M:Landroid/util/Size;
    ...
    iput-object v1, v0, Lb6/t0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    const-string v1, "featureType "

    const-string v2, ", initFeatureSetting: "

    invoke-static {v11, v1, v2}, LA2/l;->j(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, v0, Lb6/t0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
...
.method public final y()Z
    ...
    invoke-static {v0}, Lb6/J;->k(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    :cond_1
    iget-object p0, p0, Lb6/t0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
