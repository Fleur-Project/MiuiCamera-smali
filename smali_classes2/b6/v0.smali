...
.method public constructor <init>(Lb6/Z;Landroid/view/Surface;)V
    .locals 1
    ...
    iput-boolean p1, p0, Lb6/v0;->C:Z

    sget-object p1, Lx9/d;->b:Lx9/d;

    iput-object p1, p0, Lb6/v0;->D:Lx9/d;

    iput-object p2, p0, Lb6/v0;->E:Landroid/view/Surface;

    return-void
.end method

.method public static w(Lb6/v0;ZI)V
    .locals 5
...
.method public final m()V
    ...
    invoke-direct {v2, p0}, Lb6/u0;-><init>(Lb6/v0;)V

    invoke-virtual {p0}, Lb6/v0;->x()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v3

    iget-object v5, p0, Lb6/v0;->E:Landroid/view/Surface;
...
.method public final x()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v0, v1, Lb6/Z;->E:Lb6/c;
    ...
    iget-object v0, v1, Lb6/Z;->v:Lz9/b;
    ...
    invoke-virtual {v0, v5, v6}, Lz9/b;->a(Lz9/c;Lb6/X0;)Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v6, v1, Lb6/Z;->D:Lb6/F0;
    ...
    :cond_2
    invoke-virtual {v6}, Lb6/F0;->m()Landroid/util/SparseArray;

    move-result-object v5

    invoke-static {v5}, Lk6/c;->c(Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v6, v11}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v6, v8}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    iput-object v5, p0, Lb6/n0;->u:Landroid/util/Size;
    ...
    iget-object v5, p0, Lb6/n0;->u:Landroid/util/Size;

    invoke-virtual {p0, v5}, Lb6/n0;->p(Landroid/util/Size;)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v5

    iput-object v5, p0, Lb6/n0;->A:Lcom/xiaomi/engine/BufferFormat;
    ...
    iput v5, p0, Lb6/i0;->t:I

    invoke-virtual {v1}, Lb6/Z;->q2()Z

    move-result v10

    invoke-virtual {v6, v5, v10}, Lb6/F0;->k(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v6, v4}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v10, v7, v5}, Lb6/n0;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_8
    :goto_4
    iget-object p0, v6, Lb6/F0;->n:Landroid/view/Surface;
    ...
    :cond_a
    iget-object v5, v1, Lb6/Z;->A:Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-static {v0, v5}, Lb6/H;->h(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    invoke-virtual {v1, v0, v9}, Lb6/Z;->C1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-boolean v6, v5, Lb6/E;->z1:Z

    if-eqz v6, :cond_b

    iput-boolean v4, v5, Lb6/E;->z1:Z

    :cond_b
    iget-object v6, v1, Lb6/Z;->E:Lb6/c;

    invoke-static {v9, v0, v6, v5}, Lb6/H;->N(ILandroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Lb6/E;)V

    new-instance v5, Lcom/android/camera/fragment/beauty/n;

    invoke-direct {v5}, Lcom/android/camera/fragment/beauty/n;-><init>()V

    const-string v7, "i:0"

    iput-object v7, v5, Lcom/android/camera/fragment/beauty/n;->a:Ljava/lang/String;
    ...
    invoke-virtual {v7, v0, v8, v9, v5}, Lcom/android/camera2/compat/MiCameraCompatBaseImpl;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/n;)V
    ...
    invoke-static {v0, v6, v4}, Lb6/H;->x0(Landroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Z)V

    invoke-static {v0, v6, v4}, Lb6/H;->q0(Landroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Z)V
    ...
    invoke-virtual {p0}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->i()Z
    ...
    invoke-static {v0, p0, v1}, Lp6/N;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Lp6/M;Ljava/lang/Object;)V
