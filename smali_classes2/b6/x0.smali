...
# direct methods
.method public constructor <init>(Lb6/Z;Landroid/hardware/camera2/CaptureResult;ZLx9/d;Lx9/a;)V
    .locals 0
    .param p1    # Lb6/Z;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {p0, p1, p5}, Lb6/n0;-><init>(Lb6/Z;Lx9/a;)V

    const/4 p1, -0x1

    iput p1, p0, Lb6/x0;->G:I

    iput p1, p0, Lb6/x0;->H:I

    iput-object p2, p0, Lb6/n0;->w:Landroid/hardware/camera2/CaptureResult;

    iput-boolean p3, p0, Lb6/x0;->C:Z
    ...
    iput-object p4, p0, Lb6/x0;->D:Lx9/d;
...
.method public final k()V
    ...
    iput-object v2, p0, Lb6/i0;->o:Landroid/util/Size;

    iget-boolean v2, p0, Lb6/x0;->C:Z
    ...
    iget-boolean v3, v2, Lb6/E;->L0:Z

    const/16 v4, 0x8

    if-eqz v3, :cond_2

    iput v4, p0, Lb6/x0;->B:I

    :cond_2
    iget-boolean v2, v2, Lb6/E;->C2:Z
    ...
    :cond_3
    iget-object v2, v1, Lb6/Z;->E:Lb6/c;
    ...
    :cond_6
    iget-object v4, v1, Lb6/Z;->F:Lb6/D;

    iget-object v4, v4, Lb6/D;->a:Lb6/E;

    iget-boolean v4, v4, Lb6/E;->r1:Z
    ...
    iget-boolean v1, v1, Lb6/E;->q1:Z

    if-eqz v1, :cond_8

    iget-boolean v1, p0, Lb6/x0;->C:Z
    ...
    iget-boolean v10, v4, Lb6/E;->q1:Z
    ...
    invoke-static {v1, v8}, LC/G;->h(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    :goto_2
    iput-boolean v8, p0, Lb6/i0;->m:Z

    iput-boolean v8, p0, Lb6/i0;->p:Z

    iget v1, p0, Lb6/x0;->B:I

    invoke-virtual {p0, v1}, Lb6/i0;->d(I)I

    move-result v1

    iput v1, p0, Lb6/i0;->n:I
    ...
    iget-object v1, p0, Lb6/n0;->w:Landroid/hardware/camera2/CaptureResult;

    invoke-virtual {v0, v1}, Lb6/Z;->m2(Landroid/hardware/camera2/CaptureResult;)Z

    move-result v0

    iput-boolean v0, p0, Lb6/x0;->F:Z
...
.method public final m()V
    ...
    :try_start_0
    new-instance v4, Lb6/w0;

    invoke-direct {v4, p0}, Lb6/w0;-><init>(Lb6/x0;)V

    invoke-virtual {p0}, Lb6/x0;->x()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v5

    invoke-virtual {p0, v5}, Lb6/x0;->w(Landroid/hardware/camera2/CaptureRequest$Builder;)V

    iget-object v6, v1, Lb6/Z;->E:Lb6/c;
    ...
    iget-object v7, p0, Lb6/n0;->A:Lcom/xiaomi/engine/BufferFormat;
    ...
    iget-object v9, p0, Lb6/n0;->u:Landroid/util/Size;
    ...
    :cond_2
    invoke-virtual {p0, v5, v7, v6}, Lb6/n0;->r(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object v6

    if-eqz v6, :cond_3

    invoke-virtual {p0, v6}, Lb6/n0;->u(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    iget-object v6, p0, Lb6/i0;->c:Landroid/os/Handler;
    ...
    invoke-static {p0, v2}, LC/y2;->a(II)V
...
.method public final w(Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    :cond_0
    iget-object v2, v3, Lb6/Z;->E:Lb6/c;
    ...
    iget-object v6, p0, Lb6/n0;->w:Landroid/hardware/camera2/CaptureResult;
    ...
    iget-object v7, p0, Lb6/n0;->v:Landroid/graphics/Rect;

    if-eqz v2, :cond_1

    iget-object v0, v3, Lb6/Z;->F:Lb6/D;

    iget-object v0, v0, Lb6/D;->a:Lb6/E;

    iget v0, v0, Lb6/E;->b0:F

    invoke-static {v7, v0}, LHg/n;->q(Landroid/graphics/Rect;F)Landroid/graphics/Rect;

    move-result-object v6

    const-string v0, "isZoomRatioSupported: uw set crop = "

    invoke-static {v6, v0}, LC/G;->g(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, v2, Lw7/b;->e:L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;
    ...
    invoke-static {p1, v4, v6, v1}, Lp6/N;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
    ...
    invoke-static {v7, v0}, LC/G;->g(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v4, v7, v1}, Lp6/N;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
    ...
    sget-object v3, Lp6/L;->l1:Lp6/M;

    const v4, 0xbabe

    invoke-static {v0, v3, v4}, Lp6/N;->j(Landroid/hardware/camera2/CaptureResult;Lp6/M;I)Ljava/lang/Object;
    ...
    invoke-static {v0, v3}, LC/G;->g(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, v3, Lb6/Z;->E:Lb6/c;

    invoke-static {p1, p0, v1}, Lb6/H;->x0(Landroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Z)V
...
.method public final x()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v1, v2, v5}, Lz9/b;->a(Lz9/c;Lb6/X0;)Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-boolean v2, v2, Lb6/E;->q1:Z

    iget-object v5, v0, Lb6/Z;->D:Lb6/F0;
    ...
    invoke-virtual {v5, v2}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    :cond_1
    :goto_0
    invoke-virtual {v5, v8}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v9}, Lb6/n0;->p(Landroid/util/Size;)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v10

    iput-object v10, p0, Lb6/n0;->A:Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_3
    invoke-virtual {v5}, Lb6/F0;->m()Landroid/util/SparseArray;
    ...
    invoke-virtual {v5, v10}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v5, v6}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-static {v9}, Lbc/M;->d(Landroid/view/Surface;)Landroid/util/Size;
    ...
    iput-object v2, p0, Lb6/n0;->u:Landroid/util/Size;
    ...
    :cond_7
    iget-object v2, p0, Lb6/n0;->u:Landroid/util/Size;

    invoke-virtual {p0, v2}, Lb6/n0;->p(Landroid/util/Size;)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v2

    iput-object v2, p0, Lb6/n0;->A:Lcom/xiaomi/engine/BufferFormat;
    ...
    iput v2, p0, Lb6/i0;->t:I

    iget-boolean v9, p0, Lb6/x0;->F:Z
    ...
    invoke-virtual {v5, v2, v9}, Lb6/F0;->h(IZ)Landroid/view/Surface;

    move-result-object v2

    invoke-virtual {v0}, Lb6/Z;->c2()Landroid/util/Size;
    ...
    invoke-virtual {v5, v2, v9}, Lb6/F0;->k(IZ)Landroid/view/Surface;
    ...
    :goto_4
    invoke-virtual {v0}, Lb6/Z;->H()I

    move-result v10

    iput v10, p0, Lb6/x0;->G:I
    ...
    invoke-virtual {v5, v4}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    :goto_5
    iget-boolean v11, p0, Lb6/x0;->E:Z
    ...
    iget-object v10, p0, Lb6/x0;->D:Lx9/d;
    ...
    invoke-virtual {p0, v9, v10, v2}, Lb6/n0;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v0, v2}, Lb6/Z;->d2(Z)I

    move-result v2

    iput v2, p0, Lb6/x0;->G:I
    ...
    invoke-virtual {v0, v2}, Lb6/Z;->e2(Z)I

    move-result v2

    iput v2, p0, Lb6/x0;->H:I
    ...
    invoke-virtual {v2}, Lg0/t;->R()Z

    move-result v2

    if-nez v2, :cond_10

    iget-object v2, v5, Lb6/F0;->n:Landroid/view/Surface;
    ...
    invoke-virtual {v0, v1, v7}, Lb6/Z;->C1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v5, v0, Lb6/Z;->E:Lb6/c;
    ...
    invoke-static {v1, v6, v9}, Lp6/N;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Lp6/M;Ljava/lang/Object;)V
    ...
    iget-byte v2, v2, Lb6/E;->k3:B

    sget-object v6, Lp6/p;->M3:Lp6/M;

    invoke-static {v2}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v2

    invoke-static {v1, v6, v2}, Lp6/N;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Lp6/M;Ljava/lang/Object;)V
    ...
    iget-boolean v2, v2, Lb6/E;->R0:Z

    if-eqz v2, :cond_17

    iget-object v2, p0, Lb6/n0;->w:Landroid/hardware/camera2/CaptureResult;

    invoke-static {v2}, Lb6/J;->l(Landroid/hardware/camera2/CaptureResult;)Ljava/lang/Integer;

    move-result-object v2

    const-string v6, "apply specshot mode capture request: "

    invoke-static {v6, v2}, LC/Q;->f(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
    ...
    invoke-static {v1, v7, v2}, Lb6/H;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILb6/E;)V

    iget-object v2, v0, Lb6/Z;->F:Lb6/D;

    iget-object v2, v2, Lb6/D;->a:Lb6/E;

    iget-boolean v6, v2, Lb6/E;->e2:Z

    iget-boolean v2, v2, Lb6/E;->e3:Z

    iget-object v7, v0, Lb6/Z;->F:Lb6/D;

    iget-object v7, v7, Lb6/D;->a:Lb6/E;

    iget-boolean v7, v7, Lb6/E;->g3:Z

    invoke-virtual {v0}, Lb6/Z;->x()I
    ...
    iget-boolean v10, v10, Lb6/E;->L0:Z
    ...
    invoke-static {v11, v12, v13, v6, v2}, LG5/a;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)Ljava/lang/StringBuilder;
    ...
    iget-boolean v6, v6, Lb6/E;->n3:Z

    if-eqz v6, :cond_18

    const-string v6, "isHQQuickShot Do not apply hwmfnr. numOfHQQuickShots:"

    invoke-static {v9, v6}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v5, p0}, Lb6/H;->n0(Landroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Ljava/lang/String;)V

    :cond_1b
    sget-object p0, Lp6/p;->q3:Lp6/M;

    iget-object v2, v0, Lb6/Z;->F:Lb6/D;

    iget-object v2, v2, Lb6/D;->a:Lb6/E;

    iget v2, v2, Lb6/E;->a3:I

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    invoke-static {v1, p0, v2}, Lp6/N;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Lp6/M;Ljava/lang/Object;)V

    iget-object p0, v0, Lb6/Z;->F:Lb6/D;

    iget-object p0, p0, Lb6/D;->a:Lb6/E;

    iget-boolean p0, p0, Lb6/E;->l3:Z
