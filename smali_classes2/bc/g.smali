...
.method public static final c(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    :try_start_0
    invoke-static {p0, p1}, Lbc/J;->g(Landroid/content/Context;Ljava/lang/String;)[B
...
.method public static final g(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Lbc/g;->a(Landroid/util/Size;I)I
    ...
    invoke-direct {v2, p0}, Lg8/b;-><init>(Ljava/lang/String;)V

    sget-object v3, Lg8/a;->e:Li8/b;

    if-eqz v3, :cond_0

    iget v4, v2, Lg8/b;->d:I

    invoke-interface {v3, v4}, Li8/b;->a(I)Ly6/b;

    move-result-object v3

    if-eqz v3, :cond_0

    iput-object v3, v2, Lg8/b;->i:Li8/a;

    invoke-virtual {v3, p0}, Ly6/b;->e(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v0, p0, v1}, Lbc/g;->h(Landroid/graphics/Bitmap;IF)Landroid/graphics/Bitmap;
...
.method public static final h(Landroid/graphics/Bitmap;IF)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-static/range {v0 .. v5}, Lbc/g;->m(Landroid/graphics/Bitmap;IFZZI)Landroid/graphics/Bitmap;
...
.method public static final i(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-static {p0, p1, v0}, Lbc/g;->k(Landroid/graphics/Bitmap;Ljava/lang/String;I)Z

    return-void
.end method

.method public static final j(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    .locals 1
...
.method public static k(Landroid/graphics/Bitmap;Ljava/lang/String;I)Z
    .locals 2
    ...
    invoke-static {p2}, Lbc/A;->l(Ljava/io/File;)V
...
.method public static final l(Landroid/graphics/Bitmap;Landroid/graphics/ColorSpace;)V
    .locals 2
...
.method public static m(Landroid/graphics/Bitmap;IFZZI)Landroid/graphics/Bitmap;
    .locals 8
    ...
    invoke-static {p5, p1, p0}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
