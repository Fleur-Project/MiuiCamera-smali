...
.method public A()Z
    ...
    iget-object p0, p0, Lc6/a;->B:Lb6/Y0;

    iget-object v7, p0, Lb6/Y0;->g:Lb6/Y0$a;
...
.method public E()Lc6/a$d;
    ...
    iget-object v3, v2, Lb6/Y0;->g:Lb6/Y0$a;

    iget-boolean v3, v3, Lb6/Y0$a;->h:Z
    ...
    iget-object v2, v4, Lb6/Z;->D:Lb6/F0;
    ...
    :cond_1
    invoke-virtual {v4}, Lb6/Z;->p2()Z

    move-result v3

    invoke-virtual {v4}, Lb6/Z;->T()Z
    ...
    iget-object v8, v4, Lb6/Z;->D:Lb6/F0;

    if-eqz v3, :cond_5

    invoke-virtual {v4}, Lb6/Z;->G()I

    move-result v3

    iput v3, p0, Lb6/i0;->t:I

    iget-object v9, v2, Lb6/Y0;->g:Lb6/Y0$a;

    iget-boolean v9, v9, Lb6/Y0$a;->e:Z

    if-eqz v9, :cond_4

    invoke-virtual {v8, v3, v7}, Lb6/F0;->h(IZ)Landroid/view/Surface;

    move-result-object v3

    invoke-virtual {v4}, Lb6/Z;->c2()Landroid/util/Size;

    move-result-object v9

    iget v10, p0, Lb6/i0;->t:I

    invoke-virtual {v8}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v10}, Lb6/F0;->i(I)I
    ...
    :cond_4
    invoke-virtual {v8, v3, v7}, Lb6/F0;->k(IZ)Landroid/view/Surface;
    ...
    invoke-static {v10}, Lb6/F0;->l(I)I
    ...
    iget-object v3, v3, Lb6/Y0$a;->f:Lx9/d;
    ...
    invoke-virtual {v8, v7}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    :cond_5
    invoke-virtual {v8}, Lb6/F0;->m()Landroid/util/SparseArray;

    move-result-object v3

    invoke-static {v3}, Lk6/c;->c(Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v8, v9}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-static {v7}, Lbc/M;->d(Landroid/view/Surface;)Landroid/util/Size;
    ...
    :cond_8
    iget-object v3, v4, Lb6/Z;->F:Lb6/D;

    iget-object v3, v3, Lb6/D;->a:Lb6/E;

    iget-object v3, v3, Lb6/E;->i:Landroid/util/Size;

    iput-object v3, p0, Lb6/n0;->u:Landroid/util/Size;

    :cond_9
    :goto_5
    iget v3, v2, Lb6/Y0;->d:I
    ...
    invoke-virtual {v4, v3}, Lb6/Z;->d2(Z)I
    ...
    invoke-virtual {v4, v3}, Lb6/Z;->e2(Z)I
    ...
    iget-object p0, v8, Lb6/F0;->n:Landroid/view/Surface;
...
.method public final H(Lc6/a$c;)V
    ...
    iget-boolean v3, v2, Lb6/Y0$a;->h:Z
    ...
    iget-boolean v5, v5, Lb6/Y0$a;->i:Z
    ...
    iget-object v3, p0, Lc6/a;->B:Lb6/Y0;

    iget-object v3, v3, Lb6/Y0;->g:Lb6/Y0$a;

    iget-boolean v3, v3, Lb6/Y0$a;->i:Z
    ...
    iget-boolean v2, v2, Lb6/Y0$a;->i:Z
    ...
    iget-object v2, v2, Lb6/Y0$a;->f:Lx9/d;
    ...
    iget-boolean v5, v3, Lb6/E;->e2:Z

    iget-boolean v6, v3, Lb6/E;->e3:Z

    iget-boolean v7, v3, Lb6/E;->f3:Z

    iget-boolean v3, v3, Lb6/E;->g3:Z

    invoke-virtual {v2}, Lb6/Z;->x()I
    ...
    :goto_2
    iget-object v9, p0, Lb6/i0;->a:Ljava/lang/String;
    ...
    invoke-static {v10, v11, v12, v5, v6}, LG5/a;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v5}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->F2()Z
    ...
    invoke-static {v1, v3, v2}, Lb6/H;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILb6/E;)V
    ...
    invoke-static {v1, p0, v0}, Lb6/H;->x0(Landroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Z)V
...
.method public final x(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object p2, p0, Lb6/Y0;->g:Lb6/Y0$a;

    iget-object p2, p2, Lb6/Y0$a;->S:Lb6/Y0$a$a;

    if-eqz p2, :cond_2

    iget p2, p2, Lb6/Y0$a$a;->a:I
    ...
    iget-object v0, p0, Lb6/Y0;->g:Lb6/Y0$a;

    iget-object v0, v0, Lb6/Y0$a;->S:Lb6/Y0$a$a;

    iget-boolean v0, v0, Lb6/Y0$a$a;->b:Z
    ...
    :cond_1
    iget-object p0, p0, Lb6/Y0;->g:Lb6/Y0$a;

    iget-object p0, p0, Lb6/Y0$a;->S:Lb6/Y0$a$a;

    iget p0, p0, Lb6/Y0$a$a;->a:I
...
.method public y(Lc6/a$c;)V
    ...
    iget-boolean v3, v1, Lb6/Y0$a;->h:Z
    ...
    invoke-virtual {p0, p1}, Lb6/n0;->p(Landroid/util/Size;)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_1
    iget-object p1, v1, Lb6/Y0$a;->f:Lx9/d;
