...
.method public final A()Z
    ...
    iget-object v0, v0, Lb6/Z;->E:Lb6/c;
    ...
    invoke-static {v3, v2, v0}, Lb6/d;->B0(IILb6/c;)Z
...
.method public final D()Lc6/a$b;
    ...
    invoke-direct {v0, p0}, Lc6/g$a;-><init>(Lc6/g;)V
...
.method public final E()Lc6/a$d;
    ...
    iput-object v1, v2, Lc6/a$d;->a:Ljava/util/ArrayList;

    iget-object v3, v0, Lc6/a;->B:Lb6/Y0;

    iget-object v4, v3, Lb6/Y0;->g:Lb6/Y0$a;

    iget-boolean v4, v4, Lb6/Y0$a;->h:Z
    ...
    iget-object v3, v5, Lb6/Z;->D:Lb6/F0;
    ...
    iput-object v4, v0, Lc6/a;->F:Landroid/util/Size;
    ...
    iget-object v0, v0, Lc6/a;->F:Landroid/util/Size;
    ...
    :cond_0
    invoke-virtual {v5}, Lb6/Z;->p2()Z

    move-result v4

    iput-boolean v4, v2, Lc6/a$d;->b:Z

    invoke-virtual {v5}, Lb6/Z;->T()Z

    move-result v4

    iget-boolean v9, v2, Lc6/a$d;->b:Z
    ...
    :goto_1
    iput-boolean v4, v2, Lc6/a$d;->c:Z

    iget-object v9, v5, Lb6/Z;->D:Lb6/F0;

    if-eqz v4, :cond_c

    invoke-virtual {v5}, Lb6/Z;->G()I

    move-result v4

    iput v4, v0, Lb6/i0;->t:I

    iget-object v11, v3, Lb6/Y0;->g:Lb6/Y0$a;

    iget-boolean v12, v11, Lb6/Y0$a;->e:Z
    ...
    invoke-virtual {v9, v4, v10}, Lb6/F0;->h(IZ)Landroid/view/Surface;

    move-result-object v4

    invoke-virtual {v5}, Lb6/Z;->c2()Landroid/util/Size;

    move-result-object v11

    iput-object v11, v0, Lc6/a;->F:Landroid/util/Size;

    iget v11, v0, Lb6/i0;->t:I

    invoke-virtual {v9}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v11}, Lb6/F0;->i(I)I

    move-result v11

    iput v11, v0, Lc6/a;->E:I

    goto/16 :goto_4

    :cond_3
    iget-boolean v4, v11, Lb6/Y0$a;->o:Z
    ...
    iget-object v4, v5, Lb6/Z;->E:Lb6/c;

    if-eqz v4, :cond_8

    invoke-static {v4}, Lb6/d;->c0(Lb6/c;)I

    move-result v4

    if-ne v14, v4, :cond_8

    iget v4, v0, Lb6/i0;->t:I

    invoke-virtual {v9, v4, v10}, Lb6/F0;->q(IZ)Landroid/view/Surface;
    ...
    invoke-static {v12, v11}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v9, v4, v10}, Lb6/F0;->k(IZ)Landroid/view/Surface;
    ...
    invoke-static {v11}, Lb6/F0;->l(I)I
    ...
    iget-object v11, v0, Lc6/a;->F:Landroid/util/Size;
    ...
    iget-object v12, v0, Lc6/a;->F:Landroid/util/Size;
    ...
    iput-object v8, v0, Lc6/a;->F:Landroid/util/Size;

    sget-object v11, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    const-string v11, "[SAT]hdr fusion mode, size is: "

    invoke-static {v11, v8}, LB8/h;->g(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    :cond_a
    :goto_4
    invoke-virtual {v5}, Lb6/Z;->H()I

    move-result v5

    iput v5, v0, Lc6/a;->C:I
    ...
    iget-object v6, v0, Lc6/a;->F:Landroid/util/Size;
    ...
    iget-object v4, v4, Lb6/Y0$a;->f:Lx9/d;

    invoke-virtual {v4}, Lx9/d;->d()I
    ...
    :cond_b
    invoke-virtual {v9, v14}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v5}, LH3/e;->s()I

    move-result v5

    iput v5, v0, Lc6/a;->D:I
    ...
    :cond_c
    invoke-virtual {v9}, Lb6/F0;->m()Landroid/util/SparseArray;

    move-result-object v4

    invoke-static {v4}, Lk6/c;->c(Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v9, v8}, Lb6/F0;->n(I)Landroid/view/Surface;
    ...
    :cond_e
    iget-object v8, v3, Lb6/Y0;->g:Lb6/Y0$a;

    iget-boolean v8, v8, Lb6/Y0$a;->n:Z
    ...
    :cond_10
    iget-object v4, v5, Lb6/Z;->F:Lb6/D;

    iget-object v4, v4, Lb6/D;->a:Lb6/E;

    iget-object v4, v4, Lb6/E;->i:Landroid/util/Size;

    iput-object v4, v0, Lb6/n0;->u:Landroid/util/Size;

    :cond_11
    :goto_6
    iget v3, v3, Lb6/Y0;->d:I
    ...
    iget-object v3, v9, Lb6/F0;->n:Landroid/view/Surface;
...
.method public final H(Lc6/a$c;)V
    ...
    iget-object v0, p0, Lc6/a;->B:Lb6/Y0;

    iget-object v0, v0, Lb6/Y0;->g:Lb6/Y0$a;

    iget-boolean v0, v0, Lb6/Y0$a;->n:Z
    ...
    invoke-static {p1, p0, v0, v1}, Lp6/N;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
...
.method public final x(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v1, p0, Lc6/a;->B:Lb6/Y0;

    iget-object v1, v1, Lb6/Y0;->g:Lb6/Y0$a;

    iget v1, v1, Lb6/Y0$a;->c:I
    ...
    iget-object v2, p0, Lc6/a;->B:Lb6/Y0;

    iget-object v2, v2, Lb6/Y0;->g:Lb6/Y0$a;

    iget v2, v2, Lb6/Y0$a;->c:I
    ...
    iget-object v2, v1, Lb6/Y0$a;->q:[I
    ...
    :goto_0
    iget-boolean v1, v1, Lb6/Y0$a;->n:Z
    ...
    iget-object v4, v1, Lw7/b;->e:L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;
    ...
    iget-object v5, p0, Lc6/a;->B:Lb6/Y0;

    iget-object v5, v5, Lb6/Y0;->g:Lb6/Y0$a;

    iget v5, v5, Lb6/Y0$a;->c:I
    ...
    invoke-static {p1, v4, v5, v3}, Lp6/N;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
    ...
    iget v5, v5, Lb6/Y0$a;->r:I

    invoke-static {v5}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v5

    iget-object v6, p0, Lc6/a;->B:Lb6/Y0;

    iget-object v6, v6, Lb6/Y0;->g:Lb6/Y0$a;

    iget v6, v6, Lb6/Y0$a;->s:I
    ...
    iget-object v4, p0, Lb6/i0;->b:Lb6/Z;

    iget-object v4, v4, Lb6/Z;->E:Lb6/c;

    invoke-static {v4}, Lb6/d;->I2(Lb6/c;)Z
    ...
    iget-object v5, v5, Lb6/Y0$a;->A:[B
    ...
    invoke-virtual {v4}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->G6()Z

    move-result v4

    if-eqz v4, :cond_5

    iget-object v4, p0, Lc6/a;->B:Lb6/Y0;

    iget-object v4, v4, Lb6/Y0;->g:Lb6/Y0$a;

    iget-object v4, v4, Lb6/Y0$a;->u:[I
    ...
    invoke-virtual {v4}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->R4()Z
    ...
    invoke-static {v7}, Lb6/d;->i(Lb6/c;)I
    ...
    invoke-virtual {v7}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->l2()Z
    ...
    iget-object v8, p0, Lb6/i0;->b:Lb6/Z;

    iget-boolean v8, v8, Lb6/a;->m:Z

    if-eqz v8, :cond_f

    iget-object v8, v1, Lw7/b;->e:L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;

    invoke-virtual {v8}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->M7()Z
    ...
    :cond_f
    iget-object v8, p0, Lc6/a;->B:Lb6/Y0;

    iget-object v8, v8, Lb6/Y0;->g:Lb6/Y0$a;

    iget-boolean v8, v8, Lb6/Y0$a;->B:Z
    ...
    iget-object v7, p0, Lc6/a;->B:Lb6/Y0;

    iget-object v7, v7, Lb6/Y0;->g:Lb6/Y0$a;

    iget v7, v7, Lb6/Y0$a;->c:I
    ...
    iget-boolean v6, v6, Lb6/Y0$a;->x:Z
    ...
    iget-boolean v4, v4, Lb6/Y0$a;->n:Z
    ...
    invoke-static {v2, v5}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-boolean v2, v2, Lb6/Y0$a;->n:Z
    ...
    invoke-static {v2}, Lb6/d;->K0(Lb6/c;)Z
    ...
    :cond_17
    iget-object v4, v1, Lb6/Z;->D:Lb6/F0;
    ...
    :cond_18
    invoke-static {v2}, Lb6/d;->I0(Lb6/c;)Z

    move-result v4

    if-eqz v4, :cond_19

    iget-object p0, v1, Lb6/Z;->D:Lb6/F0;
    ...
    iget-object v5, v4, Lb6/Y0;->g:Lb6/Y0$a;

    iget-object v5, v5, Lb6/Y0$a;->q:[I
    ...
    :cond_1a
    invoke-static {v2}, Lb6/d;->J0(Lb6/c;)Z

    move-result v2

    if-eqz v2, :cond_1c

    iget-object v2, v4, Lb6/Y0;->g:Lb6/Y0$a;

    iget-object v2, v2, Lb6/Y0$a;->q:[I
    ...
    invoke-static {p2, v2}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_1b
    iget-object v1, v1, Lb6/Z;->D:Lb6/F0;

    iget-object v1, v1, Lb6/F0;->n:Landroid/view/Surface;
    ...
    invoke-static {p2, p1}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
...
.method public final y(Lc6/a$c;)V
    ...
    iget-boolean v0, v0, Lb6/Y0$a;->h:Z
    ...
    iget-object p1, p0, Lb6/i0;->b:Lb6/Z;

    iget-object v0, p1, Lb6/Z;->E:Lb6/c;
    ...
    iget-object v0, p0, Lc6/a;->F:Landroid/util/Size;
    ...
    invoke-virtual {p0, v2, p1, v1, v0}, Lb6/n0;->o(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object p1

    iput-object p1, p0, Lb6/n0;->A:Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {p0, p1, v1, v0}, Lb6/n0;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
