...
.method public static synthetic Be(LX3/d0;Ljava/lang/Integer;)Z
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/fragment/BasePanelFragment;->lambda$needsContainerShowAnimation$6(LX3/d0;Ljava/lang/Integer;)Z
...
.method public static synthetic Ce(Lcom/android/camera/fragment/BasePanelFragment;Landroid/content/Context;Lq3/n;LX3/d0;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/fragment/BasePanelFragment;->lambda$onAttach$0(Landroid/content/Context;Lq3/n;LX3/d0;)V

    return-void
.end method

.method public static synthetic Dc(Lc4/d;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/fragment/BasePanelFragment;->lambda$onShot$3(Lc4/d;)V

    return-void
.end method

.method public static synthetic Gf(Lcom/android/camera/fragment/BasePanelFragment;)I
    .locals 0
...
.method public static synthetic Mc(Lcom/android/camera/fragment/BasePanelFragment;LX3/d0;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/BasePanelFragment;->lambda$unloadFragment$4(LX3/d0;)V

    return-void
.end method

.method public static synthetic Pc(LX3/H0;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/fragment/BasePanelFragment;->lambda$showSlideMaskView$11(LX3/H0;)V

    return-void
.end method

.method public static synthetic Pd(Lcom/android/camera/fragment/BasePanelFragment;LX3/L0;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/BasePanelFragment;->lambda$onAttach$1(LX3/L0;)V

    return-void
.end method

.method public static synthetic Uc(Lcom/android/camera/fragment/BasePanelFragment;Ljava/lang/Integer;)Z
    .locals 0
...
.method public static synthetic be(Lcom/android/camera/fragment/BasePanelFragment;LX3/H0;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/BasePanelFragment;->lambda$showSlideMaskView$10(LX3/H0;)V
...
.method private static synthetic lambda$needsContainerShowAnimation$6(LX3/d0;Ljava/lang/Integer;)Z
    .locals 0
    ...
    invoke-interface {p0, p1}, LX3/d0;->L5(I)Z
...
.method private synthetic lambda$needsContainerShowAnimation$7(LX3/d0;)Ljava/lang/Boolean;
    .locals 3
    ...
    invoke-direct {v1, p0, v2}, LN0/x;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, p1, v1}, LW1/h;-><init>(Ljava/lang/Object;I)V
...
.method private synthetic lambda$onAttach$0(Landroid/content/Context;Lq3/n;LX3/d0;)V
    .locals 1
    ...
    invoke-interface {p3, v0}, LX3/d0;->H4(I)I
    ...
    invoke-virtual {p0, p3, p2, p1}, Lcom/android/camera/fragment/BasePanelFragment;->loadRequest(LX3/d0;Lq3/n;I)V

    return-void
.end method

.method private synthetic lambda$onAttach$1(LX3/L0;)V
    .locals 4
    ...
    invoke-interface {p1, p0, v3}, LX3/L0;->ki(Lcom/android/camera/fragment/BasePanelFragment;Ljava/lang/String;)V
...
.method private synthetic lambda$onDetach$2(LX3/L0;)V
    .locals 4
    ...
    invoke-interface {p1, p0, v3}, LX3/L0;->B0(Lcom/android/camera/fragment/BasePanelFragment;Ljava/lang/String;)V
...
.method private static synthetic lambda$onShot$3(Lc4/d;)V
    .locals 1

    const/4 v0, 0x1

    invoke-interface {p0, v0}, Lc4/d;->md(Z)V

    return-void
.end method

.method private synthetic lambda$showSlideMaskView$10(LX3/H0;)V
    .locals 3
    ...
    invoke-interface {p1, p0, v1}, LX3/H0;->yb(Z[Ljava/util/function/IntSupplier;)V

    return-void
.end method

.method private static synthetic lambda$showSlideMaskView$11(LX3/H0;)V
    .locals 2
    ...
    invoke-interface {p0, v0, v1}, LX3/H0;->yb(Z[Ljava/util/function/IntSupplier;)V

    return-void
.end method

.method private static synthetic lambda$showSlideMaskView$8(LX3/H0;)V
    .locals 2
...
.method private synthetic lambda$unloadFragment$4(LX3/d0;)V
    .locals 2
...
.method public static synthetic ne(Lcom/android/camera/fragment/BasePanelFragment;LX3/L0;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/BasePanelFragment;->lambda$onDetach$2(LX3/L0;)V

    return-void
.end method

.method public static synthetic of(LX3/H0;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/fragment/BasePanelFragment;->lambda$showSlideMaskView$8(LX3/H0;)V

    return-void
.end method

.method public static synthetic sd(Lcom/android/camera/fragment/BasePanelFragment;LX3/d0;)Ljava/lang/Boolean;
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/BasePanelFragment;->lambda$needsContainerShowAnimation$7(LX3/d0;)Ljava/lang/Boolean;
...
.method private unloadWithAnimation()V
    ...
    iput v2, v0, Lq3/n$b;->c:F

    const/4 v2, 0x0

    iput v2, v0, Lq3/n$b;->d:F

    const/16 v3, 0x8

    iput v3, v0, Lq3/n$b;->f:I

    iput v2, v0, Lq3/n$b;->a:F

    const/high16 v2, 0x42480000    # 50.0f

    iput v2, v0, Lq3/n$b;->b:F

    const-wide/16 v2, 0x64

    iput-wide v2, v0, Lq3/n$b;->e:J
    ...
    iput-object v2, v0, Lq3/n$b;->h:Landroid/animation/AnimatorListenerAdapter;
    ...
    invoke-direct {v3, v0}, Lq3/n;-><init>(Lq3/n$b;)V

    filled-new-array {v2}, [Landroid/view/View;

    move-result-object v0

    invoke-virtual {v3, v0}, Lq3/n;->a([Landroid/view/View;)V
...
# virtual methods
.method public addExtraExclusionRequest(LX3/d0;Lq3/r;Z)V
    .locals 1
    ...
    invoke-virtual {p2, p3, v0, p1}, Lq3/r;->d(III)Lq3/q;
    ...
    invoke-virtual {p1, p0}, Lq3/q;->g(I)Lq3/q;
...
.method public enterAnim(Landroid/view/View;)V
    ...
    iput v4, v2, Lq3/n$b;->c:F

    iput v4, v2, Lq3/n$b;->d:F

    const-wide/16 v5, 0x12c

    iput-wide v5, v2, Lq3/n$b;->e:J
    ...
    iput v1, v2, Lq3/n$b;->c:F

    iput v4, v2, Lq3/n$b;->d:F

    iput v3, v2, Lq3/n$b;->f:I
    ...
    iput p0, v2, Lq3/n$b;->a:F

    iput v1, v2, Lq3/n$b;->b:F

    new-instance p0, LZi/g;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p0, v2, Lq3/n$b;->g:LZi/g;

    new-instance p0, Lq3/n;

    invoke-direct {p0, v2}, Lq3/n;-><init>(Lq3/n$b;)V

    filled-new-array {p1}, [Landroid/view/View;

    move-result-object p1

    invoke-virtual {p0, p1}, Lq3/n;->a([Landroid/view/View;)V
    ...
    invoke-static {p1, p0, v0, v3}, LO/i;->c(Landroid/view/View;III)V
...
.method public getFeatureUIAnimator(ZI)Lq3/n;
    .locals 2
    ...
    iput v0, p1, Lq3/n$b;->d:F

    const/16 p2, 0x8

    iput p2, p1, Lq3/n$b;->f:I

    new-instance p2, LZi/g;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p1, Lq3/n$b;->g:LZi/g;

    iput v0, p1, Lq3/n$b;->a:F

    iput p0, p1, Lq3/n$b;->b:F
    ...
    iput p0, p1, Lq3/n$b;->a:F

    iput v0, p1, Lq3/n$b;->b:F

    new-instance p0, LZi/g;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p0, p1, Lq3/n$b;->g:LZi/g;
...
.method public loadRequest(LX3/d0;Lq3/n;I)V
    .locals 3
    ...
    invoke-direct {v1, v2, p3}, Lq3/p$a;-><init>(II)V

    invoke-virtual {p0}, Lcom/xiaomi/camera/base/ui/fragments/BaseFragmentV2;->getFragmentId()I

    move-result p3

    iput p3, v1, Lq3/p$a;->d:I
    ...
    iput-object p2, v1, Lq3/p$a;->f:Lq3/n;
...
.method public onAttach(Landroid/content/Context;)V
    ...
    iput-wide v1, v0, Lq3/n$b;->e:J

    const/4 v1, 0x0

    iput v1, v0, Lq3/n$b;->c:F

    const/high16 v1, 0x3f800000    # 1.0f

    iput v1, v0, Lq3/n$b;->d:F

    const/4 v1, 0x0

    iput v1, v0, Lq3/n$b;->f:I

    new-instance v1, Lq3/n;

    invoke-direct {v1, v0}, Lq3/n;-><init>(Lq3/n$b;)V
    ...
    invoke-direct {v2, p0, p1, v1}, Lcom/android/camera/fragment/k;-><init>(Lcom/android/camera/fragment/BasePanelFragment;Landroid/content/Context;Lq3/n;)V
    ...
    invoke-direct {v0, p0, v1}, LC/u1;-><init>(Ljava/lang/Object;I)V
...
.method public onBackEvent(I)Z
    ...
    iget-object p1, v0, LV/c;->d:LV/a;

    iget-boolean p1, p1, LV/a;->b:Z
