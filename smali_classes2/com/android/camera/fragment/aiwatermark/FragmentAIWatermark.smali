...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->k:LG/a;
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->o:LH1/i;

    return-void
.end method

.method public static synthetic Ce(Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;LJ/m;)V
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->Gg(LJ/m;)V

    return-void
.end method

.method public static synthetic of(Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;)V
    .locals 2
...
.method public final E9(Z)V
    ...
    invoke-direct {v0, p1}, LT1/a;-><init>(Z)V
...
.method public final Gf()LL/e;
    .locals 5

    iget-object v0, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->b:[LL/e;
    ...
    iget-object v4, p0, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->k:LG/a;

    invoke-direct {v2, v3, v4}, LL/k;-><init>(Landroid/view/ViewGroup;Landroid/view/View$OnTouchListener;)V
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->b:[LL/e;
...
.method public final I2()V
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->b:[LL/e;

    iget v2, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->c:I

    aget-object v1, v1, v2

    invoke-interface {v1}, LL/e;->getLayout()Landroid/view/View;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->Pc(LJ/m;LL/e;Landroid/widget/FrameLayout$LayoutParams;)V
...
.method public final Mc(ILjava/lang/String;)LL/e;
    .locals 6
    ...
    iget-object v4, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->b:[LL/e;

    if-nez v4, :cond_0

    const/4 v4, 0x7

    new-array v4, v4, [LL/e;

    iput-object v4, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->b:[LL/e;
    ...
    iget-object p1, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->b:[LL/e;

    iget p2, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->c:I

    aget-object p1, p1, p2

    invoke-interface {p1}, LL/e;->getLayout()Landroid/view/View;

    move-result-object p1

    invoke-virtual {p0, v3, p1}, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->Uc(ILandroid/view/View;)V
    ...
    invoke-virtual {p0, v5, v4}, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->Uc(ILandroid/view/View;)V
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->k:LG/a;

    invoke-direct {p2, v0, v1}, LL/g;-><init>(Landroid/view/ViewGroup;Landroid/view/View$OnTouchListener;)V
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->k:LG/a;

    invoke-direct {p2, v1, v2}, LL/n;-><init>(Landroid/view/ViewGroup;Landroid/view/View$OnTouchListener;)V
    ...
    :pswitch_1
    invoke-virtual {p0}, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->Gf()LL/e;
    ...
    invoke-direct {p2, v0, v1}, LL/n;-><init>(Landroid/view/ViewGroup;Landroid/view/View$OnTouchListener;)V
    ...
    :pswitch_3
    iget-object p2, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->b:[LL/e;
    ...
    invoke-direct {v0, v1, v2}, LL/n;-><init>(Landroid/view/ViewGroup;Landroid/view/View$OnTouchListener;)V
    ...
    invoke-direct {p2, v0, v2}, LL/n;-><init>(Landroid/view/ViewGroup;Landroid/view/View$OnTouchListener;)V
...
.method public final Pc(LJ/m;LL/e;Landroid/widget/FrameLayout$LayoutParams;)V
    .locals 4

    if-eqz p1, :cond_8

    iget-boolean v0, p1, LJ/m;->l:Z
    ...
    :cond_7
    :goto_2
    invoke-interface {p2}, LL/e;->getLayout()Landroid/view/View;
...
.method public final Y0()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->Mc(ILjava/lang/String;)LL/e;

    move-result-object p0

    invoke-interface {p0}, LL/e;->getLayout()Landroid/view/View;
...
.method public final be([ILandroid/graphics/Rect;Lh0/b;LJ/m;)V
    .locals 1
    ...
    iget-object p4, p0, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->k:LG/a;
    ...
    iput-object p3, p4, LG/a;->a:Landroid/graphics/Rect;

    const/4 p0, 0x0

    iput-boolean p0, p4, LG/a;->i:Z

    iput-object p1, p4, LG/a;->g:[I

    iget-object p0, p4, LG/a;->h:Lh0/b;

    iget-object p3, p0, Lh0/b;->f:LJ/m;

    if-eqz p3, :cond_1

    iput-object p1, p3, LJ/m;->i:[I

    iput-object p2, p3, LJ/m;->k:Landroid/graphics/Rect;

    return-void

    :cond_1
    iget-object p0, p0, Lh0/b;->g:LJ/m;

    if-eqz p0, :cond_2

    iput-object p1, p0, LJ/m;->i:[I

    iput-object p2, p0, LJ/m;->k:Landroid/graphics/Rect;
...
.method public final ce(ZIJJLjava/lang/String;)V
    .locals 4
    ...
    invoke-direct {v0, p2, p1, p3, p4}, LT1/b;-><init>(IZJ)V
...
.method public final initView(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->o:LH1/i;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    const/4 v2, 0x0

    iput-object v2, p1, LG/a;->f:Landroid/view/View;

    const/4 v3, 0x4

    new-array v3, v3, [I

    iput-object v3, p1, LG/a;->g:[I

    iput-object v2, p1, LG/a;->h:Lh0/b;

    const/4 v3, 0x0

    iput-boolean v3, p1, LG/a;->i:Z

    iput-object v2, p1, LG/a;->j:LH1/i;

    const/high16 v2, 0x3f800000    # 1.0f

    iput v2, p1, LG/a;->k:F

    iput-object v0, p1, LG/a;->a:Landroid/graphics/Rect;
    ...
    iput-object v0, p1, LG/a;->h:Lh0/b;

    iput-object v1, p1, LG/a;->j:LH1/i;

    iput-object p1, p0, Lcom/android/camera/fragment/aiwatermark/FragmentAIWatermark;->k:LG/a;

    return-void
.end method

.method public final j8(LJ/m;)V
    .locals 4
...
.method public final onDestroy()V
    ...
    sget-object v0, LJ/d;->d:Ljava/util/ArrayList;

    sget-object v0, LJ/d$c;->a:LJ/d;
    ...
    iget-object v0, v0, LJ/d;->b:LJ/d$a;

    invoke-virtual {v1, v0}, Ls3/b;->c(Ls3/b$a;)V
    ...
    invoke-interface {p0}, LL/e;->release()V
...
.method public final onResume()V
    ...
    invoke-virtual {v0, v1}, Lh0/b;->m(Z)V
    ...
    invoke-static {v0, p0, v1}, LC/s3;->e(Landroid/content/Context;Ljava/lang/String;Z)V
...
.method public final onStop()V
    ...
    invoke-interface {v0}, LL/e;->getLayout()Landroid/view/View;

    move-result-object v0

    const/16 v1, 0x8

    invoke-virtual {p0, v1, v0}, Lcom/android/camera/fragment/watermark/wmSettingV1/fragment/FragmentWatermarkBase;->Uc(ILandroid/view/View;)V
...
.method public final provideRotateItem(Ljava/util/List;I)V
    ...
    invoke-static {p2, v0, v2, v3}, LM4/u;->g(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final sd(Landroid/view/View;)V
    .locals 3
    ...
    invoke-direct {v0, p0, v1}, LT1/d;-><init>(Ljava/lang/Object;I)V
