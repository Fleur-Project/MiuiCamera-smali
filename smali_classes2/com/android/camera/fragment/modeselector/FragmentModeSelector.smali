...
.method public static synthetic Dc(Lcom/android/camera/fragment/modeselector/FragmentModeSelector;)V
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    invoke-virtual {v1, v0}, Lg0/s;->w(I)Z
...
.method public final L9(F)Z
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    invoke-virtual {v2}, Lg0/s;->m()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v7, p0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    invoke-virtual {v7}, Lg0/s;->getItems()Ljava/util/List;
    ...
    :cond_c
    :goto_6
    iget-object p1, p0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    invoke-virtual {p1}, Lg0/s;->getItems()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    invoke-virtual {v0}, Lg0/s;->getItems()Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Lg0/s;->w(I)Z
    ...
    invoke-static {v0, v2, v4, v6, v7}, LQ1/t;->l(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final Mg(Z)V
    ...
    invoke-virtual {v0}, Lg0/s;->m()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->Rb(ILjava/lang/String;)V
...
.method public final Mi()V
    ...
    invoke-virtual {v1}, Lg0/s;->m()Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final Pd(Landroid/view/View;Z)V
    ...
    invoke-static {v1, p0, p2}, LC/W1;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public final Rb(ILjava/lang/String;)V
    .locals 1
    ...
    iget-object p2, p0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    invoke-virtual {p2, p1}, Lg0/s;->w(I)Z
...
.method public final Y4()V
    ...
    invoke-virtual {v2}, Lg0/s;->o()Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final ci()V
    ...
    iget-object v3, p0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    invoke-virtual {v3, v0}, Lg0/s;->w(I)Z
    ...
    invoke-virtual {p0, v2, v0}, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->Rb(ILjava/lang/String;)V
...
.method public final delayInflatingViews(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->of()V
...
.method public final ha()V
    ...
    iget-object v5, p0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    invoke-virtual {v5}, Lg0/s;->o()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-direct {v4, v0}, Lcom/android/camera/fragment/top/z;-><init>(I)V
    ...
    new-instance v6, Lcom/android/camera/ui/p;

    invoke-direct {v6, p0}, Lcom/android/camera/ui/p;-><init>(Lcom/android/camera/ui/DragLayout;)V
    ...
    invoke-interface {v4, v3, v1}, Lmiuix/animation/FolmeStyle;->to(Ljava/lang/Object;[Lmiuix/animation/base/AnimConfig;)Lmiuix/animation/IStateStyle;

    new-instance v1, Lc2/k;

    invoke-direct {v1, v0}, Lc2/k;-><init>(I)V
...
.method public final ii(IZ)V
    ...
    invoke-direct {v2, v0, v4}, Ll1/a;-><init>(Ljava/lang/Object;I)V
    ...
    iput-object v0, p2, LQ/e;->l:LZi/g;
    ...
    invoke-direct {v2, v0, v4}, Lh6/a;-><init>(Ljava/lang/Object;I)V
...
.method public final initView(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;
...
.method public final ne(ILjava/lang/String;Z)Z
    ...
    invoke-interface {v6}, Lu3/k;->i0()Z
    ...
    :cond_c
    invoke-virtual {v4, p1}, Lg0/t;->Y(I)V
    ...
    iget-object p3, v0, Lcom/android/camera/Camera;->w1:LC/G1;
    ...
    iget-object v2, v0, Lcom/android/camera/Camera;->w1:LC/G1;
    ...
    invoke-direct {p3, v0, p0, p2}, LCc/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final notifyAfterFrameAvailable(I)V
    ...
    instance-of p1, p1, L㸋㸇㸅㹆㸅㸁㹆㸌㸍㸞㸁㸋㸍㹆㸰㸝㸉㸆㸑㸝㸉㸆;
...
.method public final notifyDataChanged(II)V
    ...
    invoke-virtual {p2, v0}, Lg0/s;->y(Z)V

    :cond_2
    iget-object p2, p0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    iget-boolean v1, p2, Lg0/s;->b:Z

    const/4 v2, 0x0

    if-eqz v1, :cond_3

    iput-boolean v2, p2, Lg0/s;->b:Z
    ...
    invoke-direct {v1, p2}, LD2/a;-><init>(Ljava/lang/Object;)V
...
.method public final notifyThemeChanged(II)V
    ...
    invoke-direct {v0, p1}, LD2/a;-><init>(Ljava/lang/Object;)V
...
.method public final onShot(LZ/h;)V
    ...
    invoke-direct {v1, p0, p1, v2}, LC3/D;-><init>(Ljava/lang/Object;II)V
...
.method public final provideAnimateElement(ILjava/util/List;I)V
    ...
    invoke-static {v6, v1, v12, v13, v14}, LQ1/t;->l(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v13, v0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    invoke-virtual {v13}, Lg0/s;->m()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {v13}, Lg0/s;->o()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    sget-object v12, La0/a;->f:La0/a;

    invoke-virtual {v12}, La0/a;->k()Z
    ...
    invoke-virtual {v11, v13, v8}, LW9/a;->g(Ljava/lang/String;Z)Z
    ...
    invoke-direct {v14, v0, v5}, Lf3/h;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {v11, v13, v7}, LW9/a;->m(Ljava/lang/String;Z)LW9/a;
    ...
    invoke-direct {v13, v7}, Lk2/j;-><init>(I)V
    ...
    new-instance v13, LC/u0;

    const/4 v14, 0x6

    invoke-direct {v13, v0, v14}, LC/u0;-><init>(Ljava/lang/Object;I)V
    ...
    const-class v9, Lcd/t;

    invoke-virtual {v4, v9}, Lj0/a;->a(Ljava/lang/Class;)Lj0/c;

    move-result-object v4

    check-cast v4, Lcd/t;

    invoke-virtual {v4}, Lcd/t;->c()Z
    ...
    :cond_f
    sget-object v11, LU3/g$a;->a:LU3/g;

    const-class v15, LX3/D0;

    invoke-virtual {v11, v15}, LU3/g;->d(Ljava/lang/Class;)Ljava/util/Optional;

    move-result-object v11

    new-instance v15, LC/U2;

    invoke-direct {v15, v4}, LC/U2;-><init>(I)V
    ...
    const-string v4, " set isVisibility = false"
    ...
    invoke-static {v9, v4, v11}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v9, v11}, LW9/b;->v(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {v9, v11}, Lf0/c;->a(I)Ljava/util/List;
    ...
    :cond_12
    invoke-virtual {v4}, Lcom/xiaomi/milive/data/LiveMasterProcessing;->isInWorkSpaceRecording()Z
    ...
    :goto_5
    iget-boolean v4, v9, Lf0/c;->b:Z

    if-nez v4, :cond_c

    iget-object v4, v0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->f:Lcom/android/camera/ui/j;

    invoke-virtual {v0, v4, v8}, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->Pd(Landroid/view/View;Z)V
    ...
    new-instance v11, LC3/V;

    invoke-direct {v11, v4}, LC3/V;-><init>(I)V
    ...
    invoke-virtual {v0, v8}, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->s2(Z)V
    ...
    iget-object v4, v0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->e:Landroid/widget/FrameLayout;
    ...
    :cond_17
    iget-object v4, v0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->b:Lg0/s;

    invoke-virtual {v4, v1}, Lg0/s;->w(I)Z

    move-result v4

    if-eqz v4, :cond_1a

    invoke-static {v1}, Lg0/s;->x(I)Z
    ...
    const-string v4, "to common mode"
    ...
    invoke-virtual {v0, v2, v8}, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->Pd(Landroid/view/View;Z)V
    ...
    invoke-direct {v8, v2}, LD2/a;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v2, v4, v8}, Lcom/android/camera/ui/ModeSelectView;->h(ILcom/android/camera/ui/ModeSelectView$a;)V
    ...
    const-string v9, "to more mode"

    new-array v11, v8, [Ljava/lang/Object;

    invoke-static {v4, v9, v11}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v4, v0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->j:Lcom/android/camera/ui/EdgeHorizonScrollView;

    invoke-virtual {v0, v4, v8}, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->Pd(Landroid/view/View;Z)V

    iget-object v4, v0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->c:Lcom/android/camera/ui/DragLayout;

    invoke-virtual {v4}, Lcom/android/camera/ui/DragLayout;->f()V
    ...
    :cond_1c
    invoke-virtual {v4, v1, v7}, Lg0/s;->l(IZ)Ljava/lang/String;
    ...
    iget-object v11, v0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->h:Landroid/widget/TextView;
    ...
    invoke-static {v4, v14}, LC/R1;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    sget-object v12, La0/d;->c:La0/d;

    const v13, 0x7f060943

    invoke-virtual {v12, v13, v7}, La0/d;->a(IZ)I

    move-result v7

    invoke-virtual {v9, v7}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object v7, v0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->g:Landroid/widget/FrameLayout;

    const/4 v9, 0x0

    invoke-virtual {v7, v9}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    iget-object v7, v0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->i:Landroid/widget/ImageView;
    ...
    invoke-virtual {v7, v8, v8, v8, v8}, Landroid/view/View;->setPaddingRelative(IIII)V
    ...
    invoke-virtual {v7, v8, v8, v9, v8}, Landroid/view/View;->setPaddingRelative(IIII)V
    ...
    iget-object v7, v0, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->f:Lcom/android/camera/ui/j;
    ...
    invoke-direct {v4, v5}, LQ/c;-><init>(Landroid/view/View;)V
    ...
    invoke-direct {v5}, LZi/j;-><init>()V

    iput-object v5, v4, LQ/c;->d:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v0, v2, v5}, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->Pd(Landroid/view/View;Z)V
    ...
    new-instance v4, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/a;

    const/16 v5, 0x11

    invoke-direct {v4, v5}, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/a;-><init>(I)V
    ...
    invoke-virtual {v0, v5}, Lcom/android/camera/fragment/modeselector/FragmentModeSelector;->s0(Z)V
...
.method public final q1()Z
    ...
    invoke-direct {v2, v3}, LC/Z1;-><init>(I)V
    ...
    invoke-virtual {v0, v3}, Lg0/s;->w(I)Z
    ...
    invoke-direct {v2, v4}, LC/X0;-><init>(I)V
...
.method public final r8()Z
    ...
    invoke-direct {v1, p0}, LO/i$d;-><init>(Lcom/android/camera/ui/o;)V
...
.method public final s2(Z)V
    ...
    iget-object v2, v2, Lg0/t;->u:Ljava/lang/String;
    ...
    invoke-virtual {v2, v4}, Lg0/s;->w(I)Z
...
.method public final unRegister(LU3/f;)V
    ...
    invoke-static {p1, p0}, Li5/a;->tg(Ljava/lang/String;Lcom/android/camera/ui/DragLayout$c;)V
...
.method public final updateView(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1}, Lg0/s;->o()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {p2}, Lg0/s;->m()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-static {v1, p0, p2}, LA2/l;->j(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
