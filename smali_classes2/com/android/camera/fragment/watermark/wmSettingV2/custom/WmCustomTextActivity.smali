...
.method public final fj()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/watermark/wmSettingV2/custom/WmCustomEditActivity;->jj()V
    ...
    :try_start_4
    invoke-static {v1, v0}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public final gj()Ljava/lang/String;
    ...
    invoke-virtual {v0, p0}, Lo9/N;->n(Ljava/lang/String;)Ljava/lang/String;
...
.method public final hj()Ljava/lang/String;
    ...
    invoke-direct {v2, v3}, Luf/j;-><init>(Ljava/io/BufferedReader;)V

    new-instance v4, LOg/a;

    invoke-direct {v4, v2}, LOg/a;-><init>(LOg/h;)V

    new-instance v2, LL2/c;

    invoke-direct {v2, v0}, LL2/c;-><init>(I)V

    invoke-static {v4, v2}, LOg/t;->x(LOg/h;Lyf/l;)LOg/v;
    ...
    invoke-direct {v4, v5}, LE3/c;-><init>(I)V

    invoke-static {v2, v4}, LOg/t;->s(LOg/h;Lyf/l;)LOg/e;

    move-result-object v2

    new-instance v4, LOg/e$a;

    invoke-direct {v4, v2}, LOg/e$a;-><init>(LOg/e;)V

    :goto_0
    invoke-virtual {v4}, LOg/e$a;->hasNext()Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {v4}, LOg/e$a;->next()Ljava/lang/Object;
    ...
    :try_start_4
    invoke-static {v3, v2}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public final ij(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Lo9/N;->n(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Lo9/N;->n(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_2
    invoke-static {v0, p0}, LI4/a;->j(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public final kj(Ljava/lang/String;)V
    ...
    invoke-static {v4}, LPg/p;->k0(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :try_start_4
    invoke-static {p0, v4}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    const-string v5, "updateHistory->BufferedReader error: "
