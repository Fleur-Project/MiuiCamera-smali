...
# virtual methods
.method public final fj(Landroid/graphics/Bitmap;)V
    .locals 4
    ...
    iput-object v1, p0, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/SignatureByHandActivity;->n:LBd/c;
    ...
    invoke-direct {v0, p1}, LP2/b;-><init>(Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v1, p0, p1, v2}, LM2/e;-><init>(Landroid/content/ComponentCallbacks;Landroid/os/Parcelable;I)V

    new-instance v2, LD3/c;

    const/4 v3, 0x4

    invoke-direct {v2, v1, v3}, LD3/c;-><init>(Ljava/lang/Object;I)V

    new-instance v1, LP2/c;

    const/4 v3, 0x0

    invoke-direct {v1, v3, p0, p1}, LP2/c;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    new-instance p1, LK2/t;

    const/4 v3, 0x1

    invoke-direct {p1, v1, v3}, LK2/t;-><init>(Ljava/lang/Object;I)V
...
.method public final gj()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/SignatureByHandActivity;->n:LBd/c;
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/camera/hand/signature/SignatureView;->setSignatureStateListener(LHa/e;)V
...
.method public final hj(Landroid/graphics/Bitmap;)V
    .locals 10
    ...
    invoke-static {p1, v3, v4}, Ld3/g;->a(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v6, v4}, Ld3/g;->a(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {v5, v1, v7, v8, v4}, Ld3/g;->b(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Landroid/net/Uri;

    move-result-object v5

    const-string v8, "black"

    invoke-static {p1, v1, v7, v8, v4}, Ld3/g;->b(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static {p1, v6, v4, v2}, LPg/p;->X(Ljava/lang/String;CII)I
    ...
    invoke-virtual {p1, v1}, Lcom/xiaomi/cam/watermark/b;->T(Ljava/lang/String;)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p0, v1}, LEg/V;->b(Landroid/content/Context;I)I
    ...
    invoke-virtual {p1, v1}, Lcom/xiaomi/camera/hand/signature/SignatureView;->setSignatureStateListener(LHa/e;)V
    ...
    invoke-direct {v0, p0, v1}, LIh/d;-><init>(Ljava/lang/Object;I)V
...
.method public final onDestroy()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/SignatureByHandActivity;->gj()V
