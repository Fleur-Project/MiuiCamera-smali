...
.method public static final a(Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/menu/DialogFontMenuViewModel;Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/MarketTextStyle;Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/menu/DialogFontMenuViewModel$a$a;)Ljava/lang/Object;
    ...
    invoke-static {p4}, LBi/a;->o(Lnf/d;)Lnf/d;

    move-result-object p4

    invoke-direct {p0, v1, p4}, LRg/k;-><init>(ILnf/d;)V

    invoke-virtual {p0}, LRg/k;->r()V

    new-instance p4, LO5/b;

    invoke-direct {p4, v1, p1, p0}, LO5/b;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    sget-object v2, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/mark/a;->a:LX2/a;
    ...
    invoke-static {p3, p1, v2}, LPg/p;->d0(Ljava/lang/CharSequence;[Ljava/lang/String;I)Ljava/util/List;

    move-result-object p1

    invoke-static {p1}, Lkf/v;->j0(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-static {p3, v2, p1}, LPg/m;->K(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p4, p2}, LO5/b;->c(Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    sget-object p1, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/mark/a;->a:LX2/a;

    invoke-interface {p1, p2}, LX2/a;->b(Ljava/lang/String;)LB8/g;

    move-result-object p1

    new-instance v2, LCa/b;

    invoke-direct {v2, p3, v1}, LCa/b;-><init>(Ljava/lang/Object;I)V

    iget-object p1, p1, LB8/g;->a:Lio/reactivex/Observable;

    new-instance v3, LB8/d;

    invoke-direct {v3, v2, v0}, LB8/d;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v1}, LQ1/p;-><init>(I)V
    ...
    invoke-direct {v2, p4, p2}, LX2/e;-><init>(LO5/b;Ljava/lang/String;)V

    new-instance v3, LX2/f;

    invoke-direct {v3, p3, p4, p2}, LX2/f;-><init>(Ljava/lang/String;LO5/b;Ljava/lang/String;)V

    new-instance p2, LB8/f;

    invoke-direct {p2, v2, v0}, LB8/f;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, v1, p2, v3}, Lio/reactivex/Observable;->subscribe(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;)Lio/reactivex/disposables/Disposable;
...
.method public final b(Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/TextStyle;)V
    ...
    invoke-virtual {v4}, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/MarketTextStyle;->c()Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0}, Landroidx/lifecycle/ViewModelKt;->getViewModelScope(Landroidx/lifecycle/ViewModel;)LRg/D;

    move-result-object v0

    new-instance v1, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/menu/DialogFontMenuViewModel$a;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/menu/DialogFontMenuViewModel$a;-><init>(Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/TextStyle;Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/menu/DialogFontMenuViewModel;Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/MarketTextStyle;Ljava/lang/String;Ljava/lang/String;Lnf/d;)V

    const/4 p0, 0x3

    const/4 p1, 0x0

    invoke-static {v0, p1, p1, v1, p0}, LRg/f;->a(LRg/D;Lnf/e;LRg/F;Lyf/p;I)LRg/B0;
