...
.method public static synthetic Tj(LX3/B;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/video/ProVideoModule;->lambda$setProVideoLogLut$1(LX3/B;)V

    return-void
.end method

.method public static synthetic Uj(Lcom/android/camera/module/video/ProVideoModule;Lcom/android/camera/module/VideoBase$e;Ljava/util/List;)V
    .locals 0
...
.method private importFile(Landroid/net/Uri;)V
    ...
    invoke-direct {v3, v4}, LC/q;-><init>(I)V
    ...
    invoke-static {v5, v6, v0}, LC/f2;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v7}, LMe/Z;->p(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_3
    ...
    invoke-static {p1, v4}, LC/M;->f(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v4}, Lh0/n0;->isSupportMode(I)Z
    ...
    :cond_3
    iget-object v6, p1, Lh0/n0;->a:Lcom/android/camera/ui/lut/a;

    if-nez v6, :cond_4

    invoke-virtual {p1, v4}, Lh0/n0;->j(I)V
...
.method private static synthetic lambda$setProVideoLogLut$1(LX3/B;)V
    .locals 0
...
.method private setLogLut(Lh0/n0;)V
    ...
    invoke-static {v0, v1, p1, v2}, LM4/u;->g(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private updateCubeThumb(Lcom/android/camera/ui/lut/b;Ljava/lang/String;)Z
    ...
    iput v2, v5, Lff/a;->b:I

    invoke-static {v0, v4}, LC/F;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    new-instance v7, Ljava/io/File;

    invoke-static {v6, p2}, LC/F;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v7}, Lff/a;->d(Ljava/lang/String;)Z
    ...
    :try_start_2
    invoke-virtual {v5, v6}, Lff/a;->e(Ljava/lang/String;)Z
    ...
    invoke-static {p2, v5}, LC/M;->f(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v0, v4, v1}, LM/a;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, v3, Lcom/android/camera/effect/EffectController;->F:LVe/b;
    ...
    invoke-direct {v2, v5, v6}, LVe/b;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v2, v3, Lcom/android/camera/effect/EffectController;->F:LVe/b;
    ...
    invoke-static {v0, v4, v5}, LM/a;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    new-instance v4, LR0/b;

    invoke-direct {v4, v3, v2, v0, p2}, LR0/b;-><init>(Lcom/android/camera/effect/EffectController;LVe/b;Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, v2, LVe/b;->b:LTe/k;
    ...
    :cond_4
    iget-object p2, p2, LTe/k;->b:Landroid/os/Handler;
    ...
    invoke-static {p1, p2, v1}, LC/f2;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public isPurePreview()Z
    ...
    invoke-virtual {v0}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->i5()Z
...
.method public onActivityResult(Lcom/android/camera/module/N;IILandroid/content/Intent;)V
    ...
    invoke-static {p1, p3}, LC/F;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
...
.method public onRenderEngineCreate()V
    ...
    invoke-static {v2, p0}, Lcom/android/camera/data/data/h;->t(ILb6/c;)[F
    ...
    invoke-virtual {v0, v3, v2}, Lq5/g;->k(LQe/d;LSe/k;)V

    goto :goto_1

    :cond_2
    invoke-virtual {v0, v3, v1}, Lq5/g;->k(LQe/d;LSe/k;)V

    :goto_1
    sget-object p0, LQe/d;->M:LQe/d;

    invoke-virtual {v0, p0, v1}, Lq5/g;->k(LQe/d;LSe/k;)V

    sget-object p0, LQe/d;->e:LQe/d;

    invoke-virtual {v0, p0}, Lq5/g;->f(LQe/d;)LZe/t;
...
.method public onRenderEngineDestroy()V
    ...
    invoke-virtual {v0, p0}, Lq5/g;->d(LQe/d;)V
...
.method public resetEvValue(Z)V
    ...
    invoke-interface {p1}, Lu3/k;->R()I

    move-result p1

    :goto_0
    invoke-virtual {v0, p1}, Lb6/D;->E(I)V
    ...
    invoke-virtual {p1, v1}, Lb6/D;->i(Z)V
...
.method public updateFpsRange()V
    ...
    invoke-virtual {v0, p0}, Lb6/D;->d0(Landroid/util/Range;)V
    ...
    invoke-virtual {p0, v1}, Lb6/D;->d0(Landroid/util/Range;)V
