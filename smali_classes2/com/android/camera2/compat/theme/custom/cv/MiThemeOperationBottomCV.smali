...
.method private onLongExposeFinish(LW1/b;Ln5/b;)V
    ...
    :cond_0
    iget-object p0, p2, Ln5/b;->d:Ln5/x;

    iget p1, p0, Ln5/x;->Y:F

    invoke-virtual {p0, p1}, Ln5/x;->t(F)V

    iget-object p0, p2, Ln5/b;->d:Ln5/x;

    iget p1, p0, Ln5/x;->c0:I

    invoke-virtual {p0, p1}, Ln5/x;->s(I)V

    iget-object p0, p2, Ln5/b;->f:Ln5/q;

    iget p1, p0, Ln5/q;->T:I

    iput p1, p0, Ln5/q;->S:I

    const/4 p1, 0x0

    iput p1, p0, Ln5/q;->U:I
...
.method public handleIntoPattern(Lh0/v0;Ln5/b;)Z
    .locals 18
    ...
    iget-object v2, v1, Ln5/b;->d:Ln5/x;

    iget v3, v2, Lj5/d;->g:F

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4}, Ln5/x;->r(FI)V

    iget-object v2, v1, Ln5/b;->f:Ln5/q;

    invoke-virtual {v2, v4}, Ln5/q;->o(I)V
    ...
    :goto_3
    iget v9, v0, Lh0/v0;->a:I

    iget-object v10, v1, Ln5/b;->l:Landroid/content/Context;

    iget-object v11, v1, Ln5/b;->g:Ln5/r;

    iget-object v12, v1, Ln5/b;->e:Ln5/z;
    ...
    :pswitch_1
    iget-object v6, v1, Ln5/b;->c:Ln5/s;
    ...
    iget-object v6, v1, Ln5/b;->d:Ln5/x;

    invoke-virtual {v6, v15, v5}, Ln5/x;->r(FI)V
    ...
    invoke-virtual {v12}, Ln5/z;->o()V

    iget v0, v0, Lh0/v0;->e:I

    invoke-static {v0, v4}, LC/s2;->x(IZ)Z
    ...
    invoke-virtual {v11, v10, v0}, Ln5/r;->p(Landroid/content/Context;I)V
    ...
    iget-object v3, v1, Ln5/b;->c:Ln5/s;
    ...
    iget-object v3, v1, Ln5/b;->d:Ln5/x;

    invoke-virtual {v3, v15, v5}, Ln5/x;->r(FI)V
    ...
    invoke-virtual {v0, v15, v6}, Ln5/x;->r(FI)V
    ...
    :goto_8
    invoke-virtual {v0, v4}, Ln5/q;->o(I)V
    ...
    invoke-virtual {v3, v15, v6}, Ln5/x;->r(FI)V
...
.method public handleLongExposeCaptureCompleted(LW1/b;Ln5/b;)Z
    ...
    invoke-virtual {p0, v1}, Ln5/q;->s(I)V
...
.method public handlePrepareRecording(LW1/b;Ln5/b;)Z
    ...
    iget v2, v0, Ln5/x;->Y:F

    mul-float/2addr v2, v14

    invoke-virtual {v0, v2}, Ln5/x;->t(F)V

    iget-object v0, v1, Ln5/b;->d:Ln5/x;

    invoke-virtual {v0, v13}, Ln5/x;->s(I)V

    iget-object v0, v1, Ln5/b;->d:Ln5/x;

    iget v2, v0, Lj5/d;->g:F

    invoke-virtual {v0, v2}, Ln5/x;->u(F)V

    iget-object v0, v1, Ln5/b;->d:Ln5/x;

    invoke-virtual {v0, v7}, Ln5/x;->v(F)V

    iget-object v0, v1, Ln5/b;->c:Ln5/s;

    invoke-virtual {v0, v8}, Ln5/s;->p(Z)V

    iget-object v0, v1, Ln5/b;->c:Ln5/s;

    const/4 v2, 0x0

    iput v2, v0, Ln5/s;->I:F
    ...
    iget-object v2, v1, Ln5/b;->c:Ln5/s;
    ...
    iget-object v1, v1, Ln5/b;->c:Ln5/s;
    ...
    invoke-virtual {v0, v13}, Ln5/s;->p(Z)V
    ...
    invoke-virtual {v0, v2}, Ln5/q;->q(F)V
    ...
    iput v6, v2, Ln5/q;->U:I

    iget v3, v2, Ln5/q;->b0:F

    iput v3, v2, Ln5/q;->a0:F

    iput v14, v2, Ln5/q;->c0:F
    ...
    iget-object v0, v1, Ln5/b;->g:Ln5/r;
    ...
    iget-object v0, v0, Ln5/r;->K:Landroid/graphics/Paint;

    invoke-virtual {v0, v8}, Landroid/graphics/Paint;->setFakeBoldText(Z)V

    iget-object v0, v1, Ln5/b;->k:Ljava/util/ArrayList;

    iget-object v1, v1, Ln5/b;->g:Ln5/r;
    ...
    invoke-virtual {v0, v2}, Ln5/r;->q(F)V
...
.method public handleScaleDown(ILn5/b;)Z
    ...
    iget-object p0, p2, Ln5/b;->c:Ln5/s;
    ...
    invoke-virtual {p0, p1}, Ln5/x;->m(F)Lj5/d;
...
.method public handleStopRecording(LW1/b;Ln5/b;)Z
    ...
    invoke-virtual {p0, p1}, Ln5/x;->u(F)V
    ...
    invoke-virtual {p0, p1}, Ln5/x;->w(F)V

    iget-object p0, p2, Ln5/b;->d:Ln5/x;

    invoke-virtual {p0, v2}, Ln5/x;->v(F)V
...
.method public handleSuspendShutterIntoPattern(Lh0/v0;Ln5/H;)Z
    .locals 4
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
...
.method public handleSuspendShutterScaleDown(Ln5/H;)Z
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "supportSuspendShutter"
    ...
    iget-object p0, p1, Ln5/b;->c:Ln5/s;
    ...
    iget-object p0, p1, Ln5/b;->f:Ln5/q;
...
.method public handleThemeChanged(ZLh0/v0;Ln5/b;)Z
    .locals 4

    iget p0, p2, Lh0/v0;->a:I
    ...
    :cond_4
    iget-object v3, p3, Ln5/b;->c:Ln5/s;

    invoke-virtual {v3, v2}, Lj5/d;->j(I)V

    iget-object v2, p3, Ln5/b;->c:Ln5/s;
    ...
    iget-object v2, p3, Ln5/b;->d:Ln5/x;

    iget v3, v2, Ln5/x;->Z:F

    invoke-virtual {v2, v3, v1}, Ln5/x;->r(FI)V

    iget-object v1, p3, Ln5/b;->d:Ln5/x;

    invoke-virtual {v1, p2}, Ln5/x;->s(I)V

    invoke-virtual {v1}, Ln5/x;->h()V

    iget-object v1, p3, Ln5/b;->f:Ln5/q;

    invoke-virtual {v1, v0}, Lj5/d;->j(I)V

    iget-object v0, p3, Ln5/b;->f:Ln5/q;
    ...
    :goto_3
    invoke-virtual {v0, p2}, Ln5/q;->o(I)V
...
.method public onLongExposePrepare(LW1/b;Ln5/b;)V
    ...
    invoke-virtual {p0, p1}, Ln5/q;->q(F)V

    iget-object p0, p2, Ln5/b;->c:Ln5/s;

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Ln5/s;->p(Z)V
    ...
    iget v1, p0, Ln5/x;->Y:F

    mul-float/2addr v1, v0

    invoke-virtual {p0, v1}, Ln5/x;->t(F)V
    ...
    iput-boolean p1, p0, Ln5/x;->Q:Z

    iget-object p0, p2, Ln5/b;->k:Ljava/util/ArrayList;

    iget-object p1, p2, Ln5/b;->f:Ln5/q;
...
.method public playPickersAnimation(LX1/I;)V
    .locals 0

    invoke-virtual {p1}, LX1/I;->c()V
