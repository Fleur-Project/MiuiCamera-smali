...
# instance fields
.field private mComponentRunningCvLens:Lh0/x;
...
.method public static synthetic Lf(Ljava/lang/String;LX3/B;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->lambda$onItemSelected$1(Ljava/lang/String;LX3/B;)V

    return-void
.end method

.method public static synthetic Mf(Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;Landroid/view/View;IZ)V
    .locals 0
...
.method private static synthetic lambda$onItemSelected$1(Ljava/lang/String;LX3/B;)V
    .locals 0

    invoke-interface {p1, p0}, LX3/B;->Wg(Ljava/lang/String;)V
...
.method private notifyItemChanged(II)V
    ...
    iget-object v4, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh0/x;

    if-eqz v4, :cond_2

    invoke-virtual {v4}, Lh0/x;->getItems()Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh0/x;

    if-eqz p1, :cond_4

    invoke-virtual {p1}, Lh0/x;->getItems()Ljava/util/List;
...
.method private onItemSelected(IZ)V
    ...
    .line 16
    :try_start_0
    iget-object p2, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh0/x;

    invoke-virtual {p2}, Lh0/x;->getItems()Ljava/util/List;
    ...
    .line 17
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh0/x;

    invoke-virtual {v1}, Lh0/x;->getItems()Ljava/util/List;
    ...
    invoke-direct {v1, p2, v2}, Lcom/android/camera/features/mode/capture/p;-><init>(Ljava/lang/String;I)V
...
.method public initView(Landroid/view/View;)V
    ...
    iput-object p1, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh0/x;
    ...
    iget-object v2, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh0/x;
    ...
    invoke-direct {v0, p0, v2}, LBa/e;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance v3, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens$1;
    ...
    iput-object v3, v4, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mLayoutManager:Lcom/android/camera/fragment/beauty/LinearLayoutManagerWrapper;

    new-instance p0, Lcom/android/camera/fragment/DefaultItemAnimator;
    ...
    invoke-virtual {p0, v2, v3}, Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;->setAddDuration(J)V

    iget-object p1, v4, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p0, v4, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mCvLensItemPadding:Lcom/android/camera/fragment/beauty/BaseImageTextAdapter$ImageTextItemPadding;
    ...
    iput-object p0, v4, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mCvLensItemPadding:Lcom/android/camera/fragment/beauty/BaseImageTextAdapter$ImageTextItemPadding;
    ...
    iput p0, v4, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mTotalWidth:I
    ...
    iput p0, v4, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mHolderWidth:I

    iget-object p0, v4, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh0/x;

    iget p1, v4, Lcom/android/camera/fragment/BaseFragment;->mCurrentMode:I

    invoke-virtual {p0, p1}, Lcom/android/camera/data/data/c;->getComponentValue(I)Ljava/lang/String;

    move-result-object p0

    iget-object p1, v4, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh0/x;
    ...
    iput v1, v4, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mCurrentIndex:I
    ...
    :cond_2
    :goto_1
    invoke-virtual {v4}, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->showCvLens()V
...
.method public reInit()V
    ...
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh0/x;
...
.method public showCvLens()V
    ...
    invoke-static {v0, v1, v3, v2}, LO/i;->c(Landroid/view/View;III)V
