...
# virtual methods
.method public draw(LS0/b;ZLr6/g;II)V
    .locals 0

    invoke-super/range {p0 .. p5}, Lcom/android/camera2/compat/theme/custom/cv/filter/softfilter/program/BaseProgram;->drawTexture(LS0/b;ZLr6/g;II)V

    if-eqz p2, :cond_0

    check-cast p1, LS0/c;

    iget-object p1, p1, LS0/c;->c:Lr6/b;
    ...
    :goto_0
    invoke-virtual {p0, p3, p1}, Lcom/android/camera2/compat/theme/custom/cv/filter/softfilter/program/SamplingProgram;->initShaderValue(Lr6/g;I)V

    return-void
.end method

.method public getAvgBright(LS0/b;ZLr6/g;)F
    .locals 8
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/camera2/compat/theme/custom/cv/filter/softfilter/program/SamplingProgram;->draw(LS0/b;ZLr6/g;II)V

    iget-object p0, v0, Lcom/android/camera2/compat/theme/custom/cv/filter/softfilter/program/SamplingProgram;->mPixelBuffer:Ljava/nio/ByteBuffer;

    invoke-virtual {p0}, Ljava/nio/ByteBuffer;->rewind()Ljava/nio/Buffer;

    const/16 v6, 0x1401

    iget-object v7, v0, Lcom/android/camera2/compat/theme/custom/cv/filter/softfilter/program/SamplingProgram;->mPixelBuffer:Ljava/nio/ByteBuffer;
    ...
    iget-object p1, v0, Lcom/android/camera2/compat/theme/custom/cv/filter/softfilter/program/SamplingProgram;->mPixels:[B
    ...
    iget-object p2, v0, Lcom/android/camera2/compat/theme/custom/cv/filter/softfilter/program/SamplingProgram;->mPixels:[B
    ...
    const p3, 0x3e59b3d0    # 0.2126f

    int-to-float v1, v1

    mul-float/2addr v1, p3

    const p3, 0x3f371759    # 0.7152f
...
.method public initShaderValue(Lr6/g;I)V
    .locals 13
