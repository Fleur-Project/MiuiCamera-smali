...
.method private static initFilterComponent(ILjava/util/ArrayList;)V
    ...
    invoke-virtual {v1, p1, p0, v0}, Lh0/K;->m(Ljava/util/ArrayList;II)V

    const/4 p0, 0x0

    invoke-virtual {v1, v0, p0}, Lh0/K;->n(IZ)V
...
.method private static synthetic lambda$setWidgetCameraMasterFilter$0(ILjava/util/concurrent/atomic/AtomicBoolean;LX3/B;)V
    ...
    invoke-interface {p2, p0}, LX3/B;->a9(I)V
...
.method private static mutexByCclockWidget(I)V
    ...
    invoke-static {v1}, Ld0/g1;->e(Ljava/lang/String;)I
    ...
    invoke-virtual {v1, p0}, Lh0/S;->isSwitchOn(I)Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-virtual {v1, p0}, Lh0/S;->i(I)V
    ...
    invoke-static {p0, v2}, Lcom/android/camera/data/data/x;->v0(IZ)V

    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/c;->reset(I)V

    :cond_4
    invoke-static {p0, v2}, Lcom/android/camera/data/data/x;->u0(IZ)V
...
.method private static mutexByMasterFilterWidget(I)V
    ...
    invoke-virtual {v0, p0}, Lh0/S;->i(I)V
    ...
    invoke-static {p0, v0}, Lcom/android/camera/data/data/x;->v0(IZ)V
...
.method public static setCameraWidget(Landroid/content/pm/PackageManager;Landroid/content/Context;)V
    ...
    invoke-virtual {v1}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->Y5()Z
    ...
    invoke-virtual {v0}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->m5()Z
...
.method private static setWidgetCameraFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-direct {v2, p0, v3}, LC3/a0;-><init>(II)V
...
.method private static setWidgetCameraLens(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    :goto_1
    invoke-static {p0}, Lcom/android/camera/data/data/x;->p0(Ljava/lang/String;)V
...
.method private static setWidgetCameraMasterFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-direct {v2, p0, v1, v3}, LC3/e1;-><init>(ILjava/lang/Object;I)V
    ...
    invoke-direct {v0, v2, v1, p1}, LN0/m;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method private static updateDefaultWidget(Landroid/content/Context;Landroid/content/pm/PackageManager;)V
    ...
    invoke-virtual {v1}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->m5()Z
    ...
    invoke-virtual {v0}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->Y5()Z
