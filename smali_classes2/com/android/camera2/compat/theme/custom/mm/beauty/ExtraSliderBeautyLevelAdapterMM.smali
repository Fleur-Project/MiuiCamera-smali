...
.field private mManuallyListener:Lk2/o;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lk2/o;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera/fragment/manually/adapter/b;-><init>()V

    iput-object p3, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Lk2/o;
...
.method public draw(Lcom/android/camera/ui/d$a$a;ILandroid/graphics/Canvas;ZIFI)V
    ...
    invoke-super/range {v0 .. v6}, Lcom/android/camera/ui/d$a;->draw(ILandroid/graphics/Canvas;ZIFI)V

    const/4 p0, -0x1

    if-eq v6, p0, :cond_0

    iget-object p0, v0, Lcom/android/camera/ui/d$a;->mNormalPaint:Landroid/graphics/Paint;

    invoke-virtual {p0, v6}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p0, v0, Lcom/android/camera/ui/d$a;->mStopPointPaint:Landroid/graphics/Paint;
    ...
    iget p2, v0, Lcom/android/camera/ui/d$a;->mLineColorNormal:I

    invoke-virtual {p0, p2}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p0, v0, Lcom/android/camera/ui/d$a;->mStopPointPaint:Landroid/graphics/Paint;

    iget p2, v0, Lcom/android/camera/ui/d$a;->mLineColorStop:I

    invoke-virtual {p0, p2}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p0, v0, Lcom/android/camera/ui/d$a;->mSelectTextPaint:Landroid/graphics/Paint;

    iget p2, v0, Lcom/android/camera/ui/d$a;->mSelectTextColor:I

    invoke-virtual {p0, p2}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p0, v0, Lcom/android/camera/ui/d$a;->mPointPaint:Landroid/graphics/Paint;

    invoke-virtual {v0, v1}, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->isStopPoint(I)Z
    ...
    iget-object p2, v0, Lcom/android/camera/ui/d$a;->mCurrentValue:Ljava/lang/String;

    invoke-virtual {v0, v2, p0, p2}, Lcom/android/camera/ui/d$a;->drawText(Landroid/graphics/Canvas;ZLjava/lang/String;)V

    iget p0, v0, Lcom/android/camera/ui/d$a;->mLineSelectWidth:F
    ...
    iget p0, v0, Lcom/android/camera/ui/d$a;->mLineStopPointWidth:F

    goto :goto_2

    :cond_3
    iget p0, v0, Lcom/android/camera/ui/d$a;->mLineWidth:F

    :goto_2
    if-nez v3, :cond_5

    invoke-virtual {v0, v1}, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->isFlagPosition(I)Z
    ...
    iget p2, p1, Lcom/android/camera/ui/d$a$a;->i:F
    ...
    iget p1, p1, Lcom/android/camera/ui/d$a$a;->h:F
    ...
    :cond_4
    invoke-virtual {v0, v2}, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->drawPoint(Landroid/graphics/Canvas;)V

    :cond_5
    invoke-virtual {v0, v1, v2, v3, p0}, Lcom/android/camera/ui/d$a;->drawLine(ILandroid/graphics/Canvas;ZF)V
...
.method public drawPoint(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, Lcom/android/camera/ui/d$a;->mCurrentLineHalfHeight:F

    iget v1, p0, Lcom/android/camera/ui/d$a;->mPointLineGap:F

    add-float/2addr v0, v1

    iget v1, p0, Lcom/android/camera/ui/d$a;->mPointRadius:F
    ...
    iget-object v1, p0, Lcom/android/camera/ui/d$a;->mStrokePaint:Landroid/graphics/Paint;
    ...
    iget-object p0, p0, Lcom/android/camera/ui/d$a;->mPointPaint:Landroid/graphics/Paint;
...
.method public getDefaultPositionRange()Landroid/util/Range;
    ...
    iget-object v0, p0, Lcom/android/camera/ui/d$a;->mDefaultValue:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/camera/ui/d$a;->mDefaultValue:Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/android/camera/ui/d$a;->needSample()Z

    move-result v2

    if-eqz v2, :cond_3

    iget v1, p0, Lcom/android/camera/ui/d$a;->mSampleInterval:I
    ...
    iget v2, p0, Lcom/android/camera/ui/d$a;->mSampleInterval:I
...
.method public initDataList(Lu5/d;Ljava/util/List;Ljava/lang/String;)V
    ...
    invoke-super {p0, p1, p2, p3}, Lcom/android/camera/ui/d$a;->initDataList(Lu5/d;Ljava/util/List;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/ui/d$a;->needVirtual()Z
    ...
    iget p2, p0, Lcom/android/camera/ui/d$a;->mRealInterval:I
    ...
    iget p2, p0, Lcom/android/camera/ui/d$a;->mSampleInterval:I
...
.method public initStyle(Landroid/content/Context;)V
    ...
    invoke-super {p0, p1}, Lcom/android/camera/ui/d$a;->initStyle(Landroid/content/Context;)V
...
.method public isFlagPosition(I)Z
    ...
    :cond_1
    iget v0, p0, Lcom/android/camera/ui/d$a;->mRealInterval:I
    ...
    iget v0, p0, Lcom/android/camera/ui/d$a;->mSampleInterval:I
    ...
    iget-object p0, p0, Lcom/android/camera/ui/d$a;->mDefaultValue:Ljava/lang/String;
...
.method public onCustomWheelScroll(Ljava/lang/String;Z)V
    ...
    iget-object v2, p0, Lcom/android/camera/ui/d$a;->mCurrentValue:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera/ui/d$a;->mCurrentValue:Ljava/lang/String;
    ...
    .line 8
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Lk2/o;
    ...
    .line 9
    invoke-interface {v1, p1, v0, v2}, Lk2/o;->onZoomItemSlideOn(IZI)V

    .line 10
    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Lk2/o;

    const/4 v0, 0x3

    invoke-interface {p1, p2, v0}, Lk2/o;->onManuallyDataChanged(Ljava/lang/String;I)V
...
.method public onPositionSelect(Landroid/view/View;FII)V
    ...
    .line 6
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Lk2/o;

    if-eqz v0, :cond_0

    .line 7
    invoke-interface {v0, p1, p3, p4}, Lk2/o;->onZoomItemSlideOn(IZI)V
    ...
    invoke-interface {p1, p2, p3}, Lk2/o;->onManuallyDataChanged(Ljava/lang/String;I)V
...
.method public onPositionSelect(Landroid/view/View;FIII)V
    ...
    .line 1
    invoke-interface {p0, p1, p2, p3, p4}, Lcom/android/camera/ui/d$c;->onPositionSelect(Landroid/view/View;FII)V
...
.method public updateColor(Z)V
    ...
    iget-object p0, p0, Lcom/android/camera/ui/d$a;->mStrokePaint:Landroid/graphics/Paint;
...
.method public updateDefaultValue(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/android/camera/ui/d$a;->mDefaultValue:Ljava/lang/String;
