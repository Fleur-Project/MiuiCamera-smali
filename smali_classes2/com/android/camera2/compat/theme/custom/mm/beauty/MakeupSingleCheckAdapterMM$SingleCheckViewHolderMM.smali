...
.method public onItemClick(Landroid/view/View;)V
    ...
    iget-boolean v0, v0, Lcom/android/camera/data/data/y;->g:Z
...
.method public setDataToView(Lcom/android/camera/data/data/y;I)V
    .locals 9

    invoke-super {p0, p1, p2}, Lcom/android/camera/fragment/beauty/MakeupSingleCheckAdapter$SingleCheckViewHolder;->setDataToView(Lcom/android/camera/data/data/y;I)V
    ...
    invoke-interface/range {v1 .. v7}, Lcom/android/camera2/compat/theme/common/MiThemeOperationPopUpNewStyleInterface;->setDataView(Landroid/content/Context;Lcom/android/camera/data/data/y;ILcom/android/camera/fragment/beauty/MakeupSingleCheckAdapter$SingleCheckViewHolder;ZZ)V

    iget-boolean p0, v3, Lcom/android/camera/data/data/y;->g:Z

    if-eqz p0, :cond_1

    iget-object p0, v5, Lcom/android/camera/fragment/beauty/MakeupSingleCheckAdapter$SingleCheckViewHolder;->mBeautyProcessRing:Lcom/android/camera2/compat/theme/custom/mm/beauty/BeautyProcessRing;
    ...
    iget-object p1, v3, Lcom/android/camera/data/data/y;->c:Ljava/lang/String;

    invoke-static {p1, p0}, Lcom/android/camera/data/data/h;->w(Ljava/lang/String;Le6/b;)I
    ...
    invoke-virtual {p0, v8}, Lcom/android/camera2/compat/theme/custom/mm/beauty/BeautyProcessRing;->onProcessChanged(I)V
    ...
    iget-object p2, v5, Lcom/android/camera/fragment/beauty/MakeupSingleCheckAdapter$SingleCheckViewHolder;->mBeautyProcessRing:Lcom/android/camera2/compat/theme/custom/mm/beauty/BeautyProcessRing;

    invoke-interface {p0, p1, p2}, LX3/r0;->v2(Ljava/lang/String;LC/N2;)V
