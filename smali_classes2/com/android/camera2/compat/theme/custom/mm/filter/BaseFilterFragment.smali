...
.field protected mComponentFilter:Ld0/a;

.field private mComponentRunningFilterSlide:Lh0/M;
...
.method public static synthetic Hi(Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Ljava/lang/String;)V
    .locals 0
...
.method public static synthetic Lf(Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;Ljava/util/concurrent/ConcurrentHashMap;)V
    .locals 0
...
.method public static synthetic Mf(Lcom/xiaomi/camera/cloudfilter/entity/FilterData;)V
    .locals 0
...
.method public static synthetic Tf(Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;Lcom/android/camera/data/data/d;)V
    .locals 0
...
.method public static synthetic Vf(Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;Ljava/lang/String;)V
    .locals 0
...
.method public static synthetic ah(Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;ILX3/n;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->lambda$notifyItemChanged$1(ILX3/n;)V
...
.method private getCurrentType(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 5
    invoke-static {p1}, LR0/f;->f(Ljava/lang/String;)Z
    ...
    .line 6
    iget-object p0, v1, Lcom/android/camera/data/data/d;->a:Lcom/android/camera/data/data/o;
...
.method private initData()V
    ...
    invoke-virtual {p0}, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->getComponentConfigFilter()Ld0/a;

    move-result-object v1

    iput-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentFilter:Ld0/a;
    ...
    invoke-interface {v1, v2, v3}, Ld0/d1;->mapToCloudItems(ILjava/util/Map;)V
    ...
    invoke-direct {v2, p0, v3}, LC3/a2;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-interface {v1, v2}, Ld0/d1;->initItems(I)V
...
.method private isNeedMoveDownFilter()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->getComponentFilterSlide()Lh0/M;

    move-result-object p0

    invoke-virtual {p0}, Lh0/M;->i()Z
...
.method private lambda$initCloudFilter$5(Ljava/util/concurrent/ConcurrentHashMap;)V
    ...
    sget-object v3, LC/w2;->a:Lcom/google/gson/Gson;

    invoke-virtual {v3, p1}, Lcom/google/gson/Gson;->toJson(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v2, v3}, LW9/a;->q(Ljava/lang/String;Ljava/lang/String;)LW9/a;
    ...
    invoke-interface {v0, v2, p1}, Ld0/d1;->mapToCloudItems(ILjava/util/Map;)V

    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentFilter:Ld0/a;
    ...
    invoke-direct {v0, p0, v2}, LC/A0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {p1, v0}, LC3/p2;->g(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method private synthetic lambda$notifyItemChanged$1(ILX3/n;)V
    .locals 0
...
.method private lambda$processCloudFilter$8(ILjava/lang/String;Lcom/android/camera/data/data/d;)V
    ...
    invoke-virtual {v1, v2, v3}, Ld0/a;->i(ILjava/util/List;)V

    iget-object v1, p3, Lcom/android/camera/data/data/d;->a:Lcom/android/camera/data/data/o;

    check-cast v1, Lcom/android/camera/data/data/b;

    iget-object v2, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentFilter:Ld0/a;

    invoke-virtual {v2}, Ld0/a;->getItems()Ljava/util/List;
    ...
    iget-object v2, v2, Lcom/android/camera/data/data/d;->a:Lcom/android/camera/data/data/o;
    ...
    invoke-direct {v4, p3, v5}, LN0/S;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v3, v4}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v3

    new-instance v4, LX3/l1;

    const/16 v5, 0x1a

    invoke-direct {v4, v5}, LX3/l1;-><init>(I)V
    ...
    invoke-virtual {p3}, LW9/a;->f()LW9/a;

    sget-object v2, LC/w2;->a:Lcom/google/gson/Gson;
    ...
    invoke-virtual {p3, v2, v0}, LW9/a;->q(Ljava/lang/String;Ljava/lang/String;)LW9/a;

    invoke-virtual {p3}, LW9/a;->b()V

    iget-object p3, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentRunningFilterSlide:Lh0/M;

    iget-object v0, v1, Lcom/android/camera/data/data/b;->h:Ljava/lang/String;

    iput-object v0, p3, Lh0/M;->c:Ljava/lang/String;
...
.method public static synthetic pg(Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;Lcom/android/camera/data/data/d;)V
    .locals 0
...
.method private setCombineViewContentDescription(Ljava/lang/String;)V
    ...
    iget-object v1, v1, Lcom/android/camera/data/data/d;->a:Lcom/android/camera/data/data/o;
    ...
    new-instance v4, LC/C1;

    invoke-direct {v4, p0}, LC/C1;-><init>(Ljava/lang/Object;)V
...
.method public static synthetic ti(Lcom/android/camera/data/data/d;Lcom/xiaomi/camera/cloudfilter/entity/FilterData;)Z
    .locals 0
...
.method public abstract getComponentConfigFilter()Ld0/a;
.end method

.method public getComponentFilterSlide()Lh0/M;
    .locals 2
    ...
    sget-object v1, Ld0/F;->e:Ljava/util/List;
...
.method public initCloudFilter()V
    ...
    sget-object v0, LU0/p;->b:Landroidx/lifecycle/MutableLiveData;
...
.method public initSlideView()V
    ...
    invoke-interface {v0, v1, v2, p0}, Lcom/android/camera2/compat/theme/common/MiThemeOperationSeekbarInterface;->getBeautyLevelSeekbarAdapter(Landroid/content/Context;Ljava/lang/String;Lk2/o;)Lcom/android/camera/ui/M;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/camera/ui/CombineSlideView;->b(Lcom/android/camera/ui/M;F[Lu5/a;)V
    ...
    iput-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentRunningFilterSlide:Lh0/M;
...
.method public isNeedShowSlideView()Z
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentRunningFilterSlide:Lh0/M;
...
.method public notifyItemChanged(II)V
    ...
    invoke-direct {v2, p0, p2, v3}, Lbc/b;-><init>(Ljava/lang/Object;II)V
    ...
    invoke-static {v1}, LR0/f;->f(Ljava/lang/String;)Z
    ...
    invoke-direct {v5, v6, p0, v1}, Lcom/android/camera2/compat/theme/custom/mm/filter/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v0}, LR0/f;->f(Ljava/lang/String;)Z
    ...
    iget-object p2, p2, Lcom/android/camera/data/data/d;->a:Lcom/android/camera/data/data/o;
    ...
    invoke-direct {v2, p0, p1}, LUc/b;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-static {v3, v4, v0, v5}, LM/a;->j(Ljava/lang/StringBuilder;IILjava/lang/String;)Ljava/lang/String;
...
.method public onFilterItemSelected(IZ)V
    ...
    iget v3, p2, Lg0/t;->s:I

    invoke-virtual {p2, v3}, Lg0/t;->B(I)I
    ...
    iget-object p2, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentFilter:Ld0/a;
    ...
    invoke-static {p2}, LR0/f;->f(Ljava/lang/String;)Z
    ...
    :cond_3
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentRunningFilterSlide:Lh0/M;

    const-string v2, "100"

    iput-object v2, v0, Lh0/M;->c:Ljava/lang/String;
...
.method public onFilterStatsTracked(IZ)V
    ...
    iget-object p1, p1, Lcom/android/camera/data/data/d;->a:Lcom/android/camera/data/data/o;
...
.method public onManuallyDataChanged(Ljava/lang/String;I)V
    ...
    iget-object p2, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentRunningFilterSlide:Lh0/M;
...
.method public onTouchUpState(I)V
    ...
    invoke-virtual {p1, v0, p0}, LMb/h;->c(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public processCloudFilter(Ljava/lang/String;I)V
    ...
    iget-object v3, v0, Lcom/android/camera/data/data/d;->a:Lcom/android/camera/data/data/o;
    ...
    invoke-static {v5, p1, v6}, LC/E1;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2, v0, v6}, LC/s3;->c(Landroid/content/Context;IZ)V

    iget-object p2, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentRunningFilterSlide:Lh0/M;

    iget-object v0, v3, Lcom/android/camera/data/data/b;->h:Ljava/lang/String;

    iput-object v0, p2, Lh0/M;->c:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, LU0/h;->a(Lcom/android/camera/data/data/d;Landroidx/lifecycle/MutableLiveData;)V
    ...
    iput-object v1, v0, Lh0/M;->c:Ljava/lang/String;
...
.method public updateSlide(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v1, v2}, Lh0/M;->h(II)Ljava/lang/String;
    ...
    iput-object v2, v1, Lu5/d;->a:Ljava/lang/String;

    const/4 v3, 0x0

    iput v3, v1, Lu5/d;->b:I

    iput-object v2, v1, Lu5/d;->c:Ljava/lang/String;

    const/4 v4, 0x2

    iput v4, v1, Lu5/d;->d:I

    iput-object v2, v1, Lu5/d;->f:Lcom/android/camera/ui/d$a$b;
    ...
    iget-object v4, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentRunningFilterSlide:Lh0/M;

    iget v5, p0, Lcom/android/camera/fragment/BaseFragment;->mCurrentMode:I

    invoke-virtual {v4, v5}, Lh0/M;->getDefaultValue(I)Ljava/lang/String;

    move-result-object v4

    invoke-interface {v0, v1, v2, v4}, Lcom/android/camera/ui/M;->initDataList(Lu5/d;Ljava/util/List;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseFilterFragment;->mComponentRunningFilterSlide:Lh0/M;
