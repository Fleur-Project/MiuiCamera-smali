...
.method private loadAllOfficialItemForAperture(Landroid/content/Context;I)V
    ...
    invoke-virtual {v1}, Lh0/k;->getItems()Ljava/util/List;

    move-result-object v1

    sget-object v2, LZ/a;->b:Ljava/lang/String;
    ...
    invoke-static {v4, v1}, LQ1/t;->f(ILjava/util/List;)Ljava/lang/Object;
    ...
    const-string v14, "p_pref_camera_zoom_retain_key_1.0"

    const-string v15, "p_pref_camera_cv_type_key_1"

    const-string v6, "p_pref_qc_camera_style_tone_key_15"

    const-string v7, "p_pref_qc_camera_style_vibrance_key_8"

    const-string v8, "p_pref_qc_camera_style_texture_key_18"

    const-string v9, "p_pref_qc_camera_pro_exposure_value_key_-0.3"
    ...
    const-string v7, "p_pref_qc_camera_style_tone_key_12"

    const-string v8, "p_pref_qc_camera_style_vibrance_key_-6"

    const-string v9, "p_pref_qc_camera_style_texture_key_40"

    const-string v10, "p_pref_qc_camera_exposuretime_key_1000000"
    ...
    const-string v16, "p_pref_camera_zoom_retain_key_2.0"

    const-string v17, "p_pref_camera_cv_type_key_1"

    const-string v8, "p_pref_qc_camera_style_tone_key_28"

    const-string v9, "p_pref_qc_camera_style_vibrance_key_-50"

    const-string v10, "p_pref_qc_camera_style_texture_key_30"

    const-string v11, "p_pref_qc_camera_pro_exposure_value_key_-0.3"

    const-string v12, "p_pref_qc_camera_exposuretime_key_0"
    ...
    iget-object v2, v0, Lcom/xiaomi/microfilm/vlog/vv/o;->mItemList:Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/xiaomi/microfilm/vlog/vv/o;->mItemList:Ljava/util/List;
...
.method private loadAllOfficialItemForCommon(Landroid/content/Context;I)V
    ...
    :goto_0
    const-string v12, "p_pref_camera_cv_type_key_1"

    const-string v2, "p_pref_camera_ultra_pixel_167_"
    ...
    const-string v8, "p_pref_qc_camera_exposuretime_key_66700000"

    const-string v9, "p_pref_camera_manually_lens_wide"

    const-string v10, "p_pref_focus_position_key_1000"

    const-string v11, "p_pref_camera_zoom_retain_key_1.0"
    ...
    const-string v14, "p_pref_camera_cv_type_key_1"
    ...
    const-string v11, "p_pref_camera_manually_lens_wide"

    const-string v12, "p_pref_focus_position_key_1000"

    const-string v13, "p_pref_camera_zoom_retain_key_1.0"
    ...
    const-string v15, "p_pref_camera_zoom_retain_key_2.0"
...
.method public getComponentsChangeList(Lcom/android/camera2/compat/theme/custom/mm/manually/BaseWorkspaceItem;Ljava/util/List;ILjava/util/List;Z)V
    ...
    instance-of v0, v2, Ld0/p0;

    if-nez v0, :cond_4

    instance-of v0, v2, Ld0/H0;

    if-nez v0, :cond_4

    instance-of v0, v2, Ld0/Y0;

    if-nez v0, :cond_4

    instance-of v0, v2, Ld0/D0;

    if-nez v0, :cond_4

    instance-of v0, v2, Ld0/J0;
    ...
    check-cast v0, Lcom/android/camera/data/data/u;

    invoke-interface {v0, p3, p1}, Lcom/android/camera/data/data/u;->c(ILjava/lang/String;)V
...
.method public prepareManualWorkspaceData(ILandroidx/lifecycle/LifecycleOwner;Lio/reactivex/functions/Consumer;)V
    ...
    invoke-direct {v0, p0, v1}, LM2/d;-><init>(Ljava/lang/Object;I)V

    new-instance v1, LLd/c;

    const/4 v2, 0x2

    invoke-direct {v1, p0, v2}, LLd/c;-><init>(Ljava/lang/Object;I)V
...
.method public pullNew(I)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/xiaomi/microfilm/vlog/vv/o;->mItemList:Ljava/util/List;
    ...
    invoke-static {v1}, Lbc/A;->c(Ljava/lang/String;)V
...
.method public updateLoadState(I)V
    ...
    :cond_0
    invoke-virtual {p0}, Lj0/c;->judge()V
