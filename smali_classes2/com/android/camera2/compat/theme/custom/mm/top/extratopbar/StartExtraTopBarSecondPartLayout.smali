...
.method public static synthetic a(Lt2/e;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;->lambda$updateData$1(Lt2/e;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic b(Ljava/util/ArrayList;Lt2/e;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;->lambda$updateData$0(Ljava/util/List;Lt2/e;)V

    return-void
.end method

.method public static synthetic c(Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;ILt2/e;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;->lambda$updateData$2(ILt2/e;)V

    return-void
.end method

.method private static lambda$updateData$0(Ljava/util/List;Lt2/e;)V
    .locals 2
...
.method private static lambda$updateData$1(Lt2/e;Landroid/view/View;)V
    .locals 1
    ...
    :cond_0
    iget-object p0, p0, Lt2/e;->i:Landroid/view/View$OnClickListener;
...
.method private lambda$updateData$2(ILt2/e;)V
    .locals 3
    ...
    iget-object v1, p2, Lt2/e;->g:Lt2/e$c;

    invoke-interface {v1, p1}, Lt2/e$c;->updateResource(I)Lt2/f;
    ...
    invoke-virtual {v1, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/ExtraTopBarImageViewHolder;->updateView(Lt2/f;)V

    new-instance v1, LS2/c;

    const/16 v2, 0x8

    invoke-direct {v1, p2, v2}, LS2/c;-><init>(Ljava/lang/Object;I)V
...
.method public notifyItemChanged(I)V
    ...
    iget-object v2, v2, Lt2/e;->g:Lt2/e$c;

    invoke-interface {v2, v3}, Lt2/e$c;->updateResource(I)Lt2/f;
    ...
    invoke-virtual {v3, v2}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/ExtraTopBarImageViewHolder;->updateView(Lt2/f;)V

    iget v2, v2, Lt2/f;->j:I
...
.method public updateData(ILjava/util/List;Landroid/view/View$OnClickListener;Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/IExtraTopBarUIConfig;)V
    ...
    new-instance p4, LC3/N1;

    const/16 v0, 0x14

    invoke-direct {p4, p3, v0}, LC3/N1;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance p3, Lcom/android/camera/fragment/top/x;

    invoke-direct {p3, p0, p1}, Lcom/android/camera/fragment/top/x;-><init>(Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;I)V
