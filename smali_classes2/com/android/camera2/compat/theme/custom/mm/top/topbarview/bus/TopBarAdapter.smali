...
.method public static synthetic a(Lt2/e;ILh0/l0;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->lambda$updateView$3(Lt2/e;ILh0/l0;)Ljava/lang/Boolean;
...
.method public static synthetic b(Lt2/e;Lh0/l0;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->lambda$setData$1(Lt2/e;Lh0/l0;)V

    return-void
.end method

.method public static synthetic c(LB/b;)Landroid/graphics/ColorFilter;
    .locals 0

    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->lambda$updateThemeColor$6(LB/b;)Landroid/graphics/ColorFilter;
...
.method private contains(Ljava/util/List;Lt2/e;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2, v0}, Lt2/e;->equals(Ljava/lang/Object;)Z
...
.method public static synthetic d(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;Lt2/e;)Z
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->lambda$updateActiveTopItems$2(Lt2/e;)Z
...
.method public static synthetic e(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;Lt2/e;)Z
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->lambda$setData$0(Lt2/e;)Z
...
.method public static synthetic f(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;Lcom/android/camera2/compat/theme/custom/mm/top/StrikethroughImageView;Lt2/e;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->lambda$showJsonAnimation$4(Lcom/android/camera2/compat/theme/custom/mm/top/StrikethroughImageView;Lt2/e;II)V
...
.method private findViewByConfigItem(I)Landroid/view/View;
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->mTopBarView:Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/TopBarView;
...
.method public static synthetic g(ILB/b;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->lambda$updateThemeColor$5(ILB/b;)Ljava/lang/Integer;
...
.method private isConfigItemInvisible(Lt2/e;)Z
    .locals 1
...
.method private lambda$setData$0(Lt2/e;)Z
    .locals 1
...
.method private static lambda$setData$1(Lt2/e;Lh0/l0;)V
    .locals 1

    iget p0, p0, Lt2/e;->c:I

    iget-object v0, p1, Lh0/l0;->a:Landroid/util/SparseIntArray;
...
.method private lambda$showJsonAnimation$4(Lcom/android/camera2/compat/theme/custom/mm/top/StrikethroughImageView;Lt2/e;II)V
    .locals 4
    ...
    invoke-static {p3, v2}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p4, p0, p2, p3, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter$1;-><init>(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;Lt2/e;ILcom/android/camera2/compat/theme/custom/mm/top/StrikethroughImageView;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->updateThemeColor(Lt2/f;Lcom/android/camera2/compat/theme/custom/mm/top/StrikethroughImageView;)V
...
.method private lambda$updateActiveTopItems$2(Lt2/e;)Z
    .locals 0
...
.method private static synthetic lambda$updateThemeColor$5(ILB/b;)Ljava/lang/Integer;
    .locals 0
...
.method private static lambda$updateThemeColor$6(LB/b;)Landroid/graphics/ColorFilter;
    .locals 1
    ...
    invoke-virtual {p0, v0}, La0/a;->f(I)I
    ...
    invoke-static {v0, p0}, La0/a;->e(IZ)Landroid/graphics/ColorFilter;
...
.method private static lambda$updateView$3(Lt2/e;ILh0/l0;)Ljava/lang/Boolean;
    .locals 5

    iget p0, p0, Lt2/e;->c:I

    iget-boolean v0, p2, Lh0/l0;->c:Z
    ...
    :cond_0
    invoke-virtual {p2, p0}, Lh0/l0;->h(I)I
    ...
    invoke-static {p0, v0, v2, v3, v4}, LQ1/t;->l(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method private showJsonAnimation(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarViewHolder;Lt2/e;I)V
    .locals 6

    iget v4, p2, Lt2/e;->c:I
    ...
    new-instance v0, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/d;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/d;-><init>(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;Lcom/android/camera2/compat/theme/custom/mm/top/StrikethroughImageView;Lt2/e;II)V
...
.method private showJsonLastFrame(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarViewHolder;Lt2/e;I)V
    .locals 3
    ...
    iget-object p2, p2, Lt2/e;->g:Lt2/e$c;

    if-eqz p2, :cond_0

    iget p3, p0, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->mCurrentMode:I

    invoke-interface {p2, p3}, Lt2/e$c;->updateResource(I)Lt2/f;

    move-result-object p2

    invoke-direct {p0, p2, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->updateThemeColor(Lt2/f;Lcom/android/camera2/compat/theme/custom/mm/top/StrikethroughImageView;)V
...
.method private updateActiveTopItems()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/a;-><init>(Ljava/lang/Object;I)V
...
.method private updateThemeColor(Lt2/f;Lcom/android/camera2/compat/theme/custom/mm/top/StrikethroughImageView;)V
    .locals 5
    ...
    sget-object v2, Lo/p;->a:Landroid/graphics/PointF;

    invoke-static {p1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    new-instance v4, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/b;

    invoke-direct {v4, p0}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/b;-><init>(I)V

    invoke-virtual {p2, v1, v2, v4}, Lcom/airbnb/lottie/LottieAnimationView;->addValueCallback(Lt/e;Ljava/lang/Object;LB/e;)V
    ...
    invoke-direct {p0, p1}, Lt/e;-><init>([Ljava/lang/String;)V

    sget-object p1, Lo/p;->y:Landroid/graphics/ColorFilter;
    ...
    invoke-virtual {p2, p0, p1, v0}, Lcom/airbnb/lottie/LottieAnimationView;->addValueCallback(Lt/e;Ljava/lang/Object;LB/e;)V

    return-void
.end method

.method private updateView(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarViewHolder;Lt2/e;)V
    .locals 6
    ...
    iget v4, v0, Lt2/f;->e:I

    if-gtz v4, :cond_1

    invoke-virtual {p1, v0}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarViewHolder;->updateView(Lt2/f;)V

    return-void

    :cond_1
    invoke-direct {p0, p2}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->isConfigItemInvisible(Lt2/e;)Z
    ...
    invoke-virtual {v5}, Lw7/b;->Q0()V

    invoke-static {}, Lb0/a;->i()Lh0/s0;

    move-result-object v5

    invoke-virtual {v5, v3}, LW9/b;->t(Ljava/lang/Class;)Ljava/util/Optional;

    move-result-object v3

    new-instance v5, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/c;

    invoke-direct {v5, p2, v4}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/c;-><init>(Lt2/e;I)V
    ...
    invoke-interface {p2, v0}, Lt2/e$c;->updateResource(I)Lt2/f;
    ...
    invoke-virtual {v1, v5, v4}, Lh0/l0;->j(II)Z

    invoke-direct {p0, p1, p2, v0}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->showJsonLastFrame(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarViewHolder;Lt2/e;I)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->showJsonAnimation(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarViewHolder;Lt2/e;I)V
...
.method public getItemViewVisibility(I)I
    ...
    invoke-direct {p0, v0}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->isConfigItemInvisible(Lt2/e;)Z
...
.method public notifyTopBarItemChanged(I)Z
    ...
    invoke-static {p1, v4}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
...
.method public onBindViewHolder(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarViewHolder;I)V
    ...
    .line 18
    :cond_4
    iget-object v1, v0, Lt2/f;->g:Ljava/lang/String;
    ...
    .line 21
    iget-object v3, v0, Lt2/f;->g:Ljava/lang/String;
    ...
    .line 25
    invoke-direct {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->updateView(Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarViewHolder;Lt2/e;)V
    ...
    .line 40
    invoke-static {p1, p0}, LO/i;->j(F[Landroid/view/View;)V
...
.method public setData(Ljava/util/List;Z)V
    ...
    invoke-direct {p2, p0, v0}, LN0/S;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {p0, v4, v3}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->contains(Ljava/util/List;Lt2/e;)Z
    ...
    invoke-direct {p0, p2, v4}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->contains(Ljava/util/List;Lt2/e;)Z
    ...
    invoke-direct {p0, p2, v5}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/TopBarAdapter;->contains(Ljava/util/List;Lt2/e;)Z
    ...
    invoke-virtual {v7, v5}, Lt2/e;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v6, v0}, LW9/b;->t(Ljava/lang/Class;)Ljava/util/Optional;

    move-result-object v6

    new-instance v7, LA2/t;

    const/16 v8, 0x1a

    invoke-direct {v7, v5, v8}, LA2/t;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {v4, v0}, Lt2/e;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p2, v0}, LW9/b;->t(Ljava/lang/Class;)Ljava/util/Optional;
