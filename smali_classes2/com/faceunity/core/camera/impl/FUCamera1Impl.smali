...
.method private final calculateTapArea(FFIIII)Landroid/graphics/Rect;
    ...
    invoke-static {p1}, LS9/D;->y(F)I

    move-result p1

    iget p2, p3, Landroid/graphics/RectF;->top:F

    invoke-static {p2}, LS9/D;->y(F)I

    move-result p2

    iget p4, p3, Landroid/graphics/RectF;->right:F

    invoke-static {p4}, LS9/D;->y(F)I

    move-result p4

    iget p3, p3, Landroid/graphics/RectF;->bottom:F

    invoke-static {p3}, LS9/D;->y(F)I
...
.method private final handleFocusMetering(Landroid/hardware/Camera;FFIIIIII)V
    ...
    invoke-direct/range {v1 .. v7}, Lcom/faceunity/core/camera/impl/FUCamera1Impl;->calculateTapArea(FFIIII)Landroid/graphics/Rect;
    ...
    new-instance p5, Landroid/hardware/Camera$Area;

    const/16 p6, 0x3e8

    invoke-direct {p5, p2, p6}, Landroid/hardware/Camera$Area;-><init>(Landroid/graphics/Rect;I)V
    ...
    invoke-direct {v2, v3, p6}, Landroid/hardware/Camera$Area;-><init>(Landroid/graphics/Rect;I)V
    ...
    const-string p6, "auto"

    if-lez p2, :cond_2

    invoke-static {p3, p6}, Lkotlin/jvm/internal/k;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, p4}, Landroid/hardware/Camera$Parameters;->setFocusAreas(Ljava/util/List;)V
    ...
    invoke-virtual {v0, p5}, Landroid/hardware/Camera$Parameters;->setMeteringAreas(Ljava/util/List;)V
    ...
    new-instance p2, Lcom/faceunity/core/camera/impl/FUCamera1Impl$handleFocusMetering$1;

    invoke-direct {p2, p0, p3}, Lcom/faceunity/core/camera/impl/FUCamera1Impl$handleFocusMetering$1;-><init>(Lcom/faceunity/core/camera/impl/FUCamera1Impl;Ljava/lang/String;)V
    ...
    const-string p2, "KIT_FUCamera1Impl"

    const-string p4, "handleFocusMetering: not support focus"

    invoke-static {p2, p4}, Lcom/faceunity/toolbox/utils/FULogger;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance p2, Lcom/faceunity/core/camera/impl/FUCamera1Impl$handleFocusMetering$2;

    invoke-direct {p2, p0, p3}, Lcom/faceunity/core/camera/impl/FUCamera1Impl$handleFocusMetering$2;-><init>(Lcom/faceunity/core/camera/impl/FUCamera1Impl;Ljava/lang/String;)V
...
.method private final setExposureCompensation(Landroid/hardware/Camera;F)V
    ...
    invoke-static {v1, v0, p2, v0}, LM/a;->c(FFFF)F
