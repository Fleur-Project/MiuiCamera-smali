...
.field private final mCameraManager$delegate:Ljf/f;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->mCameraManager$delegate:Ljf/f;
...
.method private final getMCameraManager()Landroid/hardware/camera2/CameraManager;
    ...
    iget-object p0, p0, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->mCameraManager$delegate:Ljf/f;
...
.method public handleFocus(IIFFI)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->handleFocusMetering(IIFFI)V
...
.method public openCamera()V
    ...
    invoke-virtual {v4, v2}, Lcom/faceunity/core/camera/base/FUAbstractCamera;->setMCameraWidth(I)V

    invoke-virtual {p0}, Landroid/util/Size;->getHeight()I

    move-result p0

    invoke-virtual {v4, p0}, Lcom/faceunity/core/camera/base/FUAbstractCamera;->setMCameraHeight(I)V
    ...
    invoke-virtual {v4}, Lcom/faceunity/core/camera/base/FUAbstractCamera;->getMCameraWidth()I

    move-result v6

    invoke-virtual {v4}, Lcom/faceunity/core/camera/base/FUAbstractCamera;->getMCameraHeight()I
    ...
    :cond_3
    iput-object v2, v4, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->mYuvDataBufferArray:[[B
    ...
    invoke-static {v2, v3, v5, p0}, Landroid/media/ImageReader;->newInstance(IIII)Landroid/media/ImageReader;

    move-result-object p0

    iput-object p0, v4, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->mImageReader:Landroid/media/ImageReader;

    iget-object p0, v4, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->mImageReader:Landroid/media/ImageReader;

    if-eqz p0, :cond_4

    iget-object v2, v4, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->mOnImageAvailableListener:Landroid/media/ImageReader$OnImageAvailableListener;

    iget-object v3, v4, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->mCameraHandler:Landroid/os/Handler;
    ...
    :cond_5
    invoke-direct {v4}, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->getMCameraManager()Landroid/hardware/camera2/CameraManager;
    ...
    iget-object v1, v4, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->mStateCallback:Lcom/faceunity/core/camera/impl/FUCamera2Impl$mStateCallback$1;

    iget-object v2, v4, Lcom/faceunity/core/camera/impl/FUCamera2Impl;->mCameraHandler:Landroid/os/Handler;
...
.method public startPreview()V
    ...
    invoke-static {v0}, Lkf/o;->F([Ljava/lang/Object;)Ljava/util/ArrayList;
