...
.method public constructor <init>(Ljava/lang/ref/WeakReference;)V
    ...
    iput-object p1, p0, Li4/f;->a:Ljava/lang/ref/WeakReference;
...
.method public final a(Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Li4/a;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v3}, Lq6/i$a;->toString()Ljava/lang/String;
    ...
    invoke-static {v4}, Li4/a;->a(Ljava/lang/String;)V

    iget v4, v3, Lq6/i$a;->a:I

    iget v5, v3, Lq6/i$a;->b:I
    ...
    :cond_0
    sget-object v6, Li4/c;->a:Ljava/util/ArrayList;
    ...
    iget v9, v8, Li4/d;->a:I

    if-ne v9, v4, :cond_1

    int-to-float v4, v5

    iget v6, v8, Li4/d;->b:F
    ...
    invoke-static {v3}, Li4/a;->a(Ljava/lang/String;)V

    goto/16 :goto_7

    :cond_4
    filled-new-array {v3}, [Lq6/i$a;

    move-result-object v3

    iget-object v4, p0, Li4/f;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v8}, Lcom/android/camera/data/data/k;->X(I)Z
    ...
    invoke-direct {v6, v8}, Lbd/l;-><init>(I)V
    ...
    invoke-virtual {v3, v6}, LU3/g;->d(Ljava/lang/Class;)Ljava/util/Optional;
    ...
    invoke-interface {v3}, LX3/f;->isShowing()Z
    ...
    invoke-virtual {v8, v9, v7}, LW9/a;->g(Ljava/lang/String;Z)Z
    ...
    invoke-interface {v6, v9, v7, v8, v3}, LX3/o;->Gb(IZZ[Ljava/lang/Object;)V
    ...
    invoke-virtual {v6, v3}, Lcom/android/camera/module/Camera2Module;->setAsdScenes([Lq6/i$a;)V
    ...
    invoke-virtual {v6, v3}, Lcom/android/camera/module/AmbilightModule;->setAsdScenes([Lq6/i$a;)V
