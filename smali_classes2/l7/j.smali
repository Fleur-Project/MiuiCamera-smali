...
.method public constructor <init>(LV6/i;ZLg7/g;LV6/n;)V
    ...
    invoke-direct/range {v0 .. v5}, Ll7/b;-><init>(Ljava/lang/Class;LV6/i;ZLg7/g;LV6/n;)V
...
.method public final f(Ljava/lang/Object;LL6/f;LV6/C;)V
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Ll7/j;->u(Ljava/util/Collection;LL6/f;LV6/C;)V
...
.method public final u(Ljava/util/Collection;LL6/f;LV6/C;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Ll7/b;->c:LV6/i;

    invoke-virtual {p2, p1}, LL6/f;->g(Ljava/lang/Object;)V

    const/4 v1, 0x0

    iget-object v2, p0, Ll7/b;->g:Lg7/g;
    ...
    invoke-virtual {v4, v0, p2, p3}, LV6/n;->f(Ljava/lang/Object;LL6/f;LV6/C;)V

    goto :goto_0

    :cond_2
    invoke-virtual {v4, v0, p2, p3, v2}, LV6/n;->g(Ljava/lang/Object;LL6/f;LV6/C;Lg7/g;)V
    :try_end_0
    ...
    :goto_1
    invoke-static {p3, p0, p1, v3}, Ll7/Q;->o(LV6/C;Ljava/lang/Exception;Ljava/lang/Object;I)V
    ...
    :cond_7
    iget-object v8, p0, Ll7/b;->d:LV6/c;

    invoke-virtual {p3, v7, v8}, LV6/C;->s(Ljava/lang/Class;LV6/c;)LV6/n;
    ...
    :cond_a
    invoke-virtual {v8, v6, p2, p3, v2}, LV6/n;->g(Ljava/lang/Object;LL6/f;LV6/C;Lg7/g;)V
