...
.method public final d()V
    ...
    invoke-virtual {v5, v6}, LN3/l;->m(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v8, v9}, LS9/c;->f(II)I

    move-result v7

    iget-object v8, v1, Ln4/B;->u:Ljava/lang/String;
    ...
    iget-object v8, v1, Ln4/b;->a:Landroid/app/Application;

    invoke-virtual {v8}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v8

    iget-object v11, v1, Ln4/b;->c:Landroid/net/Uri;

    invoke-static {v8, v11}, Lr4/a;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/lang/String;
    ...
    iput-object v8, v1, Ln4/B;->u:Ljava/lang/String;

    :cond_0
    iget-object v8, v1, Ln4/B;->u:Ljava/lang/String;

    :try_start_0
    invoke-static {v8, v10}, Lbc/A;->o(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, v1, Ln4/b;->b:Ln4/s;

    check-cast v0, Ln4/j;

    iget-boolean v11, v1, Ln4/B;->x:Z

    invoke-virtual {v0, v11}, Ln4/j;->m(Z)Z

    move-result v11

    new-array v12, v9, [Landroid/graphics/Bitmap;

    iget-object v13, v1, Ln4/B;->w:Landroid/content/ContentValues;
    ...
    iget-object v0, v1, Ln4/B;->C:Ljava/util/List;
    ...
    iput-object v0, v1, Ln4/B;->C:Ljava/util/List;
    ...
    invoke-static {v0, v8}, Ls4/b;->b(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;

    move-result-object v2

    invoke-static {v8}, Ll3/b;->d(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    :try_start_2
    invoke-static {v13}, Lbc/J;->e(Landroid/content/ContentValues;)Landroid/util/Size;

    move-result-object v0

    invoke-static {v9, v2, v8, v0, v12}, Ll3/b;->a(Landroid/media/MediaMetadataRetriever;Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Landroid/util/Size;[Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v0, v9}, LC3/p2;->g(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v4, v0, v9}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v0, v2}, Lt9/e;->a(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    invoke-direct {v2, v12, v3, v9}, Ll3/b$a;-><init>(Ljava/lang/String;Ljava/lang/String;[B)V
    ...
    invoke-direct {v0, v8, v3}, Lbc/I;-><init>(Ljava/lang/Object;I)V

    invoke-static {v0}, Lbc/J;->d(Lyf/l;)J
    ...
    const-string v9, "save video: mHandler -> "
    ...
    iget-object v1, v1, Ln4/b;->b:Ln4/s;
    ...
    sget-object v9, Ll3/b;->a:Ljava/lang/String;

    const/4 v9, 0x0

    new-array v12, v9, [Ljava/lang/Object;

    const-string v9, "MP4UtilEx"

    move-wide/from16 v22, v2

    const-string/jumbo v2, "writeTags E"

    invoke-static {v9, v2, v12}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v7, "mCurrentVideoFilename: "

    invoke-static {v7, v8}, LB2/p;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v5, v0}, Ll3/a;-><init>(Ljava/util/List;)V

    invoke-static {v12, v5}, Lvj/d;->a(Ljava/io/File;Lvj/b;)V
    :try_end_8
    ...
    const-string/jumbo v5, "writeTags X , duration = "

    invoke-direct {v0, v5}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v2, v3, v0}, LC/E1;->h(JLjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v3, v1, Ln4/b;->c:Landroid/net/Uri;

    const/4 v7, 0x0

    invoke-virtual {v0, v3, v11, v7, v7}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {v5, v8, v7}, Ln4/z;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static {v3, v6}, LC/F;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_14
    :try_start_10
    invoke-static {v4, v15, v0}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_10
    .catchall {:try_start_10 .. :try_end_10} :catchall_6

    invoke-static {v12, v6}, LC/F;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v3}, Lr4/a;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v0, v10}, Lbc/A;->o(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    const-string v0, "save video: query update, path -> "

    invoke-static {v0, v8}, LB2/p;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v8}, Ln4/k;->a(Landroid/app/Application;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual {v2, v3, v13, v7, v7}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {v8}, Ln4/z;->u(Ljava/lang/String;)Z

    move-result v0

    sget-object v3, Ln4/z;->a:Ljava/lang/String;

    sget-object v6, Ln4/z;->e:Ljava/lang/String;
    ...
    invoke-static {v6, v2, v3, v3}, LC/n3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LC/n3;
    ...
    :goto_1a
    invoke-virtual {v2, v5, v6}, LC/n3;->p(J)V

    const/4 v7, 0x1

    iput-boolean v7, v2, LC/n3;->h:Z

    iget-object v3, v1, Ln4/b;->b:Ln4/s;

    check-cast v3, Ln4/j;

    invoke-virtual {v3, v2, v7}, Ln4/j;->v(LC/n3;Z)V

    iget-object v2, v1, Ln4/B;->C:Ljava/util/List;
    ...
    invoke-direct {v3, v5}, LO0/c;-><init>(I)V
    ...
    invoke-virtual {v3, v2}, Ln4/j;->n(Lp4/d;)V

    goto :goto_1b

    :cond_19
    iget-object v2, v1, Ln4/b;->b:Ln4/s;

    check-cast v2, Ln4/j;

    invoke-virtual {v2}, Ln4/j;->u()V
    ...
    iget-object v0, v0, Ln4/j;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {v0, v7}, Ln4/j$a;->b(Z)V
    ...
    invoke-virtual/range {v14 .. v19}, Ln4/j;->o(ILandroid/net/Uri;Ljava/lang/String;ZZ)V
    ...
    invoke-static/range {v27 .. v38}, Ln4/z;->y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    invoke-virtual {v1, v0}, LN3/l;->p([LN3/a;)J
    ...
    :goto_1f
    invoke-static {v9, v6}, LC/F;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
...
.method public final run()V
    ...
    iget-object p0, p0, Ln4/b;->b:Ln4/s;
