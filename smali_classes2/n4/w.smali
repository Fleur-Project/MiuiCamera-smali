...
.method public synthetic constructor <init>(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    iput p1, p0, Ln4/w;->a:I

    iput-object p8, p0, Ln4/w;->b:Landroid/content/Context;

    iput-object p10, p0, Ln4/w;->c:Ljava/lang/String;

    iput-wide p2, p0, Ln4/w;->d:J

    iput-boolean p11, p0, Ln4/w;->e:Z

    iput-wide p4, p0, Ln4/w;->f:J

    iput-object p9, p0, Ln4/w;->g:Landroid/location/Location;

    iput-boolean p12, p0, Ln4/w;->h:Z

    iput-wide p6, p0, Ln4/w;->i:J
...
.method public final run()V
    ...
    iget v1, v0, Ln4/w;->a:I

    iget-object v2, v0, Ln4/w;->b:Landroid/content/Context;

    iget-object v3, v0, Ln4/w;->c:Ljava/lang/String;

    iget-wide v4, v0, Ln4/w;->d:J

    iget-boolean v6, v0, Ln4/w;->e:Z

    iget-wide v7, v0, Ln4/w;->f:J

    iget-object v9, v0, Ln4/w;->g:Landroid/location/Location;

    iget-boolean v10, v0, Ln4/w;->h:Z
    ...
    invoke-static/range {v2 .. v10}, Ln4/z;->k(Landroid/content/Context;Ljava/lang/String;JZJLandroid/location/Location;Z)Landroid/content/Intent;
    ...
    invoke-static/range {v2 .. v9}, Ln4/z;->v(JJLandroid/content/Context;Ljava/lang/String;ZZ)V
    ...
    :goto_0
    sget-object v0, Ln4/z;->p:[Ljava/lang/String;
