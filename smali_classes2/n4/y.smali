...
.method public synthetic constructor <init>(Landroid/app/Application;[BZLandroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIIJIZ)V
    ...
    iput-object p1, p0, Ln4/y;->a:Landroid/app/Application;

    iput-object p2, p0, Ln4/y;->b:[B

    iput-boolean p3, p0, Ln4/y;->c:Z

    iput-object p4, p0, Ln4/y;->d:Landroid/net/Uri;

    iput-object p5, p0, Ln4/y;->e:Ljava/lang/String;

    iput-object p6, p0, Ln4/y;->f:Landroid/location/Location;

    iput p7, p0, Ln4/y;->g:I

    iput p8, p0, Ln4/y;->h:I

    iput p9, p0, Ln4/y;->i:I

    iput-wide p10, p0, Ln4/y;->j:J

    iput p12, p0, Ln4/y;->k:I

    iput-boolean p13, p0, Ln4/y;->l:Z
...
.method public final invoke()Ljava/lang/Object;
    ...
    iget-object v4, v1, Ln4/y;->d:Landroid/net/Uri;
    ...
    iget-object v3, v1, Ln4/y;->a:Landroid/app/Application;
    ...
    :cond_3
    :goto_3
    iget-boolean v7, v1, Ln4/y;->c:Z

    iget-object v8, v1, Ln4/y;->e:Ljava/lang/String;
    ...
    :goto_4
    invoke-static {v8, v7}, Ln4/z;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    :cond_6
    invoke-static {v8}, LB2/p;->m(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    const-string v14, "updateImage uri-> "
    ...
    iget-object v7, v1, Ln4/y;->b:[B

    iget v14, v1, Ln4/y;->k:I
    ...
    :try_start_3
    sget-object v0, Ln4/o;->a:Ljava/io/File;
    ...
    const-string v10, "tryLock %s failed, %s times"
    ...
    sget-object v1, Ln4/o;->a:Ljava/io/File;
    ...
    :goto_11
    :try_start_b
    invoke-static {v0, v12}, Ln4/z;->b(Ljava/lang/Exception;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Ln4/z;->s(Ljava/lang/Exception;)Z

    move-result v0

    if-eqz v0, :cond_14

    sget-object v0, Ln4/z;->r:Lcom/xiaomi/camera/utils/lifecycle/FreshLiveData;
    ...
    const-string v5, "updateImage  writeFile cost %s ms, fileLen: %d"
    ...
    invoke-static {v13, v0}, LD8/a;->e(Ljava/io/File;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v2, v1, Ln4/y;->f:Landroid/location/Location;
    ...
    :goto_1a
    invoke-static/range {v3 .. v8}, Ln4/z;->z(Landroid/app/Application;Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[BI)I
    ...
    const-string v1, "updateImage ret->%s, updateAfter cost %s ms"
    ...
    invoke-static/range {v12 .. v23}, Ln4/z;->y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
