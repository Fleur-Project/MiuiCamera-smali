...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Ln5/D;->S:[F

    new-array p1, p1, [F

    iput-object p1, p0, Ln5/D;->T:[F
...
.method public final a(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Ln5/D;->I:Landroid/graphics/Path;

    if-eqz v0, :cond_0

    iget-object v1, p0, Ln5/D;->J:Landroid/graphics/Path;
    ...
    iget-object p0, p0, Ln5/D;->J:Landroid/graphics/Path;
...
.method public final c(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Ln5/D;->P:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Ln5/D;->R:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/PathMeasure;

    invoke-direct {p1}, Landroid/graphics/PathMeasure;-><init>()V

    iput-object p1, p0, Ln5/D;->Q:Landroid/graphics/PathMeasure;
...
.method public final h()V
    ...
    iput v0, p0, Ln5/D;->K:I

    iget v0, p0, Ln5/D;->N:I
...
.method public final o(Ljf/i;Z)Landroid/graphics/Path;
    .locals 32
    ...
    iget v4, v0, Ln5/D;->K:I

    int-to-float v4, v4

    iget v5, v0, Ln5/D;->L:I

    int-to-float v5, v5

    iget-boolean v6, v0, Ln5/D;->U:Z
    ...
    iget v7, v0, Ln5/D;->O:F

    goto :goto_1

    :cond_0
    iget v6, v0, Ln5/D;->O:F
    ...
    iget-object v15, v1, Ljf/i;->a:Ljava/lang/Object;

    move/from16 v16, v10

    iget-object v10, v1, Ljf/i;->b:Ljava/lang/Object;
    ...
    :goto_4
    iget-object v14, v0, Ln5/D;->R:Landroid/graphics/RectF;
    ...
    iget-object v1, v0, Ln5/D;->P:Landroid/graphics/Path;

    invoke-virtual {v1}, Landroid/graphics/Path;->rewind()V

    iget-object v1, v0, Ln5/D;->P:Landroid/graphics/Path;

    iget-object v2, v0, Ln5/D;->R:Landroid/graphics/RectF;
    ...
    iget-object v1, v0, Ln5/D;->Q:Landroid/graphics/PathMeasure;

    iget-object v2, v0, Ln5/D;->P:Landroid/graphics/Path;
    ...
    iget-object v0, v0, Ln5/D;->P:Landroid/graphics/Path;
...
.method public final p()V
    ...
    iget-boolean v0, p0, Ln5/D;->U:Z

    if-eqz v0, :cond_0

    invoke-static/range {v2 .. v7}, LEg/B;->m(FFFFFF)Ljf/i;
    ...
    invoke-virtual {p0, v0, v1}, Ln5/D;->o(Ljf/i;Z)Landroid/graphics/Path;

    move-result-object v1

    const/4 v2, 0x1

    invoke-virtual {p0, v0, v2}, Ln5/D;->o(Ljf/i;Z)Landroid/graphics/Path;

    move-result-object v0

    iput-object v1, p0, Ln5/D;->I:Landroid/graphics/Path;

    iput-object v0, p0, Ln5/D;->J:Landroid/graphics/Path;
