...
.field public f:Lqe/n;

.field public g:Lq3/f;

.field public h:LC/q1;

.field public i:Lq3/i;
...
.method public final F3(Z)V
    ...
    invoke-interface {p1}, Lq3/u;->reset()V
...
.method public final H4(I)I
    ...
    iget-object p0, p0, Lq3/o;->g:Lq3/f;

    iget-object p0, p0, Lq3/f;->f:LX3/a0;
...
.method public final H5(I)I
    ...
    sget-object v0, Lq3/k;->b:Ljava/util/HashMap;
...
.method public final K2(III)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lq3/r;->c(III)Lq3/q;

    new-instance p1, Lq3/z;

    invoke-direct {p1}, Lq3/z;-><init>()V

    iput-object p1, v0, Lq3/r;->c:Lq3/h;

    invoke-virtual {p0, v0}, Lq3/o;->Y2(Lq3/r;)V
...
.method public final L5(I)Z
    ...
    iget-object p0, p0, Lq3/o;->i:Lq3/i;

    iget-object v0, p0, Lq3/i;->d:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {v1, p1, p0, v2}, Lcom/android/camera2/compat/theme/custom/mm/top/R0;-><init>(ILjava/lang/Object;I)V

    new-instance p0, LN0/Q;

    const/4 p1, 0x5

    invoke-direct {p0, v1, p1}, LN0/Q;-><init>(Ljava/lang/Object;I)V
...
.method public final Y2(Lq3/r;)V
    .locals 1

    iget-object v0, p0, Lq3/o;->e:Lio/reactivex/disposables/Disposable;
    ...
    :cond_0
    iget-boolean v0, p1, Lq3/r;->e:Z

    if-eqz v0, :cond_1

    invoke-virtual {p0, p1}, Lq3/o;->m(Lq3/r;)V

    return-void

    :cond_1
    iget-object p0, p0, Lq3/o;->d:Lio/reactivex/ObservableEmitter;
...
.method public final Y3(III)V
    ...
    invoke-static {p1, p2, p3}, LC/F;->g(III)Lq3/r;

    move-result-object p1

    new-instance p2, Lq3/z;

    invoke-direct {p2}, Lq3/z;-><init>()V

    iput-object p2, p1, Lq3/r;->c:Lq3/h;
...
.method public final e9(II)Z
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/android/camera2/compat/theme/custom/mm/top/E0;-><init>(Ljava/lang/Object;II)V

    new-instance p0, LJ0/c;

    const/4 p1, 0x2

    invoke-direct {p0, v1, p1}, LJ0/c;-><init>(Ljava/lang/Object;I)V
...
.method public final m(Lq3/r;)V
    ...
    iget-object v1, p1, Lq3/r;->c:Lq3/h;

    if-eqz v1, :cond_0

    invoke-interface {v1, p1, v0}, Lq3/t;->h(Lq3/r;LBa/d;)Ljava/util/ArrayList;
    ...
    iget-object v4, v3, Lq3/j;->i:Lq3/t;

    invoke-interface {v4}, Lq3/t;->k()Z
    ...
    iget-object p1, p1, Lq3/r;->d:Ljava/lang/Runnable;
    ...
    invoke-direct {v1, p0, v2}, LN0/k;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, v0, v1}, Lq3/f;->c(Ljava/util/List;Ljava/lang/Runnable;)V
...
.method public final varargs o5(I)V
    ...
    iget-object v0, v0, Lq3/i;->c:Landroid/util/SparseArray;
...
.method public final rc(II)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lq3/f;->b(I)Ljava/util/List;
...
.method public final u0(I)Ljava/util/List;
    ...
    iget-object p0, p0, Lq3/i;->c:Landroid/util/SparseArray;
