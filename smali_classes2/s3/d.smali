...
.field public final g:Ls3/b$b;

.field public h:J

.field public i:J

.field public final j:[Ls3/d$b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ls3/d;->g:Ls3/b$b;

    new-instance v0, Ls3/d$b;

    const-string v1, "gps"

    invoke-direct {v0, p0, v1}, Ls3/d$b;-><init>(Ls3/d;Ljava/lang/String;)V

    new-instance v1, Ls3/d$b;

    const-string v2, "network"

    invoke-direct {v1, p0, v2}, Ls3/d$b;-><init>(Ls3/d;Ljava/lang/String;)V

    filled-new-array {v0, v1}, [Ls3/d$b;

    move-result-object v0

    iput-object v0, p0, Ls3/d;->j:[Ls3/d$b;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Ls3/d;->k:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v0, p0, Ls3/d;->f:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Ls3/d;->f:Landroid/os/HandlerThread;
    ...
    invoke-direct {v1, p0, v0}, Ls3/d$a;-><init>(Ls3/d;Landroid/os/Looper;)V

    iput-object v1, p0, Ls3/d;->a:Ls3/d$a;

    return-void
.end method

.method public static h(Ls3/d;)V
    .locals 4

    const-string v0, "NormalLocationManager"

    iget-object v1, p0, Ls3/d;->j:[Ls3/d$b;

    iget-object p0, p0, Ls3/d;->b:Landroid/location/LocationManager;
    ...
    iput-boolean v2, p0, Ls3/d$b;->b:Z
...
# virtual methods
.method public final a(Landroid/location/Location;)Ls3/b$b;
    .locals 13
    ...
    invoke-virtual/range {v0 .. v6}, Ls3/d;->i(JDD)V
    ...
    iget-wide v7, p0, Ls3/d;->i:J

    iget-wide v11, p0, Ls3/d;->h:J
    ...
    iget-object v1, p0, Ls3/d;->g:Ls3/b$b;
    ...
    iput-wide v7, v1, Ls3/b$b;->a:J

    div-long/2addr v11, v2

    iput-wide v11, v1, Ls3/b$b;->b:J
...
.method public final b()Landroid/location/Location;
    ...
    :goto_0
    iget-object v2, p0, Ls3/d;->j:[Ls3/d$b;
    ...
    iget-boolean v5, v3, Ls3/d$b;->b:Z

    if-eqz v5, :cond_0

    iget-object v3, v3, Ls3/d$b;->a:Landroid/location/Location;
    ...
    invoke-static {v1, p0, v0}, LA2/l;->j(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p0

    aget-object v0, v2, v1

    iget-object v0, v0, Ls3/d$b;->c:Ljava/lang/String;
    ...
    invoke-static {v3}, Ls3/d;->l(Landroid/location/Location;)V
    ...
    :cond_2
    iget-object v1, p0, Ls3/d;->d:Landroid/location/Location;
    ...
    iget-object p0, p0, Ls3/d;->d:Landroid/location/Location;

    invoke-static {p0}, Ls3/d;->l(Landroid/location/Location;)V

    return-object p0
.end method

.method public final c(Ls3/b$a;)V
    .locals 2

    if-eqz p1, :cond_0

    iget-object p0, p0, Ls3/d;->k:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/a;

    const/4 v1, 0x2

    invoke-direct {v0, p1, v1}, Lcom/android/camera2/compat/theme/custom/mm/top/topbarview/bus/a;-><init>(Ljava/lang/Object;I)V
...
.method public final d()Landroid/location/Location;
    ...
    :cond_0
    invoke-virtual {p0}, Ls3/d;->b()Landroid/location/Location;
...
.method public final e()Landroid/location/Location;
    ...
    :cond_0
    iget-object p0, p0, Ls3/d;->e:Landroid/location/Location;

    return-object p0
.end method

.method public final f(Ls3/b$a;)V
    .locals 3
    ...
    invoke-direct {v1, p1, v2}, LE3/v0;-><init>(Ljava/lang/Object;I)V
...
.method public final g(Z)V
    ...
    invoke-direct {v0, v1, p0, p1}, LY1/f;-><init>(ILjava/lang/Object;Z)V

    iget-object p0, p0, Ls3/d;->a:Ls3/d$a;
...
.method public final i(JDD)V
    ...
    invoke-static/range {v5 .. v10}, LD8/a;->a(DDD)D
    ...
    invoke-static/range {v11 .. v16}, LD8/a;->a(DDD)D
    ...
    iput-wide v7, v0, Ls3/d;->h:J

    iput-wide v7, v0, Ls3/d;->i:J
...
.method public final k()V
    ...
    iget-object v0, v1, Ls3/d;->f:Landroid/os/HandlerThread;

    iget-object v3, v1, Ls3/d;->j:[Ls3/d$b;

    iget-object v4, v1, Ls3/d;->b:Landroid/location/LocationManager;
    ...
    iput-object v4, v1, Ls3/d;->b:Landroid/location/LocationManager;

    :cond_0
    iget-object v5, v1, Ls3/d;->b:Landroid/location/LocationManager;
    ...
    iget-object v13, v1, Ls3/d;->b:Landroid/location/LocationManager;
    ...
    iget-object v0, v1, Ls3/d;->a:Ls3/d$a;
    ...
    :cond_2
    iget-object v0, v1, Ls3/d;->e:Landroid/location/Location;

    iget-object v4, v1, Ls3/d;->d:Landroid/location/Location;

    invoke-static {v0, v4}, Ls3/d;->j(Landroid/location/Location;Landroid/location/Location;)Landroid/location/Location;
    ...
    :cond_3
    iget-object v0, v1, Ls3/d;->b:Landroid/location/LocationManager;
    ...
    iput-object v0, v1, Ls3/d;->b:Landroid/location/LocationManager;
    ...
    iget-object v6, v1, Ls3/d;->b:Landroid/location/LocationManager;
    ...
    invoke-static {v0, v6}, Ls3/d;->j(Landroid/location/Location;Landroid/location/Location;)Landroid/location/Location;

    move-result-object v0

    iput-object v0, v1, Ls3/d;->e:Landroid/location/Location;

    iget-object v6, v1, Ls3/d;->d:Landroid/location/Location;

    invoke-static {v6, v0}, Ls3/d;->j(Landroid/location/Location;Landroid/location/Location;)Landroid/location/Location;
    ...
    iget-object v0, v1, Ls3/d;->d:Landroid/location/Location;
    ...
    iput-object v0, v1, Ls3/d;->d:Landroid/location/Location;

    goto :goto_4

    :cond_5
    iput-object v3, v1, Ls3/d;->d:Landroid/location/Location;
