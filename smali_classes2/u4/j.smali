...
.method public final O2()Ljava/lang/String;
    ...
    invoke-static {v2, v3}, LC/v2;->a(J)Ljava/lang/String;
...
.method public final Sd(II)V
    ...
    new-instance p2, Lcom/android/camera2/compat/theme/custom/mm/top/m;

    const/16 v0, 0xf

    invoke-direct {p2, v0}, Lcom/android/camera2/compat/theme/custom/mm/top/m;-><init>(I)V
    ...
    invoke-static {v1, v2, p0, p1}, LYi/b;->H(Lio/reactivex/Scheduler;Ljava/lang/Runnable;J)Lio/reactivex/disposables/Disposable;
    ...
    invoke-interface {v2, p2}, Lu3/g;->q(I)V
    ...
    invoke-direct {v2, v4, v3}, Lcom/android/camera/fragment/top/p;-><init>(II)V
    ...
    invoke-direct {v2, v4, v3}, Lc2/t;-><init>(II)V
    ...
    invoke-direct {p1, p0, p2}, Lu4/f;-><init>(Lu4/j;I)V

    iput-object p1, v0, Lbc/k;->d:Lu4/f;
...
.method public final mc()V
    ...
    iget-object v3, p0, Lu4/j;->b:Ljava/lang/ref/WeakReference;
    ...
    iget-object v5, v4, Lcom/android/camera/AutoLockManager;->g:LC/X;

    iget-object v4, v4, Lcom/android/camera/AutoLockManager;->f:Lbc/G;

    invoke-virtual {v4, v5}, Lbc/G;->a(Ljava/lang/Object;)V

    invoke-virtual {p0}, Lu4/j;->n()Lu4/c;

    iget-object v4, p0, Lu4/j;->g:Lu4/c;

    iput-boolean v2, v4, Lu4/c;->b:Z
    ...
    invoke-interface {v4}, LX3/P0;->onFinish()V
    ...
    invoke-direct {v7, v8}, LC/w;-><init>(I)V

    invoke-virtual {v6, v7}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    invoke-virtual {v3}, Lcom/android/camera/module/BaseModule;->getFlashAsdManager()Lu3/h;
    ...
    invoke-direct {v8, v6, v2}, Lw2/f;-><init>(Ljava/lang/Object;I)V

    invoke-static {v7, v8}, LYi/b;->G(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct {v7, v3, v2}, Lx3/A;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v7, v4, v1}, LC3/b0;-><init>(ZI)V
    ...
    iget v12, v6, Lu3/a;->g:I

    invoke-direct/range {v8 .. v13}, Lv4/b;-><init>(ZIIIF)V

    invoke-virtual {v4, v8}, LMb/h;->a(Ljava/lang/Object;)V

    invoke-virtual {v4}, LMb/h;->d()V

    iget-object v4, p0, Lu4/j;->g:Lu4/c;

    invoke-virtual {v4, v5, v5}, Lu4/c;->e(ZZ)V
    ...
    sget-object v4, LY9/b$c;->l:LY9/b$c;

    invoke-virtual {v4, v5}, LY9/b$c;->b(Z)V

    :cond_2
    invoke-virtual {v3}, Lcom/android/camera/module/BaseModule;->getCameraManager()Lu3/k;
    ...
    invoke-virtual {v4, v5}, Lb6/D;->L(Z)V

    invoke-virtual {v3, v5}, Lcom/android/camera/module/BaseModule;->lockScreenOrientation(Z)V

    :cond_3
    iget-object v4, p0, Lu4/j;->c:Lbc/k;

    if-eqz v4, :cond_4

    iget-object v4, v4, Lbc/k;->a:Lio/reactivex/disposables/Disposable;
    ...
    new-instance v5, Lcom/xiaomi/microfilm/dualcam/mode/q;

    const/16 v6, 0xf

    invoke-direct {v5, v6}, Lcom/xiaomi/microfilm/dualcam/mode/q;-><init>(I)V
    ...
    invoke-direct {v4, v2}, Lqd/c;-><init>(I)V
    ...
    invoke-direct {v2, v0}, Lcom/xiaomi/mimoji/common/module/g;-><init>(I)V
...
.method public final q2(J)V
    ...
    invoke-static {v3, v4, v0, v5}, LC/u3;->e(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final qh(I)I
    ...
    invoke-interface {v2}, Lcom/android/camera/module/N;->uc()Lbc/h;
...
.method public final ya(I)Z
    ...
    iget-object v5, p0, Lu4/j;->b:Ljava/lang/ref/WeakReference;
    ...
    iput v6, p1, Lu4/b;->a:I

    invoke-static {}, LX3/P0;->impl()Ljava/util/Optional;

    move-result-object p1

    new-instance v6, LC3/N1;

    const/16 v10, 0x1b

    invoke-direct {v6, v5, v10}, LC3/N1;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance v6, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/a;

    const/16 v10, 0x15

    invoke-direct {v6, v10}, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/a;-><init>(I)V
    ...
    invoke-direct {v5, p0, v6}, Lid/g;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v5, v6}, Lk2/g;-><init>(I)V
    ...
    iget v5, p1, Lg0/t;->s:I

    invoke-virtual {p1, v5}, Lg0/t;->B(I)I

    move-result p1

    const-wide/32 v5, 0x5b8d80

    iput-wide v5, p0, Lu4/j;->a:J
    ...
    invoke-virtual {v5, v6}, LW9/b;->t(Ljava/lang/Class;)Ljava/util/Optional;

    move-result-object v5

    new-instance v6, Lu4/g;

    invoke-direct {v6, p1}, Lu4/g;-><init>(I)V
    ...
    invoke-virtual {p1, v6}, LW9/b;->t(Ljava/lang/Class;)Ljava/util/Optional;
    ...
    invoke-direct {v6, v10}, LC/i;-><init>(I)V
    ...
    invoke-static {v5, v6, v10, p1}, LC/E1;->g(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v9}, Lu4/j;->Sd(II)V
    ...
    invoke-direct {p1, v1, v0}, LC3/a0;-><init>(II)V
    ...
    invoke-virtual {p0, v0, v8}, Lu4/j;->Sd(II)V
    ...
    :cond_e
    iget-object v2, p0, Lu4/j;->b:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {p0, v1, p1}, Lu4/j;->Sd(II)V
