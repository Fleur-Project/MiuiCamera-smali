...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lw3/g;->C:[I

    return-void
.end method

.method public constructor <init>(Landroid/opengl/EGLContext;LTe/a;LTe/a;Ljava/lang/String;Lw3/f;Lw3/e$a;II)V
    .locals 1
    .param p2    # LTe/a;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-direct {p0, p5, p6}, Lw3/e;-><init>(Lw3/f;Lw3/e$a;)V

    const-string/jumbo p5, "video/avc"

    iput-object p5, p0, Lw3/g;->r:Ljava/lang/String;

    iget-object p5, p0, Lw3/e;->a:Ljava/lang/String;
    ...
    invoke-static {p7, p8, p6, v0}, LM4/u;->g(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput p7, p0, Lw3/g;->s:I

    iput p8, p0, Lw3/g;->t:I

    iput-object p2, p0, Lw3/g;->y:LTe/a;

    iput-object p3, p0, Lw3/g;->A:LTe/a;
    ...
    iput-object p4, p0, Lw3/g;->r:Ljava/lang/String;

    :cond_0
    iget-object p2, p0, Lw3/e;->a:Ljava/lang/String;

    invoke-static {p7, p8, p2}, Lw3/h;->a(IILjava/lang/String;)Lw3/h;

    move-result-object p2

    iput-object p2, p0, Lw3/g;->u:Lw3/h;

    iput-object p1, p0, Lw3/g;->x:Landroid/opengl/EGLContext;
...
.method public final f()V
    ...
    iget-object v0, p0, Lw3/g;->w:Landroid/view/Surface;
    ...
    iput-object v1, p0, Lw3/g;->w:Landroid/view/Surface;

    :cond_0
    iget-object v0, p0, Lw3/g;->u:Lw3/h;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lw3/h;->e()V

    iput-object v1, p0, Lw3/g;->x:Landroid/opengl/EGLContext;

    iput-object v1, p0, Lw3/g;->u:Lw3/h;

    :cond_1
    invoke-super {p0}, Lw3/e;->f()V
...
.method public final h(JZ)Z
    ...
    invoke-super {p0, p1, p2, p3}, Lw3/e;->h(JZ)Z
...
.method public final j(LS0/e;)V
    .locals 9

    invoke-virtual {p0}, Lw3/e;->c()Z
    ...
    iget-object v3, p1, LS0/e;->d:Lr6/f;

    iget-object v4, p1, LS0/e;->c:[F

    new-instance v5, Landroid/graphics/Rect;

    iget v6, v0, Lw3/h;->g:I

    const/4 v7, 0x0

    iget v8, v0, Lw3/h;->f:I

    invoke-direct {v5, v7, v7, v8, v6}, Landroid/graphics/Rect;-><init>(IIII)V

    invoke-virtual {v2, v3, v4, v5}, LS0/e;->a(Lr6/f;[FLandroid/graphics/Rect;)V

    iget-object v3, p1, LS0/e;->f:LTe/a;

    iput-object v3, v2, LS0/e;->f:LTe/a;

    iget-object p1, p1, LS0/e;->g:LTe/a;

    iput-object p1, v2, LS0/e;->g:LTe/a;

    invoke-virtual {v1, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v0, v1}, Lw3/h;->b(Ljava/util/ArrayList;)V

    iget-object p0, p0, Lw3/g;->u:Lw3/h;

    invoke-virtual {p0}, Lw3/h;->g()V
...
.method public final k()V
    ...
    iput-boolean v1, p0, Lw3/e;->l:Z

    iput-boolean v1, p0, Lw3/e;->k:Z
    ...
    iget-object v3, p0, Lw3/g;->r:Ljava/lang/String;
    ...
    sget-object v2, LTe/a;->b:LTe/a$c;

    iget-object v5, p0, Lw3/g;->y:LTe/a;

    if-ne v5, v2, :cond_8

    sget-object v5, LTe/a;->a:LTe/a$a;

    iget-object v8, p0, Lw3/g;->A:LTe/a;
    ...
    iget-object v2, p0, Lw3/g;->u:Lw3/h;

    iget-object v3, p0, Lw3/g;->x:Landroid/opengl/EGLContext;

    invoke-virtual {v2, v3, v1}, Lw3/h;->f(Landroid/opengl/EGLContext;Landroid/view/Surface;)V

    iget-object p0, p0, Lw3/e;->n:Landroid/media/MediaCodec;
