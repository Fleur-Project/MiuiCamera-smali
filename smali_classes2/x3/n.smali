...
.method public final g()V
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lx3/m;->t(Z)V
...
.method public final n()V
    ...
    iget-boolean v0, v0, Lx3/m$a;->c:Z
    ...
    iget v1, p0, Lx3/m;->D:I

    const/4 v2, 0x0

    invoke-virtual {p0, v0, v2, v1}, Lx3/m;->f(Landroid/util/Size;ZI)Landroid/util/Size;

    move-result-object v0

    iput-object v0, p0, Lx3/m;->B:Landroid/util/Size;

    sget-object v0, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    iget v0, p0, Lx3/m;->D:I
...
.method public final o()V
    ...
    iget-object v2, v1, Lx3/m$a;->p:Lb6/c;

    iget-boolean v3, v1, Lx3/m$a;->c:Z
    ...
    :goto_0
    iget-boolean v1, v1, Lx3/m$a;->i:Z
    ...
    invoke-virtual {v1}, L谧谫谩豪谩谭豪谠谡谲谭谧谡豪谧谫谩谩谫谪豪谇谫谩谩谫谪;->I1()I

    move-result v7

    iget-object v1, v0, Lx3/m;->G:Lx3/m$a;

    iget v8, v1, Lx3/m$a;->d:I

    iget v9, v1, Lx3/m$a;->l:I

    iget-object v10, v1, Lx3/m$a;->p:Lb6/c;
    ...
    sget-object v3, LC/L2;->a:Ljava/util/ArrayList;

    invoke-static {v1, v3}, LC/L2;->c(ILjava/util/List;)Landroid/util/Size;

    move-result-object v1

    const-string v3, "updateSize: isLimitMaxWidth pictureSize: "

    invoke-static {v3, v1}, LB8/h;->g(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    iget v3, v1, Lx3/m$a;->d:I

    iget v6, v1, Lx3/m$a;->l:I

    iget-object v1, v1, Lx3/m$a;->p:Lb6/c;

    invoke-static {v5, v3, v6, v1}, LC/L2;->e(Ljava/util/List;IILb6/c;)Landroid/util/Size;
    ...
    invoke-static {v3, v5, v2}, Lcom/android/camera/data/data/h;->J(IILb6/c;)F
    ...
    :goto_2
    iget-object v6, v0, Lx3/m;->G:Lx3/m$a;

    iget v6, v6, Lx3/m$a;->d:I
    ...
    const-string v3, "updateSize:scale="

    invoke-static {v3, v6}, LC/f2;->d(Ljava/lang/String;F)Ljava/lang/String;
    ...
    :cond_5
    const-string v3, "updateSize:previewSize="
    ...
    invoke-static {v10}, Lcom/android/camera/data/data/h;->K(I)F
    ...
    invoke-static {v6}, Lcom/android/camera/data/data/h;->S0(I)Z
    ...
    iget v12, v1, Lx3/m$a;->d:I

    iget v13, v1, Lx3/m$a;->l:I

    const/16 v16, 0x0

    const/16 v17, 0x0

    invoke-static/range {v12 .. v17}, Lx3/m;->d(IILjava/util/List;FLandroid/util/Size;Z)Landroid/util/Size;
    ...
    :cond_10
    iget-object v5, v3, Lx3/m$a;->p:Lb6/c;
    ...
    invoke-static {v3}, Lcom/android/camera/data/data/h;->B0(I)Z
    ...
    sget-object v4, Lx3/m$b;->Q:Lx3/m$b;
    ...
    :cond_16
    iget-object v0, v0, Lx3/m;->H:Ljava/util/HashMap;
