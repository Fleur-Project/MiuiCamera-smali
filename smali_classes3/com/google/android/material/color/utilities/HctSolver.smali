...
.method public static findResultByJ(DDD)I
    ...
    sget-object v12, Lcom/google/android/material/color/utilities/ViewingConditions;->DEFAULT:Lcom/google/android/material/color/utilities/ViewingConditions;

    invoke-virtual {v12}, Lcom/google/android/material/color/utilities/ViewingConditions;->getN()D
    ...
    div-double v15, v13, v4

    const-wide/high16 v17, 0x4000000000000000L    # 2.0

    add-double v4, p0, v17
    ...
    invoke-virtual {v12}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNc()D

    move-result-wide v8

    mul-double/2addr v8, v4

    invoke-virtual {v12}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNcb()D
    ...
    invoke-virtual {v12}, Lcom/google/android/material/color/utilities/ViewingConditions;->getAw()D

    move-result-wide v5

    invoke-virtual {v12}, Lcom/google/android/material/color/utilities/ViewingConditions;->getC()D

    move-result-wide v30

    div-double v30, v13, v30

    invoke-virtual {v12}, Lcom/google/android/material/color/utilities/ViewingConditions;->getZ()D

    move-result-wide v32

    div-double v13, v30, v32
    ...
    invoke-virtual {v12}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNbb()D
    ...
    invoke-static {v13, v14}, Lcom/google/android/material/color/utilities/HctSolver;->inverseChromaticAdaptation(D)D
    ...
    aput-wide v10, v1, v28

    sget-object v4, Lcom/google/android/material/color/utilities/HctSolver;->LINRGB_FROM_SCALED_DISCOUNT:[[D

    invoke-static {v1, v4}, Lcom/google/android/material/color/utilities/MathUtils;->matrixMultiply([D[[D)[D

    move-result-object v1

    aget-wide v4, v1, v23

    cmpg-double v6, v4, v24

    if-ltz v6, :cond_7

    aget-wide v6, v1, v29

    cmpg-double v10, v6, v24

    if-ltz v10, :cond_7

    aget-wide v10, v1, v28

    cmpg-double v13, v10, v24
    ...
    aget-wide v30, v13, v23

    aget-wide v32, v13, v29

    aget-wide v13, v13, v28
    ...
    add-double v13, v13, v32

    cmpg-double v4, v13, v24
...
.method public static lerpPoint([DD[D)[D
    ...
    invoke-static/range {v1 .. v8}, LC/L;->a(DDDD)D
    ...
    invoke-static/range {v3 .. v10}, LC/L;->a(DDDD)D
