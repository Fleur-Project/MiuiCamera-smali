...
.method private createCornerAnimator(Lcom/google/android/material/internal/ClippableRoundedCornerLayout;)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v1, p1, v0}, Lcom/android/camera/ui/B;-><init>(Landroid/view/View;I)V
...
.method private getRoundedCornerRadius(Landroid/view/WindowInsets;I)I
    ...
    invoke-static {p1, p2}, Landroidx/appfunctions/e;->i(Landroid/view/WindowInsets;I)Landroid/view/RoundedCorner;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p0}, Landroidx/appfunctions/j;->b(Landroid/view/RoundedCorner;)I
