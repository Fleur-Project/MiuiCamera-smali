...
.method public static final a(LB8/i$a;)Lzj/v;
    .locals 5
    ...
    invoke-direct {v4, v2}, LAj/g;-><init>(Lio/reactivex/Scheduler;)V

    invoke-direct {v3, v4}, LC8/a;-><init>(LAj/g;)V

    new-instance v2, Lzj/v$b;

    invoke-direct {v2}, Lzj/v$b;-><init>()V

    const-string v4, "executor == null"

    invoke-static {v1, v4}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    iput-object v1, v2, Lzj/v$b;->f:Ljava/util/concurrent/ExecutorService;

    iget-object v1, v2, Lzj/v$b;->e:Ljava/util/ArrayList;

    invoke-virtual {v1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, p0, LB8/i$a;->d:Lzj/f$a;
    ...
    invoke-direct {v3, v1}, LBj/a;-><init>(Lcom/google/gson/Gson;)V

    move-object v1, v3

    :cond_2
    iget-object v3, v2, Lzj/v$b;->d:Ljava/util/ArrayList;

    invoke-virtual {v3, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object p0, p0, LB8/i$a;->a:Ljava/lang/String;

    invoke-virtual {v2, p0}, Lzj/v$b;->a(Ljava/lang/String;)V
    ...
    iput-object p0, v2, Lzj/v$b;->b:Lokhttp3/Call$Factory;

    invoke-virtual {v2}, Lzj/v$b;->b()Lzj/v;
