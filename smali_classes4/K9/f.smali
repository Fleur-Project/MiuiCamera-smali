...
# direct methods
.method public constructor <init>(Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/MiviInfo4EntityJsonAdapter;LI9/b;)V
    .locals 1
    ...
    iput-object p2, p0, LK9/f;->b:LI9/b;
...
.method public final fromJson(LR8/q;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lkf/H;->m(Ljava/util/Set;Ljava/util/Map;)Ljava/util/Map;
...
.method public final toJson(LR8/v;Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lkf/H;->t(Ljava/util/Map;)Ljava/util/LinkedHashMap;
    ...
    :cond_4
    iget-object p0, p0, LK9/f;->b:LI9/b;

    invoke-virtual {p0, p1, v0}, LI9/b;->toJson(LR8/v;Ljava/lang/Object;)V
