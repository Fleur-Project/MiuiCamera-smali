...
# direct methods
.method public constructor <init>(Le8/a;Ld8/c;Ld8/b;)V
    .locals 1
    ...
    iput-object p1, p0, Lb8/h;->a:Le8/a;

    iput-object p3, p0, Lb8/h;->b:Ld8/b;

    new-instance p1, Lb8/h$a;

    new-instance p3, Ljava/lang/ref/WeakReference;

    invoke-direct {p3, p2}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    invoke-direct {p1, p3}, Lb8/h$a;-><init>(Ljava/lang/ref/WeakReference;)V

    iput-object p1, p0, Lb8/h;->c:Lb8/h$a;

    iget-object p1, p2, Ld8/c;->c:Ljava/lang/String;

    iput-object p1, p0, Lb8/h;->d:Ljava/lang/String;

    iget-object p1, p2, Ld8/c;->b:Ljava/lang/String;

    iput-object p1, p0, Lb8/h;->e:Ljava/lang/String;

    iget-object p1, p2, Ld8/c;->e:Ljava/util/Locale;

    iput-object p1, p0, Lb8/h;->f:Ljava/util/Locale;

    iget-object p1, p2, Ld8/c;->d:Ljava/lang/String;
...
.method public final call()Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v1, p0, Lb8/h;->b:Ld8/b;

    iget-object v2, p0, Lb8/h;->d:Ljava/lang/String;

    invoke-virtual {v1, v2}, Ld8/b;->a(Ljava/lang/String;)Ljava/util/Map;

    move-result-object v1

    if-nez v1, :cond_1

    iget-object v1, p0, Lb8/h;->a:Le8/a;

    iget-object v2, p0, Lb8/h;->e:Ljava/lang/String;

    invoke-interface {v1, v2}, Le8/a;->a(Ljava/lang/String;)Lzj/b;

    move-result-object v1

    invoke-interface {v1}, Lzj/b;->execute()Lzj/u;

    move-result-object v1

    iget-object v1, v1, Lzj/u;->b:Ljava/lang/Object;
    ...
    iget-object v3, p0, Lb8/h;->b:Ld8/b;
    ...
    iget-object v5, v3, Ld8/b;->b:Landroid/util/LruCache;
    ...
    :cond_1
    iget-object v2, p0, Lb8/h;->f:Ljava/util/Locale;
    ...
    iget-object v3, p0, Lb8/h;->f:Ljava/util/Locale;
    ...
    invoke-static {v2, v3, v1}, Lb8/c;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
    ...
    sget-object v2, La8/a;->a:Ljf/m;

    sget-object v2, La8/a;->b:Landroid/content/Context;
    ...
    iget-object v3, p0, Lb8/h;->d:Ljava/lang/String;
    ...
    :cond_4
    iget-object p0, p0, Lb8/h;->c:Lb8/h$a;
