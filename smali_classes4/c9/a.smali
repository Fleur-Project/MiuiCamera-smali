...
.field public j:Lc9/a$d;

.field public k:Lc9/a$e;

.field public l:Landroid/media/MediaPlayer;

.field public m:Lc9/a$c;
...
.method public constructor <init>(Lb9/d;)V
    ...
    iput-object v0, p0, Lc9/a;->e:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lc9/a;->f:Ljava/lang/Object;

    sget-object v0, Lc9/a$c;->a:Lc9/a$c;

    iput-object v0, p0, Lc9/a;->m:Lc9/a$c;

    iput-object p1, p0, Lc9/a;->i:Lb9/d;

    invoke-virtual {p0}, Lc9/a;->c()V

    return-void
.end method

.method public constructor <init>(Lb9/d;ILjava/lang/String;)V
    .locals 0
    ...
    iput-object p3, p0, Lc9/a;->e:Ljava/lang/Object;

    new-instance p3, Ljava/lang/Object;

    invoke-direct {p3}, Ljava/lang/Object;-><init>()V

    iput-object p3, p0, Lc9/a;->f:Ljava/lang/Object;

    sget-object p3, Lc9/a$c;->a:Lc9/a$c;

    iput-object p3, p0, Lc9/a;->m:Lc9/a$c;
...
.method public final a([BZ)V
    ...
    :try_start_0
    iget-object v1, p0, Lc9/a;->o:Landroid/os/Handler;
...
.method public final b()V
    ...
    :try_start_0
    iget-object v0, p0, Lc9/a;->o:Landroid/os/Handler;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lc9/a;->k:Lc9/a$e;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lc9/a$e;->a()V

    iput-object v1, p0, Lc9/a;->k:Lc9/a$e;

    :cond_1
    iget-object v0, p0, Lc9/a;->j:Lc9/a$d;
    ...
    iput-boolean v2, v0, Lc9/a$d;->c:Z

    const/4 v2, 0x1

    invoke-virtual {v0, v1, v2}, Lc9/a$d;->b([BZ)V

    iput-object v1, p0, Lc9/a;->j:Lc9/a$d;
...
.method public final c()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lc9/a;->e()V

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, Lc9/a;->i:Lb9/d;
    ...
    iput-object v0, p0, Lc9/a;->n:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Ljava/lang/Thread;->start()V

    new-instance v0, Landroid/os/Handler;

    iget-object v1, p0, Lc9/a;->n:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    new-instance v2, Lc9/a$a;

    invoke-direct {v2, p0}, Lc9/a$a;-><init>(Lc9/a;)V

    invoke-direct {v0, v1, v2}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object v0, p0, Lc9/a;->o:Landroid/os/Handler;
...
.method public final d()V
    ...
    invoke-virtual {p0}, Lc9/a;->g()Z

    move-result v0

    iput-boolean v0, p0, Lc9/a;->q:Z

    iget-boolean v0, p0, Lc9/a;->q:Z
    ...
    invoke-static {v1, v5}, Ll9/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v5}, Ll9/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v5, p0, Lc9/a;->c:Landroid/media/MediaCodec;
    :try_end_1
    ...
    :goto_5
    iget-object v5, p0, Lc9/a;->c:Landroid/media/MediaCodec;
    ...
    iget-object v0, p0, Lc9/a;->c:Landroid/media/MediaCodec;
...
.method public final e()V
    ...
    iput-object v2, p0, Lc9/a;->o:Landroid/os/Handler;
    ...
    invoke-static {v1, v3}, Ll9/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iput-object v2, p0, Lc9/a;->n:Landroid/os/HandlerThread;

    :cond_1
    iget-object v1, p0, Lc9/a;->j:Lc9/a$d;
    ...
    iput-boolean v0, v1, Lc9/a$d;->c:Z

    const/4 v0, 0x1

    invoke-virtual {v1, v2, v0}, Lc9/a$d;->b([BZ)V

    iput-object v2, p0, Lc9/a;->j:Lc9/a$d;
    ...
    iput-object v2, p0, Lc9/a;->k:Lc9/a$e;
    ...
    iget-object v0, p0, Lc9/a;->f:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lc9/a;->b:Landroid/media/AudioTrack;

    if-eqz v1, :cond_4

    invoke-virtual {v1}, Landroid/media/AudioTrack;->release()V

    iput-object v2, p0, Lc9/a;->b:Landroid/media/AudioTrack;
    ...
    :goto_2
    :try_start_1
    iget-object v0, p0, Lc9/a;->e:Ljava/lang/Object;
    ...
    :try_start_2
    iget-object v1, p0, Lc9/a;->c:Landroid/media/MediaCodec;
    ...
    iput-object v2, p0, Lc9/a;->c:Landroid/media/MediaCodec;
...
.method public final f()V
    ...
    iget-object v0, p0, Lc9/a;->l:Landroid/media/MediaPlayer;
    ...
    iput-object v0, p0, Lc9/a;->l:Landroid/media/MediaPlayer;
...
.method public final g()Z
    ...
    iput-object v4, p0, Lc9/a;->b:Landroid/media/AudioTrack;
    ...
    iget-object v0, p0, Lc9/a;->b:Landroid/media/AudioTrack;

    invoke-virtual {v0}, Landroid/media/AudioTrack;->release()V

    const/4 v0, 0x0

    iput-object v0, p0, Lc9/a;->b:Landroid/media/AudioTrack;
    ...
    :cond_0
    iget-object p0, p0, Lc9/a;->b:Landroid/media/AudioTrack;
