...
.method public register(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1, v0}, Lq8/e;->getMetaData(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v4}, Lq8/e;->getMetaData(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    if-eqz p0, :cond_1

    invoke-static {p0, v2, v1}, LPg/m;->K(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v1}, LLe/b;->n(Landroid/content/Context;Lcom/miui/camerainfra/cloudconfig/push/cn/MiPushInitializer$b;)V
    ...
    sput-object v2, LMe/a3;->a:Landroid/content/Context;
    ...
    invoke-static {v2, v5, v4}, LMe/W2;->b(Landroid/content/Context;Lcom/xiaomi/push/service/receivers/NetworkStatusReceiver;Landroid/content/IntentFilter;)V
    :try_end_0
    ...
    invoke-static {v2}, LMe/t;->b(Landroid/content/Context;)LMe/r;

    :cond_3
    sget-object v2, Lcom/xiaomi/mipush/sdk/b;->a:Landroid/content/Context;

    invoke-static {v2}, Lqe/k;->b(Landroid/content/Context;)Lqe/k;

    move-result-object v2

    iput-object v1, v2, Lqe/k;->b:LC5/b;

    iget-object v1, v2, Lqe/k;->a:Landroid/content/Context;
    ...
    iget-object v1, v2, Lqe/k;->b:LC5/b;
    ...
    invoke-virtual {p1, v1, p0}, LMe/d;->c(Ljava/lang/Runnable;I)V
