...
.field private mBufferPool:Lcom/miui/extravideo/interpolation/BufferPool;
...
.method public constructor <init>(IILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;[FZ)V
    ...
    .line 14
    iput-boolean v1, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mNeedDump:Z

    const/4 v2, 0x0

    .line 15
    iput-object v2, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mYuvFile:Ljava/io/File;
    ...
    iput v2, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mSkipSizeTarget2Origin:I
    ...
    .line 21
    iput v2, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mFrameSizeInterpolation:I
    ...
    .line 25
    iput-boolean p2, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mSupportEditor:Z
    ...
    invoke-direct {p2, v0}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;->a(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;)Landroid/os/Handler;

    move-result-object v0

    invoke-direct {p2, p3, v0}, Lcom/miui/extravideo/common/MediaDecoderAsync;-><init>(Ljava/lang/String;Landroid/os/Handler;)V
    ...
    .line 32
    iget v5, p2, Lcom/miui/extravideo/common/MediaParamsHolder;->videoDegree:I

    iput v5, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mDegree:I

    .line 33
    new-instance v2, Lcom/miui/extravideo/common/MediaEncoderAsync;

    iget v3, p2, Lcom/miui/extravideo/common/MediaParamsHolder;->videoWidth:I

    iget v4, p2, Lcom/miui/extravideo/common/MediaParamsHolder;->videoHeight:I

    iget-object v6, p2, Lcom/miui/extravideo/common/MediaParamsHolder;->mimeType:Ljava/lang/String;
    ...
    invoke-static {p3}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;->a(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;)Landroid/os/Handler;
    ...
    iput-object v2, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mEncoder:Lcom/miui/extravideo/common/MediaEncoderAsync;

    .line 34
    iget-object p3, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mDecoder:Lcom/miui/extravideo/common/MediaDecoderAsync;

    new-instance v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$DecodeUpdateListener;

    invoke-direct {v0, p0, p2}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$DecodeUpdateListener;-><init>(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;Lcom/miui/extravideo/common/MediaParamsHolder;)V

    invoke-virtual {p3, v0}, Lcom/miui/extravideo/common/MediaDecoderAsync;->setListener(Lcom/miui/extravideo/common/MediaDecoderAsync$DecodeUpdateListener;)V

    .line 35
    iget-object p3, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mEncoder:Lcom/miui/extravideo/common/MediaEncoderAsync;

    new-instance v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$EncodeUpdateListener;

    invoke-direct {v0, p0, v1}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$EncodeUpdateListener;-><init>(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;I)V

    invoke-virtual {p3, v0}, Lcom/miui/extravideo/common/MediaEncoderAsync;->setListener(Lcom/miui/extravideo/common/MediaEncoderAsync$EncodeUpdateListener;)V

    .line 36
    iget p3, p2, Lcom/miui/extravideo/common/MediaParamsHolder;->videoWidth:I

    iget v0, p2, Lcom/miui/extravideo/common/MediaParamsHolder;->videoHeight:I
    ...
    .line 37
    new-instance v0, Lcom/miui/extravideo/interpolation/BufferPool;

    invoke-direct {v0}, Lcom/miui/extravideo/interpolation/BufferPool;-><init>()V

    iput-object v0, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mBufferPool:Lcom/miui/extravideo/interpolation/BufferPool;

    .line 38
    invoke-virtual {v0, p3}, Lcom/miui/extravideo/interpolation/BufferPool;->warmup(I)V

    if-eqz p1, :cond_2

    .line 39
    new-instance v1, Lcom/miui/extravideo/watermark/WatermarkRenderPipeline;

    invoke-direct {v1}, Lcom/miui/extravideo/watermark/WatermarkRenderPipeline;-><init>()V

    iput-object v1, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mWatermarkPipeline:Lcom/miui/extravideo/watermark/WatermarkRenderPipeline;

    .line 40
    iget v2, p2, Lcom/miui/extravideo/common/MediaParamsHolder;->videoWidth:I

    iget v3, p2, Lcom/miui/extravideo/common/MediaParamsHolder;->videoHeight:I

    iget v6, p2, Lcom/miui/extravideo/common/MediaParamsHolder;->videoDegree:I

    move-object v4, p5

    move-object v5, p6

    invoke-virtual/range {v1 .. v6}, Lcom/miui/extravideo/watermark/WatermarkRenderPipeline;->init(IILandroid/graphics/Bitmap;[FI)V
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;[FZ)V
    ...
    .line 54
    :goto_0
    iput-boolean v1, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mSupportWatermark:Z
    ...
    invoke-static {v2}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;->a(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;)Landroid/os/Handler;
    ...
    iget-object p5, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mEncodeThread:Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;

    invoke-static {p5}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;->a(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;)Landroid/os/Handler;
    ...
    invoke-direct {p5, p0, v0}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$EncodeUpdateListener;-><init>(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;I)V
    ...
    .line 66
    iget p2, p1, Lcom/miui/extravideo/common/MediaParamsHolder;->videoWidth:I

    iget p5, p1, Lcom/miui/extravideo/common/MediaParamsHolder;->videoHeight:I
    ...
    .line 67
    new-instance p5, Lcom/miui/extravideo/interpolation/BufferPool;

    invoke-direct {p5}, Lcom/miui/extravideo/interpolation/BufferPool;-><init>()V

    iput-object p5, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mBufferPool:Lcom/miui/extravideo/interpolation/BufferPool;

    .line 68
    invoke-virtual {p5, p2}, Lcom/miui/extravideo/interpolation/BufferPool;->warmup(I)V
...
.method public static bridge synthetic a(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)Z
    .locals 0
...
.method private addMetaData()V
    ...
    invoke-static {v2}, Lvj/c;->a(Ljava/io/File;)Lvj/c;

    move-result-object v2

    iget-object v3, v2, Lvj/c;->a:Ljava/util/Map;
...
.method public static bridge synthetic b(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)Lcom/miui/extravideo/interpolation/BufferPool;
    .locals 0

    iget-object p0, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mBufferPool:Lcom/miui/extravideo/interpolation/BufferPool;

    return-object p0
.end method

.method public static bridge synthetic c(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;
    .locals 0
...
.method public static bridge synthetic d(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)Lcom/miui/extravideo/common/MediaDecoderAsync;
    .locals 0
...
.method public static bridge synthetic e(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;
    .locals 0
...
.method public static bridge synthetic f(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)Lcom/miui/extravideo/common/MediaEncoderAsync;
    .locals 0
...
.method public static bridge synthetic g(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)I
    .locals 0
...
.method private getBufferFromQueue()Lcom/miui/extravideo/interpolation/EncodeBufferHolder;
    ...
    const-string v1, "getBufferFromQueue: "
...
.method public static bridge synthetic h(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)[I
    .locals 0
...
.method public static bridge synthetic i(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)I
    .locals 0
...
.method public static bridge synthetic j(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)Z
    .locals 0
...
.method public static bridge synthetic k(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)Ljava/util/concurrent/BlockingQueue;
    .locals 0
...
.method public static bridge synthetic l(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)I
    .locals 0
...
.method public static bridge synthetic m(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)I
    .locals 0
...
.method public static bridge synthetic n(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)Ljava/io/File;
    .locals 0
...
.method private notifyTaskFinish()V
    ...
    const-string v3, "notifyTaskFinish: "
...
.method public static bridge synthetic o(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;Z)V
    .locals 0
...
.method public static bridge synthetic p(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)V
    .locals 0
...
.method private putBufferToQueue([BJI)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mBufferPool:Lcom/miui/extravideo/interpolation/BufferPool;

    array-length v1, p1

    invoke-virtual {v0, v1}, Lcom/miui/extravideo/interpolation/BufferPool;->acquire(I)Lcom/miui/extravideo/interpolation/EncodeBufferHolder;

    move-result-object v0

    iget-object v1, v0, Lcom/miui/extravideo/interpolation/EncodeBufferHolder;->data:[B
    ...
    iput v3, v0, Lcom/miui/extravideo/interpolation/EncodeBufferHolder;->flag:I
    ...
    const-string p2, "putBufferToQueue: "
...
.method private putEndFlagToQueue()V
    ...
    const-string v1, "putEndFlagToQueue: "
...
.method public static bridge synthetic q(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)Lcom/miui/extravideo/interpolation/EncodeBufferHolder;
    .locals 0
...
.method public static bridge synthetic r(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)V
    .locals 0
...
.method public static bridge synthetic s(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)V
    .locals 0
...
.method public static bridge synthetic t(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;[BJI)V
    .locals 0
...
.method public static bridge synthetic u(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;)V
    .locals 0
...
.method public doDecodeAndEncode()V
    ...
    const-string v1, "doDecodeAndEncode: "
