...
.method public constructor <init>(Landroid/app/Application;)V
    ...
    iput-object p1, p0, Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;->a:Ljf/m;

    new-instance p1, LM4/l;

    const/4 v0, 0x4

    invoke-direct {p1, v0}, LM4/l;-><init>(I)V

    invoke-static {p1}, LC/s2;->p(Lyf/a;)Ljf/m;

    move-result-object p1

    iput-object p1, p0, Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;->b:Ljf/m;
    ...
    iput-object p1, p0, Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;->c:Ljf/m;

    new-instance p1, LJ9/a;

    const/4 v0, 0x6

    invoke-direct {p1, v0}, LJ9/a;-><init>(I)V

    invoke-static {p1}, LC/s2;->p(Lyf/a;)Ljf/m;

    move-result-object p1

    iput-object p1, p0, Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;->d:Ljf/m;
    ...
    iput-object p1, p0, Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;->e:Ljf/m;

    new-instance p1, LT/b;

    const/4 v0, 0x1

    invoke-direct {p1, p0, v0}, LT/b;-><init>(Ljava/lang/Object;I)V

    invoke-static {p1}, LC/s2;->p(Lyf/a;)Ljf/m;

    move-result-object p1

    iput-object p1, p0, Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;->f:Ljf/m;
...
# virtual methods
.method public final a()LO/g;
    .locals 0

    iget-object p0, p0, Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;->d:Ljf/m;
...
.method public final d()LP9/d;
    .locals 0

    iget-object p0, p0, Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;->e:Ljf/m;
...
.method public final e(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;->a:Ljf/m;
    ...
    iget-object v1, v0, Lg5/d;->f:Lg5/a;

    iget-object v1, v1, Lg5/a;->a:Landroid/speech/tts/TextToSpeech;
    ...
    iput-object v1, v0, Lg5/d;->j:Ljava/lang/String;
    ...
    iget-object v2, p0, Lg5/d;->f:Lg5/a;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v3, p0, Lg5/d;->c:Landroid/media/AudioManager;

    const/4 v4, 0x3

    iget-object v5, p0, Lg5/d;->d:Lg5/b;
    ...
    :cond_1
    iget-object v3, v2, Lg5/a;->a:Landroid/speech/tts/TextToSpeech;
    ...
    invoke-direct {v3, p0}, Lg5/c;-><init>(Lg5/d;)V

    iget-object v4, v2, Lg5/a;->a:Landroid/speech/tts/TextToSpeech;

    if-nez v4, :cond_3

    new-instance v4, Landroid/speech/tts/TextToSpeech;

    iget-object v6, p0, Lg5/d;->b:Landroid/app/Application;
    ...
    iput-object v4, v2, Lg5/a;->a:Landroid/speech/tts/TextToSpeech;

    :cond_3
    iget-object v2, v2, Lg5/a;->a:Landroid/speech/tts/TextToSpeech;

    iget-object v3, p0, Lg5/d;->l:Lg5/d$b;
    ...
    :cond_4
    iget-object v2, p0, Lg5/d;->a:Landroid/os/Handler;

    iget-object v3, p0, Lg5/d;->k:Lg5/d$a;

    invoke-virtual {v2, v3}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-wide v6, p0, Lg5/d;->e:J

    invoke-virtual {v2, v3, v6, v7}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z

    iget v2, p0, Lg5/d;->g:I

    const/4 v3, -0x2

    if-ne v2, v3, :cond_6

    iget-object v1, p0, Lg5/d;->h:Lg5/d$d;

    if-eqz v1, :cond_5

    iget-object v1, v1, Lg5/d$d;->b:Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel$a;

    invoke-virtual {p0, v1, v5}, Lg5/d;->a(Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel$a;Z)V

    :cond_5
    new-instance v1, Lg5/d$d;

    invoke-direct {v1, p1, v0}, Lg5/d$d;-><init>(Ljava/util/List;Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel$a;)V

    iput-object v1, p0, Lg5/d;->h:Lg5/d$d;

    return-void

    :cond_6
    invoke-virtual {p0, p1, v0, v1}, Lg5/d;->b(Ljava/util/List;Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel$a;Landroid/os/Bundle;)V
...
.method public final onCleared()V
    ...
    iget-object v2, v1, LO/g;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v2, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    iget-object v2, v1, LO/g;->g:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, v1, LO/g;->g:Landroid/animation/ValueAnimator;

    iget-object v2, v1, LO/g;->a:Landroid/util/SparseArray;

    invoke-virtual {v2}, Landroid/util/SparseArray;->clear()V

    iget-object v2, v1, LO/g;->b:Landroid/util/SparseArray;
    ...
    iget-object v2, v1, LO/g;->e:Lio/reactivex/FlowableEmitter;

    invoke-interface {v2}, Lio/reactivex/Emitter;->onComplete()V

    iput-object v0, v1, LO/g;->e:Lio/reactivex/FlowableEmitter;
    ...
    iget-object v1, p0, Lg5/d;->a:Landroid/os/Handler;

    invoke-virtual {v1, v0}, Landroid/os/Handler;->removeCallbacksAndMessages(Ljava/lang/Object;)V

    invoke-virtual {p0}, Lg5/d;->c()V
