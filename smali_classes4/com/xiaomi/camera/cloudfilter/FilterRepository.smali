...
# instance fields
.field private final dataSource$delegate:Ljf/f;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/camera/cloudfilter/FilterRepository;->dataSource$delegate:Ljf/f;
...
.method private final getDataSource()Lcom/xiaomi/camera/cloudfilter/FilterDataSource;
    ...
    iget-object p0, p0, Lcom/xiaomi/camera/cloudfilter/FilterRepository;->dataSource$delegate:Ljf/f;
...
.method private final processFilterData(Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterData;)Ljava/util/List;
    ...
    new-instance v10, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterItem;
    ...
    invoke-virtual {v10}, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterItem;->supported()Z
    ...
    invoke-virtual {v10}, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterItem;->getName()Ljava/lang/String;

    move-result-object v11

    invoke-direct {v0, v8, v11}, Lcom/xiaomi/camera/cloudfilter/FilterRepository;->isValidConfig(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    new-instance v11, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterItem;
    ...
    invoke-virtual {v11}, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterItem;->supported()Z

    move-result v10

    if-eqz v10, :cond_b

    invoke-virtual {v11}, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterItem;->getInitValue()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v11}, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterItem;->getName()Ljava/lang/String;

    move-result-object v12

    invoke-direct {v0, v10, v12}, Lcom/xiaomi/camera/cloudfilter/FilterRepository;->isValidConfig(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v6, v7}, Lkf/v;->o0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
...
# virtual methods
.method public final downloadFilterResource(ILjava/lang/String;Lnf/d;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/xiaomi/camera/cloudfilter/FilterDataSource;->downloadSuccess(ILjava/lang/String;Lnf/d;)Ljava/lang/Object;
...
.method public final getDownloadStatus(ILnf/d;)Ljava/lang/Object;
    .locals 4
    ...
    invoke-direct {v0, p0, p2}, Lcom/xiaomi/camera/cloudfilter/FilterRepository$getDownloadStatus$1;-><init>(Lcom/xiaomi/camera/cloudfilter/FilterRepository;Lnf/d;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/xiaomi/camera/cloudfilter/FilterDataSource;->isResourceExist(ILnf/d;)Ljava/lang/Object;
...
.method public final loadSupportedCloudFilter(ZLnf/d;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-direct {v0, p0, p2}, Lcom/xiaomi/camera/cloudfilter/FilterRepository$loadSupportedCloudFilter$1;-><init>(Lcom/xiaomi/camera/cloudfilter/FilterRepository;Lnf/d;)V
    ...
    invoke-virtual {p2, p1, v0}, Lcom/xiaomi/camera/cloudfilter/FilterDataSource;->loadCloudFilter(ZLnf/d;)Ljava/lang/Object;
