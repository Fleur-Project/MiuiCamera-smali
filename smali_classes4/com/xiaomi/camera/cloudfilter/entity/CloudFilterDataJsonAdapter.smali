...
# instance fields
.field private final categoryConfigAdapter:LR8/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LR8/l<",
            "Lcom/xiaomi/camera/cloudfilter/entity/CategoryConfig;",
...
.field private final filterConfigAdapter:LR8/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LR8/l<",
            "Lcom/xiaomi/camera/cloudfilter/entity/FilterConfig;",
...
.field private final listOfDataFilterAdapter:LR8/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LR8/l<",
            "Ljava/util/List<",
...
.field private final moduleConfigAdapter:LR8/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LR8/l<",
            "Lcom/xiaomi/camera/cloudfilter/entity/ModuleConfig;",
...
.method public constructor <init>(LR8/y;)V
    ...
    invoke-static {v4}, LR8/q$a;->a([Ljava/lang/String;)LR8/q$a;

    move-result-object v4

    iput-object v4, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->options:LR8/q$a;

    sget-object v4, Lkf/z;->a:Lkf/z;

    const-class v5, Lcom/xiaomi/camera/cloudfilter/entity/CategoryConfig;

    invoke-virtual {p1, v5, v4, v0}, LR8/y;->b(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)LR8/l;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->categoryConfigAdapter:LR8/l;

    const-class v0, Lcom/xiaomi/camera/cloudfilter/entity/FilterConfig;

    invoke-virtual {p1, v0, v4, v1}, LR8/y;->b(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)LR8/l;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->filterConfigAdapter:LR8/l;

    const-class v0, Lcom/xiaomi/camera/cloudfilter/entity/ModuleConfig;

    invoke-virtual {p1, v0, v4, v2}, LR8/y;->b(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)LR8/l;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->moduleConfigAdapter:LR8/l;
    ...
    invoke-virtual {p1, v0, v4, v3}, LR8/y;->b(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)LR8/l;

    move-result-object p1

    iput-object p1, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->listOfDataFilterAdapter:LR8/l;
...
# virtual methods
.method public fromJson(LR8/q;)Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterData;
    .locals 11
    ...
    .line 4
    iget-object v4, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->options:LR8/q$a;

    invoke-virtual {p1, v4}, LR8/q;->q(LR8/q$a;)I
    ...
    .line 5
    :cond_0
    iget-object v3, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->listOfDataFilterAdapter:LR8/l;
    ...
    :cond_1
    invoke-static {v6, v5, p1}, LS8/c;->j(Ljava/lang/String;Ljava/lang/String;LR8/q;)LR8/n;
    ...
    .line 6
    :cond_2
    iget-object v2, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->moduleConfigAdapter:LR8/l;
    ...
    .line 8
    :cond_4
    iget-object v1, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->filterConfigAdapter:LR8/l;
    ...
    .line 10
    :cond_6
    iget-object v0, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->categoryConfigAdapter:LR8/l;
    ...
    .line 16
    :cond_a
    invoke-static {v6, v5, p1}, LS8/c;->e(Ljava/lang/String;Ljava/lang/String;LR8/q;)LR8/n;
...
.method public bridge synthetic fromJson(LR8/q;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->fromJson(LR8/q;)Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterData;
...
.method public toJson(LR8/v;Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterData;)V
    .locals 2
    ...
    .line 6
    iget-object v0, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->filterConfigAdapter:LR8/l;
    ...
    .line 8
    iget-object v0, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->moduleConfigAdapter:LR8/l;
    ...
    .line 10
    iget-object p0, p0, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->listOfDataFilterAdapter:LR8/l;
...
.method public bridge synthetic toJson(LR8/v;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterDataJsonAdapter;->toJson(LR8/v;Lcom/xiaomi/camera/cloudfilter/entity/CloudFilterData;)V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-static {p0, v0}, LB2/p;->h(ILjava/lang/String;)Ljava/lang/String;
