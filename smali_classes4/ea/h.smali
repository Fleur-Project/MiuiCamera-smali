...
.field public e:Lea/i;

.field public final f:Ljava/util/concurrent/atomic/AtomicInteger;

.field public g:Lbe/a;
...
.method public constructor <init>(Landroid/media/Image;Z)V
    ...
    iput-object v0, p0, Lea/h;->f:Ljava/util/concurrent/atomic/AtomicInteger;

    .line 3
    invoke-static {p1}, Lea/h;->d(Landroid/media/Image;)V
    ...
    .line 11
    invoke-virtual {p0, p1, p2}, Lea/h;->a(Landroid/media/Image;Z)V
...
.method public constructor <init>(Lea/h;)V
    ...
    iput-object v0, p0, Lea/h;->a:[B

    .line 21
    iget v0, p1, Lea/h;->b:I

    iput v0, p0, Lea/h;->b:I

    .line 22
    iget v0, p1, Lea/h;->c:I

    iput v0, p0, Lea/h;->c:I

    .line 23
    iget-wide v0, p1, Lea/h;->d:J

    iput-wide v0, p0, Lea/h;->d:J
...
.method public final a(Landroid/media/Image;Z)V
    ...
    invoke-static {v6, v5, v7, v8}, LM4/u;->g(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, v0, Lea/h;->g:Lbe/a;

    const-string v8, "."

    const-string v10, "Step must be positive, was: "

    iget v12, v0, Lea/h;->b:I

    iget-object v13, v0, Lea/h;->a:[B
    ...
    iget-object v6, v7, Lbe/a;->a:Ljava/lang/Object;
    ...
    iput-object v6, v7, Lbe/a;->a:Ljava/lang/Object;
    ...
    invoke-static {v4, v14, v5}, LLf/d;->i(III)I
    ...
    invoke-static {v6, v13, v11, v15, v4}, LMe/Z;->h([B[BIII)V
    ...
    invoke-static {v5, v4, v6, v11}, LM4/u;->g(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, v7, Lbe/a;->b:Ljava/lang/Object;
    ...
    iput-object v11, v7, Lbe/a;->b:Ljava/lang/Object;
    ...
    invoke-static {v6, v5, v4}, LLf/d;->i(III)I
    ...
    invoke-static {v11, v13, v8, v6, v7}, LMe/Z;->h([B[BIII)V
    ...
    invoke-static {v4, v10, v8}, LB2/p;->i(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v4, v0, v1}, LC/Q;->e(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v10, v8}, LB2/p;->i(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final b(Landroid/media/Image;)Z
    ...
    iget v2, p0, Lea/h;->b:I

    const-string v3, "PreviewImage"

    if-ne v2, v0, :cond_2

    iget v0, p0, Lea/h;->c:I
    ...
    :cond_0
    iget-object v0, p0, Lea/h;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-wide v2, p0, Lea/h;->d:J

    invoke-virtual {p0, p1, v1}, Lea/h;->a(Landroid/media/Image;Z)V
...
.method public final c()V
    ...
    iget-object v0, p0, Lea/h;->e:Lea/i;
    ...
    iget-object v2, p0, Lea/h;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget v2, v0, Lea/i;->c:I

    if-gt v1, v2, :cond_0

    iget-object v0, v0, Lea/i;->a:Ljava/util/concurrent/ArrayBlockingQueue;
