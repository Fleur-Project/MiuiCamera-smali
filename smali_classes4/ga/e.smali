...
.method public varargs constructor <init>(Ljava/lang/String;LEb/a$a;LEb/a$a;Z[Ljava/lang/String;)V
    ...
    invoke-direct {p4, p3}, Lfa/e;-><init>(LEb/a$a;)V

    iput-object p4, p0, Lga/e;->e:Lfa/e;
...
.method public final a()Lga/b;
    ...
    invoke-virtual {v3, v4}, Lb6/Z;->I2(Lga/f;)V
    ...
    iget-object v7, v3, Lb6/Z;->T:Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Lb6/Z;->b2()I

    move-result v8

    iput v8, v3, Lb6/Z;->K:I

    iput-boolean v0, v3, Lb6/Z;->x:Z

    iget-object v0, v3, Lb6/Z;->w:Landroid/hardware/camera2/CameraCaptureSession;

    iget v8, v3, Lb6/Z;->o0:I

    const-string v9, "cancelSession"

    invoke-static {v0, v8, v9}, Lb6/Z;->l2(Landroid/hardware/camera2/CameraCaptureSession;ILjava/lang/String;)Z
    ...
    iget-object v6, v3, Lb6/Z;->w:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iput-object v4, v3, Lb6/Z;->w:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    invoke-virtual {v3, v0, v4, v2}, Lb6/Z;->g2(Ljava/lang/Exception;Ljava/lang/String;Z)V
    ...
    :cond_5
    :goto_5
    iget-object v0, v1, Lfa/a$a;->e:Lb6/Z;

    iget-object v0, v0, Lb6/Z;->v:Lz9/b;

    iget-object p0, p0, Lga/e;->e:Lfa/e;
    ...
    invoke-virtual {p0, v0}, Lfa/e;->onOpened(Landroid/hardware/camera2/CameraDevice;)V
    ...
    iget-object v4, v3, Lfa/a$a;->e:Lb6/Z;
    ...
    invoke-static {v1}, Lfa/c;->b([Ljava/lang/String;)V

    invoke-static {}, Lfa/c;->d()Lfa/c;

    move-result-object v1

    iget-object v1, v1, Lfa/c;->a:Landroid/os/Handler;
    ...
    iget-object v4, v4, Lfa/c;->a:Landroid/os/Handler;
    ...
    iget-object v6, p0, Lga/e;->e:Lfa/e;
