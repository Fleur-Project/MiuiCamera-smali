...
# instance fields
.field public final b:LPa/k;

.field public final c:LPa/k;
...
# direct methods
.method public constructor <init>(LPa/k;LPa/k;ILjava/lang/String;LOa/w;Lic/b;)V
    .locals 8
    ...
    iput-object v0, p0, Lic/c$a;->j:Ljava/io/File;

    iput-object v0, p0, Lic/c$a;->k:Ljava/io/File;

    iput-object p1, p0, Lic/c$a;->b:LPa/k;

    iput-object p2, p0, Lic/c$a;->c:LPa/k;

    iput p3, p0, Lic/c$a;->f:I

    iput-object p4, p0, Lic/c$a;->g:Ljava/lang/String;

    iput-object p5, p0, Lic/c$a;->d:LOa/w;

    iput-object p6, p0, Lic/c$a;->e:Lic/b;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lic/c$a;->i:Z
    ...
    invoke-direct {v7, p2, p1}, LC/z2;-><init>(Ljava/lang/String;I)V
    ...
    iput-object v0, p0, Lic/c$a;->h:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public final a()V
    ...
    iget-object v1, p0, Lic/c$a;->g:Ljava/lang/String;
    ...
    iget-object v0, p0, Lic/c$a;->d:LOa/w;
    ...
    :cond_0
    iget-object p0, p0, Lic/c$a;->h:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public final b(Ljava/lang/Exception;)V
    ...
    iget-object v2, p0, Lic/c$a;->d:LOa/w;

    if-eqz v2, :cond_0

    iget-object v3, p0, Lic/c$a;->g:Ljava/lang/String;

    invoke-interface {v2, v3, p1}, LOa/w;->b(Ljava/lang/Object;Ljava/lang/Exception;)V

    :cond_0
    iget-object p1, p0, Lic/c$a;->h:Ljava/util/concurrent/ThreadPoolExecutor;

    invoke-virtual {p1}, Ljava/util/concurrent/ThreadPoolExecutor;->shutdown()V

    :try_start_0
    iget-object p1, p0, Lic/c$a;->j:Ljava/io/File;

    invoke-static {p1, v0}, Lkotlin/jvm/internal/k;->f(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {p1}, Luf/i;->D(Ljava/io/File;)Z

    iget-object p1, p0, Lic/c$a;->k:Ljava/io/File;

    invoke-static {p1, v0}, Lkotlin/jvm/internal/k;->f(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {p1}, Luf/i;->D(Ljava/io/File;)Z

    iget-object p1, p0, Lic/c$a;->c:LPa/k;

    if-eqz p1, :cond_1

    invoke-virtual {p1}, LPa/k;->a()V
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, Lic/c$a;->b:LPa/k;

    if-eqz p0, :cond_2

    invoke-virtual {p0}, LPa/k;->a()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final c(LPa/k;)J
    .locals 4

    iget-wide v0, p1, LPa/k;->f:J

    iget-wide v2, p1, LPa/k;->e:J
    ...
    invoke-static {v0, v1, p1, v2}, LC/u3;->e(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-object p0, p0, Lic/c$a;->g:Ljava/lang/String;
...
.method public final d(Ljava/io/File;Z)V
    ...
    iget-object p0, p0, Lic/c$a;->c:LPa/k;
...
.method public final run()V
    ...
    iget-object v6, v1, Lic/c$a;->g:Ljava/lang/String;
    ...
    iput-object v6, v1, Lic/c$a;->j:Ljava/io/File;
    ...
    iget-object v5, v1, Lic/c$a;->g:Ljava/lang/String;
    ...
    iget-object v5, v1, Lic/c$a;->j:Ljava/io/File;

    invoke-virtual {v5}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;

    move-result-object v5

    iget-object v6, v1, Lic/c$a;->j:Ljava/io/File;
    ...
    iget-object v4, v1, Lic/c$a;->g:Ljava/lang/String;
    ...
    iput-object v3, v1, Lic/c$a;->k:Ljava/io/File;

    new-instance v12, Landroid/media/MediaMuxer;

    iget-object v3, v1, Lic/c$a;->j:Ljava/io/File;
    ...
    iget-object v2, v1, Lic/c$a;->c:LPa/k;

    const/4 v3, -0x1

    if-eqz v2, :cond_3

    iget-object v2, v2, LPa/k;->c:Landroid/media/MediaFormat;
    ...
    iget-object v0, v1, Lic/c$a;->c:LPa/k;

    iget-object v0, v0, LPa/k;->c:Landroid/media/MediaFormat;
    ...
    iget-object v4, v1, Lic/c$a;->c:LPa/k;

    iget-object v4, v4, LPa/k;->c:Landroid/media/MediaFormat;
    ...
    :goto_2
    iget-object v2, v1, Lic/c$a;->b:LPa/k;

    if-eqz v2, :cond_5

    iget-object v0, v2, LPa/k;->c:Landroid/media/MediaFormat;
    :try_end_5
    ...
    :try_start_7
    iget-object v0, v1, Lic/c$a;->b:LPa/k;
    ...
    iget-boolean v4, v1, Lic/c$a;->i:Z

    if-eqz v4, :cond_6

    new-instance v11, LSa/e;

    iget-object v13, v1, Lic/c$a;->c:LPa/k;

    invoke-direct/range {v11 .. v16}, LSa/e;-><init>(Landroid/media/MediaMuxer;LPa/k;ILSa/c$a;LSa/c$a;)V
    ...
    invoke-direct {v11, v12, v4, v14, v15}, LSa/d;-><init>(Landroid/media/MediaMuxer;LPa/k;ILSa/c$a;)V

    :goto_5
    iget-object v4, v1, Lic/c$a;->h:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    :cond_7
    iget-object v4, v1, Lic/c$a;->b:LPa/k;

    if-eqz v4, :cond_9

    if-eq v0, v3, :cond_9

    iget-boolean v3, v1, Lic/c$a;->i:Z

    if-eqz v3, :cond_8

    new-instance v11, LSa/b;

    iget-object v13, v1, Lic/c$a;->b:LPa/k;

    move v14, v0

    invoke-direct/range {v11 .. v16}, LSa/b;-><init>(Landroid/media/MediaMuxer;LPa/k;ILSa/c$a;LSa/c$a;)V
    ...
    invoke-direct {v11, v12, v0, v14, v15}, LSa/a;-><init>(Landroid/media/MediaMuxer;LPa/k;ILSa/c$a;)V

    :goto_6
    iget-object v0, v1, Lic/c$a;->h:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    iget-object v5, v1, Lic/c$a;->c:LPa/k;

    invoke-virtual {v1, v5}, Lic/c$a;->c(LPa/k;)J
    ...
    iget-object v0, v1, Lic/c$a;->j:Ljava/io/File;

    iget-object v2, v1, Lic/c$a;->k:Ljava/io/File;
    ...
    invoke-virtual {v1, v2, v3}, Lic/c$a;->d(Ljava/io/File;Z)V
    ...
    iget-object v0, v1, Lic/c$a;->k:Ljava/io/File;
    ...
    invoke-static {v12}, Lic/c$a;->e(Landroid/media/MediaMuxer;)V
    ...
    :goto_a
    :try_start_a
    invoke-virtual {v1, v0}, Lic/c$a;->b(Ljava/lang/Exception;)V
    :try_end_a
    .catchall {:try_start_a .. :try_end_a} :catchall_3

    :goto_b
    invoke-static {v10}, Lic/c$a;->e(Landroid/media/MediaMuxer;)V

    goto :goto_9

    :goto_c
    :try_start_b
    iget-object v2, v1, Lic/c$a;->e:Lic/b;

    if-eqz v2, :cond_c

    invoke-virtual {v2, v9}, Lic/b;->apply(I)Ljava/lang/Object;
    ...
    iget-object v1, v1, Lic/c$a;->h:Ljava/util/concurrent/ThreadPoolExecutor;
