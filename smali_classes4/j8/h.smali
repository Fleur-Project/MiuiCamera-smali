...
.method public constructor <init>(LAg/o;)V
    ...
    iput-object v2, v1, Lk8/a;->a:Lk8/b;

    iput-object v1, p0, Lj8/h;->b:Lk8/a;

    iput-object p1, p0, Lj8/h;->c:LAg/o;

    new-instance p0, Lj8/k;

    invoke-direct {p0}, Lj8/k;-><init>()V

    const-class p1, Lj8/k;
...
.method public final a(Ljava/lang/Class;[B)V
    ...
    :try_start_0
    iget-object v0, p0, Lj8/h;->a:Ljava/util/HashMap;
    ...
    :goto_0
    iget-object p0, p0, Lj8/h;->c:LAg/o;
    ...
    :cond_1
    invoke-virtual {p0, v3}, LAg/o;->b(I)V
    ...
    :cond_2
    :goto_1
    invoke-virtual {v0, p2}, Lj8/b;->h([B)V
    :try_end_0
