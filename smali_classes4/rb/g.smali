...
.field public d:Lrb/g$b;

.field public e:Lrb/g$d;

.field public f:Lrb/b;


# direct methods
.method public constructor <init>(Landroid/content/Context;LC/i3;LC/i3;LC/i3;Landroid/os/Bundle;)V
    .locals 3
    ...
    invoke-static {p1}, Lrb/g;->b(Landroid/content/Context;)I
    ...
    iput-object p1, p0, Lrb/g;->b:Landroid/content/Context;
    ...
    iput-object v0, p1, Lrb/g$b;->a:Landroid/os/Bundle;

    iput-object p1, p0, Lrb/g;->d:Lrb/g$b;

    iput-object p2, p1, Lrb/g$b;->b:LC/i3;

    iput-object p3, p1, Lrb/g$b;->c:LC/i3;

    iput-object p4, p1, Lrb/g$b;->d:LC/i3;
    ...
    invoke-static {v2, p1}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;LC/i3;LC/i3;LC/i3;Landroid/os/Bundle;)Lrb/g;
    .locals 7
    ...
    invoke-direct/range {v1 .. v6}, Lrb/g;-><init>(Landroid/content/Context;LC/i3;LC/i3;LC/i3;Landroid/os/Bundle;)V

    const-string p0, "Binding to service found in package: "

    iget-object p1, v1, Lrb/g;->a:Ljava/lang/String;

    const-string p2, "bind: E"

    sget-boolean p3, Lxb/b;->a:Z
    ...
    iget-object p2, v1, Lrb/g;->b:Landroid/content/Context;
    ...
    :try_start_0
    iput-boolean p4, v1, Lrb/g;->c:Z

    iget-object v2, v1, Lrb/g;->e:Lrb/g$d;

    const/4 v3, 0x5

    if-nez v2, :cond_2

    new-instance v2, Lrb/g$d;

    invoke-direct {v2, v1}, Lrb/g$d;-><init>(Lrb/g;)V
    ...
    iget-object v4, v1, Lrb/g;->a:Ljava/lang/String;
    ...
    iget-object p0, v1, Lrb/g;->b:Landroid/content/Context;
    ...
    iget-object p0, v1, Lrb/g;->a:Ljava/lang/String;
    ...
    :goto_4
    iget-object p0, v1, Lrb/g;->d:Lrb/g$b;

    iget-object p1, v1, Lrb/g;->a:Ljava/lang/String;

    new-instance p2, Ljava/lang/StringBuilder;

    const-string v2, "bind: client = "
    ...
    invoke-virtual {p0, p4}, Lrb/g$b;->s0(I)V
...
.method public final c()Lrb/b;
    ...
    iget-object p0, p0, Lrb/g;->f:Lrb/b;
...
.method public final d(Z)V
    ...
    iget-object v1, p0, Lrb/g;->a:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, Lrb/g;->e:Lrb/g$d;
    ...
    iget-object p1, p0, Lrb/g;->a:Ljava/lang/String;
    ...
    :cond_0
    iget-object v1, p0, Lrb/g;->d:Lrb/g$b;
    ...
    iput-object v2, v1, Lrb/g$b;->b:LC/i3;

    iput-object v2, v1, Lrb/g$b;->c:LC/i3;

    iput-object v2, v1, Lrb/g$b;->d:LC/i3;

    :cond_1
    iget-object v4, p0, Lrb/g;->f:Lrb/b;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    invoke-interface {v4, v1}, Lrb/b;->s(Lrb/c;)V
    :try_end_1
    ...
    iput-object v2, v1, Lrb/g$b;->a:Landroid/os/Bundle;

    iput-object v2, p0, Lrb/g;->d:Lrb/g$b;
    ...
    iget-object v1, p0, Lrb/g;->f:Lrb/b;
    :try_end_2
    ...
    iget-object v4, p0, Lrb/g;->e:Lrb/g$d;
    ...
    :catch_2
    :try_start_5
    iput-object v2, p0, Lrb/g;->e:Lrb/g$d;

    :cond_5
    iput-object v2, p0, Lrb/g;->f:Lrb/b;
...
.method public final e(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p0, p1}, Lrb/b;->q0(Lrb/c;Landroid/os/Bundle;)V
...
.method public final f(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p0, p1}, Lrb/b;->a(Lrb/c;Landroid/os/Bundle;)V
...
.method public final finalize()V
    ...
    :try_start_0
    invoke-virtual {p0, v2}, Lrb/g;->d(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
