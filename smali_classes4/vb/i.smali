...
.field public final v:Lvb/h;

.field public final w:Lvb/i$d;
...
.method public constructor <init>(Landroid/app/Application;B)V
    ...
    invoke-direct {p1, p0}, Lvb/h;-><init>(Lvb/i;)V

    iput-object p1, p0, Lvb/i;->v:Lvb/h;

    new-instance p1, Lvb/i$d;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lvb/i;->w:Lvb/i$d;

    const/4 p1, 0x2

    new-array p1, p1, [B

    iput-object p1, p0, Lvb/i;->u:[B
...
.method public final m()V
    ...
    invoke-direct {v0, p0}, Lvb/e$a;-><init>(Lvb/i;)V
    ...
    invoke-virtual {v1, v0, v2}, Lac/e$c;->a(LEf/e;LEf/e;)Lac/e$c$c;

    iget-object v0, p0, Lvb/e;->g:Lvb/e$c;

    iget-object v1, p0, Lvb/e;->f:Lvb/e$g;

    invoke-virtual {p0, v0, v1}, Lac/e;->a(LEf/e;LEf/e;)V
...
.method public final r()V
    ...
    new-instance v6, Lvb/i$b;

    invoke-direct {v6, p0}, Lvb/i$b;-><init>(Lvb/i;)V
    ...
    invoke-static {v9, v8}, LLf/d;->c(Ljava/lang/String;[Ljava/lang/Object;)Luc/c;
    ...
    invoke-direct {v10, v0, v5, v4, v9}, Luc/p;-><init>(Lcom/xiaomi/continuity/netbus/NetBusManager;Lcom/xiaomi/continuity/netbus/StartAdvertisingOptionsV2;[BLandroid/os/ResultReceiver;)V

    new-instance v4, Luc/q;

    invoke-direct {v4, v0, v8}, Luc/q;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v10, v0, v5, v4, v9}, Luc/r;-><init>(Lcom/xiaomi/continuity/netbus/NetBusManager;Lcom/xiaomi/continuity/netbus/StartAdvertisingOptionsV2;[BLandroid/os/ResultReceiver;)V
    ...
    invoke-direct {v0, v6, v4}, LC/B1;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v8, v0}, Luc/c;->d(Luc/c$b;)V

    new-instance v0, LC/C1;

    invoke-direct {v0, v6}, LC/C1;-><init>(Ljava/lang/Object;)V
...
.method public final t()V
    ...
    new-instance v4, Lvb/i$a;

    invoke-direct {v4, p0}, Lvb/i$a;-><init>(Lvb/i;)V

    invoke-virtual {v3, v4}, Luc/e;->b(Luc/d;)V

    iget-object v3, p0, Lvb/e;->n:Luc/e;

    iget-object v4, p0, Lvb/i;->v:Lvb/h;
    ...
    new-instance v8, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/o;

    const/4 v9, 0x3

    invoke-direct {v8, v4, v9}, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/o;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_1
    iget-object v3, p0, Lvb/i;->w:Lvb/i$d;
...
.method public final v()V
    ...
    :cond_0
    iget-object v3, p0, Lvb/i;->v:Lvb/h;
    ...
    invoke-direct {v4, v0}, Luc/z;-><init>(Lcom/xiaomi/continuity/netbus/d;)V
...
.method public final w()V
    ...
    sget-object v3, Lvb/e;->t:Ljava/lang/String;
    ...
    new-instance v5, Lvb/i$c;

    invoke-direct {v5, p0}, Lvb/i$c;-><init>(Lvb/i;)V
    ...
    invoke-static {v7, v6}, LLf/d;->c(Ljava/lang/String;[Ljava/lang/Object;)Luc/c;

    move-result-object v6

    invoke-virtual {v1, v6}, Lcom/xiaomi/continuity/netbus/NetBusManager;->a(Luc/c;)Landroid/os/ResultReceiver;

    move-result-object v7

    new-instance v8, Luc/o;

    invoke-direct {v8, v1, v4, v7}, Luc/o;-><init>(Ljava/lang/Object;Ljava/lang/Object;Landroid/os/Parcelable;)V

    new-instance v4, LBd/b;

    invoke-direct {v4, v1, v6}, LBd/b;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    iget-object v1, v1, Lcom/xiaomi/continuity/netbus/NetBusManager;->a:Lcom/xiaomi/continuity/netbus/d;

    invoke-virtual {v1, v8, v4}, Lcom/xiaomi/continuity/netbus/d;->c(Lcom/xiaomi/continuity/netbus/d$e;Lcom/xiaomi/continuity/netbus/d$d;)V

    new-instance v1, LN2/l;

    invoke-direct {v1, v5, v0}, LN2/l;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v6, v1}, Luc/c;->d(Luc/c$b;)V

    new-instance v1, LQ3/d;

    invoke-direct {v1, v5, v0}, LQ3/d;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v6, v1}, Luc/c;->c(Luc/c$a;)V
