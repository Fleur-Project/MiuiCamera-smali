...
# direct methods
.method public constructor <init>(Lwb/a;Ljava/net/Socket;)V
    .locals 3
    ...
    iput-object p1, p0, Lwb/a$f;->f:Lwb/a;
    ...
    iput-object v0, p0, Lwb/a$f;->a:Ljava/lang/String;

    iput-object p2, p0, Lwb/a$f;->b:Ljava/net/Socket;
    ...
    invoke-static {p0, p1}, Lxb/b;->b(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public static a(Lwb/a$f;)V
    .locals 4
    ...
    iget-object v1, p0, Lwb/a$f;->c:Ljava/io/OutputStream;
...
# virtual methods
.method public final b(Lwb/a$b;)Lwb/a$d;
    .locals 18
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    new-instance v3, Lwb/a$d;

    invoke-direct {v3, v1}, Lwb/a$d;-><init>(Lwb/a$b;)V

    iget-object v4, v0, Lwb/a$f;->f:Lwb/a;

    iget-object v4, v4, Lwb/a;->a:Ljava/util/HashMap;

    monitor-enter v4

    :try_start_0
    iget-object v5, v0, Lwb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v5, v0, Lwb/a$f;->f:Lwb/a;

    iget-object v5, v5, Lwb/a;->a:Ljava/util/HashMap;
    ...
    iget-object v10, v0, Lwb/a$f;->a:Ljava/lang/String;
    ...
    invoke-static {v9}, Lxb/b;->d(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v10, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iput-object v1, v3, Lwb/a$d;->c:Ljava/lang/String;
    ...
    iput-object v0, v3, Lwb/a$d;->b:Ljava/lang/String;

    const-string v0, "400 Bad Request"

    iput-object v0, v3, Lwb/a$d;->a:Ljava/lang/String;

    return-object v3

    :cond_2
    iget-object v4, v1, Lwb/a$b;->c:Ljava/util/HashMap;
    ...
    sget-object v4, Lwb/a;->l:Ljava/lang/String;

    iget-object v4, v0, Lwb/a$f;->f:Lwb/a;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v4, v1, Lwb/a$b;->a:Ljava/lang/String;
    ...
    iget-object v2, v0, Lwb/a$f;->f:Lwb/a;

    iget-object v1, v1, Lwb/a$b;->b:Ljava/lang/String;

    iget-object v4, v0, Lwb/a$f;->b:Ljava/net/Socket;
    ...
    :cond_3
    iput-object v1, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;

    iget-object v1, v0, Lwb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v4, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v1, v0, Lwb/a$f;->f:Lwb/a;

    iget-object v4, v1, Lwb/a;->a:Ljava/util/HashMap;
    ...
    iget-object v1, v1, Lwb/a;->a:Ljava/util/HashMap;

    iget-object v2, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v2}, Lnet/majorkernelpanic/streaming/Session;->getDestination()Ljava/lang/String;

    move-result-object v2

    iget-object v5, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v1, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v0, v0, Lwb/a$f;->b:Ljava/net/Socket;
    ...
    iput-object v0, v3, Lwb/a$d;->c:Ljava/lang/String;

    iput-object v1, v3, Lwb/a$d;->b:Ljava/lang/String;
    ...
    iget-object v8, v1, Lwb/a$b;->b:Ljava/lang/String;
    ...
    iget-object v8, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v1, v1, Lwb/a$b;->c:Ljava/util/HashMap;
    ...
    :goto_1
    iget-object v9, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v11, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v11}, Lnet/majorkernelpanic/streaming/Session;->getDestination()Ljava/lang/String;

    move-result-object v11

    iget-object v12, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v13, v0, Lwb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v13, v0, Lwb/a$f;->f:Lwb/a;
    ...
    :try_start_4
    sget-boolean v14, Lwb/a;->n:Z

    if-eqz v14, :cond_c

    iget-object v14, v0, Lwb/a$f;->f:Lwb/a;

    iget-object v15, v14, Lwb/a;->h:Landroid/media/MediaCodec;

    if-nez v15, :cond_a

    iget-object v14, v0, Lwb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v15, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-virtual {v14, v15, v2}, Lwb/a;->b(Landroid/content/SharedPreferences;Lnet/majorkernelpanic/streaming/video/VideoQuality;)V
    ...
    iget-object v2, v14, Lwb/a;->g:Lnet/majorkernelpanic/streaming/video/VideoQuality;

    iget-object v14, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v2, v0, Lwb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v13, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-static {v2, v4, v5}, Lwb/a;->a(Lwb/a;Lnet/majorkernelpanic/streaming/Session;I)V
    ...
    iget-object v0, v0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v2, v1, Lwb/a$b;->a:Ljava/lang/String;
    ...
    iget-object v2, v0, Lwb/a$f;->b:Ljava/net/Socket;
    ...
    invoke-static {v1, v2}, LC/R1;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v8}, Lxb/b;->d(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v0, v0, Lwb/a$f;->f:Lwb/a;

    iget-object v0, v0, Lwb/a;->f:Lcom/xiaomi/camera/rcs/service/RemoteControlService;

    if-eqz v0, :cond_22

    iget-object v1, v1, Lwb/a$b;->d:Ljava/lang/String;
    ...
    invoke-static {v7, v4, v2}, Landroid/util/Log;->println(ILjava/lang/String;Ljava/lang/String;)I
    ...
    sget-object v3, Lrb/h;->a:Ljava/lang/String;
    ...
    invoke-static {v7, v4, v1, v0}, Lxb/b;->e(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    iput-object v1, v2, Lwb/a$d;->c:Ljava/lang/String;
    ...
    iput-object v0, v2, Lwb/a$d;->b:Ljava/lang/String;
    ...
    iput-object v0, v2, Lwb/a$d;->a:Ljava/lang/String;
    ...
    iget-object v0, v0, Lwb/a$f;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lxb/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final run()V
    ...
    :try_start_0
    iget-object v6, p0, Lwb/a$f;->d:Ljava/io/BufferedReader;

    invoke-static {v6}, Lwb/a$b;->a(Ljava/io/BufferedReader;)Lwb/a$b;
    ...
    :catch_0
    iget-object v3, p0, Lwb/a$f;->a:Ljava/lang/String;

    const-string v6, "Unknown request from client"

    sget-boolean v7, Lxb/b;->a:Z

    invoke-static {v5, v3, v6}, Landroid/util/Log;->println(ILjava/lang/String;Ljava/lang/String;)I

    new-instance v3, Lwb/a$d;

    invoke-direct {v3}, Lwb/a$d;-><init>()V

    const-string v6, "400 Bad Request"

    iput-object v6, v3, Lwb/a$d;->a:Ljava/lang/String;

    :goto_1
    if-eqz v4, :cond_1

    :try_start_1
    invoke-virtual {p0, v4}, Lwb/a$f;->b(Lwb/a$b;)Lwb/a$d;
    ...
    iget-object v6, p0, Lwb/a$f;->a:Ljava/lang/String;
    ...
    :goto_2
    invoke-static {v6, v3}, Lxb/b;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v3, p0, Lwb/a$f;->f:Lwb/a;

    invoke-virtual {v3, v0}, Lwb/a;->e(I)V

    new-instance v3, Lwb/a$d;

    invoke-direct {v3, v4}, Lwb/a$d;-><init>(Lwb/a$b;)V

    :cond_1
    :goto_3
    if-gtz v2, :cond_2

    iget-object v4, p0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v2, p0, Lwb/a$f;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v6}, Lxb/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_3
    iget-object v4, p0, Lwb/a$f;->c:Ljava/io/OutputStream;

    invoke-virtual {v3, v4}, Lwb/a$d;->a(Ljava/io/OutputStream;)V
    ...
    :catch_2
    iget-object v0, p0, Lwb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v4, p0, Lwb/a$f;->a:Ljava/lang/String;

    const-string v6, "Read timed out "

    invoke-static {v3, v6}, LC/H;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    :goto_4
    iget-object v0, p0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v0}, Lnet/majorkernelpanic/streaming/Session;->isStreaming()Z

    move-result v0

    iget-object v1, p0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v0, p0, Lwb/a$f;->f:Lwb/a;

    iget-object v1, p0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-static {v0, v1, v5}, Lwb/a;->a(Lwb/a;Lnet/majorkernelpanic/streaming/Session;I)V

    :cond_6
    iget-object v0, p0, Lwb/a$f;->f:Lwb/a;

    iget-object v0, v0, Lwb/a;->a:Ljava/util/HashMap;

    monitor-enter v0

    :try_start_5
    iget-object v1, p0, Lwb/a$f;->f:Lwb/a;

    iget-object v1, v1, Lwb/a;->a:Ljava/util/HashMap;

    iget-object v2, p0, Lwb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    :try_start_6
    iget-object v0, p0, Lwb/a$f;->b:Ljava/net/Socket;
    ...
    :catch_5
    iget-object p0, p0, Lwb/a$f;->a:Ljava/lang/String;
