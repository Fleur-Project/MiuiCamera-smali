...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lzb/l;->h:Z

    const/4 v1, -0x1

    iput v1, p0, Lzb/l;->k:I

    iput v1, p0, Lzb/l;->l:I

    iput v1, p0, Lzb/l;->m:I

    iput v1, p0, Lzb/l;->n:I

    iput v1, p0, Lzb/l;->o:I

    const/4 v1, 0x1

    iput-boolean v1, p0, Lzb/l;->p:Z

    const-string v2, ""

    iput-object v2, p0, Lzb/l;->t:Ljava/lang/String;

    iput-object v2, p0, Lzb/l;->u:Ljava/lang/String;
    ...
    iput-object v2, p0, Lzb/l;->v:Ljava/text/SimpleDateFormat;

    iput-boolean v1, p0, Lzb/l;->w:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lzb/l;->x:J

    iput-boolean v0, p0, Lzb/l;->y:Z

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lzb/l;->z:Ljava/lang/Object;

    new-instance v0, Lzb/i;

    invoke-direct {v0}, Lzb/i;-><init>()V

    iput-object v0, p0, Lzb/l;->f:Lzb/i;

    new-instance v1, Lzb/m;

    invoke-direct {v1, p0}, Lzb/m;-><init>(Lzb/l;)V

    iput-object v1, v0, Lzb/i;->w:Lzb/o$b;

    new-instance v0, Lzb/l$a;

    invoke-direct {v0, p0}, Lzb/l$a;-><init>(Lzb/l;)V

    iput-object v0, p0, Lzb/l;->r:Lzb/l$a;
...
# virtual methods
.method public final b(Lzb/p;)V
    .locals 0

    invoke-super {p0, p1}, Lzb/b;->b(Lzb/p;)V

    iget-object p1, p0, Lzb/l;->f:Lzb/i;

    if-eqz p1, :cond_0

    iget-object p0, p0, Lzb/b;->e:Lzb/p;

    invoke-virtual {p1, p0}, Lzb/b;->b(Lzb/p;)V
...
.method public final c()Z
    ...
    iget-boolean v0, v0, Lzb/p;->v:Z

    if-eqz v0, :cond_0

    iget v0, p0, Lzb/l;->n:I
...
.method public final d()V
    ...
    iget-object v1, p0, Lzb/l;->f:Lzb/i;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lzb/i;->q()V
...
.method public final e(Lcom/android/camera/module/video/w;)V
    ...
    iput-boolean v4, p0, Lzb/l;->p:Z

    iget-object v5, p0, Lzb/l;->f:Lzb/i;
    ...
    invoke-virtual {v5, p1, v6, v7}, Lzb/i;->w(Lcom/android/camera/module/video/w;J)V
    ...
    invoke-virtual {p1, v0, v1, v5, v6}, LCb/c;->m(JJ)V
    ...
    :cond_2
    iget-object p1, p0, Lzb/b;->e:Lzb/p;

    iget-boolean p1, p1, Lzb/p;->v:Z

    if-eqz p1, :cond_4

    iget p1, p0, Lzb/l;->s:I

    if-lez p1, :cond_4

    iget-boolean p1, p0, Lzb/l;->y:Z
    ...
    iget-object v0, p0, Lzb/l;->z:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lzb/l;->g:Landroid/media/MediaMuxer;
    ...
    invoke-static {v2, v3, v0, p1}, LC/L;->d(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
