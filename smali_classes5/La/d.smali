...
.field public c0:LLa/c;

.field public final d:I

.field public d0:LLa/b;
...
# direct methods
.method public constructor <init>(IIZIIIILandroid/os/Handler;LLa/i$c;)V
    .locals 23
    ...
    iput-object v9, v0, LLa/d;->y:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, LLa/d;->A:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, LLa/d;->C:Ljava/util/ArrayList;

    const/16 v9, 0x10

    new-array v9, v9, [F

    iput-object v9, v0, LLa/d;->f0:[F
    ...
    iput-object v9, v0, LLa/d;->g0:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v7, v0, LLa/d;->a:Ljava/lang/String;

    const/16 v9, 0x200

    iput v9, v0, LLa/d;->b:I

    iput v9, v0, LLa/d;->c:I

    const/16 v11, 0x20

    iput v11, v0, LLa/d;->d:I

    const-wide/high16 v11, 0x3fd0000000000000L    # 0.25

    iput-wide v11, v0, LLa/d;->e:D
    ...
    iget-object v9, v0, LLa/d;->a:Ljava/lang/String;
    ...
    iput-object v7, v0, LLa/d;->f:Landroid/media/MediaCodec;
    ...
    :cond_1
    iget-object v7, v0, LLa/d;->f:Landroid/media/MediaCodec;

    invoke-virtual {v7}, Landroid/media/MediaCodec;->release()V

    iput-object v14, v0, LLa/d;->f:Landroid/media/MediaCodec;
    ...
    :catch_0
    sget-object v7, LLa/f;->h0:Landroid/media/MediaCodecList;
    ...
    iget v8, v0, LLa/d;->b:I

    if-gt v1, v8, :cond_8

    iget v8, v0, LLa/d;->c:I
    ...
    sget-object v7, LLa/a;->h0:Landroid/media/MediaCodecList;
    ...
    :goto_c
    iput v4, v0, LLa/d;->j:I

    move-object/from16 v9, p9

    iput-object v9, v0, LLa/d;->h:LLa/i$c;
    ...
    iput-object v9, v0, LLa/d;->i:Landroid/os/Handler;
    ...
    :goto_11
    iput-boolean v4, v0, LLa/d;->H:Z

    iput v1, v0, LLa/d;->k:I

    iput v2, v0, LLa/d;->l:I

    iput-boolean v8, v0, LLa/d;->r:Z

    if-eqz v8, :cond_19

    iget v9, v0, LLa/d;->b:I

    move/from16 v16, v4

    iget v4, v0, LLa/d;->c:I
    ...
    iput v1, v0, LLa/d;->m:I

    iput v2, v0, LLa/d;->n:I

    const/4 v4, 0x1

    iput v4, v0, LLa/d;->o:I

    iput v4, v0, LLa/d;->p:I

    goto :goto_15

    :cond_1e
    iput v9, v0, LLa/d;->m:I

    iput v4, v0, LLa/d;->n:I

    iput v8, v0, LLa/d;->o:I

    iput v7, v0, LLa/d;->p:I

    :goto_15
    iget v4, v0, LLa/d;->o:I

    iget v5, v0, LLa/d;->p:I

    mul-int/2addr v4, v5

    iput v4, v0, LLa/d;->q:I
    ...
    :goto_18
    iput-object v12, v0, LLa/d;->g:Landroid/media/MediaFormat;

    new-instance v1, Landroid/graphics/Rect;

    iget v2, v0, LLa/d;->m:I

    iget v3, v0, LLa/d;->n:I

    const/4 v8, 0x0

    invoke-direct {v1, v8, v8, v2, v3}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v1, v0, LLa/d;->w:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, v0, LLa/d;->u:Landroid/graphics/Rect;
...
.method public final a([B)V
    ...
    iget-object v0, p0, LLa/d;->y:Ljava/util/ArrayList;
    ...
    :goto_0
    :try_start_0
    iget-boolean v1, p0, LLa/d;->t:Z

    if-nez v1, :cond_0

    iget-object v1, p0, LLa/d;->y:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, LLa/d;->A:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_3
    iget-object v0, p0, LLa/d;->A:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, LLa/d;->i:Landroid/os/Handler;
...
.method public final b()V
    ...
    iget v1, p0, LLa/d;->m:I

    iget v2, p0, LLa/d;->n:I
    ...
    iget-object v9, p0, LLa/d;->u:Landroid/graphics/Rect;

    invoke-virtual {v9, v5, v6, v7, v8}, Landroid/graphics/Rect;->set(IIII)V

    :try_start_0
    iget-object v5, p0, LLa/d;->d0:LLa/b;

    iget v6, p0, LLa/d;->e0:I

    sget-object v7, LLa/h;->h:[F

    invoke-virtual {v5, v6, v7, v9}, LLa/b;->a(I[FLandroid/graphics/Rect;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v5, p0, LLa/d;->c0:LLa/c;

    iget v6, p0, LLa/d;->s:I

    add-int/lit8 v7, v6, 0x1

    iput v7, p0, LLa/d;->s:I
    ...
    iget-object v8, v5, LLa/c;->a:Landroid/opengl/EGLDisplay;

    iget-object v5, v5, LLa/c;->c:Landroid/opengl/EGLSurface;
    ...
    iget-object v6, v5, LLa/c;->a:Landroid/opengl/EGLDisplay;
    ...
    iget-object p0, p0, LLa/d;->g0:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c()V
    ...
    :cond_0
    :goto_0
    iget-boolean v1, v0, LLa/d;->t:Z

    const/4 v3, 0x0

    if-nez v1, :cond_2

    iget-object v1, v0, LLa/d;->x:Ljava/nio/ByteBuffer;

    if-nez v1, :cond_2

    iget-object v1, v0, LLa/d;->A:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object v4, v0, LLa/d;->A:Ljava/util/ArrayList;
    ...
    :goto_1
    iput-object v4, v0, LLa/d;->x:Ljava/nio/ByteBuffer;
    ...
    iget-object v4, v0, LLa/d;->C:Ljava/util/ArrayList;
    ...
    iget v4, v0, LLa/d;->s:I

    iget v5, v0, LLa/d;->q:I
    ...
    iget-object v8, v0, LLa/d;->f:Landroid/media/MediaCodec;

    invoke-virtual {v8, v6}, Landroid/media/MediaCodec;->getInputImage(I)Landroid/media/Image;

    move-result-object v8

    iget v9, v0, LLa/d;->m:I

    iget v10, v0, LLa/d;->s:I

    iget v11, v0, LLa/d;->p:I

    rem-int v12, v10, v11

    mul-int/2addr v12, v9

    iget v13, v0, LLa/d;->n:I

    div-int/2addr v10, v11

    iget v11, v0, LLa/d;->o:I

    rem-int/2addr v10, v11

    mul-int/2addr v10, v13

    iget-object v11, v0, LLa/d;->u:Landroid/graphics/Rect;
    ...
    iget v9, v0, LLa/d;->k:I

    iget v10, v0, LLa/d;->l:I

    iget-object v11, v0, LLa/d;->u:Landroid/graphics/Rect;

    iget-object v12, v0, LLa/d;->w:Landroid/graphics/Rect;
    ...
    :goto_b
    iget-object v5, v0, LLa/d;->f:Landroid/media/MediaCodec;
    ...
    :goto_c
    iget v1, v0, LLa/d;->s:I

    add-int/lit8 v2, v1, 0x1

    iput v2, v0, LLa/d;->s:I
    ...
    :cond_11
    iget-object v1, v0, LLa/d;->y:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_1
    iget-boolean v2, v0, LLa/d;->t:Z

    or-int v2, v2, v20

    iput-boolean v2, v0, LLa/d;->t:Z

    iget-object v2, v0, LLa/d;->y:Ljava/util/ArrayList;

    iget-object v3, v0, LLa/d;->x:Ljava/nio/ByteBuffer;
    ...
    iput-object v1, v0, LLa/d;->x:Ljava/nio/ByteBuffer;
...
.method public final close()V
    ...
    iget-object v0, p0, LLa/d;->i:Landroid/os/Handler;
...
.method public final d()V
    ...
    iget-object v1, p0, LLa/d;->g0:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_0
    iget-object v3, p0, LLa/d;->f:Landroid/media/MediaCodec;
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, LLa/d;->f:Landroid/media/MediaCodec;
    ...
    :try_start_2
    iput-boolean v2, p0, LLa/d;->t:Z

    iget-object v2, p0, LLa/d;->y:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v0, p0, LLa/d;->d0:LLa/b;

    if-eqz v0, :cond_1

    iget-object v2, v0, LLa/b;->e:LLa/h;

    if-eqz v2, :cond_1

    iput-object v1, v0, LLa/b;->e:LLa/h;
    :try_end_3
    ...
    :cond_1
    :try_start_4
    iput-object v1, p0, LLa/d;->d0:LLa/b;
    ...
    :goto_3
    :try_start_5
    iget-object v0, p0, LLa/d;->c0:LLa/c;
    ...
    :goto_4
    :try_start_6
    iput-object v1, p0, LLa/d;->c0:LLa/c;
    ...
    :goto_6
    :try_start_7
    iget-object v0, p0, LLa/d;->Q:Landroid/graphics/SurfaceTexture;
    ...
    :goto_7
    :try_start_8
    iput-object v1, p0, LLa/d;->Q:Landroid/graphics/SurfaceTexture;
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    :cond_0
    iget-object v1, v0, LLa/c;->a:Landroid/opengl/EGLDisplay;

    iget-object v2, v0, LLa/c;->c:Landroid/opengl/EGLSurface;

    iget-object v0, v0, LLa/c;->b:Landroid/opengl/EGLContext;
    ...
    iget-object v2, p0, LLa/d;->M:LLa/d$e;

    iget v3, p0, LLa/d;->s:I

    iget v4, p0, LLa/d;->q:I
    ...
    :cond_3
    :goto_1
    iput-wide v0, v2, LLa/d$e;->c:J

    invoke-virtual {v2}, LLa/d$e;->a()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    invoke-virtual {p0}, LLa/d;->b()V

    :cond_4
    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->releaseTexImage()V

    iget-object p1, p0, LLa/d;->c0:LLa/c;

    iget-object p1, p1, LLa/c;->a:Landroid/opengl/EGLDisplay;
