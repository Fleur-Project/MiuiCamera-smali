...
.method public final run()V
    ...
    invoke-interface {v9}, Lcom/android/camera/module/M;->getModuleState()Lu3/g;

    move-result-object v9

    invoke-interface {v9}, Lu3/g;->isDeparted()Z
    ...
    iget-object v6, v1, LOa/y;->c:Lic/c;

    if-nez v6, :cond_2

    new-instance v6, Lic/c;

    invoke-direct {v6, v3, v4, v5}, Lic/c;-><init>(ZLandroid/media/MediaFormat;Landroid/media/MediaFormat;)V

    iput-object v6, v1, LOa/y;->c:Lic/c;

    :cond_2
    iget-object v3, v1, LOa/y;->c:Lic/c;
    ...
    iput p0, v3, Lic/c;->d:I

    iget-object p0, v1, LOa/y;->c:Lic/c;

    invoke-virtual {p0}, Lic/c;->b()V
    :try_end_3
