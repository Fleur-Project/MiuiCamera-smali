...
.method public final c(LQa/c$b;JZ)V
    ...
    iget-object v0, p0, LQa/c;->s:LUe/d;

    if-eqz v0, :cond_10

    iget-object v0, v0, LUe/d;->y:LOe/i;
    ...
    iget-object v3, v0, LQa/b;->b:Landroid/opengl/EGLSurface;

    iget-object v0, v0, LQa/b;->a:LQa/a;
    ...
    iget-object p3, p0, LQa/c;->s:LUe/d;

    iget-object v0, p0, LQa/c;->o:Landroid/graphics/Rect;

    iget-object p3, p3, LUe/d;->z:Landroid/graphics/RectF;
    ...
    invoke-virtual {p3, v0, v3}, LUe/d;->g(II)V
    ...
    invoke-virtual {p3, v0, v8, v3}, LUe/d;->b(Landroid/hardware/HardwareBuffer;LSe/b;Z)V
    ...
    iget-object v3, p0, LQa/c;->s:LUe/d;
    ...
    invoke-virtual/range {v3 .. v8}, LUe/d;->k(Ljava/util/ArrayList;Landroid/util/Size;Landroid/graphics/Rect;ILSe/b;)V
    ...
    invoke-virtual {p3, v0, v3}, LUe/d;->i(Ljava/util/ArrayList;Landroid/util/Size;)V
    ...
    iput-object v0, p3, LUe/d;->x:LTe/h;

    invoke-virtual {p3, v8, p4}, LUe/d;->h(LSe/b;Z)V
    ...
    :cond_e
    iget-object p2, p0, LQa/c;->s:LUe/d;

    iget-wide p2, p2, LUe/d;->r:J
...
.method public final e()V
    ...
    invoke-direct/range {v1 .. v6}, LUe/d;-><init>(Landroid/content/Context;Landroid/os/Handler;ZZZ)V

    iput-object v1, p0, LQa/c;->s:LUe/d;
...
.method public final g()V
    ...
    iget-object v1, p0, LQa/c;->s:LUe/d;
    ...
    iput-object v4, v1, LUe/d;->y:LOe/i;

    iget-object v4, v1, LUe/d;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v6, v7}, LA2/q;-><init>(I)V
    ...
    :cond_0
    iget-object v4, v1, LUe/d;->d:LZe/f;

    if-eqz v4, :cond_1

    invoke-virtual {v4}, LZe/f;->d()V

    iput-object v2, v1, LUe/d;->d:LZe/f;

    :cond_1
    iget-object v4, v1, LUe/d;->f:LZe/p;

    if-eqz v4, :cond_2

    invoke-virtual {v4}, LZe/p;->d()V

    iput-object v2, v1, LUe/d;->f:LZe/p;

    :cond_2
    iget-object v4, v1, LUe/d;->e:LZe/H;

    if-eqz v4, :cond_3

    invoke-virtual {v4}, LZe/H;->d()V

    iput-object v2, v1, LUe/d;->e:LZe/H;

    :cond_3
    iget-object v4, v1, LUe/d;->c:Ljava/util/ArrayList;
    ...
    invoke-direct {v6, v7}, LA2/r;-><init>(I)V
    ...
    :cond_4
    iget-object v4, v1, LUe/d;->a:LZe/u;

    if-eqz v4, :cond_5

    invoke-virtual {v4}, LZe/u;->a()V

    :cond_5
    iget-object v4, v1, LUe/d;->w:LXe/a;

    if-eqz v4, :cond_6

    invoke-virtual {v4}, LXe/a;->d()V

    iput-object v2, v1, LUe/d;->w:LXe/a;

    :cond_6
    iget-object v4, v1, LUe/d;->h:LPe/a;
    ...
    :cond_7
    iget-object v4, v1, LUe/d;->j:LPe/a;

    if-eqz v4, :cond_8

    invoke-virtual {v4}, LPe/a;->c()V

    iput-object v2, v1, LUe/d;->j:LPe/a;

    :cond_8
    iget-object v4, v1, LUe/d;->i:LPe/a;

    if-eqz v4, :cond_9

    invoke-virtual {v4}, LPe/a;->c()V

    iput-object v2, v1, LUe/d;->i:LPe/a;

    :cond_9
    iget-object v4, v1, LUe/d;->n:[I
    ...
    iput-object v2, p0, LQa/c;->s:LUe/d;
    ...
    iget-object v1, v1, LQa/b;->a:LQa/a;
    ...
    iget-object v4, v1, LQa/b;->b:Landroid/opengl/EGLSurface;

    iget-object v5, v1, LQa/b;->a:LQa/a;
    ...
    iput-object v4, v1, LQa/b;->b:Landroid/opengl/EGLSurface;
...
.method public final k()V
    ...
    iget-object v2, v1, LQa/b;->b:Landroid/opengl/EGLSurface;

    iget-object v4, v1, LQa/b;->a:LQa/a;
    ...
    iput-object v2, v1, LQa/b;->b:Landroid/opengl/EGLSurface;
