...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v4, LHa/c;->SignatureView:[I

    invoke-virtual {p1, p2, v4}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, LHa/c;->SignatureView_sv_hint_text_size:I
    ...
    sget p2, LHa/c;->SignatureView_sv_hint_text_color:I
    ...
    sget p2, LHa/c;->SignatureView_sv_hint_text:I
    ...
    invoke-static {p1}, LEg/V;->g(Landroid/content/Context;)Z
    ...
    invoke-static {p2, v1}, LEg/V;->b(Landroid/content/Context;I)I
    ...
    iput-object v1, p1, LJa/b;->a:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p1, LJa/b;->b:Ljava/util/ArrayList;

    new-instance v1, LIa/a;

    const/4 v2, 0x0

    invoke-direct {v1, v2, v2}, LIa/a;-><init>(FF)V

    iput-object v1, p1, LJa/b;->f:LIa/a;
    ...
    iput-object v2, v1, LJa/a;->a:LIa/a;

    new-instance v2, LIa/a;

    invoke-direct {v2}, LIa/a;-><init>()V

    iput-object v2, v1, LJa/a;->b:LIa/a;

    new-instance v2, LIa/a;

    invoke-direct {v2}, LIa/a;-><init>()V

    iput-object v2, v1, LJa/a;->c:LIa/a;

    new-instance v2, LIa/a;

    invoke-direct {v2}, LIa/a;-><init>()V

    iput-object v2, v1, LJa/a;->d:LIa/a;

    iput-object v1, p1, LJa/b;->g:LJa/a;

    iput v0, p1, LJa/b;->j:I
    ...
    :cond_1
    iput-object p2, p1, LJa/b;->c:Landroid/graphics/Paint;

    invoke-virtual {p2}, Landroid/graphics/Paint;->getStrokeWidth()F

    move-result p2

    iput p2, p1, LJa/b;->d:F

    new-instance p2, Landroid/graphics/RectF;

    invoke-direct {p2}, Landroid/graphics/RectF;-><init>()V

    iput-object p2, p1, LJa/b;->k:Landroid/graphics/RectF;

    iput-object p1, p0, Lcom/xiaomi/camera/hand/signature/SignatureView;->d:LJa/b;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p2

    iput-object p2, p1, LJa/b;->h:Landroid/content/Context;

    invoke-virtual {p0}, Landroid/view/View;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget p2, LHa/b;->signature_dialog_signature_view_height:I
...
.method public getPenColor()I
    ...
    sget-object v0, LHa/d;->b:LHa/d;

    iget v0, v0, LHa/d;->a:I
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/xiaomi/camera/hand/signature/SignatureView;->p:LHa/e;

    if-eqz v0, :cond_4

    invoke-interface {v0}, LHa/e;->b()V
    ...
    iget-object p1, p0, Lcom/xiaomi/camera/hand/signature/SignatureView;->d:LJa/b;

    iget-object p1, p1, LJa/b;->b:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lcom/xiaomi/camera/hand/signature/SignatureView;->p:LHa/e;

    if-eqz p1, :cond_6

    invoke-interface {p1}, LHa/e;->a()V
    ...
    invoke-virtual {p1, p0}, LJa/b;->a(Landroid/graphics/Canvas;)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, v0, Lcom/xiaomi/camera/hand/signature/SignatureView;->d:LJa/b;
    ...
    iput v7, v5, LIa/b;->a:F

    iput v8, v5, LIa/b;->b:F

    iput-wide v9, v5, LIa/b;->c:J

    iget-object v11, v1, LJa/b;->a:Ljava/util/ArrayList;

    invoke-virtual {v11, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v12, v1, LJa/b;->b:Ljava/util/ArrayList;

    iget-object v13, v1, LJa/b;->g:LJa/a;
    ...
    iget-object v2, v1, LJa/b;->f:LIa/a;

    iget-wide v3, v2, LIa/a;->d:J
    ...
    invoke-direct {v3, v4, v8}, LIa/a;-><init>(FF)V

    iput-wide v9, v3, LIa/a;->d:J

    iget v5, v2, LIa/a;->a:F

    sub-float/2addr v4, v5

    float-to-double v4, v4

    iget v2, v2, LIa/a;->b:F
    ...
    iput-wide v8, v1, LJa/b;->i:D

    iget v2, v1, LJa/b;->d:F
    ...
    iput v2, v3, LIa/a;->c:F

    invoke-virtual {v13}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v2, v3, LIa/a;->a:F

    iget v6, v3, LIa/a;->b:F

    iget v7, v3, LIa/a;->c:F

    iget-object v8, v13, LJa/a;->a:LIa/a;

    iget-object v9, v13, LJa/a;->c:LIa/a;

    invoke-virtual {v8}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v10, v9, LIa/a;->a:F

    iget v11, v9, LIa/a;->b:F

    iget v15, v9, LIa/a;->c:F

    invoke-virtual {v8, v10, v11, v15}, LIa/a;->a(FFF)V

    iget-object v8, v13, LJa/a;->b:LIa/a;

    iget-object v10, v13, LJa/a;->d:LIa/a;

    invoke-virtual {v8}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v11, v10, LIa/a;->a:F

    iget v15, v10, LIa/a;->b:F

    move/from16 v21, v14

    iget v14, v10, LIa/a;->c:F

    invoke-virtual {v8, v11, v15, v14}, LIa/a;->a(FFF)V

    iget v8, v10, LIa/a;->a:F

    invoke-static {v8, v2}, LJa/a;->a(FF)F

    move-result v8

    iget v11, v10, LIa/a;->b:F

    invoke-static {v11, v6}, LJa/a;->a(FF)F

    move-result v11

    iget v14, v10, LIa/a;->c:F

    invoke-static {v14, v7}, LJa/a;->a(FF)F

    move-result v14

    invoke-virtual {v9, v8, v11, v14}, LIa/a;->a(FFF)V

    invoke-virtual {v10, v2, v6, v7}, LIa/a;->a(FFF)V
    ...
    invoke-virtual {v13, v6, v7}, LJa/a;->b(D)LIa/a;
    ...
    :cond_3
    iput-object v3, v1, LJa/b;->f:LIa/a;
    ...
    invoke-direct {v4}, LIa/b;-><init>()V

    new-instance v6, LIa/b;

    invoke-direct {v6}, LIa/b;-><init>()V
    ...
    iget v8, v4, LIa/b;->a:F

    iget v9, v6, LIa/b;->a:F

    cmpl-float v8, v8, v9

    if-nez v8, :cond_6

    iget v8, v4, LIa/b;->b:F

    iget v9, v6, LIa/b;->b:F
    ...
    :cond_6
    :goto_3
    iget v7, v4, LIa/b;->a:F

    iget v8, v6, LIa/b;->a:F
    ...
    iget v4, v4, LIa/b;->b:F

    iget v6, v6, LIa/b;->b:F
    ...
    iget-object v11, v1, LJa/b;->h:Landroid/content/Context;

    const/4 v14, 0x7

    invoke-static {v11, v14}, LEg/V;->b(Landroid/content/Context;I)I

    move-result v11

    int-to-float v11, v11

    iget-object v14, v1, LJa/b;->f:LIa/a;

    iget v14, v14, LIa/a;->c:F

    iget v15, v1, LJa/b;->d:F
    ...
    iget v5, v5, LIa/b;->b:F

    if-nez v7, :cond_a

    cmpl-float v4, v22, v8
    ...
    :goto_7
    iget-object v3, v1, LJa/b;->f:LIa/a;

    iget v3, v3, LIa/a;->c:F
    ...
    iget-object v4, v13, LJa/a;->a:LIa/a;

    iget-object v6, v13, LJa/a;->c:LIa/a;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v8, v6, LIa/a;->a:F

    iget v9, v6, LIa/a;->b:F

    iget v10, v6, LIa/a;->c:F

    invoke-virtual {v4, v8, v9, v10}, LIa/a;->a(FFF)V

    iget-object v4, v13, LJa/a;->b:LIa/a;

    iget-object v8, v13, LJa/a;->d:LIa/a;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v9, v8, LIa/a;->a:F

    iget v10, v8, LIa/a;->b:F

    iget v14, v8, LIa/a;->c:F

    invoke-virtual {v4, v9, v10, v14}, LIa/a;->a(FFF)V

    iget v4, v8, LIa/a;->a:F

    invoke-static {v4, v7}, LJa/a;->a(FF)F

    move-result v4

    iget v9, v8, LIa/a;->b:F

    invoke-static {v9, v5}, LJa/a;->a(FF)F

    move-result v9

    invoke-virtual {v6, v4, v9, v3}, LIa/a;->a(FFF)V

    invoke-virtual {v8, v7, v5, v3}, LIa/a;->a(FFF)V
    ...
    :cond_10
    invoke-virtual {v1, v2}, LJa/b;->a(Landroid/graphics/Canvas;)V

    iget-object v1, v1, LJa/b;->b:Ljava/util/ArrayList;
    ...
    iput v4, v1, LJa/b;->j:I

    invoke-virtual {v12}, Ljava/util/ArrayList;->clear()V

    new-instance v2, LIa/a;

    iget v4, v1, LJa/b;->d:F

    invoke-direct {v2, v3, v8, v4}, LIa/a;-><init>(FFF)V

    iput-wide v9, v2, LIa/a;->d:J

    iput-object v2, v1, LJa/b;->e:LIa/a;

    iput-object v2, v1, LJa/b;->f:LIa/a;

    invoke-virtual {v13}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v3, v2, LIa/a;->a:F

    iget v4, v2, LIa/a;->b:F

    iget v2, v2, LIa/a;->c:F

    iget-object v5, v13, LJa/a;->a:LIa/a;

    invoke-virtual {v5, v3, v4, v2}, LIa/a;->a(FFF)V

    invoke-static {v3, v3}, LJa/a;->a(FF)F

    move-result v5

    invoke-static {v4, v4}, LJa/a;->a(FF)F

    move-result v6

    invoke-static {v2, v2}, LJa/a;->a(FF)F

    move-result v7

    iget-object v8, v13, LJa/a;->c:LIa/a;

    invoke-virtual {v8, v5, v6, v7}, LIa/a;->a(FFF)V

    invoke-static {v3, v5}, LJa/a;->a(FF)F

    move-result v5

    invoke-static {v4, v6}, LJa/a;->a(FF)F

    move-result v6

    invoke-static {v2, v7}, LJa/a;->a(FF)F
    ...
    iget-object v5, v13, LJa/a;->d:LIa/a;

    invoke-virtual {v5, v3, v4, v2}, LIa/a;->a(FFF)V

    const-wide/16 v2, 0x0

    iput-wide v2, v1, LJa/b;->i:D
    ...
    iput-boolean v2, v0, Lcom/xiaomi/camera/hand/signature/SignatureView;->i:Z
...
.method public setPenSize(F)V
    ...
    :cond_1
    iput-object p0, p1, LJa/b;->c:Landroid/graphics/Paint;

    invoke-virtual {p0}, Landroid/graphics/Paint;->getStrokeWidth()F

    move-result p0

    iput p0, p1, LJa/b;->d:F

    return-void
.end method

.method public setSignatureStateListener(LHa/e;)V
    .locals 0

    iput-object p1, p0, Lcom/xiaomi/camera/hand/signature/SignatureView;->p:LHa/e;
