...
.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;LS9/q;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;LS9/q;)V
...
.method private doJpeg(LS9/q;Landroid/media/Image;I)V
    .locals 9
    ...
    invoke-static {v1, v2, p3}, LC/W1;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(LS9/q;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
...
.method private generateReprocessData(LS9/q;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 17
    ...
    invoke-static {v2, v4}, Lt9/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v2

    iget-boolean v7, v13, LS9/r;->J:Z

    iget-object v8, v13, LS9/r;->M:Landroid/util/Size;

    invoke-virtual {v8}, Landroid/util/Size;->getWidth()I

    move-result v8

    iget-object v9, v13, LS9/r;->M:Landroid/util/Size;
    ...
    iget-object v5, v1, LS9/q;->K:Landroid/media/Image;
    ...
    iget-object v3, v1, LS9/q;->K:Landroid/media/Image;
    ...
    invoke-virtual {v2, v3, v4}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setRawInputSize(II)V
    ...
    iget-object v0, v1, LS9/q;->W:Ljava/lang/String;
...
.method private handTimeoutTask(J)V
    ...
    invoke-static {p1, p2, v1, v2}, LC/u3;->e(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p2, v0}, LN3/l;->c(Ljava/lang/String;)J

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;->getTimestamp()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)LS9/q;
    ...
    :cond_1
    iget-wide v0, p2, LS9/q;->b0:J

    iget-object v2, p2, LS9/q;->W:Ljava/lang/String;

    iget-wide v3, p2, LS9/q;->e:J
    ...
    invoke-static {v0}, Lt9/e;->h(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v1, v0}, LS9/q;->a(I[B)V
    ...
    invoke-static {v1, v2, v3}, LC/W1;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-object v0, p2, LS9/q;->K:Landroid/media/Image;
    ...
    invoke-direct {p0, v2, p2, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;LS9/q;I)V
    ...
    invoke-direct {p0, p2, v1, v2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(LS9/q;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2, p1}, LS9/q;->a(I[B)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(LS9/q;Ljava/lang/String;)V
...
.method private static synthetic lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;LS9/q;)V
    .locals 0

    invoke-virtual {p2}, LS9/q;->c()I
...
.method private postCvWaterMark(Landroid/media/Image;LS9/q;I)V
    .locals 4
    ...
    invoke-static {p1, v2}, Lt9/e;->g(Landroid/media/Image;Z)[B

    move-result-object v2

    const-string v3, ""

    invoke-static {p3, v3}, LC/M;->e(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v3, p1}, LC/L;->d(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, LC/W1;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public getParallelTaskData(J)LS9/q;
    .locals 3
...
.method public getParallelTaskSize()Ljava/lang/String;
    ...
    new-instance v4, Lcom/android/camera2/compat/theme/custom/mm/manually/y;

    const/4 v5, 0x1

    invoke-direct {v4, v1, v5}, Lcom/android/camera2/compat/theme/custom/mm/manually/y;-><init>(Ljava/io/Serializable;I)V
...
.method public putParallelTaskData(JLS9/q;)V
    .locals 5
