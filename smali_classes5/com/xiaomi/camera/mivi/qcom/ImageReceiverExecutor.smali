...
.method private static dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;LS9/q;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p1, p1, LS9/q;->W:Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, Lt9/e;->d(Landroid/media/Image;Ljava/lang/String;Ljava/lang/String;)Z

    :cond_0
    return-void
.end method

.method private getParallelTaskData(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;ZLjava/lang/String;)LS9/q;
    .locals 11
    ...
    invoke-static {v0, v1, v2, p2}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)LS9/q;
    ...
    invoke-virtual {v0, v1, v3}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->readParallelTaskDataFromSmallJpeg(Landroid/content/Context;Ljava/lang/String;)LS9/q;
    ...
    invoke-static {p0}, Ln4/z;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p0, v5, LS9/q;->h:Landroid/hardware/camera2/TotalCaptureResult;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getPictureName()Ljava/lang/String;

    move-result-object p0

    iput-object p0, v5, LS9/q;->W:Ljava/lang/String;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getFrameNumber()J

    move-result-wide v6

    iput-wide v6, v5, LS9/q;->b0:J
    ...
    iput-object p2, p0, LS9/r;->Q:Lx9/f;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getOutputSize()Landroid/util/Size;

    move-result-object p1

    iput-object p1, p0, LS9/r;->M:Landroid/util/Size;

    iput-object p0, v5, LS9/q;->r:LS9/r;

    iput-boolean v1, v5, LS9/q;->m0:Z
    ...
    iput-boolean v1, v0, LS9/q;->m0:Z

    :cond_2
    return-object v0
.end method

.method private initReprocessProxy(LS9/q;ZLjava/lang/String;)V
    .locals 2
    ...
    invoke-static {p3, p0}, LC/F;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p3, p1}, LC/F;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private lambda$startReprocessLoop$1()V
    ...
    invoke-static {v6, v7}, Lq0/b;->M(ILjava/lang/String;)V
    ...
    :goto_2
    invoke-direct {p0, v3, v5, v4}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->getParallelTaskData(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;ZLjava/lang/String;)LS9/q;
    ...
    iput v7, v5, LS9/q;->v0:I

    invoke-virtual {v3, v5}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->setParallelTaskData(LS9/q;)V
    ...
    sget-boolean v7, Lt9/e;->d:Z

    if-eqz v7, :cond_8

    const-string v7, "algo_done"

    invoke-static {v3, v5, v7}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;LS9/q;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5, v6, v4}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->initReprocessProxy(LS9/q;ZLjava/lang/String;)V
