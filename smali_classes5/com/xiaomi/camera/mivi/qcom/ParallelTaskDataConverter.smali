...
.method private createParallelTaskData(Landroid/content/Context;Lorg/json/JSONObject;)LS9/q;
    .locals 3

    :try_start_0
    const-class v0, LS9/q;
...
.method private dataToJsonRecursiveCallCheck(Ljava/util/ArrayList;Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {v4, p1}, LC/R1;->e(ILjava/util/ArrayList;)Ljava/lang/Object;
...
.method private generateJpegWithXmp([BLcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;)[B
    ...
    :try_start_0
    iget-object v6, v3, Llb/b;->a:Ljava/util/HashMap;
    ...
    .catch Lj/c; {:try_start_1 .. :try_end_1} :catch_0
    ...
    :try_start_3
    invoke-static {p2}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;->b(Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;)Lj/d;
    ...
    invoke-virtual {v1, v4, v5, v6}, Lk/k;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_0
    :goto_0
    invoke-static {v3, p1, v1}, Lw6/b;->e(Ljava/io/ByteArrayInputStream;Ljava/io/ByteArrayOutputStream;Lj/d;)V
    ...
    .catch Lj/c; {:try_start_5 .. :try_end_5} :catch_0
    ...
    .catch Lj/c; {:try_start_9 .. :try_end_9} :catch_0
    ...
    :try_start_a
    iget-object p2, p1, Llb/b;->a:Ljava/util/HashMap;
...
.method private getThumbnailPath(Landroid/content/Context;Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {p1, p2}, Ls4/d;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lq0/b;->L(Ljava/lang/String;)Lo0/b;
    ...
    iget-object p0, p1, Lo0/b;->j:Ljava/lang/String;
...
.method private parallelTaskDataToBytes(LS9/q;)[B
    .locals 8
...
.method private stringToParallelTaskData(Landroid/content/Context;Ljava/lang/String;)LS9/q;
    .locals 6
    ...
    invoke-direct {p0, p1, p2}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->createParallelTaskData(Landroid/content/Context;Lorg/json/JSONObject;)LS9/q;
...
.method private valueToString(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-static {v0, p1, v2, p0}, LM4/u;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v4, v5, v3, v2}, LC/f2;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v0, v2, p0}, LM4/u;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v0, p2, v2}, LC/f2;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public combineParallelTaskDataToSmallJpeg([BLjava/lang/String;J)[B
    ...
    invoke-static {p2, p3, p4, v1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)LS9/q;

    move-result-object p2

    if-eqz p2, :cond_5

    iget-boolean p3, p2, LS9/q;->m0:Z
    ...
    :cond_1
    invoke-virtual {p0, p2, v1}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->convertTaskDataItem(LS9/q;Z)Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;
    ...
    invoke-static {v4, v5, p1}, LC/E1;->h(JLjava/lang/StringBuilder;)Ljava/lang/String;
...
.method public convertTaskDataItem(LS9/q;Z)Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;
    .locals 12
    ...
    iget p1, p1, LS9/q;->t:I

    invoke-static {p1, p0}, LC/E1;->f(ILjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v4, p1, LS9/q;->W:Ljava/lang/String;

    iget-wide v8, p1, LS9/q;->b0:J
    ...
    invoke-static {v10, p2}, LC/G;->h(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->parallelTaskDataToBytes(LS9/q;)[B
    ...
    sget-object p1, Lj/e;->a:Lk/p;

    new-instance p1, Lk/k;

    invoke-direct {p1}, Lk/k;-><init>()V

    invoke-static {v10, p1}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;->e(Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;Lk/k;)V

    invoke-static {v10}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;->b(Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;)Lj/d;
    ...
    invoke-virtual {p1, v3, v6, v11}, Lk/k;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public getCacheSizeInfo()Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1, v2, v3}, LC/R1;->f(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public readParallelTaskDataFromSmallJpeg(Landroid/content/Context;Ljava/lang/String;)LS9/q;
    .locals 7

    const-string v0, "read parallel task data from small jpeg, pictureName: "

    invoke-static {v0, p2}, LB2/p;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v2, v6, p2}, LQ1/t;->k(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v6, p2, Lw6/b$b;->a:Ljava/lang/String;

    filled-new-array {p2}, [Lw6/b$b;

    move-result-object v6

    invoke-static {v0, v6}, Lw6/b;->a(Ljava/io/FileInputStream;[Lw6/b$b;)V

    iget-object p2, p2, Lw6/b$b;->d:[B
    :try_end_1
    ...
    invoke-direct {p0, p1, p2}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->stringToParallelTaskData(Landroid/content/Context;Ljava/lang/String;)LS9/q;
