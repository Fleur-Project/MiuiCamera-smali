...
.method private prepareVideoEncoder(Lcom/xiaomi/mediacodec/EglBase$Context;II)V
    ...
    new-instance v1, Lcom/xiaomi/mediacodec/VideoEncoder;
    ...
    iput-object v1, v9, Lcom/xiaomi/mediacodec/MiHWEncoder;->mVideoEncoder:Lcom/xiaomi/mediacodec/VideoEncoder;

    iget-boolean p0, v9, Lcom/xiaomi/mediacodec/MiHWEncoder;->mError:Z

    if-eqz p0, :cond_0

    const/4 p0, 0x0

    iput-object p0, v9, Lcom/xiaomi/mediacodec/MiHWEncoder;->mVideoEncoder:Lcom/xiaomi/mediacodec/VideoEncoder;
    ...
    iput-object p0, v9, Lcom/xiaomi/mediacodec/MiHWEncoder;->mEgl:Lcom/xiaomi/mediacodec/EglBase;

    :try_start_0
    iget-object p1, v9, Lcom/xiaomi/mediacodec/MiHWEncoder;->mVideoEncoder:Lcom/xiaomi/mediacodec/VideoEncoder;

    invoke-virtual {p1}, Lcom/xiaomi/mediacodec/VideoEncoder;->getInputSurface()Landroid/view/Surface;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/xiaomi/mediacodec/EglBase;->createSurface(Landroid/view/Surface;)V

    iget-object p0, v9, Lcom/xiaomi/mediacodec/MiHWEncoder;->mEgl:Lcom/xiaomi/mediacodec/EglBase;

    invoke-virtual {p0}, Lcom/xiaomi/mediacodec/EglBase;->makeCurrent()V

    invoke-virtual {v9}, Lcom/xiaomi/mediacodec/MiHWEncoder;->onCreated()V
    :try_end_0
...
.method public CreateEncoder(IIIIILjava/lang/String;Ljava/lang/String;J)Z
    ...
    iput-wide p8, p0, Lcom/xiaomi/mediacodec/MiHWEncoder;->mJniContext:J
    ...
    invoke-virtual/range {p0 .. p7}, Lcom/xiaomi/mediacodec/MiHWEncoder;->setParams(Ljava/lang/String;IIIIILjava/lang/String;)V

    new-instance p1, Lcom/xiaomi/mediacodec/AudioEncoder;

    invoke-direct {p1}, Lcom/xiaomi/mediacodec/AudioEncoder;-><init>()V

    iput-object p1, p0, Lcom/xiaomi/mediacodec/MiHWEncoder;->mAudioEncoder:Lcom/xiaomi/mediacodec/AudioEncoder;

    invoke-virtual {p1, p0}, Lcom/xiaomi/mediacodec/AudioEncoder;->SetEncoderDataCallback(Lcom/xiaomi/mediacodec/MiHWEncoder;)V

    iget-object p1, p0, Lcom/xiaomi/mediacodec/MiHWEncoder;->mAudioEncoder:Lcom/xiaomi/mediacodec/AudioEncoder;

    iget p0, p0, Lcom/xiaomi/mediacodec/MiHWEncoder;->sample_rate:I

    invoke-virtual {p1, p0}, Lcom/xiaomi/mediacodec/AudioEncoder;->initMediacodec(I)V
