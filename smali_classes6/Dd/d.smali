...
# direct methods
.method public static a(Lqd/h$a;)V
    .locals 10
    ...
    invoke-virtual {v2, v3}, LQd/b;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v1, v0}, LEg/k;->y(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v6, v0}, LEg/k;->y(ILjava/lang/String;Ljava/lang/String;)V

    iget-object p0, p0, Lqd/h$a;->a:Lqd/h;

    const/4 v0, 0x0

    iput-object v0, p0, Lqd/h;->r0:Lqd/h$a;
    ...
    invoke-static {v3, v1, v4}, LEg/k;->y(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v6, v1}, LEg/k;->y(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lqd/h$a;->a:Lqd/h;

    iget-object v1, v0, Lqd/h;->C:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_4
    iget-object v1, v0, Lqd/h;->A:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v2}, LQd/b;->h()I

    move-result v2

    invoke-direct {v1, v2}, Lwd/d;-><init>(I)V

    iput-object v1, v0, Lqd/h;->r:Lwd/d;

    iget-object v1, v1, Lwd/d;->a:Lwd/c;

    iput-object v1, v0, Lqd/h;->d0:Lwd/c;
    ...
    iget-object v0, v0, Lqd/h;->q:Lcom/faceunity/core/faceunity/FUAIKit;
    ...
    invoke-direct {v0, p0, v1}, Lo3/m;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v2, v0}, Lq5/g;->t(Ljava/lang/Runnable;)V
    ...
    invoke-static {v7, v6, p0}, LEg/k;->y(ILjava/lang/String;Ljava/lang/String;)V

    :cond_7
    return-void
.end method

.method public static b(Ljava/lang/String;Lqd/h$a;)V
    .locals 12
    ...
    invoke-direct/range {v6 .. v11}, LDd/a;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lqd/h$a;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-direct/range {v3 .. v9}, LDd/b;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lqd/h$a;Ljava/util/concurrent/atomic/AtomicInteger;)V
