...
.method public static final a(Ljava/util/ArrayList;Ljava/util/List;LLf/k;)LEg/F;
    .locals 1

    new-instance v0, LEg/U;

    invoke-direct {v0, p0}, LEg/U;-><init>(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v0, p1}, LEg/q0;->j(ILEg/F;)LEg/F;

    move-result-object p0

    if-nez p0, :cond_0

    invoke-virtual {p2}, LLf/k;->m()LEg/M;
...
.method public static i(Lyf/p;)LOg/i;
    .locals 1
    ...
    invoke-static {v0, v0, p0}, LBi/a;->g(Lnf/d;Lnf/d;Lyf/p;)Lnf/d;

    move-result-object p0

    iput-object p0, v0, LOg/i;->d:Lnf/d;

    return-object v0
.end method

.method public static final j(LWf/a;LWf/b;LOf/e;Lng/f;)V
    .locals 1
...
.method public static final k(LWf/a;LWf/b;LOf/F;Lng/f;)V
    .locals 1
    ...
    invoke-virtual {p3}, Lng/f;->b()Ljava/lang/String;
...
.method public static final l(LOf/a0;)LEg/F;
    .locals 5
    ...
    invoke-interface {v4}, LOf/a0;->i()LEg/d0;
    ...
    invoke-static {v1, v0, p0}, LEg/V;->a(Ljava/util/ArrayList;Ljava/util/List;LLf/k;)LEg/F;
