...
.method static constructor <clinit>()V
    ...
    sput-object v2, LIf/T;->e:[LFf/k;

    return-void
.end method

.method public constructor <init>(LEg/F;Lyf/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, LIf/T;->a:LEg/F;

    instance-of p1, p2, LIf/Y$a;
    ...
    invoke-static {v0, p2}, LIf/Y;->a(LOf/b;Lyf/a;)LIf/Y$a;
    ...
    :cond_2
    :goto_1
    iput-object p1, p0, LIf/T;->b:LIf/Y$a;

    new-instance p1, LIf/T$b;

    invoke-direct {p1, p0}, LIf/T$b;-><init>(LIf/T;)V

    invoke-static {v0, p1}, LIf/Y;->a(LOf/b;Lyf/a;)LIf/Y$a;

    move-result-object p1

    iput-object p1, p0, LIf/T;->c:LIf/Y$a;

    new-instance p1, LIf/T$a;

    invoke-direct {p1, p0, p2}, LIf/T$a;-><init>(LIf/T;Lyf/a;)V

    invoke-static {v0, p1}, LIf/Y;->a(LOf/b;Lyf/a;)LIf/Y$a;

    move-result-object p1

    iput-object p1, p0, LIf/T;->d:LIf/Y$a;
...
.method public final a()Ljava/lang/reflect/Type;
    ...
    iget-object p0, p0, LIf/T;->b:LIf/Y$a;
...
.method public final e(LEg/F;)LFf/e;
    .locals 3
    ...
    invoke-static {p1}, Lkf/v;->s0(Ljava/util/List;)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {p0, p1}, LIf/T;->e(LEg/F;)LFf/e;

    move-result-object p1

    if-eqz p1, :cond_2

    new-instance p0, LIf/n;

    invoke-static {p1}, LG8/a;->h(LFf/e;)LFf/d;

    move-result-object p1

    invoke-static {p1}, LC/e2;->b(LFf/d;)Ljava/lang/Class;
    ...
    invoke-direct {p0, p1}, LIf/n;-><init>(Ljava/lang/Class;)V
    ...
    invoke-direct {p0, v0}, LIf/n;-><init>(Ljava/lang/Class;)V
    ...
    sget-object p1, LUf/d;->b:Ljava/util/Map;
    ...
    invoke-direct {p0, v2, v0}, LIf/U;-><init>(LIf/V;LOf/a0;)V

    return-object p0

    :cond_8
    instance-of p0, v0, LOf/Z;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, LIf/T;

    if-eqz v0, :cond_0

    check-cast p1, LIf/T;

    iget-object v0, p1, LIf/T;->a:LEg/F;

    iget-object v1, p0, LIf/T;->a:LEg/F;
    ...
    invoke-virtual {p0}, LIf/T;->f()LFf/e;

    move-result-object v0

    invoke-virtual {p1}, LIf/T;->f()LFf/e;
    ...
    invoke-virtual {p0}, LIf/T;->g()Ljava/util/List;

    move-result-object p0

    invoke-virtual {p1}, LIf/T;->g()Ljava/util/List;
...
.method public final f()LFf/e;
    ...
    sget-object v0, LIf/T;->e:[LFf/k;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object p0, p0, LIf/T;->c:LIf/Y$a;
...
.method public final g()Ljava/util/List;
    ...
    iget-object p0, p0, LIf/T;->d:LIf/Y$a;
...
.method public final getAnnotations()Ljava/util/List;
    ...
    iget-object p0, p0, LIf/T;->a:LEg/F;
