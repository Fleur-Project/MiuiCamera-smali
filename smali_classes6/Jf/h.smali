...
.field public final c:LJf/h$a;


# direct methods
.method public constructor <init>(LJf/f;LOf/u;Z)V
    .locals 8
    ...
    invoke-static {p3}, LEg/x;->s(LEg/F;)Ljava/lang/Class;
    ...
    invoke-static {p3, p2}, LEg/x;->p(Ljava/lang/Class;LOf/b;)Ljava/lang/reflect/Method;
    ...
    :goto_0
    invoke-static {p2}, Lqg/j;->a(LOf/b;)Z
    ...
    new-instance p1, LJf/h$a;

    sget-object p2, LEf/d;->d:LEf/d;

    new-array p3, v2, [Ljava/lang/reflect/Method;

    invoke-direct {p1, p2, p3, v1}, LJf/h$a;-><init>(LEf/d;[Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;)V

    goto/16 :goto_9

    :cond_1
    instance-of p3, p1, LJf/g$g$c;
    ...
    :cond_2
    instance-of p3, p2, LOf/j;

    if-eqz p3, :cond_4

    instance-of p1, p1, LJf/e;
    ...
    :cond_4
    invoke-interface {p2}, LOf/a;->Y()LOf/Q;
    ...
    invoke-static {p1}, Lqg/j;->b(LOf/k;)Z
    ...
    invoke-interface {p2}, LOf/a;->a0()LOf/Q;
    ...
    invoke-interface {p3}, LOf/j;->D()LOf/e;
    ...
    :goto_6
    invoke-interface {p2}, LOf/u;->isSuspend()Z
    ...
    invoke-static {v3, v4}, LEf/f;->J(II)LEf/d;
    ...
    iget v6, v3, LEf/b;->a:I

    iget v7, v3, LEf/b;->b:I
    ...
    invoke-static {v6}, LEg/x;->s(LEg/F;)Ljava/lang/Class;

    move-result-object v6

    if-eqz v6, :cond_c

    invoke-static {v6, p2}, LEg/x;->p(Ljava/lang/Class;LOf/b;)Ljava/lang/reflect/Method;
    ...
    invoke-direct {p1, v3, v4, v1}, LJf/h$a;-><init>(LEf/d;[Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;)V

    :goto_9
    iput-object p1, p0, LJf/h;->c:LJf/h$a;
    ...
    iget-object p2, p0, LJf/h;->a:LJf/f;

    invoke-interface {p2}, LJf/f;->getParameterTypes()Ljava/util/List;
...
.method public final call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, LJf/h;->c:LJf/h$a;

    iget-object v1, v0, LJf/h$a;->a:LEf/d;
    ...
    iget v3, v1, LEf/b;->a:I

    iget v1, v1, LEf/b;->b:I

    if-gt v3, v1, :cond_2

    :goto_0
    iget-object v4, v0, LJf/h$a;->b:[Ljava/lang/reflect/Method;
    ...
    invoke-static {v4}, LIf/e0;->e(Ljava/lang/reflect/Type;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v2}, LJf/f;->call([Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    iget-object p1, v0, LJf/h$a;->c:Ljava/lang/reflect/Method;
