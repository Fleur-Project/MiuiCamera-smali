...
# static fields
.field public static final g:LJh/c$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LJh/c;->g:LJh/c$a;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, LJh/c;->a:Z

    iput-boolean v0, p0, LJh/c;->c:Z

    iput v0, p0, LJh/c;->e:I
...
.method public static d(LJh/c;Landroid/view/View;)Landroid/graphics/Rect;
    .locals 1
...
.method public static f(LJh/c;Landroid/view/View;ILmiuix/appcompat/app/AlertDialog$d;LJh/c$b;)V
    .locals 4
    ...
    new-instance v2, LJh/c$g;

    invoke-direct {v2, p0, p3, p4, p1}, LJh/c$g;-><init>(LJh/c;Lmiuix/appcompat/app/AlertDialog$d;LJh/c$b;Landroid/view/View;)V
    ...
    iget-object p1, p0, LJh/c;->b:Lmiuix/animation/IFolme;
    ...
    iput-object p1, p0, LJh/c;->b:Lmiuix/animation/IFolme;

    :cond_0
    iget-object p0, p0, LJh/c;->b:Lmiuix/animation/IFolme;
    ...
    sget-object p2, LJh/c;->g:LJh/c$a;
...
.method public final a(Landroid/view/View;Landroid/view/View;Lmiuix/appcompat/app/h;)V
    ...
    iput-object v5, v4, LJh/c$f;->a:Ljava/lang/ref/WeakReference;

    new-instance p3, Ljava/lang/ref/WeakReference;

    invoke-direct {p3, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, v4, LJh/c$f;->b:Ljava/lang/ref/WeakReference;

    sget-object p3, LNh/j;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p3}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    move-result p3

    iput p3, v4, LJh/c$f;->c:I
    ...
    new-instance p3, LJh/c$h;

    invoke-direct {p3, p0, p1}, LJh/c$h;-><init>(LJh/c;Landroid/view/View;)V
    ...
    iget-object p3, p0, LJh/c;->b:Lmiuix/animation/IFolme;
    ...
    iput-object p3, p0, LJh/c;->b:Lmiuix/animation/IFolme;
    ...
    sget-object v1, LJh/c;->g:LJh/c$a;
    ...
    invoke-static {p3}, LNh/k;->j(Landroid/content/Context;)Z
    ...
    invoke-direct {v10, p0, p1, v3, v2}, LJh/d;-><init>(LJh/c;Landroid/view/View;ILmiuix/animation/base/AnimConfig;)V
    ...
    invoke-interface/range {v4 .. v10}, Landroid/view/WindowInsetsController;->controlWindowInsetsAnimation(IJLandroid/view/animation/Interpolator;Landroid/os/CancellationSignal;Landroid/view/WindowInsetsAnimationControlListener;)V
    ...
    :cond_3
    :goto_0
    invoke-static {p2}, LYi/b;->j(Landroid/view/View;)V
...
.method public final c(Landroid/view/View;Landroid/view/View;ZLmiuix/appcompat/app/AlertDialog$d;)V
    ...
    :cond_1
    new-instance v8, LJh/c$b;

    invoke-direct {v8, p0, p1, p2, v0}, LJh/c$b;-><init>(LJh/c;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-direct/range {v3 .. v8}, LJh/c$c;-><init>(LJh/c;Landroid/view/View;ZLmiuix/appcompat/app/AlertDialog$d;LJh/c$b;)V
    ...
    new-instance p0, LJh/c$d;

    invoke-direct {p0, v4, v6, v7, v8}, LJh/c$d;-><init>(LJh/c;ZLmiuix/appcompat/app/AlertDialog$d;LJh/c$b;)V

    invoke-virtual {v5, p0}, Landroid/view/View;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    :goto_0
    invoke-static {p2}, LYi/b;->I(Landroid/view/View;)V
