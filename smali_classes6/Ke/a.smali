...
.field public final n:LGe/f;

.field public final o:LGe/i;

.field public final p:LGe/i;

.field public final q:LGe/i;

.field public final r:LGe/a;

.field public final s:LGe/d;
...
.method public constructor <init>(FLGe/p;LGe/p;LGe/p;LGe/p;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;LJe/a;Z)V
    ...
    invoke-direct {v0, v10}, LGe/a;-><init>(I)V

    iput v1, v0, LKe/a;->m:F

    sget-object v11, LJe/a;->c:LJe/a;
    ...
    :goto_0
    iput-boolean v11, v0, LKe/a;->t:Z

    if-eqz v2, :cond_5

    if-eqz v7, :cond_5

    new-instance v14, LGe/f;

    const-string v15, ""

    invoke-direct {v14, v10, v15}, LGe/f;-><init>(ILjava/lang/String;)V

    iget-object v15, v2, LGe/p;->a:Ljava/lang/String;

    invoke-static {v15}, LLe/b;->d(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {v15}, LLe/b;->e(Ljava/lang/String;)Z
    ...
    invoke-static/range {v16 .. v17}, LS9/D;->x(D)I
    ...
    invoke-static/range {v18 .. v19}, LS9/D;->x(D)I
    ...
    invoke-virtual {v14, v1}, LGe/e;->o(LGe/a;)V
    ...
    invoke-direct {v1, v15, v2}, LGe/j;-><init>(Ljava/lang/String;Landroid/graphics/Paint;)V
    ...
    invoke-static/range {v18 .. v24}, LGe/a;->l(LGe/a;IIIIII)LGe/a;
    ...
    :cond_6
    :goto_3
    iput-object v14, v0, LKe/a;->n:LGe/f;
    ...
    :goto_4
    iput-object v1, v0, LKe/a;->o:LGe/i;
    ...
    :goto_5
    iput-object v2, v0, LKe/a;->p:LGe/i;
    ...
    invoke-direct {v1, v10}, LGe/a;-><init>(I)V
    ...
    :goto_8
    iput-object v1, v0, LKe/a;->r:LGe/a;
    ...
    invoke-direct {v13, v6}, LGe/d;-><init>(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_9
    iput-object v13, v0, LKe/a;->s:LGe/d;
...
.method public static o(LIe/a;LGe/a;)V
    ...
    iget v1, p1, LGe/a;->e:I

    int-to-float v1, v1

    iget v2, p1, LGe/a;->f:I

    int-to-float v2, v2

    invoke-virtual {p0, v1, v2}, LIe/a;->h(FF)V

    iget v1, p1, LGe/a;->g:I

    iget v2, p1, LGe/a;->h:I

    invoke-virtual {p0, v1, v2}, LIe/a;->b(II)V
    ...
    invoke-virtual {p0, v0}, LIe/a;->f(I)V
...
.method public final a(LIe/a;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object p2, p0, LKe/a;->n:LGe/f;

    invoke-static {p1, p2}, LKe/a;->o(LIe/a;LGe/a;)V

    iget-object p2, p0, LKe/a;->o:LGe/i;
    ...
    iget-object p2, p0, LKe/a;->r:LGe/a;

    invoke-static {p1, p2}, LKe/a;->o(LIe/a;LGe/a;)V

    iget-object p0, p0, LKe/a;->s:LGe/d;
...
.method public final g(II)V
    ...
    iget-object v4, v0, LKe/a;->q:LGe/i;

    const/4 v5, 0x0

    iget-object v6, v0, LKe/a;->p:LGe/i;
    ...
    :goto_0
    iget-object v8, v0, LKe/a;->n:LGe/f;
    ...
    :cond_1
    iget-object v9, v0, LKe/a;->o:LGe/i;
    ...
    iget-object v13, v6, LGe/i;->n:Landroid/graphics/Paint;
    ...
    iget-object v13, v4, LGe/i;->n:Landroid/graphics/Paint;
    ...
    iput v3, v9, LGe/a;->e:I

    if-nez v4, :cond_f

    iget v3, v9, LGe/a;->h:I
    ...
    :cond_15
    iget-object v3, v0, LKe/a;->r:LGe/a;
    ...
    iput v6, v3, LGe/a;->h:I

    :cond_18
    iget-object v0, v0, LKe/a;->s:LGe/d;
    ...
    :goto_d
    iput v4, v0, LGe/a;->g:I

    iput v4, v0, LGe/a;->h:I

    if-eqz v3, :cond_1a

    iget v3, v3, LGe/a;->e:I
    ...
    invoke-static {v2, v3, v14, v4}, LC/R1;->d(IIII)I
