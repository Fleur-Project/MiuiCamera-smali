...
# static fields
.field public static volatile b:LMe/O0;
...
# direct methods
.method public static a(Landroid/content/Context;)LMe/O0;
    .locals 2

    sget-object v0, LMe/O0;->b:LMe/O0;

    if-nez v0, :cond_1

    const-class v0, LMe/O0;

    monitor-enter v0

    :try_start_0
    sget-object v1, LMe/O0;->b:LMe/O0;
    ...
    iput-object p0, v1, LMe/O0;->a:Landroid/content/Context;

    sput-object v1, LMe/O0;->b:LMe/O0;
    ...
    :cond_1
    :goto_2
    sget-object p0, LMe/O0;->b:LMe/O0;
...
.method public b(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-static {p3}, LMe/N0;->d(I)Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v8}, LMe/O0;->c(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
...
.method public c(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    invoke-virtual {p0, v0}, LMe/O0;->g(Llc/d;)V
...
.method public d(Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-static {p2}, LMe/N0;->d(I)Ljava/lang/String;
...
.method public e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v7}, LMe/O0;->c(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
...
.method public g(Llc/d;)V
    ...
    invoke-virtual {p0}, Lmc/e;->b()Llc/a;
    ...
    invoke-direct {v0, p0, p1}, Lmc/b;-><init>(Lmc/e;Llc/c;)V

    iget-object p0, p0, Lmc/e;->a:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {v0, p0, p1}, Lmc/a;-><init>(Lmc/e;Llc/b;)V
