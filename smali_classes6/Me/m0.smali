...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LMe/m0;->a:Ljava/text/SimpleDateFormat;

    const/high16 v0, 0x200000

    iput v0, p0, LMe/m0;->f:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, LMe/m0;->g:Ljava/util/ArrayList;
...
.method public final a(Landroid/content/Context;Ljava/util/Date;Ljava/util/Date;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {v0}, LMe/c3;->b(Ljava/io/File;)Z
    ...
    iget-object v2, p0, LMe/m0;->g:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, LMe/m0;->a:Ljava/text/SimpleDateFormat;
    ...
    iput-object p3, p0, LMe/m0;->b:Ljava/lang/String;

    invoke-virtual {v2, p2}, Ljava/text/DateFormat;->format(Ljava/util/Date;)Ljava/lang/String;

    move-result-object p2

    iput-object p2, p0, LMe/m0;->c:Ljava/lang/String;
    ...
    iput-object p2, p0, LMe/m0;->b:Ljava/lang/String;
    ...
    const-string v4, "\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}"
    ...
    :try_start_3
    invoke-virtual {p0, v8, v6, v4}, LMe/m0;->b(Ljava/io/BufferedReader;Ljava/io/BufferedWriter;Ljava/util/regex/Pattern;)V
    ...
    invoke-virtual {p0}, LMe/S;->m()Ljava/lang/String;
    ...
    invoke-direct {p4, p1, v5}, Ljava/io/FileOutputStream;-><init>(Ljava/io/File;Z)V
    ...
    :try_start_7
    invoke-static {v2, v0, v1}, Lfc/f;->f(Ljava/util/zip/ZipOutputStream;Ljava/io/File;Ljava/lang/String;)V
    :try_end_7
...
.method public final b(Ljava/io/BufferedReader;Ljava/io/BufferedWriter;Ljava/util/regex/Pattern;)V
    ...
    iget-object v10, p0, LMe/m0;->b:Ljava/lang/String;
    ...
    iget-boolean v11, p0, LMe/m0;->d:Z

    if-nez v11, :cond_0

    iget-object v11, p0, LMe/m0;->b:Ljava/lang/String;
    ...
    :cond_0
    iget-object v11, p0, LMe/m0;->c:Ljava/lang/String;
    ...
    :cond_3
    :goto_3
    iget-boolean v4, p0, LMe/m0;->d:Z

    if-eqz v4, :cond_5

    sub-int/2addr v1, v9

    iget v4, p0, LMe/m0;->e:I

    add-int/2addr v4, v1

    iput v4, p0, LMe/m0;->e:I
    ...
    iget v1, p0, LMe/m0;->e:I

    iget v4, p0, LMe/m0;->f:I
