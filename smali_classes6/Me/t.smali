...
.method static constructor <clinit>()V
    ...
    sput-object v0, LMe/t;->a:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static a(Ljava/lang/String;Ljava/util/TreeMap;)LMe/p;
    .locals 8
    ...
    invoke-direct {v1, v4}, LMe/p;-><init>(I)V

    new-instance v4, Ljava/util/HashMap;

    invoke-direct {v4}, Ljava/util/HashMap;-><init>()V

    iput-object v4, v1, LMe/p;->d:Ljava/lang/Object;
    ...
    invoke-virtual {v0, p1, v5, v2}, Ljava/io/OutputStream;->write([BII)V
    ...
    :goto_3
    invoke-virtual {v4, v5}, Ljava/net/HttpURLConnection;->getHeaderFieldKey(I)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v4, v5}, Ljava/net/HttpURLConnection;->getHeaderField(I)Ljava/lang/String;
    ...
    new-instance v2, LMe/t$b;

    invoke-virtual {v4}, Ljava/net/URLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object v5

    invoke-direct {v2, v5}, LMe/t$b;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-direct {v2, v4}, LMe/t$b;-><init>(Ljava/io/InputStream;)V
    ...
    iput-object v0, v1, LMe/p;->c:Ljava/lang/String;
    ...
    :cond_7
    :try_start_7
    iget-object v2, v1, LMe/p;->d:Ljava/lang/Object;
    ...
    :goto_8
    invoke-static {v3}, Lfc/f;->d(Ljava/io/Closeable;)V

    invoke-static {p1}, Lfc/f;->d(Ljava/io/Closeable;)V

    throw p0
.end method

.method public static b(Landroid/content/Context;)LMe/r;
    .locals 3

    if-nez p0, :cond_0

    sget-object p0, LMe/a3;->a:Landroid/content/Context;
...
.method public static c(Landroid/content/Context;Ljava/net/URL;)LMe/t$b;
    .locals 3
    ...
    const-string v2, "be988a6134bc8254465424e5a70ef037"
    ...
    invoke-static {v0}, LS9/D;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v2, "&key="

    invoke-static {p1, v2, v0}, LM/a;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    new-instance p1, LMe/t$b;

    invoke-virtual {p0}, Ljava/net/URLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object p0

    invoke-direct {p1, p0}, LMe/t$b;-><init>(Ljava/io/InputStream;)V
    :try_end_0
...
.method public static d()LMe/u;
    .locals 6

    sget-object v0, LMe/t;->a:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, LMe/t$a;

    if-eqz v1, :cond_3

    :try_start_0
    sget-object v2, LMe/a3;->a:Landroid/content/Context;
    ...
    invoke-virtual {v1}, LMe/t$a;->run()V
...
.method public static f(Landroid/content/Context;Ljava/net/URL;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0, p1}, LMe/t;->c(Landroid/content/Context;Ljava/net/URL;)LMe/t$b;
    ...
    :cond_0
    invoke-static {p0}, Lfc/f;->d(Ljava/io/Closeable;)V
...
.method public static g(Ljava/lang/String;Ljava/util/HashMap;Ljava/io/File;)V
    ...
    invoke-direct {v2, p0}, LMe/t$b;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-static {p2}, Lfc/f;->d(Ljava/io/Closeable;)V
