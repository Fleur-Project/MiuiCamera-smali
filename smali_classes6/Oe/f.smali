...
.method public synthetic constructor <init>(LOe/g;Landroid/view/Surface;II)V
    ...
    iput-object p2, p0, LOe/f;->b:Landroid/view/Surface;
...
.method public final run()V
    ...
    iget-object v1, p0, LOe/f;->b:Landroid/view/Surface;

    iget v2, p0, LOe/f;->c:I

    iget p0, p0, LOe/f;->d:I
    ...
    iget-object v3, v0, LOe/g;->G:LZe/s;
    ...
    iget-object v5, v3, LZe/s;->p:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v5}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v5, v3, LZe/s;->g:Landroid/view/Surface;
    ...
    :cond_0
    :goto_0
    iput v2, v3, LZe/s;->h:I

    iput p0, v3, LZe/s;->i:I

    iget-boolean v5, v3, LZe/s;->k:Z

    if-nez v5, :cond_1

    iget-object v5, v3, LZe/s;->m:Landroid/graphics/Rect;

    invoke-virtual {v5, v6, v6, v2, p0}, Landroid/graphics/Rect;->set(IIII)V

    :cond_1
    iput-object v1, v3, LZe/s;->g:Landroid/view/Surface;

    iput-boolean v7, v3, LZe/s;->r:Z
    ...
    :cond_2
    iput-boolean v7, v3, LZe/s;->q:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v1, v3, LZe/s;->p:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-direct {v4, v0, v5}, LA2/b;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v4, v3, LZe/s;->t:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, LOe/g;->r:Lq5/j;

    if-eqz v3, :cond_8

    iget-object v3, v3, Lq5/j;->a:Lq5/g;

    invoke-virtual {v3}, Lq5/g;->q()Lcom/android/camera/ui/h0;
    ...
    :cond_5
    iget-object v5, v3, Lq5/g;->p:LOe/g;

    if-eqz v5, :cond_6

    iget-object v7, v5, LOe/g;->q:Lbf/a;

    iput v4, v7, Lbf/a;->g:I

    iget-object v5, v5, LOe/g;->G:LZe/s;

    iput v4, v5, LZe/s;->j:I

    :cond_6
    iget-object v4, v3, Lq5/g;->o:Lr6/k;

    if-nez v4, :cond_7

    new-instance v4, Lr6/k;

    invoke-direct {v4}, Lr6/k;-><init>()V

    iput-object v4, v3, Lq5/g;->o:Lr6/k;
    ...
    invoke-static {v3, v2, p0}, LC/W1;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    :goto_1
    iget-object v0, v3, LZe/s;->p:Ljava/util/concurrent/locks/ReentrantLock;
