...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v1, p0, LOe/g$a;->a:LOe/g;

    iget-object v2, v1, LOe/g;->r:Lq5/j;

    iget-object v3, v1, LOe/g;->t:Lq5/i;

    sget-boolean v4, LOe/g;->V:Z

    const/4 v5, 0x0

    if-eqz v4, :cond_3

    iget-boolean v4, v1, LOe/g;->T:Z

    if-eqz v4, :cond_3

    iget-boolean v1, v1, LOe/g;->L:Z

    if-nez v1, :cond_1

    sget-object v1, Lre/d$a;->a:Lre/d;

    sput v5, Lre/d;->c:I

    iget-object v4, v1, Lre/d;->a:Lre/c;
    ...
    :cond_0
    iget-object v1, v1, Lre/d;->b:Lre/c;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lre/c;->b()V
    ...
    invoke-direct {v4}, Lre/c;-><init>()V

    iput-object v4, v1, Lre/d;->a:Lre/c;

    :cond_2
    iget-object v1, v1, Lre/d;->a:Lre/c;

    sget v4, Lre/d;->c:I

    iput v4, v1, Lre/c;->c:I

    invoke-virtual {v1}, Lre/c;->a()V

    :cond_3
    iget-object v1, p0, LOe/g$a;->a:LOe/g;

    iget-object v4, v1, LOe/g;->e:Landroid/os/Handler;

    if-eqz v4, :cond_c

    iget-object v4, v1, LOe/g;->c:LOe/i;
    ...
    :cond_4
    iget-object v1, v1, LOe/g;->M:Lff/d;

    monitor-enter v1

    :try_start_0
    iget v4, v1, Lff/d;->a:I
    :try_end_0
    ...
    iget-object v4, v1, LOe/g;->M:Lff/d;

    monitor-enter v4

    :try_start_1
    iget v1, v4, Lff/d;->a:I

    add-int/2addr v1, v0

    iput v1, v4, Lff/d;->a:I
    :try_end_1
    ...
    invoke-direct {v1, v0, p0, p1}, LOe/d;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p1, v6, v7}, LOe/g;->l(LAc/a;J)Z
    ...
    invoke-interface {p1}, Lcom/android/camera/ui/i0;->B()LC/b2;

    move-result-object p1

    iget-object p1, p1, LC/b2;->y:LC/k2;

    if-eqz p1, :cond_7

    invoke-interface {p1}, LC/k2;->blockPreviewForPrepare()Z
    ...
    iget-object p1, v2, Lq5/j;->a:Lq5/g;

    invoke-virtual {p1}, Lq5/g;->q()Lcom/android/camera/ui/h0;
    ...
    invoke-virtual {p1, v2}, LOe/g;->h(Lq5/j;)V

    if-eqz v3, :cond_b

    invoke-virtual {v3}, Lq5/i;->z()V
