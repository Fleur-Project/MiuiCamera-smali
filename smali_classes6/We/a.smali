...
.method public constructor <init>(LTe/k;)V
    ...
    iput-object v0, p0, LWe/a;->e:Landroid/graphics/Rect;

    new-instance v0, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v0}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v0, p0, LWe/a;->i:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iput-object p1, p0, LWe/a;->a:LTe/k;

    iget-object v1, p1, LTe/k;->b:Landroid/os/Handler;

    iput-object v1, p0, LWe/a;->d:Landroid/os/Handler;

    invoke-virtual {p1}, LTe/k;->a()LTe/c;

    move-result-object p1

    iput-object p1, p0, LWe/a;->f:LTe/c;

    sget-object p1, LTe/a;->a:LTe/a$a;

    iput-object p1, p0, LWe/a;->g:LTe/a;

    new-instance p1, LA9/r;

    const/16 v1, 0xe

    invoke-direct {p1, p0, v1}, LA9/r;-><init>(Ljava/lang/Object;I)V

    iget-object p0, p0, LWe/a;->d:Landroid/os/Handler;
...
.method public final b(LTe/a;I[FIIIIII)V
    ...
    iget-object v4, p0, LWe/a;->b:LXe/a;
    ...
    iget-object v6, p0, LWe/a;->i:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v6}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v7, p0, LWe/a;->h:Landroid/view/Surface;
    ...
    iget-object v7, p0, LWe/a;->g:LTe/a;

    if-ne p1, v7, :cond_1

    iget-object v7, p0, LWe/a;->j:LTe/f;
    ...
    iput-object v8, p0, LWe/a;->j:LTe/f;
    ...
    iget-object v4, p0, LWe/a;->h:Landroid/view/Surface;
    ...
    iget-object v7, p0, LWe/a;->f:LTe/c;

    iget-object v8, p0, LWe/a;->h:Landroid/view/Surface;

    invoke-static {p1}, LWe/a;->a(LTe/a;)[I

    move-result-object v9

    invoke-direct {v4, v7, v8, v9}, LTe/f;-><init>(LTe/c;Landroid/view/Surface;[I)V

    iput-object v4, p0, LWe/a;->j:LTe/f;
    ...
    iget-object v8, p0, LWe/a;->j:LTe/f;
    ...
    iget-object v4, p0, LWe/a;->a:LTe/k;

    if-eqz v4, :cond_6

    invoke-virtual {v4}, LTe/k;->a()LTe/c;
    ...
    iget-object v6, p0, LWe/a;->e:Landroid/graphics/Rect;

    invoke-virtual {v6, v1, v3, v4, v5}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v1, p0, LWe/a;->b:LXe/a;

    iget-object v8, p0, LWe/a;->e:Landroid/graphics/Rect;

    iget-object v9, p0, LWe/a;->c:LTe/h;
    ...
    invoke-virtual/range {v0 .. v9}, LXe/a;->a(ILTe/a;ILTe/a;II[FLandroid/graphics/Rect;LTe/h;)V
