...
.field public final p:Lad/d;

.field public final q:Lad/d$a;

.field public final r:Landroid/os/Handler;

.field public s:LXc/g;
...
.method public constructor <init>(LXc/j$b;)V
    ...
    iput-object v0, p0, LXc/j;->a:Ljava/lang/String;

    new-instance v1, Ljava/util/Stack;

    invoke-direct {v1}, Ljava/util/Stack;-><init>()V

    iput-object v1, p0, LXc/j;->d:Ljava/util/Stack;

    new-instance v2, LS0/e;

    invoke-direct {v2}, LS0/e;-><init>()V

    iput-object v2, p0, LXc/j;->e:LS0/e;

    const/4 v2, 0x0

    iput v2, p0, LXc/j;->u:I

    new-instance v3, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v3}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v3, p0, LXc/j;->w:Ljava/util/concurrent/locks/ReentrantLock;

    const v3, 0xac44

    iput v3, p0, LXc/j;->A:I

    const/4 v3, 0x2

    iput v3, p0, LXc/j;->C:I
    ...
    invoke-direct {v3, p0}, LXc/j$a;-><init>(LXc/j;)V

    iput-object v3, p0, LXc/j;->g0:LXc/j$a;
    ...
    iget-object v4, p1, LXc/j$b;->a:Ljava/lang/ref/WeakReference;

    iput-object v4, p0, LXc/j;->f:Ljava/lang/ref/WeakReference;

    iget v5, p1, LXc/j$b;->b:I

    iput v5, p0, LXc/j;->i:I

    iget-object v5, p1, LXc/j$b;->c:Lad/d;

    iput-object v5, p0, LXc/j;->p:Lad/d;

    iget-object v5, p1, LXc/j$b;->d:Lad/d$a;

    iput-object v5, p0, LXc/j;->q:Lad/d$a;

    iget-object v5, p1, LXc/j$b;->f:Landroid/os/Handler;

    iput-object v5, p0, LXc/j;->r:Landroid/os/Handler;

    iget-object p1, p1, LXc/j$b;->e:Ljava/util/List;
    ...
    iget-object v0, p1, Lcom/android/camera/ActivityBase;->j0:Lq5/g;

    iput-object v0, p0, LXc/j;->b:Lq5/g;
    ...
    iput-object p1, p0, LXc/j;->c:Lcom/xiaomi/milive/data/LiveMasterProcessing;
...
.method public final c()V
    ...
    iget-object v1, v0, Lgf/a;->d:Lcom/xiaomi/milab/videosdk/XmsTimeline;
    ...
    :cond_0
    iget-object v2, p0, LXc/j;->f:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, p0, LXc/j;->Y:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;
    ...
    iget-object v4, p0, LXc/j;->a:Ljava/lang/String;
    ...
    iget-object v2, p0, LXc/j;->g0:LXc/j$a;
    ...
    iput-object v0, p0, LXc/j;->Y:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    invoke-virtual {v1}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->appendAudioTrack()Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    move-result-object v0

    iput-object v0, p0, LXc/j;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    invoke-virtual {v1}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->appendVideoTrack()Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    move-result-object v0

    iput-object v0, p0, LXc/j;->d0:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    iget-object v0, p0, LXc/j;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    iget-object v2, p0, LXc/j;->l:Ljava/lang/String;

    iget v3, p0, LXc/j;->i:I
    ...
    iget-object v0, p0, LXc/j;->b:Lq5/g;
...
.method public final d(Lcom/xiaomi/milive/data/EffectItem;)V
    ...
    invoke-direct {v2, v3, p0, v0, p1}, LXc/c;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final f(Lcom/xiaomi/milive/data/LiveWorkspaceItem;)V
    ...
    iget-object v0, p0, LXc/j;->d:Ljava/util/Stack;
    ...
    invoke-virtual {p0, p1}, LXc/j;->i(I)V
...
.method public final h(Ljava/lang/String;)V
    ...
    iget-object v2, p0, LXc/j;->a:Ljava/lang/String;
...
.method public final i(I)V
    ...
    iget v2, p0, LXc/j;->u:I

    invoke-static {v2}, LXc/j;->b(I)Ljava/lang/String;
    ...
    invoke-static {p1}, LXc/j;->b(I)Ljava/lang/String;
    ...
    iput p1, p0, LXc/j;->u:I

    iget-object p1, p0, LXc/j;->p:Lad/d;

    if-eqz p1, :cond_3

    iget p0, p0, LXc/j;->u:I

    iput p0, p1, Lad/d;->h:I
    ...
    :cond_0
    iget-object p0, p1, Lad/d;->f:Landroid/os/Handler;
    ...
    iget-object v0, p1, Lad/d;->f:Landroid/os/Handler;

    new-instance v1, LA9/p;

    const/4 v2, 0x5

    invoke-direct {v1, v2, p1, p0}, LA9/p;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final k(Lad/d$a;)V
    .locals 8
    ...
    iget-object v2, p0, LXc/j;->e0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;
    ...
    invoke-direct/range {v1 .. v7}, LXc/g;-><init>(LXc/j;JJLad/d$a;)V

    iput-object v1, v2, LXc/j;->s:LXc/g;
    ...
    iget-object v0, v2, LXc/j;->a:Ljava/lang/String;
...
.method public final l()V
    ...
    iput-boolean v0, p0, LXc/j;->Z:Z

    :cond_0
    iget-object p0, p0, LXc/j;->Y:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;
...
.method public final m()V
    ...
    :cond_0
    iget-object v0, p0, LXc/j;->c:Lcom/xiaomi/milive/data/LiveMasterProcessing;

    invoke-virtual {v0}, Lcom/xiaomi/milive/data/LiveMasterProcessing;->getCurrentWorkspaceItem()Lcom/xiaomi/milive/data/LiveWorkspaceItem;

    move-result-object v0

    iput-object v0, p0, LXc/j;->e0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;

    iget-object v0, p0, LXc/j;->l:Ljava/lang/String;

    invoke-static {v0}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z

    move-result v0

    iget v2, p0, LXc/j;->i:I

    if-nez v0, :cond_1

    iget-object v0, p0, LXc/j;->e0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;
    ...
    iget-object v5, p0, LXc/j;->l:Ljava/lang/String;
    ...
    iget-object p0, p0, LXc/j;->l:Ljava/lang/String;
