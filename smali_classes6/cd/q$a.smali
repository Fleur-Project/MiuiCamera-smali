...
.field public final synthetic l:Lcd/q;


# direct methods
.method public constructor <init>(Lcd/q;Landroid/content/Context;Lcom/xiaomi/mimoji/common/fragment/bottomlist/FragmentMimojiBottomList;Landroid/widget/RelativeLayout;)V
    .locals 6
    ...
    iput-object p1, p0, Lcd/q$a;->l:Lcd/q;

    const/16 p1, 0x68

    iput p1, p0, Lcd/q$a;->a:I

    const/4 p1, 0x3

    new-array v1, p1, [I

    iput-object v1, p0, Lcd/q$a;->b:[I

    const/4 v2, 0x0

    iput-boolean v2, p0, Lcd/q$a;->k:Z

    iput-object p2, p0, Lcd/q$a;->j:Landroid/content/Context;

    iput-object p4, p0, Lcd/q$a;->c:Landroid/widget/RelativeLayout;

    new-instance p4, Landroid/widget/ImageView;

    invoke-direct {p4, p2}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object p4, p0, Lcd/q$a;->g:Landroid/widget/ImageView;
    ...
    iput-object v3, p0, Lcd/q$a;->h:Landroid/widget/ImageView;
    ...
    iput-object v4, p0, Lcd/q$a;->i:Landroid/widget/ImageView;
    ...
    iget-object p3, p0, Lcd/q$a;->g:Landroid/widget/ImageView;
    ...
    iget-object p3, p0, Lcd/q$a;->h:Landroid/widget/ImageView;

    invoke-static {p3, v2}, Lcom/android/camera/features/mode/capture/A;->g(Landroid/widget/ImageView;Z)V

    invoke-static {p3}, Lcom/android/camera/features/mode/capture/A;->e(Landroid/view/View;)V

    iget-object p3, p0, Lcd/q$a;->i:Landroid/widget/ImageView;
    ...
    iput-object p3, p0, Lcd/q$a;->d:Landroid/widget/RelativeLayout$LayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, Lcd/q$a;->e:Landroid/widget/RelativeLayout$LayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, Lcd/q$a;->f:Landroid/widget/RelativeLayout$LayoutParams;
...
.method public final a(III)V
    ...
    iget-boolean v7, v0, Lcd/q$a;->k:Z

    iget-object v8, v0, Lcd/q$a;->i:Landroid/widget/ImageView;

    iget-object v9, v0, Lcd/q$a;->g:Landroid/widget/ImageView;

    iget-object v10, v0, Lcd/q$a;->h:Landroid/widget/ImageView;

    const/4 v11, 0x1

    if-nez v7, :cond_0

    iget-object v7, v0, Lcd/q$a;->c:Landroid/widget/RelativeLayout;
    ...
    iput-boolean v11, v0, Lcd/q$a;->k:Z

    :cond_0
    iget-object v7, v0, Lcd/q$a;->l:Lcd/q;

    iget-boolean v12, v7, Lcd/q;->g:Z

    if-nez v12, :cond_a

    iget-boolean v12, v7, Lcd/q;->f:Z
    ...
    :cond_1
    iget-object v12, v0, Lcd/q$a;->b:[I
    ...
    iget-boolean v3, v7, Lcd/q;->j:Z

    if-eqz v3, :cond_4

    iget-wide v2, v7, Lcd/q;->a:D
    ...
    invoke-direct {v2, v0}, Lcd/n;-><init>(Lcd/q$a;)V
    ...
    iget-boolean v10, v7, Lcd/q;->j:Z

    if-eqz v10, :cond_5

    iget-wide v10, v7, Lcd/q;->d:D
    ...
    invoke-direct {v3, v0}, Lcd/o;-><init>(Lcd/q$a;)V
    ...
    invoke-direct {v1, v0}, Lcd/p;-><init>(Lcd/q$a;)V
    ...
    :goto_4
    invoke-static/range {v18 .. v18}, Lcd/q$a;->b(Z)V
    ...
    iput v2, v0, Lcd/q$a;->a:I

    iget v2, v7, Lcd/q;->e:I

    sub-int v2, v2, p1

    iget-object v3, v0, Lcd/q$a;->j:Landroid/content/Context;
    ...
    new-instance v11, Lcd/k;

    invoke-direct {v11, v0, v1, v2}, Lcd/k;-><init>(Lcd/q$a;II)V
    ...
    invoke-direct {v4, v0, v1, v2}, Lcd/l;-><init>(Lcd/q$a;II)V
    ...
    invoke-direct {v3, v0, v1, v2}, Lcd/m;-><init>(Lcd/q$a;II)V
    ...
    invoke-static/range {v17 .. v17}, Lcd/q$a;->b(Z)V
