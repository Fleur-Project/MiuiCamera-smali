...
.method public renderFrame(IJ)Landroid/graphics/Bitmap;
    ...
    :cond_0
    sget-object v10, Lcom/xiaomi/milab/videosdk/utils/DrawText$1;->$SwitchMap$com$xiaomi$milab$videosdk$utils$TextAnim$Type:[I

    iget v14, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->type:I
    ...
    iget v13, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->posY:F
    ...
    iget-object v9, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->scale:Ljava/lang/String;

    invoke-static {v9}, Ljava/lang/Float;->parseFloat(Ljava/lang/String;)F

    move-result v9

    iget-object v13, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->scale:Ljava/lang/String;

    invoke-static {v13}, Ljava/lang/Float;->parseFloat(Ljava/lang/String;)F

    move-result v13

    iget v14, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->posX:F

    add-float/2addr v14, v10

    iget v15, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->posY:F

    add-float/2addr v15, v7

    invoke-virtual {v8, v9, v13, v14, v15}, Landroid/graphics/Matrix;->postScale(FFFF)Z
    ...
    iget v13, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->posX:F
    ...
    invoke-virtual {v8, v9, v13, v10}, Landroid/graphics/Matrix;->postRotate(FFF)Z
    ...
    iget-object v15, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->color:Ljava/lang/String;
    ...
    :cond_5
    iget v15, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->textSize:F
    ...
    iget-boolean v15, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->underline:Z

    invoke-virtual {v10, v15}, Landroid/graphics/Paint;->setUnderlineText(Z)V

    iget-boolean v15, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->bold:Z

    invoke-virtual {v10, v15}, Landroid/graphics/Paint;->setFakeBoldText(Z)V
    ...
    iget v13, v0, Lcom/xiaomi/milab/videosdk/utils/DrawText;->centerPointX:F

    add-float v15, v9, v13

    move-object/from16 v18, v5

    iget v5, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->posY:F
    ...
    iget v4, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->posY:F

    iget v5, v0, Lcom/xiaomi/milab/videosdk/utils/DrawText;->centerPointY:F

    add-float/2addr v4, v5

    invoke-virtual {v7, v14, v1, v8}, Lcom/xiaomi/milab/videosdk/XmsAnimProperties;->AnimGetDouble(Ljava/lang/String;II)D
    ...
    invoke-static {v10}, Lcom/xiaomi/milab/videosdk/utils/StringUtils;->isEmpty(Ljava/lang/CharSequence;)Z
    ...
    invoke-virtual {v7, v9, v1, v8}, Lcom/xiaomi/milab/videosdk/XmsAnimProperties;->AnimGetDouble(Ljava/lang/String;II)D
    ...
    sget-object v11, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Type;->TEXT:Lcom/xiaomi/milab/videosdk/utils/TextAnim$Type;

    invoke-virtual {v11}, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Type;->getValue()I
    ...
    invoke-virtual {v7, v12, v1, v8}, Lcom/xiaomi/milab/videosdk/XmsAnimProperties;->AnimGetDouble(Ljava/lang/String;II)D

    move-result-wide v11

    double-to-float v9, v11

    iget-object v11, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->text:Ljava/lang/String;

    iget v12, v0, Lcom/xiaomi/milab/videosdk/utils/DrawText;->textWidth:F

    iget-boolean v13, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->isChangeSize:Z

    invoke-static {v11, v10, v12, v9, v13}, Lcom/xiaomi/milab/videosdk/utils/Bitmaps;->textEvaporateAsBitmap(Ljava/lang/String;Landroid/text/TextPaint;FFZ)Landroid/graphics/Bitmap;
    ...
    iget v11, v0, Lcom/xiaomi/milab/videosdk/utils/DrawText;->textWidth:F

    invoke-static {v9, v10, v11}, Lcom/xiaomi/milab/videosdk/utils/Bitmaps;->textAsBitmap(Ljava/lang/String;Landroid/text/TextPaint;F)Landroid/graphics/Bitmap;
    ...
    sget-object v11, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Type;->CUE:Lcom/xiaomi/milab/videosdk/utils/TextAnim$Type;
    ...
    invoke-direct {v0, v9, v13, v14}, Lcom/xiaomi/milab/videosdk/utils/DrawText;->getCueByPts(Ljava/util/List;J)Lcom/xiaomi/milab/videosdk/utils/TextAnim$Cue;
    ...
    invoke-direct {v0, v9, v13}, Lcom/xiaomi/milab/videosdk/utils/DrawText;->getOldCue(Ljava/util/List;Lcom/xiaomi/milab/videosdk/utils/TextAnim$Cue;)Lcom/xiaomi/milab/videosdk/utils/TextAnim$Cue;

    move-result-object v9

    if-eqz v9, :cond_b

    invoke-direct {v0, v13, v9, v10}, Lcom/xiaomi/milab/videosdk/utils/DrawText;->getCueDiffInfo(Lcom/xiaomi/milab/videosdk/utils/TextAnim$Cue;Lcom/xiaomi/milab/videosdk/utils/TextAnim$Cue;Landroid/text/TextPaint;)Lcom/xiaomi/milab/videosdk/utils/CueDiffInfo;
    ...
    invoke-virtual {v14, v12, v1, v8}, Lcom/xiaomi/milab/videosdk/XmsAnimProperties;->AnimGetDouble(Ljava/lang/String;II)D
    ...
    invoke-static/range {v20 .. v25}, Lcom/xiaomi/milab/videosdk/utils/Bitmaps;->textSubtitleAsBitmap(Ljava/lang/String;Landroid/text/TextPaint;FFZLcom/xiaomi/milab/videosdk/utils/CueDiffInfo;)Landroid/graphics/Bitmap;
    ...
    iget v9, v6, Lcom/xiaomi/milab/videosdk/utils/TextAnim$Anim;->posY:F
    ...
    invoke-static {v0, v1, v3, v4, v2}, LC/H;->e(JJLjava/lang/StringBuilder;)Ljava/lang/String;
