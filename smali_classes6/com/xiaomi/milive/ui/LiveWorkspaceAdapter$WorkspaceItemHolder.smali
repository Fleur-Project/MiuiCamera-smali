...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lcom/xiaomi/milive/ui/LiveWorkspaceAdapter$WorkspaceItemHolder;->g:Lcom/xiaomi/milive/ui/LiveWorkspaceAdapter;
    ...
    iget-object v2, v1, Lcom/xiaomi/milive/ui/LiveWorkspaceAdapter;->a:Landroid/app/Activity;

    const v3, 0x7f15019d

    iget-object v4, p0, Lcom/xiaomi/milive/ui/LiveWorkspaceAdapter$WorkspaceItemHolder;->c:Landroidx/cardview/widget/CardView;

    invoke-direct {p1, v2, v4, v3}, LIh/o;-><init>(Landroid/content/Context;Landroid/view/View;I)V

    new-instance v2, Landroidx/appcompat/view/SupportMenuInflater;

    iget-object v3, p1, LIh/o;->a:Landroid/content/Context;

    invoke-direct {v2, v3}, Landroidx/appcompat/view/SupportMenuInflater;-><init>(Landroid/content/Context;)V

    iget-object v3, p1, LIh/o;->b:Lmiuix/appcompat/internal/view/menu/d;

    const/high16 v4, 0x7f100000

    invoke-virtual {v2, v4, v3}, Landroidx/appcompat/view/SupportMenuInflater;->inflate(ILandroid/view/Menu;)V

    new-instance v2, Lbd/t;

    invoke-direct {v2, p0, v0}, Lbd/t;-><init>(Lcom/xiaomi/milive/ui/LiveWorkspaceAdapter$WorkspaceItemHolder;I)V

    iput-object v2, p1, LIh/o;->e:LIh/o$b;

    iget-object p0, v1, Lcom/xiaomi/milive/ui/LiveWorkspaceAdapter;->a:Landroid/app/Activity;
    ...
    :cond_1
    iget-object p0, v1, Lcom/xiaomi/milive/ui/LiveWorkspaceAdapter;->h:Lcom/xiaomi/microfilm/milive/b$c;

    iget-object p1, v1, Lcom/xiaomi/milive/ui/LiveWorkspaceAdapter;->b:Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/milive/ui/LiveWorkspaceActivity;->fj(Lcom/xiaomi/milive/data/LiveWorkspaceItem;)V
