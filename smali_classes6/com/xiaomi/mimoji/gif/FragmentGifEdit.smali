...
.field public d:Lpd/g;

.field public e:Lpd/f;
...
.method public static synthetic Mc(Lcom/xiaomi/mimoji/gif/FragmentGifEdit;)V
    .locals 4
    ...
    invoke-interface {v0}, LX3/p;->onReviewCancelClicked()V
...
.method public static Pc(Lcom/xiaomi/mimoji/gif/FragmentGifEdit;Ljava/lang/Boolean;)V
    .locals 2
    ...
    iget-object v0, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Lpd/f;
    ...
    iget-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->q:Ls4/c;

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Lpd/f;

    invoke-virtual {p1}, Lpd/f;->e()Z
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->be(Ls4/c;)V

    return-void

    :cond_1
    iget-object p0, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Lpd/f;

    invoke-virtual {p0}, Lpd/f;->l()V
    ...
    invoke-static {p1, p0, v1}, LC/s3;->e(Landroid/content/Context;Ljava/lang/String;Z)V
...
.method public static Uc(Lcom/xiaomi/mimoji/gif/FragmentGifEdit;Ljava/lang/Boolean;)V
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->ne(Ls4/c;)V
...
.method public static synthetic sd(Lcom/xiaomi/mimoji/gif/FragmentGifEdit;)Ljava/lang/String;
    .locals 0
...
# virtual methods
.method public final P6(JLjava/lang/String;)V
    .locals 4
    ...
    invoke-static {v1, p3}, LB2/p;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v1, v0, Lpd/f;->i:Landroid/view/Surface;
    ...
    iput-wide v0, p1, Lpd/f;->x:J

    iput-object p2, p1, Lpd/f;->w:Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lpd/f;->i(JLjava/lang/String;)V
...
.method public final Sa()V
    ...
    invoke-virtual {p0}, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->Pd()V

    return-void
.end method

.method public final Z7(Ls4/c;)V
    .locals 2

    iput-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->q:Ls4/c;
    ...
    invoke-virtual {v0, v1, v1}, Lnd/b;->a(II)V
...
.method public final be(Ls4/c;)V
    .locals 7
    ...
    invoke-interface {v0, v1}, LX3/c;->announceForAccessibility(I)V
    ...
    iget-object v3, p1, Ls4/c;->b:Ljava/lang/String;
    ...
    iget-object v6, p1, Ls4/c;->b:Ljava/lang/String;

    iput-object v6, v5, Ln4/e$a;->r:Ljava/lang/String;

    iput-wide v3, v5, Ln4/e$a;->s:J

    iput-object v2, v5, Ln4/e$a;->t:Ljava/lang/String;

    const/16 v2, 0x12c

    iput v2, v5, Ln4/b$a;->g:I

    iput v2, v5, Ln4/b$a;->h:I

    const/16 v2, 0x5a

    iput v2, v5, Ln4/b$a;->i:I

    iget-object v2, p1, Ls4/c;->c:Landroid/net/Uri;

    iput-object v2, v5, Ln4/b$a;->a:Landroid/net/Uri;

    iput-object v0, v5, Ln4/b$a;->l:Landroid/location/Location;

    iput v1, v5, Ln4/e$a;->u:I
    ...
    iget-object v1, v1, Lcom/android/camera/Camera;->f1:Ln4/j;

    iget-object p1, p1, Ls4/c;->b:Ljava/lang/String;

    invoke-virtual {v1, v0, p1}, Ln4/j;->b(Ln4/e;Ljava/lang/String;)V
...
.method public final initView(Landroid/view/View;)V
    ...
    iput-object v6, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->k:Landroid/content/Context;
    ...
    iput-boolean v5, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->n:Z
    ...
    iput-object v7, v6, Lpd/g;->d:Landroid/content/Context;

    iput-object v6, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->d:Lpd/g;

    iget-object v7, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->c:Landroid/view/View;
    ...
    iput-object v8, v6, Lpd/g;->e:Landroid/widget/RelativeLayout;
    ...
    iput-object v8, v6, Lpd/g;->f:Landroid/widget/LinearLayout;
    ...
    iput-object v8, v6, Lpd/g;->g:Landroid/widget/LinearLayout;
    ...
    iput-object v8, v6, Lpd/g;->h:Landroid/widget/LinearLayout;
    ...
    iput-object v8, v6, Lpd/g;->i:Landroid/widget/LinearLayout;
    ...
    iput-object v8, v6, Lpd/g;->k:Landroid/widget/LinearLayout;
    ...
    iput-object v8, v6, Lpd/g;->j:Landroid/widget/LinearLayout;
    ...
    iput-object v7, v6, Lpd/g;->l:Landroid/widget/LinearLayout;

    invoke-virtual {v7, v6}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v7, v6, Lpd/g;->h:Landroid/widget/LinearLayout;

    iget-object v8, v6, Lpd/g;->i:Landroid/widget/LinearLayout;

    iget-object v9, v6, Lpd/g;->k:Landroid/widget/LinearLayout;

    iget-object v10, v6, Lpd/g;->j:Landroid/widget/LinearLayout;

    iget-object v11, v6, Lpd/g;->l:Landroid/widget/LinearLayout;
    ...
    invoke-static {v7, v12}, LO/i;->j(F[Landroid/view/View;)V

    invoke-virtual {v6}, Lpd/g;->a()V
    ...
    invoke-static {v6}, Lfc/d;->a(Landroid/view/View;)Lfc/i;
    ...
    invoke-direct {v11, p0, v3}, Leb/c;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {v7, v11}, Lio/reactivex/Observable;->observeOn(Lio/reactivex/Scheduler;)Lio/reactivex/Observable;

    move-result-object v7

    new-instance v11, Lcom/android/camera2/compat/theme/custom/mm/manually/f;

    invoke-direct {v11, v6, v1}, Lcom/android/camera2/compat/theme/custom/mm/manually/f;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance v7, LC3/T1;

    const/16 v11, 0x9

    invoke-direct {v7, p0, v11}, LC3/T1;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {p1}, Lfc/d;->a(Landroid/view/View;)Lfc/i;

    move-result-object v1

    invoke-virtual {v1, v9, v10, v8}, Lio/reactivex/Observable;->throttleFirst(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/Observable;

    move-result-object v1

    new-instance v7, LL2/e;

    invoke-direct {v7, p0, v0}, LL2/e;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v1, p1, v2}, LL2/f;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, p0, v4}, LC/U1;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-interface {p1}, Lhd/d;->S4()Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v3, v5}, LC/s2;->w(Landroid/view/View;ZZ)Z
    ...
    invoke-static {p1, v5, v5}, LC/s2;->w(Landroid/view/View;ZZ)Z
    ...
    invoke-virtual {p1, v0}, Lcd/t;->a(Ljava/lang/Integer;)Lcom/xiaomi/mimoji/common/bean/MimojiItem;
    ...
    invoke-direct {p1, v0, v3}, Lpd/f;-><init>(Landroid/content/Context;Z)V

    iput-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Lpd/f;
    ...
    :cond_7
    iget-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->d:Lpd/g;

    iget-object v0, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Lpd/f;

    iput-object v0, p1, Lpd/g;->m:Lpd/f;

    iget-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->g:Landroid/view/TextureView;

    iput-object p1, v0, Lpd/f;->e:Landroid/view/TextureView;
    ...
    iput-object v0, p1, Lpd/f;->f:Landroid/widget/ImageView;

    iget-object v0, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->i:Landroid/widget/ProgressBar;

    iput-object v0, p1, Lpd/f;->g:Landroid/widget/ProgressBar;

    iget-object v0, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->j:Lcom/xiaomi/mimoji/gif/GifEditLayout;

    iput-object v0, p1, Lpd/f;->h:Lcom/xiaomi/mimoji/gif/GifEditLayout;

    iget-boolean p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->o:Z

    if-eqz p1, :cond_8

    iput-boolean v5, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->o:Z

    iget-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->l:Ljava/lang/String;

    iget-wide v0, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->m:J

    invoke-virtual {p0, v0, v1, p1}, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->P6(JLjava/lang/String;)V

    :cond_8
    return-void
.end method

.method public final ne(Ls4/c;)V
    .locals 7
    ...
    iget-object p1, p1, Ls4/c;->c:Landroid/net/Uri;

    iput-object p1, v5, Ln4/b$a;->a:Landroid/net/Uri;
    ...
    iget-object v0, v0, Lcom/android/camera/Camera;->f1:Ln4/j;

    monitor-enter v0

    :try_start_0
    iget v1, v0, Ln4/j;->e:I
    ...
    iput-object v1, p1, Ln4/b;->a:Landroid/app/Application;

    iput-object v0, p1, Ln4/b;->b:Ln4/s;
    ...
    invoke-direct {v1, v2, p0, p1}, LC/K0;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final onBackEvent(I)Z
    ...
    invoke-direct {p1, p0}, Lpd/a;-><init>(Lcom/xiaomi/mimoji/gif/FragmentGifEdit;)V

    invoke-virtual {p0, p1}, Lcom/xiaomi/mimoji/common/mvp/base/BaseFragmentMimoji;->Dc(Lcom/xiaomi/mimoji/common/mvp/base/BaseFragmentMimoji$b;)V
...
.method public final onDestroyView()V
    ...
    iget-object v2, v0, Lpd/f;->A:Landroid/os/HandlerThread;

    const/4 v3, 0x0

    if-eqz v2, :cond_0

    iget-object v2, v0, Lpd/f;->C:Landroid/os/Handler;
    ...
    iput-object v3, v0, Lpd/f;->A:Landroid/os/HandlerThread;

    iput-object v3, v0, Lpd/f;->C:Landroid/os/Handler;

    :cond_0
    iget-object v2, v0, Lpd/f;->w:Ljava/lang/String;
    ...
    :cond_1
    iget-object v2, v0, Lpd/f;->k:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
    ...
    iput-object v3, v0, Lpd/f;->k:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;

    :cond_2
    iget-object v2, v0, Lpd/f;->e:Landroid/view/TextureView;
    ...
    :try_start_0
    iget-object v2, v0, Lpd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;

    if-eqz v2, :cond_4

    invoke-virtual {v2}, Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;->DestructMediaEffectGraph()V

    iput-object v3, v0, Lpd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget v4, v0, Lpd/f;->Q:I

    invoke-virtual {v2, v4}, LS9/c;->i(I)V

    invoke-virtual {v0, v1}, Lpd/f;->k(Z)V

    iget-wide v4, v0, Lpd/f;->m:J
    ...
    iput-wide v6, v0, Lpd/f;->m:J

    :cond_5
    iget-object v2, v0, Lpd/f;->i:Landroid/view/Surface;

    if-eqz v2, :cond_6

    invoke-virtual {v2}, Landroid/view/Surface;->release()V

    iput-object v3, v0, Lpd/f;->i:Landroid/view/Surface;

    :cond_6
    sget-boolean v0, Lpd/f;->Y:Z

    if-eqz v0, :cond_7

    invoke-static {}, Lcom/xiaomi/MediaRecord/SystemUtil;->UnInit()V

    sput-boolean v1, Lpd/f;->Y:Z
    ...
    iput-object v3, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Lpd/f;
...
.method public final onPause()V
    ...
    iget-object v1, v0, Lpd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Lpd/f;->g()Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v0, v0, Lpd/f;->k:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
...
.method public final provideAnimateElement(ILjava/util/List;I)V
    ...
    invoke-static {p1}, LC/s2;->l(Landroid/view/View;)Z
    ...
    invoke-direct {p1, p2, p3}, Lcom/xiaomi/milive/mode/b;-><init>(IB)V
