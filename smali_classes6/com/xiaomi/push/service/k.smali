...
# direct methods
.method public static a(Lcom/xiaomi/push/service/j;LMe/a2;)I
    .locals 3
...
.method public static b(Ljava/util/ArrayList;Z)Ljava/util/ArrayList;
    ...
    invoke-static {p0}, Lbc/e;->d(Ljava/util/List;)Z
    ...
    check-cast v2, LMe/f2;

    iget v3, v2, LMe/f2;->a:I

    iget v4, v2, LMe/f2;->b:I
    ...
    :cond_1
    sget-object v4, LMe/b2;->d:LMe/b2;

    goto :goto_1

    :cond_2
    sget-object v4, LMe/b2;->c:LMe/b2;

    goto :goto_1

    :cond_3
    sget-object v4, LMe/b2;->b:LMe/b2;

    goto :goto_1

    :cond_4
    sget-object v4, LMe/b2;->a:LMe/b2;
    ...
    iget-object v2, v2, LMe/f2;->f:Ljava/lang/String;
...
.method public static c(Lcom/xiaomi/push/service/j;LMe/r2;)V
    .locals 4
    ...
    iget-object p1, p1, LMe/r2;->a:Ljava/util/ArrayList;

    const/4 v0, 0x1

    invoke-static {p1, v0}, Lcom/xiaomi/push/service/k;->b(Ljava/util/ArrayList;Z)Ljava/util/ArrayList;

    move-result-object p1

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {p1}, Lbc/e;->d(Ljava/util/List;)Z
...
.method public static d(Lcom/xiaomi/push/service/j;LMe/s2;)V
    .locals 6
    ...
    iget-object p1, p1, LMe/s2;->a:Ljava/util/ArrayList;
    ...
    check-cast v2, LMe/d2;

    new-instance v3, Landroid/util/Pair;

    iget-object v4, v2, LMe/d2;->c:LMe/a2;

    iget v5, v2, LMe/d2;->a:I
    ...
    iget-object v2, v2, LMe/d2;->b:Ljava/util/ArrayList;

    const/4 v3, 0x0

    invoke-static {v2, v3}, Lcom/xiaomi/push/service/k;->b(Ljava/util/ArrayList;Z)Ljava/util/ArrayList;

    move-result-object v2

    invoke-static {v2}, Lbc/e;->d(Ljava/util/List;)Z
    ...
    invoke-static {v0}, Lbc/e;->d(Ljava/util/List;)Z

    move-result p1

    if-nez p1, :cond_9

    invoke-static {v1}, Lbc/e;->d(Ljava/util/List;)Z
