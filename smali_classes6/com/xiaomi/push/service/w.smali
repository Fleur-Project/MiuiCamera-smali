...
.method public static declared-synchronized a()Ljava/lang/String;
    ...
    sget-object v1, LMe/a3;->a:Landroid/content/Context;
    ...
    invoke-static {v2}, LMe/M2;->b(Landroid/content/Context;)Ljava/lang/String;
...
.method public static c(Lcom/xiaomi/push/service/w;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/xiaomi/push/service/w;->b:LMe/z0;
    ...
    invoke-direct {v0, v1, v2}, LMe/M;-><init>(Ljava/io/BufferedOutputStream;[B)V

    iget-object p0, p0, Lcom/xiaomi/push/service/w;->b:LMe/z0;

    invoke-virtual {p0, v0}, LMe/z0;->i(LMe/M;)V
...
# virtual methods
.method public final b(LMe/B0;)V
    .locals 3

    iget-boolean v0, p1, LMe/B0;->e:Z

    const/4 v1, 0x0

    if-eqz v0, :cond_2

    iget v0, p1, LMe/B0;->f:I

    invoke-virtual {p0}, Lcom/xiaomi/push/service/w;->d()V

    iget-object v2, p0, Lcom/xiaomi/push/service/w;->b:LMe/z0;

    if-eqz v2, :cond_0

    iget v2, v2, LMe/z0;->b:I
    ...
    sget-object v2, LMe/O1;->a:LMe/g;

    invoke-virtual {v2, v0}, LMe/g;->a(LMe/g$b;)V
    ...
    invoke-virtual {v2, p1}, Lcom/xiaomi/push/service/w$a;->a(LMe/B0;)V
...
.method public final d()V
    ...
    invoke-direct {v1, v3}, LMe/y;-><init>(Ljava/io/BufferedInputStream;)V

    new-instance v2, LMe/z0;

    invoke-direct {v2}, LMe/z0;-><init>()V

    invoke-virtual {v2, v1}, LMe/z0;->G(LMe/y;)V

    iput-object v2, p0, Lcom/xiaomi/push/service/w;->b:LMe/z0;
    ...
    iput-object v0, p0, Lcom/xiaomi/push/service/w;->b:LMe/z0;
