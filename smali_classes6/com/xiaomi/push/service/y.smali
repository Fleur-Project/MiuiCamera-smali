...
.method public static b(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;I)Ljava/util/ArrayList;
    ...
    new-instance v6, LMe/Y1;

    invoke-direct {v6}, LMe/Y1;-><init>()V
    ...
    :cond_2
    iget-object v13, v10, LMe/Z1;->j:Ljava/util/Map;
    ...
    :goto_1
    iget-object v15, v10, LMe/Z1;->j:Ljava/util/Map;
    ...
    iput-object v4, v10, LMe/Z1;->j:Ljava/util/Map;

    goto :goto_2

    :cond_4
    iget-object v7, v10, LMe/Z1;->j:Ljava/util/Map;
    ...
    invoke-static {v10}, LMe/D2;->c(LMe/E2;)[B
    ...
    iget-object v10, v10, LMe/Z1;->i:Ljava/lang/String;
    ...
    new-instance v7, LMe/t2;

    const/4 v9, 0x0

    invoke-direct {v7, v12, v9}, LMe/t2;-><init>(Ljava/lang/String;Z)V

    iput-object v1, v7, LMe/t2;->i:Ljava/lang/String;

    iput-object v2, v7, LMe/t2;->d:Ljava/lang/String;

    invoke-static {v6}, LMe/D2;->c(LMe/E2;)[B

    move-result-object v6

    invoke-static {v6}, Lfc/f;->h([B)[B
    ...
    iput-object v6, v7, LMe/t2;->m:Ljava/nio/ByteBuffer;

    iput-object v11, v7, LMe/t2;->e:Ljava/lang/String;
    ...
    :cond_8
    iget-object v7, v6, LMe/Y1;->a:Ljava/util/ArrayList;
    ...
    iput-object v7, v6, LMe/Y1;->a:Ljava/util/ArrayList;
    ...
    :cond_a
    iget-object v0, v6, LMe/Y1;->a:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v12, v9}, LMe/t2;-><init>(Ljava/lang/String;Z)V

    iput-object v1, v0, LMe/t2;->i:Ljava/lang/String;

    iput-object v2, v0, LMe/t2;->d:Ljava/lang/String;

    invoke-static {v6}, LMe/D2;->c(LMe/E2;)[B

    move-result-object v1

    invoke-static {v1}, Lfc/f;->h([B)[B
    ...
    iput-object v1, v0, LMe/t2;->m:Ljava/nio/ByteBuffer;

    iput-object v11, v0, LMe/t2;->e:Ljava/lang/String;
...
.method public static c(LMe/Z1;Z)Z
    .locals 5
    ...
    iget-object p1, p0, LMe/Z1;->a:Ljava/lang/String;
    ...
    :cond_1
    iget-object p1, p0, LMe/Z1;->g:Ljava/lang/String;
    ...
    :cond_2
    iget-object p1, p0, LMe/Z1;->c:Ljava/lang/String;
    ...
    :cond_9
    iget-object p1, p0, LMe/Z1;->b:Ljava/lang/String;
