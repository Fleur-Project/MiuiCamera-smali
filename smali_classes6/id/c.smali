...
.method public constructor <init>(Lid/f;)V
    ...
    iput-object v0, p0, Lid/c;->c:[I

    iput-object p1, p0, Lid/c;->a:Lid/f;
    ...
    iput-object p1, p0, Lid/c;->b:Lcom/android/camera/ActivityBase;
...
.method public final P(Landroid/media/Image;)V
    ...
    iget-object p0, p0, Lid/c;->d:Lhd/b;
...
.method public final Q()V
    ...
    iget-object v0, p0, Lid/c;->a:Lid/f;

    iget-boolean v0, v0, Lid/f;->m:Z

    const/4 v1, 0x0

    if-eqz v0, :cond_5

    iget-object v0, p0, Lid/c;->b:Lcom/android/camera/ActivityBase;

    if-eqz v0, :cond_5

    iget-object v0, p0, Lid/c;->f:Lcd/t;
    ...
    invoke-virtual {v0, v2}, Lid/f;->Xb(I)V
    ...
    invoke-static {v1, v3}, Lcom/android/camera/data/data/h;->r1(ILjava/lang/String;)V
    ...
    invoke-interface {v0, v3}, Lu3/k;->j(I)V
    ...
    invoke-virtual {p0, v1}, LC/H2;->j(I)V
...
.method public final a(Landroid/graphics/Rect;IIZZ)Z
    ...
    iget-object v1, v0, Lid/c;->d:Lhd/b;

    const/4 v9, 0x0

    if-eqz v1, :cond_2

    iget-object v6, v0, Lid/c;->c:[I
    ...
    iget-boolean v3, v0, Lid/c;->e:Z

    if-eqz v3, :cond_1

    iput-boolean v9, v0, Lid/c;->e:Z

    iget-object v3, v0, Lid/c;->f:Lcd/t;

    iget v3, v3, Lcd/t;->m:I
    ...
    iget-object v5, v0, Lid/c;->a:Lid/f;

    iget-object v5, v5, Lid/f;->d:Ljava/util/concurrent/ExecutorService;

    new-instance v6, Lid/b;

    invoke-direct {v6, v0, v2, v4, v3}, Lid/b;-><init>(Lid/c;Landroid/graphics/Rect;[BI)V
...
.method public final b()V
    ...
    iput-object v0, p0, Lid/c;->d:Lhd/b;
    ...
    iput-object v0, p0, Lid/c;->f:Lcd/t;
    ...
    iget-object v1, p0, Lid/c;->b:Lcom/android/camera/ActivityBase;
...
.method public final f0(I)V
    ...
    invoke-virtual {v1, p1}, Lcd/t;->b(I)I

    move-result p1

    invoke-virtual {v0, p1}, Lid/f;->Z0(I)V
    ...
    :cond_0
    iget-object p1, p0, Lid/c;->a:Lid/f;

    invoke-virtual {p1}, Lid/f;->m()V
    ...
    iget-object p0, p0, Lid/c;->b:Lcom/android/camera/ActivityBase;
