...
.field public final f:LMe/Z2;

.field public final g:Lq5/g;

.field public h:Lcd/t;

.field public i:Lid/e;
...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput v0, p0, Lid/f;->n:I

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lid/f;->l:Ljava/lang/ref/WeakReference;

    new-instance v0, Lid/i;

    invoke-direct {v0, p0}, Lid/i;-><init>(Lid/f;)V

    iput-object v0, p0, Lid/f;->a:Lid/i;

    new-instance v1, Lid/l;

    invoke-direct {v1, p0}, Lid/l;-><init>(Lid/f;)V

    iput-object v1, p0, Lid/f;->b:Lid/l;

    new-instance v1, Lid/c;

    invoke-direct {v1, p0}, Lid/c;-><init>(Lid/f;)V

    iput-object v1, p0, Lid/f;->c:Lid/c;

    new-instance v1, Lid/d;

    invoke-direct {v1, p0}, Lid/d;-><init>(Lid/f;)V

    iput-object v1, p0, Lid/f;->e:Lid/d;
    ...
    iput-object v2, v1, LMe/Z2;->c:Ljava/lang/Object;

    iput-object p0, v1, LMe/Z2;->a:Ljava/lang/Object;

    iput-object v1, p0, Lid/f;->f:LMe/Z2;

    new-instance v1, LC/z2;

    const/4 v2, 0x5

    const-string v3, "mimojiStateExecutor"

    invoke-direct {v1, v3, v2}, LC/z2;-><init>(Ljava/lang/String;I)V

    invoke-static {v1}, Ljava/util/concurrent/Executors;->newSingleThreadExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;

    move-result-object v1

    iput-object v1, p0, Lid/f;->d:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v1, p0, Lid/f;->h:Lcd/t;

    iget-object p1, p1, Lcom/android/camera/ActivityBase;->j0:Lq5/g;

    iput-object p1, p0, Lid/f;->g:Lq5/g;

    iget-object p1, p0, Lid/f;->i:Lid/e;

    if-nez p1, :cond_0

    iput-object v0, p0, Lid/f;->i:Lid/e;
...
.method public final K(I)V
    ...
    iget-object p0, p0, Lid/f;->i:Lid/e;

    invoke-interface {p0, p1}, Lid/e;->K(I)V
...
.method public final M()Landroid/util/Size;
    ...
    iget-object p0, p0, Lid/f;->k:Landroid/util/Size;
...
.method public final Xb(I)V
    ...
    iget-object p0, p0, Lid/f;->h:Lcd/t;

    invoke-virtual {p0, p1}, Lcd/t;->h(I)V
...
.method public final Z0(I)V
    ...
    iget-object v0, p0, Lid/f;->a:Lid/i;
    ...
    :cond_0
    iget-object v0, p0, Lid/f;->f:LMe/Z2;
    ...
    :cond_1
    iget-object v0, p0, Lid/f;->e:Lid/d;
    ...
    :cond_2
    iget-object v0, p0, Lid/f;->c:Lid/c;
    ...
    :cond_3
    iget-object v0, p0, Lid/f;->b:Lid/l;

    iput-object v0, p0, Lid/f;->i:Lid/e;

    :goto_0
    iput p1, p0, Lid/f;->n:I

    iget-object v0, p0, Lid/f;->h:Lcd/t;

    invoke-virtual {v0, p1}, Lcd/t;->j(I)V

    iget-object p1, p0, Lid/f;->i:Lid/e;

    invoke-interface {p1}, Lid/e;->b()V

    iget-object p0, p0, Lid/f;->h:Lcd/t;

    invoke-virtual {p0, v1}, Lcd/t;->h(I)V
...
.method public final f0(I)V
    ...
    invoke-interface {p0, p1}, Lid/e;->f0(I)V
...
.method public final f7(ZLandroid/util/Size;)V
    ...
    iput-boolean p1, p0, Lid/f;->j:Z

    iput-object p2, p0, Lid/f;->k:Landroid/util/Size;

    iget-object p1, p0, Lid/f;->h:Lcd/t;
    ...
    iput-object p1, p0, Lid/f;->h:Lcd/t;
    ...
    iget-boolean p2, p1, Lcd/t;->j:Z

    if-eqz p2, :cond_1

    const/4 p2, 0x0

    iput-boolean p2, p1, Lcd/t;->j:Z

    :cond_1
    iget-object p0, p0, Lid/f;->i:Lid/e;

    invoke-interface {p0}, Lid/e;->b()V
...
.method public final m()V
    ...
    invoke-direct {v3, v0, v4}, Ld0/x;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_2
    iget-object p0, p0, Lid/f;->l:Ljava/lang/ref/WeakReference;
...
.method public final onDrawFrame(Landroid/graphics/Rect;IIZ)Z
    ...
    iget-object v4, p0, Lid/f;->i:Lid/e;

    iget-boolean v9, p0, Lid/f;->o:Z
    ...
    invoke-interface/range {v4 .. v9}, Lid/e;->a(Landroid/graphics/Rect;IIZZ)Z
...
.method public final onPreviewFrame(Landroid/media/Image;Lb6/a;I)Z
    ...
    invoke-interface {p0, p1}, Lid/e;->P(Landroid/media/Image;)V
...
.method public final onSurfaceViewPause()V
    ...
    invoke-interface {v0}, Lhd/b;->Kf()V
    ...
    iget-object p0, p0, Lid/f;->g:Lq5/g;
...
.method public final t()Lke/b;
    ...
    iput-object v0, p0, Lid/f;->p:Lke/b;

    :cond_0
    iget-object p0, p0, Lid/f;->p:Lke/b;
