...
.method public constructor <init>(Lid/f;)V
    ...
    iput-object v0, p0, Lid/i;->e:[I

    iput-object p1, p0, Lid/i;->a:Lid/f;
    ...
    iput-object p1, p0, Lid/i;->b:Lcom/android/camera/ActivityBase;
    ...
    iput-object p1, p0, Lid/i;->g:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lid/i;->c:Lcd/t;
...
.method public static c()Ljc/b;
    ...
    :goto_1
    iput-object v0, v6, Ljc/b;->d:Ljava/lang/String;
...
.method public final P(Landroid/media/Image;)V
    ...
    iget-object v0, p0, Lid/i;->f:Lhd/b;

    if-eqz v0, :cond_2

    iget-object v1, p0, Lid/i;->a:Lid/f;
    ...
    :cond_1
    iput p1, p0, Lid/i;->h:I

    iget-object v0, p0, Lid/i;->g:Landroid/os/Handler;

    new-instance v1, Lbd/j;

    const/4 v2, 0x2

    invoke-direct {v1, p0, p1, v2}, Lbd/j;-><init>(Ljava/lang/Object;II)V
...
.method public final Q()V
    ...
    iget-object v1, p0, Lid/i;->b:Lcom/android/camera/ActivityBase;
    ...
    invoke-virtual {v2}, Lcom/android/camera/ActivityBase;->vj()Z

    move-result v2

    if-eqz v2, :cond_1

    iget-object v2, p0, Lid/i;->f:Lhd/b;
    ...
    iput-boolean v2, p0, Lid/i;->d:Z

    invoke-virtual {v1}, Lcom/android/camera/ActivityBase;->ti()I

    move-result p0

    invoke-static {p0}, Lcom/android/camera/data/data/k;->i(I)Ljava/lang/String;
    ...
    invoke-direct {v2, p0, v0}, Lmd/a;-><init>(Ljava/lang/String;Z)V
...
.method public final a(Landroid/graphics/Rect;IIZZ)Z
    ...
    iget-object v1, v0, Lid/i;->f:Lhd/b;

    const/4 v10, 0x0

    if-eqz v1, :cond_5

    iget-object v2, v0, Lid/i;->b:Lcom/android/camera/ActivityBase;

    if-eqz v2, :cond_5

    iget-object v11, v0, Lid/i;->c:Lcd/t;
    ...
    :cond_0
    iget-object v6, v0, Lid/i;->e:[I

    iget-boolean v8, v0, Lid/i;->d:Z
    ...
    :cond_1
    iget-boolean v1, v0, Lid/i;->d:Z

    if-eqz v1, :cond_3

    iput-boolean v10, v0, Lid/i;->d:Z
    ...
    iget-object v11, v0, Lid/i;->a:Lid/f;

    invoke-virtual {v11}, Lid/f;->t()Lke/b;
    ...
    invoke-virtual {v3, v4, v5}, Lke/b;->a(II)V
    ...
    invoke-static {v5, v3, v4, v1, v10}, Landroid/opengl/GLES20;->glFramebufferTexture2D(IIIII)V
    ...
    invoke-virtual {v1, v10}, Lnd/b;->b(I)V
    ...
    invoke-virtual {v3}, Lke/b;->b()V

    new-instance v3, LC3/k2;

    invoke-direct {v3, v9, v0, v2, v1}, LC3/k2;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    iget-object v0, v11, Lid/f;->d:Ljava/util/concurrent/ExecutorService;
...
.method public final b()V
    ...
    iput-object v0, p0, Lid/i;->f:Lhd/b;

    const/4 v0, 0x0

    iput v0, p0, Lid/i;->h:I
...
.method public final d()Lx9/f;
    ...
    iget-object p0, p0, Lid/i;->a:Lid/f;

    iget-boolean v1, p0, Lid/f;->j:Z
    ...
    :goto_0
    invoke-virtual {v0, v1}, Lx9/f;->b(Z)V

    iget-boolean p0, p0, Lid/f;->j:Z

    invoke-virtual {v0, p0}, Lx9/f;->f(Z)V

    iput-boolean v2, v0, Lx9/f;->f:Z

    const-string p0, "off"

    invoke-virtual {v0, p0}, Lx9/f;->c(Ljava/lang/String;)V
