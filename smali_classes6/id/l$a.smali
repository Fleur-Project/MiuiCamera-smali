...
.method public constructor <init>(Lid/l;)V
    ...
    iput-object p1, p0, Lid/l$a;->a:Lid/l;
...
.method public final b(Lw3/e;Z)V
    ...
    iget-object p0, p0, Lid/l$a;->a:Lid/l;
    ...
    iget-object p2, p0, Lid/l;->d:Lid/f;

    invoke-virtual {p2, p1}, Lid/f;->Xb(I)V

    invoke-static {}, LX3/p;->impl()Ljava/util/Optional;

    move-result-object p2

    iget-object v1, p0, Lid/l;->e:Lcd/t;
    ...
    check-cast v1, LX3/z0;

    if-eqz v1, :cond_0

    sget-object p1, Lcd/r;->l:Ljava/lang/String;

    iget-wide v2, p0, Lid/l;->k:J

    invoke-interface {v1, v2, v3, p1}, LX3/z0;->P6(JLjava/lang/String;)V
    ...
    invoke-static {v1, v3}, Lcd/r;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lid/l;->a:Lcom/android/camera/ActivityBase;

    invoke-static {v2, v3, v1, v4, p1}, Ls4/d;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;I)Landroid/net/Uri;

    move-result-object v1

    iget-object p0, p0, Lid/l;->a:Lcom/android/camera/ActivityBase;
    ...
    new-instance p1, Lcom/xiaomi/microfilm/dualcam/mode/o;

    const/4 v0, 0x2

    invoke-direct {p1, p2, v0}, Lcom/xiaomi/microfilm/dualcam/mode/o;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {p2, v0}, Lid/f;->Xb(I)V

    sget-object p2, Lcd/r;->h:Ljava/lang/String;

    iget p0, p0, Lid/l;->g:I

    invoke-interface {p1, p0, p2}, Lhd/g;->D7(ILjava/lang/String;)V
    ...
    iget-object p0, p0, Lid/l;->d:Lid/f;

    invoke-virtual {p0, p1}, Lid/f;->Xb(I)V
