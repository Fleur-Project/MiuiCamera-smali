...
.field public final d:Lid/f;

.field public final e:Lcd/t;
...
.method public constructor <init>(Lid/f;)V
    ...
    iput-object v0, p0, Lid/l;->b:LS0/e;

    new-instance v0, LS0/j;

    invoke-direct {v0}, LS0/j;-><init>()V

    iput-object v0, p0, Lid/l;->c:LS0/j;

    const/16 v0, 0x10

    new-array v1, v0, [F

    iput-object v1, p0, Lid/l;->l:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lid/l;->m:[F

    const/4 v0, 0x2

    new-array v0, v0, [I

    iput-object v0, p0, Lid/l;->o:[I

    iput-object p1, p0, Lid/l;->d:Lid/f;

    iget-object p1, p1, Lid/f;->l:Ljava/lang/ref/WeakReference;
    ...
    iput-object p1, p0, Lid/l;->a:Lcom/android/camera/ActivityBase;
    ...
    iput-object p1, p0, Lid/l;->r:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lid/l;->e:Lcd/t;
...
.method public final K(I)V
    ...
    iget-object v0, p0, Lid/l;->e:Lcd/t;
    ...
    iget-object v1, p0, Lid/l;->d:Lid/f;

    invoke-virtual {v1, v4}, Lid/f;->Xb(I)V

    iput p1, p0, Lid/l;->g:I
    ...
    invoke-interface {p1}, LX3/d;->ig()V

    :cond_1
    iget-object p1, p0, Lid/l;->j:Lid/k;
    ...
    iget-wide v0, p0, Lid/l;->k:J

    invoke-interface {p1, v0, v1}, Lhd/d;->b2(J)V

    :cond_3
    iget-object p1, p0, Lid/l;->f:Lw3/c;

    if-eqz p1, :cond_4

    iget-wide v0, p0, Lid/l;->i:J
...
.method public final P(Landroid/media/Image;)V
    ...
    iget-object v0, p0, Lid/l;->q:Lhd/b;
    ...
    :cond_1
    iput p1, p0, Lid/l;->s:I

    iget-object v0, p0, Lid/l;->r:Landroid/os/Handler;

    new-instance v1, Lcom/android/camera2/compat/theme/custom/mm/manually/C;

    const/4 v2, 0x1

    invoke-direct {v1, p0, p1, v2}, Lcom/android/camera2/compat/theme/custom/mm/manually/C;-><init>(Ljava/lang/Object;II)V
...
.method public final a(Landroid/graphics/Rect;IIZZ)Z
    ...
    iget-object v1, v0, Lid/l;->q:Lhd/b;

    if-eqz v1, :cond_0

    iget-object v11, v0, Lid/l;->a:Lcom/android/camera/ActivityBase;
    ...
    iget-object v1, v0, Lid/l;->e:Lcd/t;

    iget v3, v1, Lcd/t;->g:I

    iget-object v12, v0, Lid/l;->m:[F

    iget-object v13, v0, Lid/l;->d:Lid/f;

    const/4 v14, 0x1

    if-ne v3, v9, :cond_7

    iget-object v3, v0, Lid/l;->f:Lw3/c;

    if-eqz v3, :cond_7

    iget-object v15, v11, Lcom/android/camera/ActivityBase;->j0:Lq5/g;

    iget-object v3, v15, Lq5/g;->j:LC/b2;

    iget-object v4, v3, LC/b2;->e:Landroid/graphics/Rect;
    ...
    iget v1, v3, LC/b2;->b:I

    goto :goto_0

    :cond_3
    iget-object v1, v3, LC/b2;->e:Landroid/graphics/Rect;
    ...
    iget-object v3, v0, Lid/l;->c:LS0/j;

    if-eq v9, v10, :cond_8

    invoke-virtual {v13}, Lid/f;->t()Lke/b;

    move-result-object v1

    iget-boolean v4, v13, Lid/f;->j:Z
    ...
    iget-object v14, v0, Lid/l;->c:LS0/j;
    ...
    iget-object v1, v0, Lid/l;->f:Lw3/c;
    ...
    iget-object v1, v0, Lid/l;->c:LS0/j;
    ...
    invoke-virtual {v11}, Lcom/android/camera/ActivityBase;->getSurfaceTexture()Lbf/a;

    move-result-object v3

    invoke-virtual {v3, v12}, Lbf/a;->b([F)V

    iget-object v3, v0, Lid/l;->l:[F
    ...
    iget-object v1, v0, Lid/l;->l:[F

    iget-object v3, v0, Lid/l;->m:[F
    ...
    iget-object v1, v0, Lid/l;->b:LS0/e;

    invoke-virtual {v15}, Lq5/g;->i()Lr6/f;
    ...
    :goto_2
    iget-boolean v1, v0, Lid/l;->h:Z

    if-eqz v1, :cond_c

    const/4 v14, 0x0

    iput-boolean v14, v0, Lid/l;->h:Z
    ...
    invoke-virtual {v0, v12}, Lbf/a;->b([F)V
    ...
    invoke-direct {v1, v8, v10, v0}, Lcom/android/camera/module/F;-><init>(II[B)V

    iget-object v0, v13, Lid/f;->d:Ljava/util/concurrent/ExecutorService;
...
.method public final b()V
    ...
    iput-object v0, p0, Lid/l;->q:Lhd/b;

    iget-object v0, p0, Lid/l;->d:Lid/f;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lid/f;->Xb(I)V

    iput v1, p0, Lid/l;->s:I
...
.method public final e()V
    ...
    iget-object v2, v0, Lid/l;->a:Lcom/android/camera/ActivityBase;

    if-eqz v2, :cond_c

    iget-object v3, v0, Lid/l;->e:Lcd/t;

    iget v5, v3, Lcd/t;->g:I
    ...
    iput-object v1, v0, Lid/l;->f:Lw3/c;

    :cond_1
    iget-object v1, v0, Lid/l;->n:Lid/l$a;

    if-nez v1, :cond_2

    new-instance v1, Lid/l$a;

    invoke-direct {v1, v0}, Lid/l$a;-><init>(Lid/l;)V

    iput-object v1, v0, Lid/l;->n:Lid/l$a;
    ...
    :goto_1
    invoke-virtual {v3}, Lcd/t;->f()Z

    move-result v1

    iget-object v4, v0, Lid/l;->d:Lid/f;
    ...
    sget-object v1, Lcd/r;->l:Ljava/lang/String;
    ...
    :cond_4
    sget-object v1, Lcd/r;->g:Ljava/lang/String;
    ...
    iget-object v1, v4, Lid/f;->k:Landroid/util/Size;
    ...
    iget-object v5, v4, Lid/f;->k:Landroid/util/Size;
    ...
    :goto_4
    sget-object v7, Lcd/r;->h:Ljava/lang/String;
    ...
    :goto_5
    invoke-virtual {v4}, Lid/f;->n()I

    move-result v9

    iget-object v7, v0, Lid/l;->f:Lw3/c;

    iget-object v1, v2, Lcom/android/camera/ActivityBase;->j0:Lq5/g;
    ...
    iget-object v14, v0, Lid/l;->n:Lid/l$a;
    ...
    iget-object v7, v0, Lid/l;->j:Lid/k;

    if-eqz v7, :cond_7

    const-wide/16 v8, 0x0

    iput-wide v8, v0, Lid/l;->k:J
    ...
    invoke-direct {v3, v0, v7, v8}, Lid/k;-><init>(Lid/l;J)V

    iput-object v3, v0, Lid/l;->j:Lid/k;
    ...
    iget-object v3, v0, Lid/l;->q:Lhd/b;
    ...
    :cond_a
    invoke-virtual {v4, v6}, Lid/f;->Xb(I)V

    iput-boolean v5, v0, Lid/l;->h:Z

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v1

    iput-wide v1, v0, Lid/l;->i:J
