...
# static fields
.field public static final e:Lig/d;

.field public static final f:Lig/d$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lig/d;->f:Lig/d$a;
    ...
    iput-object v1, v0, Lig/d;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    .line 7
    iput-byte v0, p0, Lig/d;->c:B

    .line 8
    iput v0, p0, Lig/d;->d:I

    .line 9
    sget-object v0, Log/c;->a:Log/o;

    iput-object v0, p0, Lig/d;->a:Log/c;

    return-void
.end method

.method public constructor <init>(Lig/d$b;)V
    .locals 1
    ...
    .line 5
    iput-object p1, p0, Lig/d;->a:Log/c;
...
.method public constructor <init>(Log/d;Log/f;)V
    ...
    iput-object v0, p0, Lig/d;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lig/d;->b:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, Lig/d;->b:Ljava/util/List;

    sget-object v6, Lig/e;->j:Lig/e$a;
    ...
    .line 26
    iget-object p2, p0, Lig/d;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lig/d;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lig/d;->a:Log/c;
    ...
    .line 31
    iget-object p1, p0, Lig/d;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lig/d;->b:Ljava/util/List;
...
.method public final a(Log/e;)V
    ...
    invoke-virtual {p0}, Lig/d;->getSerializedSize()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lig/d;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lig/d;->a:Log/c;
...
.method public final getSerializedSize()I
    ...
    :goto_0
    iget-object v2, p0, Lig/d;->b:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lig/d;->a:Log/c;
...
.method public final isInitialized()Z
    ...
    :goto_0
    iget-object v3, p0, Lig/d;->b:Ljava/util/List;
    ...
    invoke-virtual {v3}, Lig/e;->isInitialized()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lig/d;->c:B
