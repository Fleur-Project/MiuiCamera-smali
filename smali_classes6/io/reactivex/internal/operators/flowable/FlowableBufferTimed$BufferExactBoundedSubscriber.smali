...
# direct methods
.method public constructor <init>(Lxj/c;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;IZLio/reactivex/Scheduler$Worker;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public bridge synthetic accept(Lxj/c;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->accept(Lxj/c;Ljava/util/Collection;)Z
...
.method public dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->upstream:Lxj/d;
...
.method public onComplete()V
    ...
    invoke-static {v0, v1, v2, p0, p0}, Lio/reactivex/internal/util/QueueDrainHelper;->drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lxj/c;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lxj/c;

    invoke-interface {v0, p1}, Lxj/c;->onError(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iput-object p0, v1, Lio/reactivex/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->timer:Lio/reactivex/disposables/Disposable;
    ...
    invoke-virtual {v1}, Lio/reactivex/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->cancel()V

    iget-object p1, v1, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lxj/c;

    invoke-interface {p1, p0}, Lxj/c;->onError(Ljava/lang/Throwable;)V
...
.method public onSubscribe(Lxj/d;)V
    ...
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->upstream:Lxj/d;
    ...
    invoke-interface {v0, p0}, Lxj/c;->onSubscribe(Lxj/d;)V
    ...
    iput-object p0, v2, Lio/reactivex/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->timer:Lio/reactivex/disposables/Disposable;

    const-wide v0, 0x7fffffffffffffffL

    invoke-interface {p1, v0, v1}, Lxj/d;->request(J)V
    ...
    iget-object v0, v2, Lio/reactivex/internal/operators/flowable/FlowableBufferTimed$BufferExactBoundedSubscriber;->w:Lio/reactivex/Scheduler$Worker;

    invoke-interface {v0}, Lio/reactivex/disposables/Disposable;->dispose()V

    invoke-interface {p1}, Lxj/d;->cancel()V

    iget-object p1, v2, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lxj/c;
