...
.method public static subscribe(Lxj/c;Lio/reactivex/functions/Function;ILio/reactivex/internal/util/ErrorMode;)Lxj/c;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {p3, p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableConcatMap$ConcatMapImmediate;-><init>(Lxj/c;Lio/reactivex/functions/Function;I)V
    ...
    invoke-direct {p3, p0, p1, p2, v0}, Lio/reactivex/internal/operators/flowable/FlowableConcatMap$ConcatMapDelayed;-><init>(Lxj/c;Lio/reactivex/functions/Function;IZ)V
...
.method public subscribeActual(Lxj/c;)V
    ...
    invoke-static {v0, p1, v1}, Lio/reactivex/internal/operators/flowable/FlowableScalarXMap;->tryScalarXMapSubscribe(Lxj/b;Lxj/c;Lio/reactivex/functions/Function;)Z
    ...
    invoke-static {p1, v1, v2, p0}, Lio/reactivex/internal/operators/flowable/FlowableConcatMap;->subscribe(Lxj/c;Lio/reactivex/functions/Function;ILio/reactivex/internal/util/ErrorMode;)Lxj/c;

    move-result-object p0

    invoke-virtual {v0, p0}, Lio/reactivex/Flowable;->subscribe(Lxj/c;)V
