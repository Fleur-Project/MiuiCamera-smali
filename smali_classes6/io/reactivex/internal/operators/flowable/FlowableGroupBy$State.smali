...
.method public checkTerminated(ZZLxj/c;ZJ)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p0, p5, p6}, Lxj/d;->request(J)V
...
.method public drainNormal()V
    ...
    :goto_2
    invoke-virtual/range {v0 .. v6}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLxj/c;ZJ)Z
    ...
    iget-object v1, v1, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lxj/d;

    invoke-interface {v1, v5, v6}, Lxj/d;->request(J)V
...
.method public subscribe(Lxj/c;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
