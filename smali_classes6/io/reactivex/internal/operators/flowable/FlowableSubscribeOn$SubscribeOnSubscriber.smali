...
# direct methods
.method public constructor <init>(Lxj/c;Lio/reactivex/Scheduler$Worker;Lxj/b;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Lxj/c;
    ...
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Lxj/b;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Lxj/c;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Lxj/c;
...
.method public onSubscribe(Lxj/d;)V
    ...
    invoke-static {v0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lxj/d;)Z
    ...
    invoke-virtual {p0, v3, v4, p1}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLxj/d;)V
...
.method public request(J)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLxj/d;)V
    ...
    invoke-virtual {p0, v2, v3, p1}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLxj/d;)V

    :cond_1
    return-void
.end method

.method public requestUpstream(JLxj/d;)V
    .locals 2
    ...
    invoke-direct {v0, p3, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber$Request;-><init>(Lxj/d;J)V
    ...
    :cond_1
    :goto_0
    invoke-interface {p3, p1, p2}, Lxj/d;->request(J)V
...
.method public run()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Lxj/b;

    const/4 v1, 0x0

    iput-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Lxj/b;

    invoke-interface {v0, p0}, Lxj/b;->subscribe(Lxj/c;)V
