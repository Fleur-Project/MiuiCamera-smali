...
# direct methods
.method public constructor <init>(Lxj/c;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;IJZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public drainLoop()V
    ...
    iget-object v2, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lxj/c;
    ...
    iget-object v2, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lxj/d;
    ...
    invoke-interface {v2, v3}, Lxj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lxj/d;

    invoke-interface {v1}, Lxj/d;->cancel()V
    ...
    invoke-interface {v2, v1}, Lxj/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v4, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lxj/c;

    invoke-interface {v4, v3}, Lxj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lxj/c;
    ...
    invoke-interface {v1, v2}, Lxj/c;->onError(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p1}, Lxj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lxj/d;

    invoke-interface {p1}, Lxj/d;->cancel()V

    iget-object p1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lxj/c;
    ...
    invoke-interface {p1, v0}, Lxj/c;->onError(Ljava/lang/Throwable;)V
...
.method public onSubscribe(Lxj/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lxj/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lxj/d;
    ...
    invoke-interface {v0, v1}, Lxj/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p0}, Lxj/c;->onError(Ljava/lang/Throwable;)V
