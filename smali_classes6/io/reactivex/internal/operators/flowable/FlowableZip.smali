...
# direct methods
.method public constructor <init>([Lxj/b;Ljava/lang/Iterable;Lio/reactivex/functions/Function;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sources:[Lxj/b;
...
.method public subscribeActual(Lxj/c;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sources:[Lxj/b;
    ...
    invoke-direct/range {v1 .. v6}, Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator;-><init>(Lxj/c;Lio/reactivex/functions/Function;IIZ)V

    invoke-interface {v2, v1}, Lxj/c;->onSubscribe(Lxj/d;)V

    invoke-virtual {v1, v0, v4}, Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator;->subscribe([Lxj/b;I)V
