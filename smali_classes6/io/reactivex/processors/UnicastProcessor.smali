...
# virtual methods
.method public checkTerminated(ZZZLxj/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p0}, Lxj/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p4, p1}, Lxj/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_2
    invoke-interface {p4}, Lxj/c;->onComplete()V
...
.method public drain()V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Lxj/c;)V

    return-void

    :cond_1
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Lxj/c;)V
...
.method public drainFused(Lxj/c;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-interface {p1, v4}, Lxj/c;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Lxj/c;)V
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_2
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLxj/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-interface {v4, v15}, Lxj/c;->onNext(Ljava/lang/Object;)V
