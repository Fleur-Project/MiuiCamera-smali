...
.field private transient reflected:LFf/c;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->getReflected()LFf/c;

    move-result-object p0

    invoke-interface {p0, p1}, LFf/c;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {p0, p1}, LFf/c;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()LFf/c;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/c;->reflected:LFf/c;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->computeReflected()LFf/c;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/c;->reflected:LFf/c;

    :cond_0
    return-object v0
.end method

.method public abstract computeReflected()LFf/c;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {p0}, LFf/b;->getAnnotations()Ljava/util/List;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, LFf/c;->getParameters()Ljava/util/List;
...
.method public getReflected()LFf/c;
    .locals 1
...
.method public getReturnType()LFf/n;
    .locals 0
    ...
    invoke-interface {p0}, LFf/c;->getReturnType()LFf/n;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, LFf/c;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()LFf/r;
    .locals 0
    ...
    invoke-interface {p0}, LFf/c;->getVisibility()LFf/r;
...
.method public isAbstract()Z
    ...
    invoke-interface {p0}, LFf/c;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {p0}, LFf/c;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {p0}, LFf/c;->isOpen()Z
