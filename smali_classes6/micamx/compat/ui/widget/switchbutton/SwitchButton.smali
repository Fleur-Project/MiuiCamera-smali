...
.field public o:Ldh/c;

.field public p:Ldh/a;
...
.method public final getImageViewAttributes()Ldh/a;
    ...
    iget-object p0, p0, Lmicamx/compat/ui/widget/switchbutton/SwitchButton;->p:Ldh/a;
...
.method public final getTextViewAttributes()Ldh/c;
    ...
    iget-object p0, p0, Lmicamx/compat/ui/widget/switchbutton/SwitchButton;->o:Ldh/c;
...
.method public final i(Landroid/view/View;Z)V
    ...
    iget v0, p0, Lmicamx/compat/ui/widget/switchbutton/SwitchButton;->b:I
    ...
    const-string v2, "getChildAt(selectedIndex)"

    invoke-static {v0, v2}, Lkotlin/jvm/internal/k;->e(Ljava/lang/Object;Ljava/lang/String;)V

    const/4 v2, 0x0

    invoke-virtual {v1, v0, v2, p2}, Lmicamx/compat/ui/widget/switchbutton/SwitchButton$a;->a(Landroid/view/View;ZZ)V

    :cond_0
    iget-object v0, p0, Lmicamx/compat/ui/widget/switchbutton/SwitchButton;->a:Lmicamx/compat/ui/widget/switchbutton/SwitchButton$a;

    const/4 v1, 0x1

    invoke-virtual {v0, p1, v1, p2}, Lmicamx/compat/ui/widget/switchbutton/SwitchButton$a;->a(Landroid/view/View;ZZ)V

    if-eqz p2, :cond_1

    new-instance v2, Lmicamx/compat/ui/widget/switchbutton/SwitchButton$b;

    const-string v7, "animateBackgroundTransition(Landroid/view/View;)V"

    const/4 v8, 0x0

    const/4 v3, 0x1

    const-class v5, Lmicamx/compat/ui/widget/switchbutton/SwitchButton;

    const-string v6, "animateBackgroundTransition"
    ...
    new-instance v3, Lmicamx/compat/ui/widget/switchbutton/SwitchButton$c;

    const-string v8, "setBackgroundViewPosition(Landroid/view/View;)V"
    ...
    const-class v6, Lmicamx/compat/ui/widget/switchbutton/SwitchButton;

    const-string v7, "setBackgroundViewPosition"
    ...
    invoke-static {v4}, Landroidx/core/view/ViewGroupKt;->getChildren(Landroid/view/ViewGroup;)LOg/h;

    move-result-object p0

    invoke-static {p0, p1}, LOg/t;->w(LOg/h;Ljava/lang/Object;)I

    move-result p0

    iput p0, v4, Lmicamx/compat/ui/widget/switchbutton/SwitchButton;->b:I
...
.method public final setAdapter(Lmicamx/compat/ui/widget/switchbutton/SwitchButton$a;)V
    ...
    invoke-direct {v0, p1}, Lmh/c;-><init>(F)V
...
.method public final setImageViewAttributes(Ldh/a;)V
    ...
    iput-object p1, p0, Lmicamx/compat/ui/widget/switchbutton/SwitchButton;->p:Ldh/a;
...
.method public final setSelectedIndex(I)V
    ...
    invoke-static {p1, v0, v1}, LEf/f;->G(III)I
...
.method public final setTextViewAttributes(Ldh/c;)V
    ...
    iput-object p1, p0, Lmicamx/compat/ui/widget/switchbutton/SwitchButton;->o:Ldh/c;
