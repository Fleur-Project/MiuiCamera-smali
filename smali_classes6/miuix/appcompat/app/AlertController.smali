...
.method public constructor <init>(Landroid/content/Context;Lmiuix/appcompat/app/AlertDialog;Landroid/view/Window;)V
    ...
    invoke-direct {v2}, LIh/b;-><init>()V

    iput-object v2, p0, Lmiuix/appcompat/app/AlertController;->g0:LIh/b;
    ...
    iput-object v5, v3, Lmiuix/appcompat/app/p;->b:Lyh/c;

    new-instance v5, LBi/a;

    invoke-direct {v5}, Ljava/lang/Object;-><init>()V

    iput-object v5, v3, Lmiuix/appcompat/app/p;->a:LBi/a;
    ...
    sget v3, Lth/a$i;->dialog_enter_duration:I
    ...
    invoke-static {p1, v4}, Lni/b;->b(Landroid/content/Context;Landroid/view/Display;)Z
    ...
    invoke-static {p1}, Lni/b;->e(Landroid/content/Context;)Z
    ...
    sget-object p3, Lth/a$m;->AlertDialog:[I
    ...
    sget v3, Lth/a$m;->AlertDialog_layout:I
    ...
    sget v3, Lth/a$m;->AlertDialog_listLayout:I
    ...
    sget v3, Lth/a$m;->AlertDialog_multiChoiceItemLayout:I
    ...
    sget v3, Lth/a$m;->AlertDialog_singleChoiceItemLayout:I
    ...
    sget v3, Lth/a$m;->AlertDialog_listItemLayout:I
    ...
    sget v1, Lth/a$m;->AlertDialog_showTitle:I
    ...
    invoke-virtual {p0, p2}, Lmiuix/appcompat/app/AlertController;->G(Landroid/content/res/Resources;)V

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget p2, Lth/a$d;->treat_as_land:I
    ...
    invoke-static {p1, v0, p0}, LC/E1;->k(Ljava/lang/StringBuilder;Ljava/lang/String;I)V
...
.method public static a(Lmiuix/appcompat/app/AlertController;Landroid/view/ViewGroup;Landroid/view/ViewGroup;)V
    ...
    invoke-static {v2, v1}, LNh/o;->b(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    :goto_3
    invoke-static {v2}, LNh/k;->e(Landroid/content/Context;)I
    ...
    invoke-static {p1, p0}, Lmiuix/appcompat/app/AlertController;->u(Landroid/view/View;Landroid/view/ViewGroup;)V

    return-void

    :cond_7
    invoke-static {p1, p2}, Lmiuix/appcompat/app/AlertController;->u(Landroid/view/View;Landroid/view/ViewGroup;)V
...
.method public static u(Landroid/view/View;Landroid/view/ViewGroup;)V
    .locals 1
...
.method public final A(FZ)V
    ...
    new-instance v8, Lcom/android/camera/features/mode/aiwatermark/a;

    const/4 v9, 0x4

    invoke-direct {v8, v0, v9}, Lcom/android/camera/features/mode/aiwatermark/a;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v1, v8}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {v0}, Lmiuix/appcompat/app/AlertController;->g()Landroid/graphics/Point;

    move-result-object v1

    invoke-virtual {v0, v1}, Lmiuix/appcompat/app/AlertController;->E(Landroid/graphics/Point;)V
    ...
    invoke-static {v4, v1}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-direct {v8, v0, v9}, Lcom/xiaomi/milive/mode/a;-><init>(Ljava/lang/Object;I)V
    ...
    sget v9, Lth/a$h;->contentPanel:I
    ...
    sget v10, Lth/a$h;->buttonPanel:I
    ...
    invoke-virtual {v0, v15}, Lmiuix/appcompat/app/AlertController;->y(Landroid/widget/FrameLayout;)Z
    ...
    invoke-static {v15}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/View;)V
    ...
    invoke-static {v12}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/View;)V
    ...
    :cond_9
    invoke-virtual {v0}, Lmiuix/appcompat/app/AlertController;->t()V
    ...
    invoke-virtual {v0, v3}, Lmiuix/appcompat/app/AlertController;->x(Landroid/view/ViewGroup;)V
    ...
    invoke-static {v2}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/View;)V

    iget-object v2, v0, Lmiuix/appcompat/app/AlertController;->n:Landroid/widget/ListView;

    sget v3, Lth/a$c;->dialogListPreferredItemHeight:I

    invoke-static {v4, v3}, Lei/d;->f(Landroid/content/Context;I)I
    ...
    invoke-virtual {v0}, Lmiuix/appcompat/app/AlertController;->B()Z
    ...
    invoke-virtual {v0, v2}, Lmiuix/appcompat/app/AlertController;->x(Landroid/view/ViewGroup;)V
    ...
    invoke-static {v11}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/View;)V
    ...
    iget-object v5, v0, Lmiuix/appcompat/app/AlertController;->D:Landroid/widget/Button;

    instance-of v5, v5, Lmiuix/internal/widget/GroupButton;

    if-eqz v5, :cond_20

    iget-object v5, v2, Lmiuix/appcompat/internal/widget/DialogButtonPanel;->m:Ljava/util/ArrayList;

    invoke-virtual {v5}, Ljava/util/ArrayList;->clear()V

    iget-object v5, v0, Lmiuix/appcompat/app/AlertController;->D:Landroid/widget/Button;

    check-cast v5, Lmiuix/internal/widget/GroupButton;
    ...
    iget-object v5, v0, Lmiuix/appcompat/app/AlertController;->G:Landroid/widget/Button;

    instance-of v5, v5, Lmiuix/internal/widget/GroupButton;

    if-eqz v5, :cond_21

    iget-object v5, v2, Lmiuix/appcompat/internal/widget/DialogButtonPanel;->n:Ljava/util/ArrayList;
    ...
    iget-object v5, v0, Lmiuix/appcompat/app/AlertController;->J:Landroid/widget/Button;

    instance-of v5, v5, Lmiuix/internal/widget/GroupButton;

    if-eqz v5, :cond_22

    iget-object v5, v2, Lmiuix/appcompat/internal/widget/DialogButtonPanel;->o:Ljava/util/ArrayList;
    ...
    :cond_22
    iget-object v5, v0, Lmiuix/appcompat/app/AlertController;->M:Ljava/util/ArrayList;
    ...
    sget v11, Lth/a$c;->buttonBarPrimaryButtonStyle:I
    ...
    sget v11, Lth/a$c;->buttonBarButtonStyle:I
    ...
    :cond_2a
    invoke-static {v4}, LNh/o;->e(Landroid/content/Context;)Z
    ...
    :goto_13
    invoke-static {v4}, LNh/k;->e(Landroid/content/Context;)I
    ...
    invoke-static {v4, v5}, LNh/o;->b(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    sget v6, Lth/a$h;->contentPanel:I
    ...
    invoke-static {v9, v2}, Lmiuix/appcompat/app/AlertController;->u(Landroid/view/View;Landroid/view/ViewGroup;)V

    goto :goto_1a

    :cond_31
    invoke-static {v9, v5}, Lmiuix/appcompat/app/AlertController;->u(Landroid/view/View;Landroid/view/ViewGroup;)V

    check-cast v5, Lmiuix/appcompat/internal/widget/NestedScrollViewExpander;

    const/4 v6, 0x0

    invoke-virtual {v5, v6}, Lmiuix/appcompat/internal/widget/NestedScrollViewExpander;->setExpandView(Landroid/view/View;)V
    ...
    iget-object v4, v0, Lmiuix/appcompat/app/AlertController;->V:Landroid/view/View;

    if-eqz v4, :cond_33

    invoke-static {v4}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v5, v14, v4}, Landroid/view/ViewGroup;->addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V

    sget v4, Lth/a$h;->alertTitle:I
    ...
    iput-object v3, v0, Lmiuix/appcompat/app/AlertController;->S:Landroid/widget/TextView;

    iget-object v4, v0, Lmiuix/appcompat/app/AlertController;->k:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget v3, v0, Lmiuix/appcompat/app/AlertController;->N:I
    ...
    :cond_34
    iget-object v3, v0, Lmiuix/appcompat/app/AlertController;->O:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v3, v4, v5, v8, v9}, Landroid/widget/TextView;->setPadding(IIII)V
    ...
    :goto_1c
    iget-boolean v3, v0, Lmiuix/appcompat/app/AlertController;->P:Z
    ...
    iget v4, v10, Lmiuix/appcompat/app/m;->j:I

    iput v4, v3, Landroid/view/ViewGroup$LayoutParams;->width:I

    iget v4, v10, Lmiuix/appcompat/app/m;->k:I

    iput v4, v3, Landroid/view/ViewGroup$LayoutParams;->height:I

    :cond_36
    iget v3, v0, Lmiuix/appcompat/app/AlertController;->Q:I
    ...
    :cond_37
    iget-object v2, v0, Lmiuix/appcompat/app/AlertController;->l:Ljava/lang/CharSequence;
    ...
    iget-object v2, v0, Lmiuix/appcompat/app/AlertController;->S:Landroid/widget/TextView;
    ...
    invoke-virtual {v2, v3, v4, v5, v14}, Landroid/widget/TextView;->setPadding(IIII)V
    ...
    :cond_3b
    :goto_1f
    sget v2, Lth/a$h;->titleDividerNoCustom:I
    ...
    sget v2, Lth/a$h;->checkbox_stub:I
    ...
    invoke-direct {v2, v0, v3}, Lcom/xiaomi/microfilm/dualcam/mode/f;-><init>(Ljava/lang/Object;I)V
...
.method public final C(I)V
    ...
    invoke-static {p1, v0, v1}, LC3/p2;->h(ILjava/lang/String;Ljava/lang/String;)V
...
.method public final D(Landroid/view/WindowInsets;)V
    .locals 7
    ...
    invoke-static {v0}, LNh/k;->j(Landroid/content/Context;)Z
    ...
    :goto_1
    sget-boolean v4, Lni/a;->b:Z

    if-eqz v1, :cond_2

    invoke-static {v0}, LNh/a;->f(Landroid/content/Context;)Z

    move-result v6

    if-nez v6, :cond_2

    invoke-static {v0}, Lni/b;->d(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v4}, Lmiuix/appcompat/app/AlertController;->F(I)V
    ...
    invoke-static {v2, v5, v1}, LC/E1;->k(Ljava/lang/StringBuilder;Ljava/lang/String;I)V
    ...
    invoke-static {v3, p1, v5}, LC3/p2;->h(ILjava/lang/String;Ljava/lang/String;)V
    ...
    :cond_11
    invoke-virtual {p0, v3}, Lmiuix/appcompat/app/AlertController;->C(I)V
...
.method public final E(Landroid/graphics/Point;)V
    ...
    invoke-static {v3, v2}, LNh/o;->b(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    iget-object v10, v9, Lmiuix/appcompat/app/p;->b:Lyh/c;
    ...
    :cond_e
    iget-object v1, v9, Lmiuix/appcompat/app/p;->b:Lyh/c;
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/AlertController;->B()Z
    ...
    sget p1, Lth/a$j;->miuix_appcompat_alert_dialog_content:I
    ...
    sget p1, Lth/a$j;->miuix_appcompat_alert_dialog_content_land:I
    ...
    iget-object p1, p1, Lei/c;->a:Ljava/util/HashMap;
...
.method public final G(Landroid/content/res/Resources;)V
    ...
    sget v0, Lth/a$f;->miuix_appcompat_dialog_max_width:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_dialog_max_width_land:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_dialog_list_view_margin_bottom:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_dialog_ime_margin:I
    ...
    sget v0, Lth/a$f;->fake_landscape_screen_minor_size:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_dialog_width_small_margin:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_dialog_width_margin:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_dialog_freeform_bottom_height_tablet_t:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_dialog_freeform_bottom_height_phone_t:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_dialog_icon_drawable_width_small:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_dialog_icon_drawable_height_small:I
...
.method public final I(Landroid/view/WindowInsets;)V
    ...
    invoke-static {v13}, LNh/a;->e(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {v13, v12}, LNh/o;->b(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    invoke-static {v14, v13}, LNh/k;->p(FF)I

    move-result v13

    int-to-float v3, v3

    invoke-static {v14, v3}, LNh/k;->p(FF)I
    ...
    iget-object v14, v3, Lmiuix/appcompat/app/p;->b:Lyh/c;
    ...
    :goto_5
    new-instance v10, Lmiuix/appcompat/app/o;

    invoke-direct {v10}, Ljava/lang/Object;-><init>()V

    iget-boolean v11, v0, Lmiuix/appcompat/app/AlertController;->O0:Z
    ...
    iget v5, v0, Lmiuix/appcompat/app/AlertController;->t0:I

    iget-boolean v1, v0, Lmiuix/appcompat/app/AlertController;->a:Z

    iput-boolean v11, v10, Lmiuix/appcompat/app/o;->a:Z

    iput-boolean v9, v10, Lmiuix/appcompat/app/o;->b:Z

    iput-boolean v12, v10, Lmiuix/appcompat/app/o;->c:Z

    iput-boolean v14, v10, Lmiuix/appcompat/app/o;->d:Z

    iput v13, v10, Lmiuix/appcompat/app/o;->e:I

    iput v5, v10, Lmiuix/appcompat/app/o;->f:I

    iput-boolean v1, v10, Lmiuix/appcompat/app/o;->g:Z

    iget-object v1, v0, Lmiuix/appcompat/app/AlertController;->A:Lmiuix/appcompat/app/m;

    invoke-virtual {v3, v10, v1}, Lmiuix/appcompat/app/p;->a(Lmiuix/appcompat/app/o;Lmiuix/appcompat/app/m;)I

    move-result v5

    new-instance v9, Lmiuix/appcompat/app/n;
    ...
    iput-object v10, v9, Lmiuix/appcompat/app/n;->j:Landroid/graphics/Rect;
    ...
    iget-object v2, v0, Lmiuix/appcompat/app/AlertController;->h0:Lmiuix/appcompat/internal/widget/DialogRootView;

    invoke-virtual {v2}, Landroid/view/View;->getPaddingLeft()I

    move-result v2

    iget-object v11, v0, Lmiuix/appcompat/app/AlertController;->h0:Lmiuix/appcompat/internal/widget/DialogRootView;
    ...
    iput v2, v9, Lmiuix/appcompat/app/n;->a:I

    iput v11, v9, Lmiuix/appcompat/app/n;->b:I

    iput v6, v9, Lmiuix/appcompat/app/n;->c:I

    iput v5, v9, Lmiuix/appcompat/app/n;->d:I

    iput v13, v9, Lmiuix/appcompat/app/n;->e:I

    iput v15, v9, Lmiuix/appcompat/app/n;->f:I

    iput v8, v9, Lmiuix/appcompat/app/n;->g:I

    iput-boolean v12, v9, Lmiuix/appcompat/app/n;->h:Z

    iput-boolean v14, v9, Lmiuix/appcompat/app/n;->i:Z

    new-instance v2, Landroid/graphics/Rect;

    invoke-direct {v2}, Landroid/graphics/Rect;-><init>()V

    iget-object v3, v3, Lmiuix/appcompat/app/p;->b:Lyh/c;
    ...
    :cond_13
    iget v3, v9, Lmiuix/appcompat/app/n;->g:I

    iget v8, v9, Lmiuix/appcompat/app/n;->c:I

    invoke-static {v3, v8}, Ljava/lang/Math;->max(II)I

    move-result v3

    iget v8, v9, Lmiuix/appcompat/app/n;->a:I

    iget v11, v9, Lmiuix/appcompat/app/n;->b:I
    ...
    :goto_7
    iget v11, v9, Lmiuix/appcompat/app/n;->d:I

    iget v12, v9, Lmiuix/appcompat/app/n;->e:I

    const/16 v13, 0x168

    if-ge v12, v13, :cond_15

    iget v12, v1, Lmiuix/appcompat/app/m;->f:I
    ...
    iget v12, v1, Lmiuix/appcompat/app/m;->g:I
    ...
    iget v6, v9, Lmiuix/appcompat/app/n;->f:I
    ...
    :cond_17
    iget-boolean v6, v9, Lmiuix/appcompat/app/n;->h:Z

    if-eqz v6, :cond_18

    iget v6, v1, Lmiuix/appcompat/app/m;->f:I

    goto :goto_9

    :cond_18
    iget v6, v1, Lmiuix/appcompat/app/m;->d:I
    ...
    :goto_b
    iget-boolean v15, v9, Lmiuix/appcompat/app/n;->i:Z
    ...
    invoke-static {v5, v14, v15}, LC/E1;->k(Ljava/lang/StringBuilder;Ljava/lang/String;I)V
    ...
    iget v8, v9, Lmiuix/appcompat/app/n;->f:I
    ...
    :goto_10
    iget-boolean v9, v9, Lmiuix/appcompat/app/n;->i:Z
    ...
    invoke-static/range {v20 .. v20}, LNh/k;->j(Landroid/content/Context;)Z
    ...
    invoke-static/range {v20 .. v20}, Lni/b;->d(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v5}, Lmiuix/appcompat/app/AlertController;->f(I)Landroid/graphics/Insets;
    ...
    invoke-virtual {v8, v5}, Landroid/view/WindowInsets;->getInsets(I)Landroid/graphics/Insets;
    ...
    :cond_30
    invoke-virtual {v0, v4}, Lmiuix/appcompat/app/AlertController;->k(Landroid/graphics/Rect;)I
...
.method public final J()V
    ...
    invoke-static {v2, v1}, LNh/a;->d(Landroid/content/Context;Landroid/content/res/Configuration;)LNh/n;
    ...
    iget-object v2, v0, LNh/n;->d:Landroid/graphics/Point;
    ...
    iget-object v0, v0, LNh/n;->c:Landroid/graphics/Point;
...
.method public final b(Lmiuix/appcompat/internal/widget/DialogButtonPanel;I)Z
    ...
    invoke-static {v4}, LNh/a;->e(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    :goto_1
    new-instance v8, Lmiuix/appcompat/app/l;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    iput v2, v8, Lmiuix/appcompat/app/l;->a:I

    iput v2, v8, Lmiuix/appcompat/app/l;->b:I

    iput v2, v8, Lmiuix/appcompat/app/l;->c:I

    iput v2, v8, Lmiuix/appcompat/app/l;->d:I
    ...
    iget-object v12, p0, Lmiuix/appcompat/app/AlertController;->B0:Landroid/graphics/Point;
    ...
    :goto_2
    iput v0, v8, Lmiuix/appcompat/app/l;->a:I

    iput v9, v8, Lmiuix/appcompat/app/l;->b:I

    iput v5, v8, Lmiuix/appcompat/app/l;->c:I

    iput v3, v8, Lmiuix/appcompat/app/l;->d:I

    iput-boolean v10, v8, Lmiuix/appcompat/app/l;->e:Z

    iput v11, v8, Lmiuix/appcompat/app/l;->f:I

    move/from16 v0, p2

    iput v0, v8, Lmiuix/appcompat/app/l;->g:I

    iput v12, v8, Lmiuix/appcompat/app/l;->h:I

    iput-boolean v4, v8, Lmiuix/appcompat/app/l;->i:Z

    iput-boolean v13, v8, Lmiuix/appcompat/app/l;->j:Z
    ...
    iget-boolean v4, p0, Lmiuix/appcompat/app/AlertController;->k0:Z
    ...
    iget-object v5, p0, Lmiuix/appcompat/app/AlertController;->j0:Lmiuix/appcompat/internal/widget/DialogParentPanel2;
    ...
    invoke-static {v1, v9, v11, v12, v13}, LQ1/t;->l(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v11, v10, v12, v4, v13}, LM4/u;->m(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/p;->a:LBi/a;
    ...
    :cond_9
    iget p0, v8, Lmiuix/appcompat/app/l;->a:I
    ...
    :cond_a
    iget p0, v8, Lmiuix/appcompat/app/l;->c:I

    invoke-static {p0, v7}, Ljava/lang/Math;->max(II)I

    move-result p0

    iget v0, v8, Lmiuix/appcompat/app/l;->b:I

    iget v1, v8, Lmiuix/appcompat/app/l;->a:I
    ...
    iget v3, v8, Lmiuix/appcompat/app/l;->d:I
    ...
    iget-boolean p0, v8, Lmiuix/appcompat/app/l;->e:Z

    if-eqz p0, :cond_b

    iget v1, v8, Lmiuix/appcompat/app/l;->f:I
    ...
    :goto_5
    iget-boolean v4, v8, Lmiuix/appcompat/app/l;->j:Z

    if-nez v4, :cond_d

    if-nez p0, :cond_c

    iget p0, v8, Lmiuix/appcompat/app/l;->h:I
    ...
    :cond_c
    iget p0, v8, Lmiuix/appcompat/app/l;->g:I
    ...
    :goto_6
    iget-boolean v4, v8, Lmiuix/appcompat/app/l;->i:Z
...
.method public final e(Lmiuix/appcompat/app/h;)V
    ...
    iput-boolean v3, p0, Lmiuix/appcompat/app/AlertController;->W0:Z
    ...
    invoke-virtual {p0, v3}, Lmiuix/appcompat/app/AlertController;->F(I)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/AlertController;->g0:LIh/b;

    invoke-virtual {p0, v0, v1, v2, p1}, LIh/b;->a(Landroid/view/View;ZLandroid/view/View;Lmiuix/appcompat/app/h;)V
...
.method public final g()Landroid/graphics/Point;
    ...
    invoke-virtual {v4, v7}, Landroid/view/WindowInsets;->getInsetsIgnoringVisibility(I)Landroid/graphics/Insets;
    ...
    sget-object v7, LNh/a;->f:Ljava/lang/Object;
    ...
    invoke-static {v4}, LNh/k;->f(Landroid/content/Context;)I
    ...
    :try_start_1
    iget-object v7, p0, Lmiuix/appcompat/app/AlertController;->c:Landroid/content/Context;
    ...
    const-string v9, "context is not associated display info, please check the type of context, the exception info = "
    ...
    iget-object v7, p0, Lmiuix/appcompat/app/AlertController;->u0:Landroid/view/WindowManager;
...
.method public final h()I
    ...
    invoke-virtual {v2, v8}, Landroid/view/WindowInsets;->isVisible(I)Z
...
.method public final i()V
    ...
    invoke-static {v2, v3, v5}, LHi/a;->d(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
...
.method public final j(Landroid/view/WindowInsets;Z)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v1, v0}, Lmiuix/appcompat/app/AlertController;->r(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4, v0}, Lmiuix/appcompat/app/AlertController;->r(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/AlertController;->u0:Landroid/view/WindowManager;
    ...
    invoke-virtual {p0, p1}, Lmiuix/appcompat/app/AlertController;->s(Landroid/graphics/Rect;)V
...
.method public final k(Landroid/graphics/Rect;)I
    ...
    invoke-static {v0}, LNh/a;->e(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-virtual {p0, v5}, Lmiuix/appcompat/app/AlertController;->f(I)Landroid/graphics/Insets;
    ...
    iget-boolean v8, p0, Lmiuix/appcompat/app/AlertController;->a:Z

    if-eqz v8, :cond_4

    new-instance v8, Ljava/lang/StringBuilder;

    const-string v9, "getPanelMaxLimitHeight: boundInset = "

    invoke-direct {v8, v9}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-virtual {v8, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v9, ", topInset = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v9, ", bottomInset = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v9, ", windowHeight = "

    const-string v10, ", verticalMargin = "

    invoke-static {v8, v6, v9, v1, v10}, LM4/u;->m(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V

    invoke-virtual {v8, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v6, ", panelMaxLimitHeight = "
    ...
    :cond_4
    iget-boolean v6, p0, Lmiuix/appcompat/app/AlertController;->v:Z
    ...
    iget v6, v3, Lmiuix/appcompat/app/m;->d:I
    ...
    invoke-static {v0}, LNh/a;->c(Landroid/content/Context;)I
...
.method public final q()Z
    ...
    sget v0, Lth/a$c;->dialogListPreferredItemHeight:I

    iget-object v1, p0, Lmiuix/appcompat/app/AlertController;->c:Landroid/content/Context;

    invoke-static {v1, v0}, Lei/d;->f(Landroid/content/Context;I)I
    ...
    :goto_0
    invoke-static {v1}, LNh/o;->e(Landroid/content/Context;)Z
    ...
    :goto_2
    invoke-static {v1}, LNh/a;->b(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {v1, v9}, LNh/k;->q(Landroid/content/Context;F)I
    ...
    invoke-static {v2, v0, v4, v8, v9}, LQ1/t;->l(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final s(Landroid/graphics/Rect;)V
    ...
    invoke-static {p0, v0}, LNh/k;->p(FF)I
...
.method public final t()V
    ...
    sget v2, Lth/a$c;->dialogListPreferredItemHeight:I

    invoke-static {v1, v2}, Lei/d;->f(Landroid/content/Context;I)I
...
.method public final w(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    .locals 2
...
.method public final x(Landroid/view/ViewGroup;)V
    ...
    :cond_2
    invoke-static {p1}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/View;)V

    return-void
.end method

.method public final y(Landroid/widget/FrameLayout;)Z
    .locals 5
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/View;)V
    ...
    sget p0, Lth/a$l;->Animation_Dialog_ExistIme:I
    ...
    invoke-static {v1, p1}, Lmiuix/appcompat/app/AlertController;->u(Landroid/view/View;Landroid/view/ViewGroup;)V
...
.method public final z()V
    ...
    invoke-virtual {p0, v0}, Lmiuix/appcompat/app/AlertController;->E(Landroid/graphics/Point;)V
    ...
    invoke-static {v3, v5}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v0, v6, v5}, LC/E1;->k(Ljava/lang/StringBuilder;Ljava/lang/String;I)V
    ...
    :goto_2
    invoke-static {v3}, LNh/k;->m(Landroid/content/Context;)Z

    move-result v12

    invoke-static {v3}, LNh/k;->j(Landroid/content/Context;)Z
    ...
    invoke-static {v3}, Lni/b;->d(Landroid/content/Context;)Z
    ...
    invoke-static {v3}, Lei/h;->d(Landroid/content/Context;)Z
    ...
    sget v0, Lth/a$e;->miuix_appcompat_transparent:I
    ...
    sget p0, Lth/a$l;->Animation_Dialog_Center:I
