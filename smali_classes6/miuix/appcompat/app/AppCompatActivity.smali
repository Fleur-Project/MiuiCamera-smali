...
.method public static synthetic Zi(Lmiuix/appcompat/app/AppCompatActivity;)V
    .locals 0
...
.method public static synthetic aj(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/MenuItem;)Z
    .locals 0
...
.method public static synthetic bj(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/Menu;)Z
    .locals 0
...
.method public static synthetic cj(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/View;Landroid/view/Menu;)Z
    .locals 0
...
.method public final O9()V
    ...
    invoke-interface {p0}, Lvh/e;->O9()V
...
.method public final P4()V
    ...
    invoke-interface {p0}, Lvh/e;->P4()V
...
.method public bindViewWithContentInset(Landroid/view/View;)V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lei/h$b;-><init>(IIII)V

    iput-object v0, p0, Lmiuix/appcompat/app/d;->p:Lei/h$b;
...
.method public final dj()Landroid/view/View;
    .locals 0
    ...
    invoke-virtual {p0}, Lwh/a;->b()Landroid/view/View;
...
.method public finish()V
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/j;->d0:Lwh/a;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lwh/a;->a()Z
...
.method public final of()V
    ...
    invoke-interface {p0}, Lvh/e;->of()V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v1}, LLi/b;->c()V

    :cond_0
    iget-object p0, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LNh/n;

    iget-boolean v1, p0, LNh/n;->a:Z

    if-nez v1, :cond_2

    iget-boolean v1, p0, LNh/n;->b:Z
    ...
    :cond_1
    sget-object v1, LNh/a;->a:Landroid/graphics/Point;

    const/4 v1, 0x1

    iput-boolean v1, p0, LNh/n;->b:Z

    iput-boolean v1, p0, LNh/n;->a:Z

    :cond_2
    :goto_0
    iget-object p0, v0, Lmiuix/appcompat/app/d;->a:Lmiuix/appcompat/app/AppCompatActivity;

    iget-object v1, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LNh/n;

    const/4 v2, 0x0

    invoke-static {p0, v1, p1, v2}, LNh/a;->k(Landroid/content/Context;LNh/n;Landroid/content/res/Configuration;Z)V

    new-instance v1, LC/N0;

    const/4 v2, 0x6

    invoke-direct {v1, v2, v0, p1}, LC/N0;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    iput-object v1, v0, Lmiuix/appcompat/app/j;->l0:LC/N0;
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/j;->l0:LC/N0;
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/d;->t:LLh/b;

    invoke-virtual {p0, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(LLh/b;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p0}, LNh/a;->i(Landroid/content/Context;)V
    ...
    sget-boolean v2, LCh/c;->a:Z

    const/4 v3, 0x1

    if-nez v2, :cond_0

    sput-boolean v3, LCh/c;->a:Z
    ...
    invoke-direct {v5, v2, v6}, LA5/c;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_0
    sget v2, Lth/a$c;->windowExtraPaddingHorizontal:I

    const/4 v4, 0x0

    invoke-static {v2, v1, v4}, Lei/d;->i(ILandroid/content/Context;I)I
    ...
    :cond_1
    sget v2, Lth/a$c;->windowExtraPaddingHorizontalEnable:I
    ...
    :cond_2
    sget v4, Lth/a$c;->windowExtraPaddingHorizontalInitEnable:I

    iget-boolean v5, v0, Lmiuix/appcompat/app/d;->w:Z

    invoke-static {v1, v4, v5}, Lei/d;->d(Landroid/content/Context;IZ)Z
    ...
    :cond_3
    sget v5, Lth/a$c;->windowExtraPaddingApplyToContentEnable:I

    iget-boolean v6, v0, Lmiuix/appcompat/app/d;->x:Z

    invoke-static {v1, v5, v6}, Lei/d;->d(Landroid/content/Context;IZ)Z
    ...
    :goto_0
    invoke-static {p0}, LNh/a;->a(Landroid/content/Context;)LNh/n;

    move-result-object p1

    const/4 v0, 0x0

    invoke-static {p0, p1, v0, v3}, LNh/a;->k(Landroid/content/Context;LNh/n;Landroid/content/res/Configuration;Z)V

    iput-object p1, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LNh/n;

    invoke-static {p0}, LNh/k;->n(Landroid/content/Context;)Z
...
.method public onDestroy()V
    ...
    iget-object v0, v0, Lmiuix/appcompat/app/j;->l0:LC/N0;
    ...
    :cond_2
    invoke-static {p0}, LNh/a;->j(Landroid/content/Context;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LNh/n;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/j;->d0:Lwh/a;
...
.method public onStop()V
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AppCompatActivity;->Zi(Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    invoke-virtual {p0, p1}, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->E(Landroid/view/ActionMode$Callback;)LDh/b;
...
.method public final startActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    sget v1, Lth/a$h;->content_mask_vs:I
    ...
    :cond_0
    sget v1, Lth/a$h;->content_mask:I
