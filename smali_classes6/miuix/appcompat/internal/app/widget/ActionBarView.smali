...
.field public F0:Lmiuix/appcompat/internal/app/widget/j;
...
.field public final q1:LFh/a;

.field public final r0:I

.field public final r1:LFh/a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Z

    const/4 v3, 0x1

    iput-boolean v3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->R0:Z
    ...
    sget v11, Lth/a$f;->miuix_appcompat_action_bar_title_horizontal_padding:I
    ...
    sget v11, Lth/a$f;->miuix_appcompat_action_bar_title_tab_horizontal_padding:I
    ...
    sget v11, Lth/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v11, Lth/a$f;->miuix_appcompat_action_bar_title_bottom_padding:I
    ...
    sget v12, Lth/a$f;->miuix_appcompat_action_bar_subtitle_bottom_padding:I
    ...
    sget v12, Lth/a$f;->miuix_appcompat_action_bar_secondary_tab_vertical_padding:I
    ...
    sget v12, Lth/a$f;->miuix_appcompat_action_bar_up_view_margin_start:I
    ...
    sget v11, Lth/a$f;->miuix_appcompat_action_bar_title_padding_gap:I
    ...
    sget v5, Lth/a$h;->action_bar_collapse_container:I
    ...
    sget v7, Lth/a$h;->action_bar_movable_container:I
    ...
    sget-object v1, Lth/a$m;->ActionBar:[I
    ...
    sget v1, Lth/a$m;->ActionBar_android_navigationMode:I
    ...
    sget v1, Lth/a$m;->ActionBar_android_title:I

    invoke-virtual {p2, v1}, Landroid/content/res/TypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v1

    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->h0:Ljava/lang/CharSequence;

    sget v1, Lth/a$m;->ActionBar_android_subtitle:I
    ...
    sget v1, Lth/a$m;->ActionBar_titleCenter:I
    ...
    sget v1, Lth/a$m;->ActionBar_android_logo:I
    ...
    sget v1, Lth/a$m;->ActionBar_android_icon:I

    invoke-virtual {p2, v1}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->l0:Landroid/graphics/drawable/Drawable;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v1

    sget v4, Lth/a$m;->ActionBar_navigatorSwitchLayout:I

    sget v5, Lth/a$j;->miuix_appcompat_action_bar_navigator_switch:I
    ...
    sget v4, Lth/a$m;->ActionBar_android_homeLayout:I

    sget v5, Lth/a$j;->miuix_appcompat_action_bar_home:I
    ...
    sget v4, Lth/a$m;->ActionBar_android_titleTextStyle:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    sget v4, Lth/a$m;->ActionBar_android_subtitleTextStyle:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    sget v4, Lth/a$m;->ActionBar_android_progressBarPadding:I
    ...
    sget v4, Lth/a$m;->ActionBar_android_itemPadding:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    sget v4, Lth/a$m;->ActionBar_android_displayOptions:I
    ...
    sget v4, Lth/a$m;->ActionBar_android_customNavigationLayout:I
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->J0:Landroid/view/View;
    ...
    :cond_2
    sget v0, Lth/a$m;->ActionBar_android_minHeight:I
    ...
    sget v0, Lth/a$m;->ActionBar_android_maxHeight:I
    ...
    sget v0, Lth/a$m;->ActionBar_actionBarMaxSizeInLargeFont:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v4, Lth/a$f;->miuix_appcompat_action_bar_large_font_max_height:I
    ...
    sget v1, Lth/a$c;->actionBarTitleAdaptLargeFont:I

    invoke-static {p1, v1, v3}, Lei/d;->d(Landroid/content/Context;IZ)Z

    move-result v1

    invoke-static {p1}, LNh/k;->e(Landroid/content/Context;)I
    ...
    sget v0, Lth/a$m;->ActionBar_showOptionIcons:I
    ...
    invoke-direct {p2, p1, v1, v0}, LFh/a;-><init>(Landroid/content/Context;ILjava/lang/CharSequence;)V

    iput-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->q1:LFh/a;
    ...
    iput-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->r1:LFh/a;

    new-instance p1, LC/l3;

    const/16 p2, 0x12

    invoke-direct {p1, p0, p2}, LC/l3;-><init>(Ljava/lang/Object;I)V
...
.method private setTitleImpl(Ljava/lang/CharSequence;)V
    ...
    iget-object v3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->q1:LFh/a;

    if-eqz v3, :cond_2

    iput-object p1, v3, LFh/a;->b:Ljava/lang/CharSequence;

    :cond_2
    iget-object v3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->r1:LFh/a;
    ...
    :cond_8
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;

    if-eqz p1, :cond_9

    iget-object p1, p1, LBh/b;->b:Landroid/widget/LinearLayout;
    ...
    :cond_9
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;

    if-eqz p1, :cond_a

    if-nez v2, :cond_a

    iget-object p1, p1, LBh/d;->b:Landroid/widget/LinearLayout;
...
.method private setTitleVisibility(Z)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;
    ...
    :goto_0
    iget-boolean v5, v0, LBh/b;->e:Z

    if-nez v5, :cond_1

    if-nez v4, :cond_1

    iget-object v0, v0, LBh/b;->b:Landroid/widget/LinearLayout;
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;
    ...
    :goto_2
    invoke-virtual {v0, p1}, LBh/d;->c(I)V
...
.method public final A(Z)V
    ...
    iput-boolean v2, v1, LBh/d;->e:Z

    new-instance v3, LBh/d$a;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-object v3, v1, LBh/d;->h:LBh/d$a;

    iput-object v0, v1, LBh/d;->a:Landroid/content/Context;

    sget v3, Lth/a$l;->Miuix_AppCompat_TextAppearance_WindowTitle_Expand:I

    iput v3, v1, LBh/d;->f:I

    sget v3, Lth/a$l;->Miuix_AppCompat_TextAppearance_WindowTitle_Subtitle_Expand:I

    iput v3, v1, LBh/d;->g:I

    new-instance v3, Landroid/widget/LinearLayout;

    invoke-direct {v3, v0}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v3, v1, LBh/d;->b:Landroid/widget/LinearLayout;

    const/4 v4, 0x2

    invoke-virtual {v3, v4}, Landroid/view/View;->setImportantForAccessibility(I)V

    iget-object v3, v1, LBh/d;->b:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v5, v1, v6}, LBh/c;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v3, v5}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    new-instance v3, LDh/d;

    sget v5, Lth/a$c;->expandTitleTheme:I

    invoke-direct {v3, v0, v5}, LDh/d;-><init>(Landroid/content/Context;I)V

    iput-object v3, v1, LBh/d;->c:LDh/d;

    sget v5, Lth/a$h;->action_bar_title_expand:I

    invoke-virtual {v3, v5}, Landroid/view/View;->setId(I)V

    iget-object v3, v1, LBh/d;->c:LDh/d;
    ...
    invoke-static {v3}, LRg/H;->h(Landroid/widget/TextView;)V

    :cond_0
    iget-object v3, v1, LBh/d;->b:Landroid/widget/LinearLayout;

    iget-object v6, v1, LBh/d;->c:LDh/d;
    ...
    sget v6, Lth/a$c;->expandSubtitleTheme:I

    invoke-direct {v3, v0, v6}, LDh/d;-><init>(Landroid/content/Context;I)V

    iput-object v3, v1, LBh/d;->d:LDh/d;

    sget v6, Lth/a$h;->action_bar_subtitle_expand:I

    invoke-virtual {v3, v6}, Landroid/view/View;->setId(I)V

    iget-object v3, v1, LBh/d;->d:LDh/d;
    ...
    iget-object v7, v1, LBh/d;->d:LDh/d;
    ...
    sget v7, Lth/a$f;->action_bar_subtitle_top_margin:I
    ...
    sget v7, Lth/a$f;->action_bar_subtitle_bottom_margin:I
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;

    iget-boolean v0, v1, LBh/d;->e:Z

    iget-boolean v3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->i1:Z

    if-eq v0, v3, :cond_2

    iput-boolean v3, v1, LBh/d;->e:Z

    iget-object v0, v1, LBh/d;->b:Landroid/widget/LinearLayout;
    ...
    :cond_3
    iget-object v0, v0, LBh/d;->d:LDh/d;
    ...
    sget v7, Lth/a$h;->action_bar_expand_container:I
    ...
    :goto_2
    iget-object v7, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;

    invoke-virtual {v7, v0}, LBh/d;->b(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;

    iget-boolean v7, p0, Lmiuix/appcompat/internal/app/widget/a;->x:Z

    iget-object v8, v0, LBh/d;->c:LDh/d;
    ...
    invoke-direct {v9, v0, v10}, LA9/a;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v8, v9}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    iget-object v0, v0, LBh/d;->c:LDh/d;
    ...
    :goto_3
    iget-object v5, v0, LBh/d;->d:LDh/d;
    ...
    iget-object v2, v0, LBh/d;->d:LDh/d;

    iget-object v0, v0, LBh/d;->h:LBh/d$a;
    ...
    invoke-virtual {v0, v1}, LBh/d;->a(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;

    iget-object p0, p0, LBh/d;->b:Landroid/widget/LinearLayout;
...
.method public final G()V
    ...
    sget v2, Lth/a$c;->actionBarIndeterminateProgressStyle:I
    ...
    sget v1, Lth/a$h;->progress_circular:I
...
.method public final H()V
    ...
    sget v6, Lth/a$f;->miuix_appcompat_action_bar_title_view_padding_horizontal:I
    ...
    invoke-direct {v7, v5, v6}, LCh/a;-><init>(ILandroid/widget/FrameLayout;)V

    invoke-virtual {v6, v7}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    sget v5, Lth/a$h;->up:I
    ...
    sget v7, Lth/a$k;->actionbar_button_up_description:I
    ...
    new-instance v7, LC/L1;

    const/4 v8, 0x2

    invoke-direct {v7, v8, v5, v1}, LC/L1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;
    ...
    invoke-direct {v1, p0, v2}, LC/W;-><init>(Ljava/lang/Object;I)V
...
.method public final K()Z
    ...
    invoke-static {p0}, LDh/a;->a(Landroid/content/Context;)LDh/a;

    move-result-object p0

    sget v0, Lth/a$c;->actionBarTightTitle:I

    iget-object p0, p0, LDh/a;->a:Landroid/content/Context;

    invoke-static {p0, v0, v1}, Lei/d;->d(Landroid/content/Context;IZ)Z
...
.method public final P()V
    ...
    sget v3, Lth/a$c;->actionBarPaddingStart:I

    invoke-static {v2, v3}, Lei/d;->f(Landroid/content/Context;I)I
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;

    iget-object v2, v2, LBh/b;->b:Landroid/widget/LinearLayout;
...
.method public final S(Lmiuix/appcompat/internal/app/widget/j;Lmiuix/appcompat/internal/app/widget/l;Lmiuix/appcompat/internal/app/widget/o;Lmiuix/appcompat/internal/app/widget/o;)V
    ...
    iput-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->F0:Lmiuix/appcompat/internal/app/widget/j;

    iput-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->G0:Lmiuix/appcompat/internal/app/widget/l;
...
.method public final V()V
    ...
    invoke-static {p0}, Landroidx/appsearch/platformstorage/m;->b(Lmiuix/appcompat/internal/app/widget/ActionBarView;)Landroid/window/OnBackInvokedDispatcher;
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->z1:LIh/j;
    ...
    invoke-direct {v1, p0, v2}, LIh/j;-><init>(Ljava/lang/Object;I)V

    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->z1:LIh/j;

    :cond_1
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->z1:LIh/j;

    invoke-static {v0, v1}, Landroidx/appsearch/platformstorage/converter/e;->d(Landroid/window/OnBackInvokedDispatcher;LIh/j;)V
    ...
    invoke-static {v0, v1}, Landroidx/appsearch/platformstorage/converter/r;->c(Landroid/window/OnBackInvokedDispatcher;LIh/j;)V
...
.method public final X()V
    ...
    iget-object v0, v0, LBh/b;->c:LDh/c;
    ...
    invoke-virtual {v0, v1}, LBh/b;->c(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;

    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->i0:Ljava/lang/CharSequence;

    invoke-virtual {v0, v1}, LBh/b;->b(Ljava/lang/CharSequence;)V
...
.method public final Y()V
    ...
    :goto_0
    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;

    iget-object v2, v2, LBh/d;->c:LDh/d;
    ...
    invoke-virtual {v0, v1}, LBh/d;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p0}, LBh/d;->a(Ljava/lang/CharSequence;)V
...
.method public final Z()Z
    ...
    sget v1, Lth/a$h;->action_bar_expand_container:I
    ...
    invoke-virtual {v0, v2}, LBh/d;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v2, v4}, LBh/d;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v1}, LBh/d;->c(I)V

    :cond_3
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;

    iget-object p0, p0, LBh/d;->d:LDh/d;
...
.method public final b0()V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->F0:Lmiuix/appcompat/internal/app/widget/j;
...
.method public final c0()V
    ...
    :goto_1
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;

    if-eqz v4, :cond_3

    iget-object v4, v4, LBh/b;->c:LDh/c;
...
.method public getCollapseTitle()LBh/b;
    .locals 1
...
.method public getExpandTitle()LBh/d;
    .locals 1
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    sget-object v0, Lth/a$m;->ActionBar:[I
    ...
    sget v2, Lth/a$c;->actionBarTitleAdaptLargeFont:I

    const/4 v4, 0x1

    invoke-static {v1, v2, v4}, Lei/d;->d(Landroid/content/Context;IZ)Z

    move-result v2

    invoke-static {v1}, LNh/k;->e(Landroid/content/Context;)I
    ...
    iget-object v0, p1, LBh/d;->c:LDh/d;

    iget v2, p1, LBh/d;->f:I

    invoke-virtual {v0, v2}, Landroid/widget/TextView;->setTextAppearance(I)V

    iget-object v0, p1, LBh/d;->d:LDh/d;

    iget v2, p1, LBh/d;->g:I
    ...
    iget-object p1, p1, LBh/d;->c:LDh/d;

    invoke-static {p1}, LRg/H;->h(Landroid/widget/TextView;)V
    ...
    sget v0, Lth/a$f;->miuix_appcompat_action_bar_title_tab_horizontal_padding:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_action_bar_title_bottom_padding:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_action_bar_subtitle_bottom_padding:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_action_bar_up_view_margin_start:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_action_bar_title_padding_gap:I
    ...
    :cond_3
    sget v0, Lth/a$f;->miuix_appcompat_action_bar_title_horizontal_padding:I
    ...
    sget v4, Lth/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v0, Lth/a$f;->miuix_appcompat_action_bar_secondary_tab_vertical_padding:I
    ...
    sget v0, Lth/a$c;->actionBarPaddingStart:I

    invoke-static {p1, v0}, Lei/d;->f(Landroid/content/Context;I)I
    ...
    sget v1, Lth/a$c;->actionBarPaddingEnd:I

    invoke-static {v0, v1}, Lei/d;->f(Landroid/content/Context;I)I
    ...
    invoke-direct {p1, p0, v0}, LA9/k;-><init>(Ljava/lang/Object;I)V
...
.method public final onLayout(ZIIII)V
    ...
    iget-object v8, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->w0:Landroid/widget/FrameLayout;
    ...
    iget v10, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->O1:I

    iget-object v11, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Landroid/widget/FrameLayout;

    invoke-virtual {v11}, Landroid/view/View;->getMeasuredHeight()I

    move-result v1

    iget v12, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->P1:I
    ...
    iget-object v15, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->z0:Landroid/widget/FrameLayout;
    ...
    iget-object v14, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->N0:Lmiuix/appcompat/internal/view/menu/action/b;
    ...
    :cond_6
    iget-object v14, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->M0:Landroid/view/View;
    ...
    :cond_7
    iget-object v14, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->K0:Landroid/widget/ProgressBar;
    ...
    iget-object v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->K0:Landroid/widget/ProgressBar;
    ...
    :goto_2
    iget-object v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->q0:Landroid/view/View;
    ...
    :cond_b
    iget-object v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->u0:Lmiuix/appcompat/internal/app/widget/ActionBarView$HomeView;
    ...
    :cond_e
    iget-object v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->E0:Landroid/widget/FrameLayout;
    ...
    :goto_a
    iget-object v2, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;

    if-eqz v2, :cond_12

    iget-object v2, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->h0:Ljava/lang/CharSequence;
    ...
    iget-object v10, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->h0:Ljava/lang/CharSequence;
    ...
    iget-object v12, v2, LBh/b;->c:LDh/c;
    ...
    iput v12, v2, LBh/b;->h:F

    const/4 v12, 0x1

    iput-boolean v12, v2, LBh/b;->g:Z
    ...
    iput v15, v2, LBh/b;->h:F

    iput-boolean v12, v2, LBh/b;->g:Z

    :cond_15
    :goto_b
    iget-boolean v12, v2, LBh/b;->g:Z
    ...
    iput v10, v2, LBh/b;->i:F

    const/4 v10, 0x0

    iput-boolean v10, v2, LBh/b;->g:Z

    :cond_16
    iget-object v10, v2, LBh/b;->c:LDh/c;
    ...
    :cond_17
    iget v10, v2, LBh/b;->i:F

    iget-object v2, v2, LBh/b;->c:LDh/c;
    ...
    :goto_d
    iget-object v10, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->n0:Landroid/content/Context;

    invoke-static {v10}, LDh/a;->a(Landroid/content/Context;)LDh/a;

    move-result-object v10

    sget v12, Lth/a$c;->actionBarTitleEnableEllipsis:I

    iget-object v10, v10, LDh/a;->a:Landroid/content/Context;

    const/4 v15, 0x0

    invoke-static {v10, v12, v15}, Lei/d;->d(Landroid/content/Context;IZ)Z
    ...
    invoke-static {v4, v10, v12, v3}, LC/R1;->d(IIII)I
    ...
    invoke-static/range {v0 .. v5}, Lei/h;->e(Landroid/view/ViewGroup;Landroid/view/View;IIII)V
    ...
    iget v4, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->M1:I
    ...
    iget v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->X0:I

    iget v2, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->U0:I
    ...
    :goto_1f
    iget v13, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->P1:I
    ...
    iget v3, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->U0:I
    ...
    iget v3, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->X0:I
    ...
    iget v4, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->X0:I
    ...
    :cond_3f
    :goto_26
    iget-boolean v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->V1:Z

    if-nez v1, :cond_4b

    iget-boolean v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->X1:Z
    ...
    iget-object v11, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->Q1:Lmiuix/appcompat/internal/app/widget/a$b;
    ...
    iput v4, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C1:F
    ...
    iget-boolean v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->J1:Z

    if-eqz v1, :cond_42

    const/4 v15, 0x0

    iput-boolean v15, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->J1:Z
    ...
    iget v2, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->K1:I
    ...
    iput-boolean v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->J1:Z
    ...
    iget v5, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->K1:I
    ...
    :cond_45
    :goto_27
    iget v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C1:F
    ...
    :goto_28
    iput-boolean v14, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D1:Z

    iput v10, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->K1:I

    const/high16 v2, 0x3f800000    # 1.0f

    iput v2, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C1:F
    ...
    iput-boolean v15, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D1:Z

    iput v15, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->K1:I

    iput v9, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C1:F

    const/4 v12, 0x1

    iput-boolean v12, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->J1:Z
...
.method public final onMeasure(II)V
    ...
    sget v2, Lth/a$h;->miuix_appcompat_navigator_switch_presenter:I
    ...
    iget-object v11, v2, LAh/b;->a:Landroid/view/View;

    iget v2, v2, LAh/b;->b:I
    ...
    :goto_5
    iget-object v5, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->N0:Lmiuix/appcompat/internal/view/menu/action/b;
    ...
    :cond_e
    iget-object v5, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->K0:Landroid/widget/ProgressBar;
    ...
    iget-object v11, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;
    ...
    iget-object v5, v11, LBh/b;->c:LDh/c;
    ...
    iget-object v5, v11, LBh/b;->d:LDh/d;
    ...
    :goto_b
    iget-object v8, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->L0:Landroid/view/View;
    ...
    iget-object v8, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->E0:Landroid/widget/FrameLayout;
    ...
    iget v3, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->c1:I
    ...
    iget-object v2, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->F0:Lmiuix/appcompat/internal/app/widget/j;
    ...
    iget-object v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->F0:Lmiuix/appcompat/internal/app/widget/j;
    ...
    iget-object v9, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->Q0:LLh/b;

    if-eqz v9, :cond_34

    iget-boolean v10, v9, LLh/b;->a:Z

    if-eqz v10, :cond_34

    invoke-virtual {v9}, LLh/b;->a()I
    ...
    iget v10, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->X0:I

    iget v12, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->U0:I
...
.method public final s()V
    ...
    invoke-virtual {v0, v2}, LBh/d;->c(I)V
    ...
    iget-object v2, v2, LBh/d;->b:Landroid/widget/LinearLayout;
...
.method public setDisplayOptions(I)V
    ...
    :cond_e
    iget-object v9, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;

    if-eqz v9, :cond_f

    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->w0:Landroid/widget/FrameLayout;

    iget-object v9, v9, LBh/b;->b:Landroid/widget/LinearLayout;

    invoke-virtual {v11, v9}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_f
    iget-object v9, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;

    if-eqz v9, :cond_10

    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Landroid/widget/FrameLayout;

    iget-object v9, v9, LBh/d;->b:Landroid/widget/LinearLayout;

    invoke-virtual {v11, v9}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_10
    iput-object v5, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;

    iput-object v5, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;
    ...
    :goto_9
    iget-object v10, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;

    if-eqz v10, :cond_14

    iget-object v10, v10, LBh/b;->b:Landroid/widget/LinearLayout;
    ...
    :goto_a
    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:LBh/d;

    if-eqz v11, :cond_15

    iget-object v11, v11, LBh/d;->b:Landroid/widget/LinearLayout;
    ...
    sget v1, Lth/a$h;->miuix_appcompat_navigator_switch_presenter:I

    new-instance v2, LAh/b;

    invoke-direct {v2, v0}, LAh/b;-><init>(Landroid/view/View;)V
    ...
    sget v0, Lth/a$k;->abc_action_bar_up_description:I
    ...
    sget v0, Lth/a$k;->abc_action_bar_home_description:I
...
.method public setExtraPaddingPolicy(LLh/b;)V
    .locals 0

    iput-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->Q0:LLh/b;
...
.method public setSplitActionBar(Z)V
    ...
    sget v1, Lth/a$d;->abc_action_bar_expanded_action_views_exclusive:I
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, LBh/b;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, LBh/d;->a(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p1, p0, v0}, LBc/b;-><init>(Ljava/lang/Object;I)V
...
.method public setTitleClickable(Z)V
    ...
    iget-object p0, p0, LBh/d;->c:LDh/d;
...
.method public final t()V
    ...
    sget v0, Lth/a$h;->action_bar_collapse_tab_container:I
...
.method public final u()V
    ...
    sget v0, Lth/a$h;->action_bar_movable_tab_container:I
...
.method public final v()V
    ...
    invoke-static {v5, v6}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v2, v5}, Lei/h;->f(ILandroid/view/View;)V
    ...
    invoke-static {v5, v6}, Lei/h;->f(ILandroid/view/View;)V
    ...
    sget v1, Lth/a$h;->expanded_menu:I
...
.method public final w()V
    ...
    sget v8, Lth/a$h;->action_bar_expand_container:I
    ...
    invoke-static {v0}, LDh/a;->a(Landroid/content/Context;)LDh/a;

    move-result-object v0

    sget v3, Lth/a$c;->actionBarTightTitle:I

    iget-object v0, v0, LDh/a;->a:Landroid/content/Context;

    invoke-static {v0, v3, v7}, Lei/d;->d(Landroid/content/Context;IZ)Z
...
.method public final x()V
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->F0:Lmiuix/appcompat/internal/app/widget/j;
...
.method public final z(Z)V
    ...
    iput-boolean v2, v1, LBh/b;->e:Z

    const/4 v3, 0x0

    iput v3, v1, LBh/b;->f:F

    const/4 v4, 0x0

    iput-boolean v4, v1, LBh/b;->g:Z

    const/high16 v5, -0x40800000    # -1.0f

    iput v5, v1, LBh/b;->h:F

    iput v3, v1, LBh/b;->i:F

    iput-boolean v4, v1, LBh/b;->j:Z

    const/4 v3, 0x2

    iput v3, v1, LBh/b;->k:I

    new-instance v5, LBh/b$a;

    invoke-direct {v5}, Ljava/lang/Object;-><init>()V

    iput-object v5, v1, LBh/b;->l:LBh/b$a;

    iput-object v0, v1, LBh/b;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v6}, LNh/a;->d(Landroid/content/Context;Landroid/content/res/Configuration;)LNh/n;

    sget v6, Lth/a$f;->miuix_appcompat_subtitle_text_size:I
    ...
    iput v6, v1, LBh/b;->f:F

    new-instance v6, Landroid/widget/LinearLayout;

    invoke-direct {v6, v0}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v6, v1, LBh/b;->b:Landroid/widget/LinearLayout;

    invoke-virtual {v6, v3}, Landroid/view/View;->setImportantForAccessibility(I)V

    new-instance v6, LDh/c;

    sget v7, Lth/a$c;->collapseTitleTheme:I

    invoke-direct {v6, v0, v7}, LDh/c;-><init>(Landroid/content/Context;I)V

    iput-object v6, v1, LBh/b;->c:LDh/c;

    invoke-virtual {v6, v4}, Landroid/view/View;->setVerticalScrollBarEnabled(Z)V

    iget-object v6, v1, LBh/b;->c:LDh/c;
    ...
    sget v6, Lth/a$c;->actionBarTitleAdaptLargeFont:I

    invoke-static {v0, v6, v2}, Lei/d;->d(Landroid/content/Context;IZ)Z

    move-result v6

    invoke-static {v0}, LNh/k;->e(Landroid/content/Context;)I
    ...
    :goto_1
    iput-boolean v6, v1, LBh/b;->j:Z

    if-eqz v6, :cond_2

    sget v6, Lth/a$c;->collapseTitleLargeFontMaxLine:I

    invoke-static {v6, v0, v3}, Lei/d;->i(ILandroid/content/Context;I)I

    move-result v6

    iput v6, v1, LBh/b;->k:I
    ...
    iget v7, v1, LBh/b;->k:I

    invoke-virtual {v6, v7}, Landroid/widget/TextView;->setMaxLines(I)V

    :cond_2
    sget v6, Lth/a$c;->collapseSubtitleTheme:I

    new-instance v7, LDh/d;

    invoke-direct {v7, v0, v6}, LDh/d;-><init>(Landroid/content/Context;I)V

    iput-object v7, v1, LBh/b;->d:LDh/d;

    invoke-virtual {v7, v4}, Landroid/view/View;->setVerticalScrollBarEnabled(Z)V

    iget-object v0, v1, LBh/b;->d:LDh/d;

    invoke-virtual {v0, v4}, Landroid/view/View;->setHorizontalScrollBarEnabled(Z)V

    iget-object v0, v1, LBh/b;->b:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v6, v1, v7}, LB2/k;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v6}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    iget-object v0, v1, LBh/b;->c:LDh/c;

    sget v6, Lth/a$h;->action_bar_title:I
    ...
    sget v6, Lth/a$h;->action_bar_subtitle:I
    ...
    iget-object v7, v1, LBh/b;->d:LDh/d;
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->B0:LBh/b;

    iget-boolean v0, v1, LBh/b;->e:Z

    iget-boolean v5, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->h1:Z

    if-eq v0, v5, :cond_4

    iput-boolean v5, v1, LBh/b;->e:Z
    ...
    iget-object v5, v0, LBh/b;->c:LDh/c;
    ...
    new-instance v7, LBh/a;

    const/4 v8, 0x0

    invoke-direct {v7, v0, v8}, LBh/a;-><init>(Ljava/lang/Object;I)V
    ...
    :goto_3
    iget-object v1, v0, LBh/b;->d:LDh/d;
    ...
    iget-object v0, v0, LBh/b;->l:LBh/b$a;
    ...
    iget-object p0, p0, LBh/b;->b:Landroid/widget/LinearLayout;
