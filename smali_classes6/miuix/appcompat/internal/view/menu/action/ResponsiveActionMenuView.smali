...
.field public M:LDh/f;

.field public Q:LFh/e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->M:LDh/f;

    iput-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->Q:LFh/e;
    ...
    sget v2, Lth/a$c;->largeFontAdaptationEnabled:I

    invoke-static {p1, v2, v5}, Lei/d;->d(Landroid/content/Context;IZ)Z
    ...
    invoke-static {p1, v4}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {p1, v6}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    sget v7, Lth/a$f;->miuix_appcompat_bottom_menu_height:I

    invoke-virtual {v6, v7}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v7

    sget v8, Lth/a$f;->miuix_appcompat_bottom_menu_height_in_large_font:I
    ...
    invoke-static {p1, v2}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    sget v4, Lth/a$f;->miuix_appcompat_suspend_menu_bg_radius:I
    ...
    sget v4, Lth/a$e;->miuix_appcompat_suspend_menu_mi_shadow:I
    ...
    sget v4, Lth/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius:I
    ...
    sget v4, Lth/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius_offset_x:I
    ...
    sget v4, Lth/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius_offset_y:I
    ...
    sget-object p2, LXi/b;->a:Lmiuix/theme/token/MaterialDayNightToken;

    :goto_2
    invoke-static {p2}, LNh/g;->a(Lmiuix/theme/token/MaterialDayNightToken;)LNh/g;
    ...
    :cond_3
    sget-object p2, LXi/a;->a:Lmiuix/theme/token/MaterialDayNightToken;

    goto :goto_2

    :goto_3
    iput-object p2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->H:LNh/g;

    new-instance v0, Lmiuix/view/i;
    ...
    iput-object v0, v2, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->C:Lmiuix/view/i;
    ...
    iput-object v1, v2, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->C:Lmiuix/view/i;

    :goto_4
    invoke-virtual {v2}, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->r()V
...
.method public bridge synthetic getCurrentMaterial()LNh/f;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public getMaterial()LNh/g;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->H:LNh/g;
...
.method public final m()V
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->M:LDh/f;

    if-eqz v1, :cond_1

    iget-object v2, v1, LDh/f;->b:LWh/c;

    iget-boolean v3, v2, LWh/b;->l:Z
    ...
    :cond_0
    invoke-virtual {v2, v1, v0}, LWh/b;->a(Landroid/view/View;Z)V
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->Q:LFh/e;

    invoke-virtual {v0, v1}, Landroid/view/View;->removeOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->M:LDh/f;
...
.method public final o(IIZ)V
    ...
    invoke-static {v4}, LNh/k;->i(Landroid/content/Context;)Z

    move-result v5

    if-eqz v5, :cond_3

    invoke-static {v4}, LNh/k;->m(Landroid/content/Context;)Z
...
.method public final onAttachedToWindow()V
    ...
    invoke-static/range {v0 .. v5}, LNh/h;->a(Landroid/view/View;IFFFF)V
    ...
    iput v2, v3, LDh/f;->a:I

    new-instance v4, Landroid/graphics/Path;

    invoke-direct {v4}, Landroid/graphics/Path;-><init>()V

    iput-object v4, v3, LDh/f;->c:Landroid/graphics/Path;
    ...
    invoke-direct/range {v5 .. v11}, LWh/a;-><init>(IIFFFF)V

    const/4 v4, 0x6

    int-to-float v4, v4

    iput v4, v5, LWh/a;->e:F
    ...
    sget v8, Lth/a$c;->isLightTheme:I

    const/4 v9, 0x1

    invoke-static {v7, v8, v9}, Lei/d;->d(Landroid/content/Context;IZ)Z

    move-result v7

    invoke-direct {v4, v6, v5, v7}, LWh/b;-><init>(Landroid/content/Context;LWh/a;Z)V

    iput-object v4, v3, LDh/f;->b:LWh/c;

    iput-boolean v2, v4, LWh/b;->c:Z
    ...
    iget-object v4, v4, LWh/b;->i:Landroid/graphics/RectF;
    ...
    iput-object v3, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->M:LDh/f;

    iget v2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->m:I

    invoke-virtual {v3, v2}, LDh/f;->setShadowHostViewRadius(I)V
    ...
    iget-object v3, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->M:LDh/f;

    invoke-virtual {v2, v3, v1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    new-instance v1, LFh/e;

    invoke-direct {v1, p0}, LFh/e;-><init>(Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;)V
    ...
    iget-object v3, v1, LDh/f;->b:LWh/c;

    iget-boolean v4, v3, LWh/b;->l:Z
    ...
    :cond_4
    invoke-virtual {v3, v1, v2}, LWh/b;->a(Landroid/view/View;Z)V
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->Q:LFh/e;

    invoke-virtual {v1, v2}, Landroid/view/View;->removeOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->M:LDh/f;
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {v1, v0}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v1, v2}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    sget v1, Lth/a$f;->miuix_appcompat_bottom_menu_height:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    sget v2, Lth/a$f;->miuix_appcompat_bottom_menu_height_in_large_font:I
    ...
    sget p1, Lth/a$f;->miuix_appcompat_suspend_menu_bg_radius:I
    ...
    sget p1, Lth/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius:I
    ...
    sget p1, Lth/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius_offset_x:I
    ...
    sget p1, Lth/a$f;->miuix_appcompat_suspend_menu_mi_shadow_radius_offset_y:I
    ...
    invoke-static/range {v6 .. v11}, LNh/h;->a(Landroid/view/View;IFFFF)V
    ...
    :goto_1
    iget-object p0, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->d0:Landroid/util/AttributeSet;

    invoke-virtual {v0, p0}, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->p(Landroid/util/AttributeSet;)V

    invoke-virtual {v0}, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->r()V

    iget-object p0, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->M:LDh/f;

    if-eqz p0, :cond_8

    iget p1, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->m:I

    invoke-virtual {p0, p1}, LDh/f;->setShadowHostViewRadius(I)V
    ...
    iget-boolean p0, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->l0:Z
    ...
    iput-boolean p0, v0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->l0:Z
...
.method public final onLayout(ZIIII)V
    ...
    iget-boolean v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->g:Z
    ...
    iget v2, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->f0:I
    ...
    iget v4, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->r:I
    ...
    iget v5, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->i:I
    ...
    invoke-static {v2, v1, v5, v4}, LC/R1;->d(IIII)I
    ...
    iget v4, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->i:I
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->C:Lmiuix/view/i;
    ...
    :cond_5
    iget-boolean v1, v1, Lmiuix/view/i;->e:Z
    ...
    :cond_6
    invoke-virtual {p0, v8}, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->i(Z)V
...
.method public final onMeasure(II)V
    ...
    invoke-static {v5, v12}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-direct {v0}, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->getMaxChildrenTotalHeight()I
    ...
    invoke-static {v2, v7, v6, v13}, LC/u3;->b(IIII)I
...
.method public final p(Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Lth/a$m;->ResponsiveActionMenuView:[I

    sget v3, Lth/a$c;->responsiveActionMenuViewStyle:I
    ...
    sget p1, Lth/a$m;->ResponsiveActionMenuView_floatingWindowBottomMenuBackground:I
    ...
    :cond_3
    sget p1, Lth/a$m;->ResponsiveActionMenuView_bottomMenuBackground:I
    ...
    sget p1, Lth/a$m;->ResponsiveActionMenuView_floatingWindowSuspendMenuBackground:I

    goto :goto_3

    :cond_4
    sget p1, Lth/a$m;->ResponsiveActionMenuView_suspendMenuBackground:I
...
.method public bridge synthetic setMaterial(LNh/f;)V
    .locals 0
    .param p1    # LNh/f;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
...
.method public setMaterial(LNh/g;)V
    .locals 3
    .param p1    # LNh/g;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    .line 2
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->H:LNh/g;
    ...
    .line 3
    iput-object p1, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->H:LNh/g;
...
.method public setTranslationY(F)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/ResponsiveActionMenuView;->M:LDh/f;
