...
.method public final b()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LHh/e;
...
.method public final f()Z
    ...
    invoke-direct {v0, v2, v1}, LIh/e;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LIh/e;

    const v1, 0x800055

    invoke-virtual {v0, v1}, Lzi/i;->c(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LIh/e;

    iput-object p0, v0, Lzi/i;->u:Landroid/widget/PopupWindow$OnDismissListener;

    iput-object p0, v0, LIh/e;->p0:LIh/e$c;

    const/4 v1, 0x0

    iput-boolean v1, v0, Lzi/i;->c0:Z

    new-instance v0, LHh/e;

    const/4 v3, 0x1

    invoke-direct {v0, v2, v3}, LHh/e;-><init>(Landroid/content/Context;Z)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LHh/e;
    ...
    iget-object v4, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LHh/e;

    invoke-virtual {v4, v0}, LHh/e;->d(Ljava/util/HashMap;)V

    :cond_1
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LHh/e;

    invoke-virtual {v0, v2}, LHh/e;->e(Lmiuix/appcompat/internal/view/menu/d;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LIh/e;

    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LHh/e;

    iget-object v0, v0, LIh/e;->i0:LIh/e$d;

    iput-object v2, v0, LIh/e$d;->b:Landroid/widget/ListAdapter;

    iget-object v0, v2, LHh/e;->e:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LIh/e;

    iput-boolean v0, v2, LIh/e;->r0:Z

    invoke-virtual {v2, v1}, Lzi/i;->setHorizontalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LIh/e;

    invoke-virtual {v0, v1}, Lzi/i;->setVerticalOffset(I)V

    iget v0, p0, Lmiuix/appcompat/internal/view/menu/b;->h:I

    if-lez v0, :cond_2

    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LIh/e;

    iput v0, v1, Lzi/i;->l:I
    ...
    invoke-virtual {v0, v1}, LIh/e;->E(Landroid/view/View;)V
...
.method public final isShowing()Z
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LIh/e;

    iget-boolean p0, p0, Lzi/i;->d0:Z
...
.method public final j()V
    ...
    iget-object v0, v0, LHh/e;->g:Ljava/util/HashMap;
    ...
    iget-object v0, v0, LHh/e;->i:Ljava/util/HashMap;
