...
.field public e:LNh/g;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field public f:LNh/f;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 7
    sget-object v2, Lth/a$m;->MiuixButton:[I

    sget v4, Lth/a$l;->Widget_Button:I
    ...
    .line 8
    sget p3, Lth/a$m;->MiuixButton_isLightTheme:I
...
.method public final b()V
    ...
    iget-object v3, v0, Lmiuix/appcompat/widget/Button;->e:LNh/g;
    ...
    :cond_0
    iget-object v4, v3, LNh/g;->a:LNh/f;

    iget-object v3, v3, LNh/g;->b:LNh/f;
    ...
    :goto_0
    iput-object v4, v0, Lmiuix/appcompat/widget/Button;->f:LNh/f;
    ...
    invoke-static {v3}, LNh/d;->b(Landroid/content/Context;)Z
    ...
    iget-object v4, v0, Lmiuix/appcompat/widget/Button;->f:LNh/f;

    iget-object v4, v4, LNh/f;->c:LNh/f$b;
    ...
    :cond_4
    :goto_1
    iget-object v3, v0, Lmiuix/appcompat/widget/Button;->f:LNh/f;

    iget-object v3, v3, LNh/f;->e:LNh/f$a;
    ...
    iget v8, v3, LNh/f$a;->g:F

    mul-float/2addr v8, v4

    add-float/2addr v8, v7

    iget v4, v3, LNh/f$a;->b:F

    iget v7, v3, LNh/f$a;->c:F

    iget v9, v3, LNh/f$a;->d:F

    iget v10, v3, LNh/f$a;->e:F

    iget v11, v3, LNh/f$a;->f:F

    iget v12, v3, LNh/f$a;->h:F

    iget v13, v3, LNh/f$a;->i:F

    iget v14, v3, LNh/f$a;->j:F

    iget v15, v3, LNh/f$a;->k:F

    const/16 v16, 0x0

    iget v2, v3, LNh/f$a;->l:F

    move/from16 v17, v1

    iget v1, v3, LNh/f$a;->m:F

    move/from16 v18, v1

    iget v1, v3, LNh/f$a;->n:F

    move/from16 v19, v1

    iget v1, v3, LNh/f$a;->o:F

    move/from16 v20, v1

    iget v1, v3, LNh/f$a;->p:F

    move/from16 v21, v1

    iget v1, v3, LNh/f$a;->q:F

    move/from16 v22, v1

    iget v1, v3, LNh/f$a;->r:F

    move/from16 v23, v1

    iget v1, v3, LNh/f$a;->s:F

    move/from16 v24, v1

    iget v1, v3, LNh/f$a;->t:F

    iget v3, v3, LNh/f$a;->u:F
    ...
    invoke-static {v0, v1}, LNh/c;->b(Landroid/view/View;[F)Z
    ...
    invoke-static {v0}, LNh/c;->a(Landroid/view/View;)Z

    :goto_2
    iget-object v1, v0, Lmiuix/appcompat/widget/Button;->f:LNh/f;
    ...
    :cond_7
    iget-object v1, v1, LNh/f;->d:LNh/f$d;

    if-eqz v1, :cond_e

    iget-object v2, v0, Lmiuix/appcompat/widget/Button;->g:LWh/b;
    ...
    iget v9, v1, LNh/f$d;->b:F

    iget v12, v1, LNh/f$d;->e:F

    iget v7, v1, LNh/f$d;->a:I

    iget v10, v1, LNh/f$d;->c:F

    iget v11, v1, LNh/f$d;->d:F

    move v8, v7

    invoke-direct/range {v6 .. v12}, LWh/a;-><init>(IIFFFF)V

    invoke-direct {v2, v3, v6, v5}, LWh/b;-><init>(Landroid/content/Context;LWh/a;Z)V

    iput-object v2, v0, Lmiuix/appcompat/widget/Button;->g:LWh/b;

    iget-object v1, v2, LWh/b;->b:LWh/a;

    if-eqz v1, :cond_8

    iget-boolean v3, v1, LWh/a;->g:Z
    ...
    :cond_9
    :goto_3
    iget-boolean v1, v2, LWh/b;->c:Z

    if-eqz v1, :cond_10

    iget-boolean v1, v2, LWh/b;->l:Z
    ...
    :cond_a
    invoke-virtual {v2, v0, v4}, LWh/b;->a(Landroid/view/View;Z)V

    :goto_4
    iget-object v1, v0, Lmiuix/appcompat/widget/Button;->g:LWh/b;

    iget-boolean v2, v1, LWh/b;->c:Z
    ...
    :cond_b
    iget v2, v1, LWh/b;->k:I

    move v3, v2

    iget v2, v1, LWh/b;->e:F

    move v4, v3

    iget v3, v1, LWh/b;->f:F

    move v5, v4

    iget v4, v1, LWh/b;->g:F

    iget-object v1, v1, LWh/b;->b:LWh/a;

    move v6, v5

    iget v5, v1, LWh/a;->f:F

    iget-boolean v1, v1, LWh/a;->g:Z
    ...
    invoke-static/range {v0 .. v6}, LNh/h;->b(Landroid/view/View;IFFFFZ)V
    ...
    iget v6, v1, LNh/f$d;->a:I

    sget-object v3, Landroid/graphics/BlurMaskFilter$Blur;->NORMAL:Landroid/graphics/BlurMaskFilter$Blur;

    iget v9, v1, LNh/f$d;->c:F

    iget v10, v1, LNh/f$d;->d:F

    iget v8, v1, LNh/f$d;->b:F

    iget v11, v1, LNh/f$d;->e:F

    move v7, v6

    invoke-direct/range {v5 .. v11}, LWh/a;-><init>(IIFFFF)V

    iput-object v5, v2, LWh/b;->b:LWh/a;

    iget-object v1, v2, LWh/b;->a:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    iget-boolean v3, v2, LWh/b;->d:Z
    ...
    iget-object v5, v2, LWh/b;->b:LWh/a;

    invoke-virtual {v2, v3, v1, v5}, LWh/b;->d(ZFLWh/a;)V

    iget v1, v2, LWh/b;->g:F
    ...
    :goto_5
    iput-boolean v1, v2, LWh/b;->l:Z

    iget-object v1, v0, Lmiuix/appcompat/widget/Button;->g:LWh/b;

    iget-boolean v2, v1, LWh/b;->l:Z

    invoke-virtual {v1, v0, v2}, LWh/b;->a(Landroid/view/View;Z)V
...
.method public getCurrentMaterial()LNh/f;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object p0, p0, Lmiuix/appcompat/widget/Button;->f:LNh/f;
...
.method public getMaterial()LNh/g;
    ...
    iget-object p0, p0, Lmiuix/appcompat/widget/Button;->e:LNh/g;
...
.method public setMaterial(LNh/f;)V
    .locals 1
    .param p1    # LNh/f;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-direct {v0, p1}, LNh/g;-><init>(LNh/f;)V

    invoke-virtual {p0, v0}, Lmiuix/appcompat/widget/Button;->setMaterial(LNh/g;)V
...
.method public setMaterial(LNh/g;)V
    ...
    .line 6
    iput-object p1, p0, Lmiuix/appcompat/widget/Button;->e:LNh/g;

    .line 7
    invoke-virtual {p0, v0}, Lmiuix/appcompat/widget/Button;->i(Z)V

    .line 8
    invoke-static {p0}, LNh/c;->a(Landroid/view/View;)Z
...
.method public setMaterial(Lmiuix/theme/token/MaterialDayNightToken;)V
    ...
    .line 2
    invoke-static {p1}, LNh/g;->a(Lmiuix/theme/token/MaterialDayNightToken;)LNh/g;

    move-result-object p1

    invoke-virtual {p0, p1}, Lmiuix/appcompat/widget/Button;->setMaterial(LNh/g;)V
...
.method public setMaterial(Lmiuix/theme/token/MaterialToken;)V
    ...
    invoke-static {v0}, LNh/g;->a(Lmiuix/theme/token/MaterialDayNightToken;)LNh/g;
