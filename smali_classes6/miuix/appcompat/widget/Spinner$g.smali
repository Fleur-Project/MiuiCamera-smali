...
.method public constructor <init>(Lmiuix/appcompat/widget/Spinner;Landroid/content/Context;)V
    ...
    sget v0, Lth/a$f;->miuix_appcompat_drop_down_menu_padding_single_item:I
    ...
    sget v1, Lth/a$f;->miuix_appcompat_drop_down_item_min_height:I
    ...
    iput p1, p2, Lwi/b;->d:I

    const p1, 0x800053

    invoke-super {p0, p1}, Lzi/i;->c(I)V
...
.method public final k(Landroid/widget/ListAdapter;Landroid/content/Context;)[[I
    ...
    iget-object p0, p0, Lzi/i;->b:Landroid/view/View;
...
.method public final m(Landroid/view/View;)Z
    ...
    invoke-super {p0, p1}, Lzi/i;->m(Landroid/view/View;)Z
...
.method public final o(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Lzi/i;->o(Landroid/widget/ListAdapter;)V
...
.method public final show(II)V
    ...
    invoke-virtual {p0, v1}, Lzi/i;->q(Landroid/view/View;)V
    ...
    invoke-virtual {v1}, Lwi/b;->toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Lzi/i;->p(Landroid/view/View;)V

    :cond_4
    iget-object v3, v1, Lwi/b;->q:Landroid/graphics/Rect;

    invoke-virtual {v3}, Landroid/graphics/Rect;->centerX()I

    move-result v3

    iget-object v4, v1, Lwi/b;->p:Landroid/graphics/Rect;
    ...
    invoke-super {p0, v3}, Lzi/i;->c(I)V
    ...
    invoke-interface {v3, v1}, Lwi/a;->d(Lwi/b;)I

    move-result v3

    iget-object v4, p0, Lzi/i;->e:Lwi/a;

    invoke-interface {v4, v1}, Lwi/a;->b(Lwi/b;)I

    move-result v4

    iget v5, v1, Lwi/b;->g:I

    invoke-virtual {p0, v5}, Landroid/widget/PopupWindow;->setWidth(I)V

    iget v1, v1, Lwi/b;->h:I
    ...
    invoke-virtual {p0, v2, v1, v3, v4}, Lzi/i;->showAtLocation(Landroid/view/View;III)V
    ...
    :goto_3
    iget-object v1, p0, Lzi/i;->f:Landroid/widget/ListView;
