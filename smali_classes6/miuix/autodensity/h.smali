...
.method public final a(Landroid/content/Context;Landroid/view/Display;Landroid/content/res/Configuration;)V
    ...
    invoke-static {v11}, LMe/Z;->H(Ljava/lang/String;)V
    ...
    invoke-static {v8}, LMe/Z;->H(Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v5}, LQ1/t;->m(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v9}, LMe/Z;->H(Ljava/lang/String;)V
    ...
    invoke-static {v12}, LMe/Z;->H(Ljava/lang/String;)V
    ...
    sget-boolean v8, Lni/a;->g:Z

    if-eqz v8, :cond_d

    invoke-static/range {p1 .. p1}, Lni/b;->c(Landroid/content/Context;)Z
    ...
    :goto_10
    sget-boolean v5, Lni/a;->f:Z

    sget v9, Lmiuix/autodensity/k;->b:F

    if-nez v5, :cond_30

    sget-boolean v5, Lni/a;->h:Z

    if-eqz v5, :cond_31

    :cond_30
    invoke-static/range {p1 .. p1}, LNh/a;->b(Landroid/content/Context;)Landroid/graphics/Point;
