...
.method public constructor <init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lmiuix/internal/view/a$a;)V
    ...
    invoke-direct/range {v0 .. v10}, Lfi/c;-><init>(Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;ZIIIIIIII)V

    iput-object v0, v1, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lfi/c;
...
.method public final applyTheme(Landroid/content/res/Resources$Theme;)V
    ...
    sget-object v1, Lth/a$m;->CheckWidgetDrawable:[I
    ...
    invoke-static {p1, v0}, Landroid/util/TypedValue;->coerceToString(II)Ljava/lang/String;
    ...
    sget v4, Lth/a$m;->CheckWidgetDrawable_checkwidget_disableBackgroundColor:I

    invoke-static {v1, v4, v2}, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->c(Landroid/content/res/TypedArray;II)I
    ...
    sget v4, Lth/a$m;->CheckWidgetDrawable_checkwidget_checkOnAlphaBackgroundColor:I
    ...
    sget v4, Lth/a$m;->CheckWidgetDrawable_checkwidget_checkOnBackgroundColor:I
    ...
    sget v3, Lth/a$m;->CheckWidgetDrawable_checkwidget_strokeColor:I

    invoke-static {v1, v3, v0}, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->c(Landroid/content/res/TypedArray;II)I

    move-result v0

    iput v0, v2, Lmiuix/internal/view/a$a;->e:I
    ...
    sget v5, Lth/a$m;->CheckWidgetDrawable_checkwidget_backgroundNormalAlpha:I

    invoke-static {v1, v5, v3}, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->d(Landroid/content/res/TypedArray;II)I
    ...
    sget v3, Lth/a$m;->CheckWidgetDrawable_checkwidget_backgroundDisableAlpha:I

    invoke-static {v1, v3, v0}, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->d(Landroid/content/res/TypedArray;II)I

    move-result v0

    iput v0, v2, Lmiuix/internal/view/a$a;->g:I
    ...
    sget v5, Lth/a$m;->CheckWidgetDrawable_checkwidget_strokeNormalAlpha:I
    ...
    sget v3, Lth/a$m;->CheckWidgetDrawable_checkwidget_strokeDisableAlpha:I

    invoke-static {v1, v3, v0}, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->d(Landroid/content/res/TypedArray;II)I

    move-result v0

    iput v0, p1, Lmiuix/internal/view/a$a;->i:I

    iget-object p1, p0, Lmiuix/internal/view/a;->a:Lmiuix/internal/view/a$a;

    sget v0, Lth/a$m;->CheckWidgetDrawable_checkwidget_touchAnimEnable:I
    ...
    iget v6, p1, Lmiuix/internal/view/a$a;->b:I

    iget v7, p1, Lmiuix/internal/view/a$a;->c:I

    iget v8, p1, Lmiuix/internal/view/a$a;->d:I

    iget v9, p1, Lmiuix/internal/view/a$a;->f:I

    iget v10, p1, Lmiuix/internal/view/a$a;->g:I

    iget v11, p1, Lmiuix/internal/view/a$a;->e:I

    iget v12, p1, Lmiuix/internal/view/a$a;->h:I

    iget v13, p1, Lmiuix/internal/view/a$a;->i:I

    move-object v4, p0

    invoke-direct/range {v3 .. v13}, Lfi/c;-><init>(Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;ZIIIIIIII)V

    iput-object v3, v4, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lfi/c;
...
.method public b()I
    ...
    sget p0, Lth/a$l;->CheckWidgetDrawable_CheckBox:I
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lfi/c;

    if-eqz v0, :cond_1

    iget-object v1, v0, Lfi/c;->d:Lfi/a;

    invoke-virtual {v1, p1}, Lfi/a;->draw(Landroid/graphics/Canvas;)V

    iget-object v1, v0, Lfi/c;->e:Lfi/a;

    invoke-virtual {v1, p1}, Lfi/a;->draw(Landroid/graphics/Canvas;)V

    iget-object v0, v0, Lfi/c;->f:Lfi/a;

    invoke-virtual {v0, p1}, Lfi/a;->draw(Landroid/graphics/Canvas;)V
...
.method public e(IIII)V
    ...
    iget-object p0, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lfi/c;

    if-eqz p0, :cond_0

    iget-object v0, p0, Lfi/c;->d:Lfi/a;

    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v0, p0, Lfi/c;->e:Lfi/a;

    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object p0, p0, Lfi/c;->f:Lfi/a;
...
.method public final onStateChange([I)Z
    ...
    iget-object v1, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lfi/c;
    ...
    iget-object p1, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lfi/c;
    ...
    :cond_6
    iget-object v2, p1, Lfi/c;->h:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_7
    iget-object v2, p1, Lfi/c;->n:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v2, p1, Lfi/c;->i:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_9
    iget-object v2, p1, Lfi/c;->j:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_a
    iget-object v2, p1, Lfi/c;->k:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_b
    iget-object v2, p1, Lfi/c;->o:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_c
    iget-object v2, p1, Lfi/c;->p:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_d
    iget-object v2, p1, Lfi/c;->q:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_e
    iget-object v2, p1, Lfi/c;->m:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_f
    iget-object v2, p1, Lfi/c;->l:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object p1, p1, Lfi/c;->l:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v2, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lfi/c;

    if-eqz v2, :cond_13

    iget-object v3, v2, Lfi/c;->d:Lfi/a;

    iget-object v6, v2, Lfi/c;->e:Lfi/a;

    iget-object v7, v2, Lfi/c;->f:Lfi/a;
    ...
    invoke-virtual {v7, p1}, Lfi/a;->setAlpha(I)V

    const/16 p1, 0x19

    invoke-virtual {v6, p1}, Lfi/a;->setAlpha(I)V

    goto :goto_3

    :cond_11
    invoke-virtual {v7, v1}, Lfi/a;->setAlpha(I)V

    invoke-virtual {v6, v1}, Lfi/a;->setAlpha(I)V

    :goto_3
    iget p1, v2, Lfi/c;->a:I

    invoke-virtual {v3, p1}, Lfi/a;->setAlpha(I)V
    ...
    :cond_15
    iget-object v1, p1, Lfi/c;->h:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_16
    iget-object v1, p1, Lfi/c;->n:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_17
    iget-object v1, p1, Lfi/c;->i:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_18
    iget-object v1, p1, Lfi/c;->j:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v1, p1, Lfi/c;->m:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_1a
    iget-object v1, p1, Lfi/c;->l:Lmiuix/animation/physics/SpringAnimation;
    ...
    new-instance v2, LC/R2;

    const/4 v3, 0x2

    invoke-direct {v2, p1, v3}, LC/R2;-><init>(Ljava/lang/Object;I)V

    const-wide/16 v6, 0x32

    invoke-virtual {v1, v2, v6, v7}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z

    iget-boolean v1, p1, Lfi/c;->r:Z

    if-eqz v1, :cond_1c

    iget-object v1, p1, Lfi/c;->k:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_1f
    iget-object v1, p1, Lfi/c;->q:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_20
    :goto_5
    iget-object p1, p1, Lfi/c;->k:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_21
    :goto_6
    iget-object v1, p1, Lfi/c;->f:Lfi/a;
    ...
    invoke-virtual {v1, p1}, Lfi/a;->setAlpha(I)V

    goto :goto_7

    :cond_22
    iget-object p1, p1, Lfi/c;->m:Lmiuix/animation/physics/SpringAnimation;
