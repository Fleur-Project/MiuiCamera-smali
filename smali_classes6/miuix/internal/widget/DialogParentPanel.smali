...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p1, p2}, Lvh/a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v0, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Lvh/a;

    const/4 p0, 0x1

    iput-boolean p0, v0, Lvh/a;->d:Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Lvh/a;
    ...
    sget v4, Lth/a$h;->contentPanel:I
...
.method public final onFinishInflate()V
    ...
    sget v0, Lth/a$h;->contentPanel:I
...
.method public final onMeasure(II)V
    ...
    iget-object v0, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Lvh/a;

    iget-object v3, v0, Lvh/a;->h:Landroid/util/TypedValue;

    iget-object v4, v0, Lvh/a;->f:Landroid/util/TypedValue;

    iget-object v5, v0, Lvh/a;->k:Landroid/util/TypedValue;

    iget-object v6, v0, Lvh/a;->l:Landroid/util/TypedValue;

    const/4 v2, 0x0

    move v1, p2

    invoke-virtual/range {v0 .. v6}, Lvh/a;->a(IZLandroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;)I

    move-result p2

    iget-boolean v1, p0, Lmiuix/internal/widget/DialogParentPanel;->b:Z
    ...
    :cond_0
    iget-object v3, v0, Lvh/a;->e:Landroid/util/TypedValue;

    iget-object v4, v0, Lvh/a;->g:Landroid/util/TypedValue;

    iget-object v5, v0, Lvh/a;->i:Landroid/util/TypedValue;

    iget-object v6, v0, Lvh/a;->j:Landroid/util/TypedValue;
