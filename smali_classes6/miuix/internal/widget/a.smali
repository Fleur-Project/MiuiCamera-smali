...
.field public t:Lgi/c;

.field public final u:Lgi/a;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lmiuix/appcompat/app/AlertDialog;Landroid/view/Window;Lgi/a;)V
    .locals 5
    ...
    invoke-direct {v1}, LIh/b;-><init>()V

    iput-object v1, p0, Lmiuix/internal/widget/a;->I:LIh/b;
    ...
    iput-object p4, p0, Lmiuix/internal/widget/a;->u:Lgi/a;
    ...
    :cond_0
    sget-object p3, Lgi/a;->a:Lgi/a;

    if-ne p4, p3, :cond_1

    sget p3, Lth/a$c;->actionSheetAlertStyle:I

    goto :goto_0

    :cond_1
    sget p3, Lth/a$c;->actionSheetArrowStyle:I

    :goto_0
    sget-object p4, Lth/a$m;->ActionSheet:[I
    ...
    sget p3, Lth/a$m;->ActionSheet_actionSheetLayout:I

    sget p4, Lth/a$j;->miuix_appcompat_action_sheet_layout:I
    ...
    sget p3, Lth/a$m;->ActionSheet_actionSheetContentLayout:I

    sget p4, Lth/a$j;->miuix_appcompat_action_sheet_alert_content:I
    ...
    sget p3, Lth/a$m;->ActionSheet_actionSheetListItem:I

    sget p4, Lth/a$j;->miuix_appcompat_action_sheet_list_item:I
...
.method public final b(Lmiuix/appcompat/app/h;)V
    ...
    invoke-virtual {v0, v3}, Landroid/view/View;->setWindowInsetsAnimationCallback(Landroid/view/WindowInsetsAnimation$Callback;)V
    ...
    iget-object v3, p0, Lmiuix/internal/widget/a;->u:Lgi/a;
    ...
    iget-object p0, p0, Lmiuix/internal/widget/a;->I:LIh/b;
...
.method public final d(Z)V
    ...
    iget-object v0, p0, Lmiuix/internal/widget/a;->t:Lgi/c;
    ...
    iget v4, p0, Lmiuix/internal/widget/a;->w:I
    ...
    iput-object v1, p0, Lmiuix/internal/widget/a;->f:Landroid/view/ViewGroup;

    :cond_0
    iget-object v1, p0, Lmiuix/internal/widget/a;->f:Landroid/view/ViewGroup;

    instance-of v4, v1, Lmiuix/internal/widget/ArrowActionSheetPanel;

    if-eqz v4, :cond_1

    check-cast v1, Lmiuix/internal/widget/ArrowActionSheetPanel;

    iget-object v4, p0, Lmiuix/internal/widget/a;->t:Lgi/c;

    invoke-interface {v4}, Lgi/c;->d()Lgi/b;

    move-result-object v4

    invoke-virtual {v1, v4}, Lmiuix/internal/widget/ArrowActionSheetPanel;->setArrowMode(Lgi/b;)V

    :cond_1
    iget-object v1, p0, Lmiuix/internal/widget/a;->t:Lgi/c;

    iget-object v4, p0, Lmiuix/internal/widget/a;->C:Landroid/graphics/Point;

    iget v5, v4, Landroid/graphics/Point;->x:I

    invoke-interface {v1, v2, v5, v0}, Lgi/c;->e(Landroid/content/Context;ILandroid/view/WindowInsets;)I

    move-result v1

    iput v1, p0, Lmiuix/internal/widget/a;->z:I
    ...
    iput v1, p0, Lmiuix/internal/widget/a;->A:I

    iget-object v1, p0, Lmiuix/internal/widget/a;->t:Lgi/c;

    invoke-interface {v1, v2, v0}, Lgi/c;->b(Landroid/content/Context;Landroid/view/WindowInsets;)[I

    move-result-object v1

    aget v5, v1, v3

    iget-object v6, p0, Lmiuix/internal/widget/a;->B:Landroid/graphics/Rect;
    ...
    iget v8, p0, Lmiuix/internal/widget/a;->z:I
    ...
    iput v8, p0, Lmiuix/internal/widget/a;->z:I

    :cond_2
    iget-object v1, p0, Lmiuix/internal/widget/a;->t:Lgi/c;

    invoke-interface {v1, v2, v0}, Lgi/c;->c(Landroid/content/Context;Landroid/view/WindowInsets;)[I
    ...
    invoke-virtual {v0, v6}, Lmiuix/internal/widget/ActionSheetRootView;->setContentPanelExtraBounds(Landroid/graphics/Rect;)V
    ...
    iget v5, p0, Lmiuix/internal/widget/a;->A:I
    ...
    :cond_4
    iget-object v0, p0, Lmiuix/internal/widget/a;->u:Lgi/a;
    ...
    sget v6, Lth/a$h;->actionSheetScrollView:I
    ...
    sget v6, Lth/a$h;->alertContentWrapper:I
    ...
    sget v6, Lth/a$h;->action_sheet_content_container:I
    ...
    sget v6, Lth/a$h;->action_sheet_message:I
    ...
    sget p1, Lth/a$k;->miuix_appcompat_action_sheet_default_message:I
    ...
    :cond_a
    sget v6, Lth/a$h;->actionSheetSpringBack:I
    ...
    sget v6, Lth/a$h;->action_sheet_list_view:I
    ...
    invoke-direct {v6, p0}, Lgi/d;-><init>(Lmiuix/internal/widget/a;)V
    ...
    invoke-direct {p1, v2, v6, v9, v8}, Landroid/widget/ArrayAdapter;-><init>(Landroid/content/Context;II[Ljava/lang/Object;)V
    ...
    sget v6, Lth/a$h;->action_sheet_cancel_button:I
    ...
    sget p1, Lth/a$k;->miuix_appcompat_cancel_description:I
    ...
    invoke-direct {v6, p0}, Lgi/h;-><init>(Lmiuix/internal/widget/a;)V
    ...
    invoke-direct {v6, p0, v8}, LA9/k;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_12
    invoke-static {v2}, LNh/a;->b(Landroid/content/Context;)Landroid/graphics/Point;

    move-result-object p1

    sget-boolean v1, Lni/a;->b:Z
    ...
    invoke-static {p1, v7}, Landroidx/core/view/ViewCompat;->setNestedScrollingEnabled(Landroid/view/View;Z)V
    ...
    invoke-static {p1, v3}, Landroidx/core/view/ViewCompat;->setNestedScrollingEnabled(Landroid/view/View;Z)V
...
.method public final e(Landroid/view/WindowInsets;)V
    ...
    invoke-interface {v0, v1, p1}, Lgi/c;->c(Landroid/content/Context;Landroid/view/WindowInsets;)[I

    move-result-object v0

    iget-object v2, p0, Lmiuix/internal/widget/a;->t:Lgi/c;

    invoke-interface {v2, v1, p1}, Lgi/c;->b(Landroid/content/Context;Landroid/view/WindowInsets;)[I
    ...
    invoke-interface {v4, v1, v3, p1}, Lgi/c;->e(Landroid/content/Context;ILandroid/view/WindowInsets;)I
...
.method public final f()V
    ...
    invoke-static {v1, v0}, LNh/a;->d(Landroid/content/Context;Landroid/content/res/Configuration;)LNh/n;

    move-result-object v0

    iget-object v1, p0, Lmiuix/internal/widget/a;->C:Landroid/graphics/Point;

    iget-object v2, v0, LNh/n;->c:Landroid/graphics/Point;
    ...
    iget-object v0, v0, LNh/n;->d:Landroid/graphics/Point;
