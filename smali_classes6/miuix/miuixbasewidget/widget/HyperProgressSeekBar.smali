...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Lii/a;->miuixProgressSeekBarStyle:I
    ...
    sget-object v6, Lii/j;->HyperProgressSeekBar:[I

    sget v7, Lii/i;->Widget_HyperProgressSeekBar_DayNight:I
    ...
    sget v1, Lii/j;->HyperProgressSeekBar_progressBarMode:I
    ...
    sget v8, Lii/b;->miuix_appcompat_hyper_progress_seekbar_shadow_default_color:I
    ...
    sget v9, Lii/c;->miuix_appcompat_hyper_progress_seekbar_shadow_radius:I

    invoke-virtual {v8, v9}, Landroid/content/res/Resources;->getDimension(I)F

    move-result v8

    sget v9, Lii/j;->HyperProgressSeekBar_shadowDx:I
    ...
    sget v9, Lii/j;->HyperProgressSeekBar_shadowDy:I
    ...
    sget v9, Lii/j;->HyperProgressSeekBar_shadowHorizontalExtend:I
    ...
    sget v9, Lii/j;->HyperProgressSeekBar_shadowVerticalExtend:I
    ...
    sget v9, Lii/j;->HyperProgressSeekBar_shadowRadius:I
    ...
    sget v3, Lii/j;->HyperProgressSeekBar_shadowColor:I
    ...
    sget v7, Lii/c;->miuix_appcompat_hyper_progress_seekbar_shadow_clip_radius:I
    ...
    sget v8, Lii/c;->miuix_appcompat_hyper_progress_seekbar_min_height:I
    ...
    sget v8, Lii/c;->miuix_appcompat_hyper_progress_seekbar_height:I
    ...
    sget v3, Lii/j;->HyperProgressSeekBar_progressSeekBarMinHeight:I
    ...
    sget v3, Lii/j;->HyperProgressSeekBar_progressSeekBarMaxHeight:I
    ...
    sget v8, Lii/c;->miuix_appcompat_hyper_progress_seekbar_padding_offset:I

    invoke-virtual {v3, v8}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    sget v8, Lii/j;->HyperProgressSeekBar_paddingOffset:I
    ...
    invoke-static {}, Landroidx/appcompat/app/c;->a()V
    ...
    sget v3, Lii/g;->music_player_tracker:I
    ...
    invoke-static {v1}, Landroidx/appsearch/platformstorage/converter/q;->a(Ljava/lang/String;)Landroid/graphics/RuntimeShader;
    ...
    sget v3, Lii/g;->music_player_tracker_middle:I
    ...
    sget v3, Lii/b;->miuix_appcompat_hyper_progress_seekbar_foreground_normal_color_light:I
    ...
    sget v4, Lii/b;->miuix_appcompat_hyper_progress_seekbar_background_disabled_color_light:I
    ...
    sget v5, Lii/b;->miuix_appcompat_hyper_progress_seekbar_background_normal_color_light:I
    ...
    sget v5, Lii/b;->miuix_appcompat_hyper_progress_seekbar_background_disabled_color_dark:I
    ...
    sget v5, Lii/j;->HyperProgressSeekBar_foregroundPrimaryColor:I
    ...
    sget v1, Lii/j;->HyperProgressSeekBar_foregroundPrimaryDisableColor:I
    ...
    sget v1, Lii/j;->HyperProgressSeekBar_backgroundPrimaryColor:I
    ...
    sget v1, Lii/j;->HyperProgressSeekBar_backgroundPrimaryDisableColor:I
    ...
    sget p1, Lii/j;->HyperProgressSeekBar_progressAlpha:I
    ...
    sget v3, Lii/j;->HyperProgressSeekBar_progressPressedAlpha:I
...
.method public final b(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v0, v1}, Landroidx/appcompat/app/e;->a(Landroid/graphics/RuntimeShader;[F)V
    ...
    invoke-static {v0, v1}, Landroidx/appsearch/platformstorage/h;->b(Landroid/graphics/RuntimeShader;F)V
...
.method public final c(Landroid/graphics/Canvas;)V
    ...
    sget v9, Lii/b;->miuix_color_transparent:I
...
.method public final e()V
    ...
    sget v1, Lii/d;->miuix_hyper_progressbar_light_head:I
    ...
    invoke-static {v0, v1}, Lji/e;->a(Landroid/graphics/RuntimeShader;Landroid/graphics/BitmapShader;)V

    iget-object v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b:Landroid/graphics/RuntimeShader;

    invoke-static {v0, v2}, Landroidx/activity/l;->c(Landroid/graphics/RuntimeShader;[F)V

    iget-object v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b:Landroid/graphics/RuntimeShader;

    iget v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->g:F

    invoke-static {v0, v1}, Landroidx/appsearch/platformstorage/converter/o;->b(Landroid/graphics/RuntimeShader;F)V
    ...
    invoke-static {v0, v2}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v0, v5}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v0, v3}, LNh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v0, v1}, Landroidx/appsearch/platformstorage/converter/p;->b(Landroid/graphics/RuntimeShader;[F)V

    iget-object p0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b:Landroid/graphics/RuntimeShader;

    invoke-static {p0, v2}, Landroidx/appcompat/app/e;->a(Landroid/graphics/RuntimeShader;[F)V
...
.method public final g()V
    ...
    iget-object v6, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->H:Landroid/content/res/ColorStateList;

    if-nez v6, :cond_0

    if-eqz v5, :cond_0

    iput-object v5, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->H:Landroid/content/res/ColorStateList;
    ...
    iget v7, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->t:I

    invoke-virtual {v5, v6, v7}, Landroid/content/res/ColorStateList;->getColorForState([II)I

    move-result v5

    iget v6, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->y:I
    ...
    iget v6, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->x:I
    ...
    iput-object v7, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->H:Landroid/content/res/ColorStateList;
    ...
    iget v6, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->w:I

    invoke-virtual {v1, v5, v6}, Landroid/content/res/ColorStateList;->getColorForState([II)I

    move-result v1

    iget v5, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->C:I
    ...
    iget v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->A:I
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/app/e;->a(Landroid/graphics/RuntimeShader;[F)V
    ...
    :goto_0
    invoke-static {p1, p3}, Lji/d;->a(Landroid/graphics/RuntimeShader;I)V
...
.method public final onSizeChanged(IIII)V
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/app/b;->b(Landroid/graphics/RuntimeShader;[F)V

    iget-object p0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b:Landroid/graphics/RuntimeShader;

    invoke-static {p0, p3}, Landroidx/appcompat/app/d;->b(Landroid/graphics/RuntimeShader;[F)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v2, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->o:Z

    iget-boolean v3, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->M:Z

    if-eqz v3, :cond_c

    invoke-virtual {v1, v0}, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar$g;->onStopTrackingTouch(Landroid/widget/SeekBar;)V

    iput-boolean v2, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->M:Z
    ...
    iget-object v7, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->d:[F
    ...
    iget-object v8, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->e:[F
