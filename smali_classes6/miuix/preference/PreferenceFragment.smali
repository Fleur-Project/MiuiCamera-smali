...
.method public static Da(Landroid/view/ViewGroup;)Landroid/view/ViewGroup$MarginLayoutParams;
    .locals 2
...
# virtual methods
.method public final Fb(Landroidx/core/graphics/Insets;)V
    .locals 7
...
.method public final Qb(Landroid/content/Context;LLh/b;II)Z
    .locals 11
    ...
    instance-of p3, p1, Lmiuix/appcompat/app/AppCompatActivity;
    ...
    invoke-virtual {p1}, Lmiuix/appcompat/app/j;->q()Z
...
.method public final Te(Landroid/view/Menu;)V
    .locals 0
...
.method public final ia(Landroid/view/ViewGroup;Landroidx/core/graphics/Insets;)V
    .locals 3
    ...
    :cond_0
    invoke-static {p1}, Lmiuix/preference/PreferenceFragment;->Da(Landroid/view/ViewGroup;)Landroid/view/ViewGroup$MarginLayoutParams;
...
.method public final kb()V
    ...
    sget v3, LAi/t;->preferenceCardPageBackground:I

    invoke-static {v2, v3}, Lei/d;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    sget v4, LAi/t;->preferenceCardPageNoFloatingBackground:I

    invoke-static {v3, v4}, Lei/d;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0}, LNh/a;->g(Landroid/content/Context;)Z
...
.method public final m(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v0}, Lmiuix/preference/PreferenceFragment;->Fb(Landroidx/core/graphics/Insets;)V
    ...
    invoke-virtual {p0, v0, p1}, Lmiuix/preference/PreferenceFragment;->ia(Landroid/view/ViewGroup;Landroidx/core/graphics/Insets;)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0}, Lmiuix/preference/PreferenceFragment;->kb()V
    ...
    invoke-static {v1}, LLh/b$a;->a(I)LLh/b;

    move-result-object v1

    iput-object v1, p0, Lmiuix/preference/PreferenceFragment;->k:LLh/b;

    if-eqz v1, :cond_3

    iget-boolean v2, p0, Lmiuix/preference/PreferenceFragment;->i:Z

    iput-boolean v2, v1, LLh/b;->a:Z
    ...
    invoke-virtual {p0, p1, v1, v2, v2}, Lmiuix/preference/PreferenceFragment;->Qb(Landroid/content/Context;LLh/b;II)Z
    ...
    iget-object v1, p0, Lmiuix/preference/PreferenceFragment;->k:LLh/b;

    iget-boolean v2, v1, LLh/b;->a:Z

    if-eqz v2, :cond_2

    invoke-virtual {v1}, LLh/b;->a()I
    ...
    iget-object v1, p0, Lmiuix/preference/PreferenceFragment;->e:LAi/l;

    if-eqz v1, :cond_3

    invoke-virtual {v1, p1}, LAi/l;->H1(I)Z
    ...
    iget-object v0, p0, Lmiuix/preference/PreferenceFragment;->e:LAi/l;
    ...
    invoke-virtual {v0, p1}, LAi/l;->e(Landroid/content/Context;)V

    iget-object p1, p0, Lmiuix/preference/PreferenceFragment;->e:LAi/l;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    sget v2, Lth/a$m;->Window_windowExtraPaddingHorizontalEnable:I
    ...
    iget-object v3, p0, Lmiuix/preference/PreferenceFragment;->k:LLh/b;

    if-eqz v3, :cond_0

    iput-boolean v2, v3, LLh/b;->a:Z

    :cond_0
    sget v2, Lth/a$m;->Window_windowExtraPaddingHorizontalInitEnable:I
    ...
    sget v1, LAi/t;->preferenceCardStyleEnable:I

    invoke-static {v1, v0, p1}, Lei/d;->i(ILandroid/content/Context;I)I
...
.method public final onCreateAdapter(Landroidx/preference/PreferenceScreen;)Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    invoke-direct {v0, p1, v1, v2}, LAi/l;-><init>(Landroidx/preference/PreferenceScreen;ZI)V

    iput-object v0, p0, Lmiuix/preference/PreferenceFragment;->e:LAi/l;

    iget p1, p0, Lmiuix/preference/PreferenceFragment;->l:I

    invoke-virtual {v0, p1}, LAi/l;->H1(I)Z
    ...
    iput p1, v0, LAi/l;->u:I

    :cond_1
    iget-object p0, p0, Lmiuix/preference/PreferenceFragment;->e:LAi/l;
...
.method public final onCreateRecyclerView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget p3, LAi/y;->miuix_preference_recyclerview:I
    ...
    :cond_1
    invoke-static {p2}, Lmiuix/preference/PreferenceFragment;->Da(Landroid/view/ViewGroup;)Landroid/view/ViewGroup$MarginLayoutParams;
    ...
    sget p3, Lth/a$h;->action_bar_overlay_layout:I
    ...
    invoke-direct {p3, p0}, LAi/j;-><init>(Lmiuix/preference/PreferenceFragment;)V

    invoke-static {p2, p3}, Lei/h;->a(Landroid/view/ViewGroup;Lei/h$a;)V
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/t;->J9()Z
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/t;->l8()Landroid/content/Context;
    ...
    sget v2, LAi/t;->windowActionBarOverlay:I

    invoke-static {v0, v2, v1}, Lei/d;->d(Landroid/content/Context;IZ)Z
    ...
    invoke-static {v0}, LLh/b$a;->a(I)LLh/b;

    move-result-object v0

    iput-object v0, p0, Lmiuix/preference/PreferenceFragment;->k:LLh/b;

    if-eqz v0, :cond_5

    iget-boolean v2, p0, Lmiuix/preference/PreferenceFragment;->i:Z

    iput-boolean v2, v0, LLh/b;->a:Z
    ...
    iget-object v2, p0, Lmiuix/preference/PreferenceFragment;->k:LLh/b;

    iget-boolean v3, v2, LLh/b;->a:Z

    if-eqz v3, :cond_4

    invoke-virtual {v2}, LLh/b;->a()I
    ...
    iget-object v0, p0, Lmiuix/preference/PreferenceFragment;->k:LLh/b;
    ...
    invoke-virtual {p0, v0, v3, v2, v1}, Lmiuix/preference/PreferenceFragment;->Qb(Landroid/content/Context;LLh/b;II)Z
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lmiuix/preference/PreferenceFragment;->pe()Landroid/graphics/Rect;
...
.method public final pe()Landroid/graphics/Rect;
    .locals 2
    ...
    invoke-interface {v0}, Lmiuix/appcompat/app/s;->pe()Landroid/graphics/Rect;
...
.method public final ue(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    .locals 0
