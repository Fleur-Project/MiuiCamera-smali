...
.method public static b(Landroid/content/Context;I[I)[I
    ...
    invoke-static {p0, v0}, Lei/d;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final a(Z)V
    ...
    invoke-static {v0, p1}, LNh/i;->e(ILandroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_3

    invoke-static {v0, p1}, LNh/i;->f(ILandroid/view/View;)Z

    :cond_3
    invoke-static {p1}, LNh/i;->b(Landroid/view/View;)V
...
.method public final d()V
    ...
    invoke-static {v3, v5}, LNh/i;->e(ILandroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {v3, v5}, LNh/i;->f(ILandroid/view/View;)Z
    ...
    :cond_1
    :goto_0
    invoke-static {v5}, LNh/i;->b(Landroid/view/View;)V
    ...
    invoke-interface {v4, v0}, Lmiuix/view/i$a;->b(Z)LNh/f$b;
    ...
    iget v8, v0, LNh/f$b;->a:I

    iget-object v0, v0, LNh/f$b;->b:LNh/f$c;

    if-eqz v0, :cond_7

    iget-object v9, v0, LNh/f$c;->a:[I

    iget-object v0, v0, LNh/f$c;->b:[I
    ...
    invoke-static {v6}, LNh/k;->d(Landroid/graphics/drawable/Drawable;)Ljava/lang/Integer;
    ...
    invoke-static {v0, v5, v4}, LNh/i;->d(ILandroid/view/View;I)Z
    ...
    :cond_a
    invoke-static {v4, v5}, LNh/i;->f(ILandroid/view/View;)Z
    ...
    :cond_d
    :try_start_1
    sget-object v1, LNh/i;->b:Ljava/lang/reflect/Method;
    ...
    sput-object v1, LNh/i;->b:Ljava/lang/reflect/Method;
    ...
    :catch_1
    sput-object v6, LNh/i;->b:Ljava/lang/reflect/Method;
    ...
    const-string v8, "warning!! colorInts("

    const-string v9, ") and blendModes("

    const-string v10, ") size not match. "

    invoke-static {v1, v2, v8, v9, v10}, LQ1/t;->l(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_13
    :try_start_2
    sget-object p0, LNh/i;->d:Ljava/lang/reflect/Method;
    ...
    sput-object p0, LNh/i;->d:Ljava/lang/reflect/Method;
    ...
    :catch_2
    sput-object v6, LNh/i;->d:Ljava/lang/reflect/Method;
    ...
    invoke-static {v2, v5, v4}, LNh/i;->a(ILandroid/view/View;I)Z
