...
.method private parse(Ljava/lang/String;J)V
    ...
    .line 10
    iget-object v5, v0, Lnet/majorkernelpanic/streaming/mp4/MP4Parser;->mFile:Ljava/io/RandomAccessFile;

    invoke-virtual {v5, v3, v11, v2}, Ljava/io/RandomAccessFile;->read([BII)I
    ...
    .line 11
    iget-wide v5, v0, Lnet/majorkernelpanic/streaming/mp4/MP4Parser;->mPos:J

    add-long v5, v5, v17

    iput-wide v5, v0, Lnet/majorkernelpanic/streaming/mp4/MP4Parser;->mPos:J
    ...
    .line 20
    invoke-static {v9, v10, v2, v5}, LC3/p2;->f(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v5}, Ljava/io/RandomAccessFile;->skipBytes(I)I
