...
.field public final a:Lpd/f$a;

.field public final b:Lpd/f$b;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lpd/f;->a:Lpd/f$a;

    new-instance v0, Lpd/f$b;

    invoke-direct {v0, p0}, Lpd/f$b;-><init>(Lpd/f;)V

    iput-object v0, p0, Lpd/f;->b:Lpd/f$b;

    const-string v0, ""

    iput-object v0, p0, Lpd/f;->r:Ljava/lang/String;

    const/4 v1, -0x1

    iput v1, p0, Lpd/f;->Q:I

    iput-object p1, p0, Lpd/f;->d:Landroid/content/Context;
    ...
    iput-object p1, p0, Lpd/f;->y:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lpd/f;->A:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    new-instance p1, Landroid/os/Handler;

    iget-object v1, p0, Lpd/f;->A:Landroid/os/HandlerThread;
    ...
    iput-object p1, p0, Lpd/f;->C:Landroid/os/Handler;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lpd/f;->t:Z

    iput-boolean p1, p0, Lpd/f;->M:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, Lpd/f;->u:Z

    iput-boolean p2, p0, Lpd/f;->c:Z

    iput-object v0, p0, Lpd/f;->r:Ljava/lang/String;

    iput p1, p0, Lpd/f;->p:I

    iput p1, p0, Lpd/f;->q:I

    invoke-virtual {p0}, Lpd/f;->c()V
...
.method public static b(Lcom/xiaomi/Video2GifEditer/EffectType;)J
    ...
    sget-object v0, Lcd/r;->d:Ljava/lang/String;
...
.method public final declared-synchronized a(JJ)V
    ...
    :try_start_0
    iget-object v0, p0, Lpd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;
...
.method public final c()V
    ...
    iget-object v0, p0, Lpd/f;->d:Landroid/content/Context;
    ...
    iput-object v0, p0, Lpd/f;->w:Ljava/lang/String;
    ...
    iput-object v0, p0, Lpd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;
    ...
    iget-object v1, p0, Lpd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;

    invoke-direct {v0, v1}, Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;-><init>(Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;)V

    iput-object v0, p0, Lpd/f;->k:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
...
.method public final e()Z
    ...
    iget-object v0, p0, Lpd/f;->h:Lcom/xiaomi/mimoji/gif/GifEditLayout;
    ...
    iget-object v3, p0, Lpd/f;->r:Ljava/lang/String;
    ...
    :goto_0
    iget v3, p0, Lpd/f;->p:I

    iget v4, p0, Lpd/f;->q:I
...
.method public final h()V
    ...
    iget-object v0, p0, Lpd/f;->y:Landroid/os/Handler;

    new-instance v1, Lpd/d;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lpd/d;-><init>(Ljava/lang/Object;I)V
...
.method public final i(JLjava/lang/String;)V
    ...
    invoke-static {v0, p3, v1}, LC/E1;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iput-boolean v0, p0, Lpd/f;->M:Z

    iput-wide p1, p0, Lpd/f;->x:J

    iget-object p1, p0, Lpd/f;->C:Landroid/os/Handler;

    new-instance p2, LBd/c;

    const/16 v0, 0xd

    invoke-direct {p2, v0, p0, p3}, LBd/c;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final k(Z)V
    ...
    invoke-direct {v1, v2, p0, p1}, LOe/c;-><init>(ILjava/lang/Object;Z)V
...
.method public final l()V
    ...
    invoke-virtual {v0, v1, v2}, Lnd/b;->a(II)V
    ...
    invoke-virtual {v0, v3, v4}, LS9/c;->f(II)I

    move-result v0

    iput v0, p0, Lpd/f;->Q:I

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v3

    iput-wide v3, p0, Lpd/f;->H:J
    ...
    :cond_1
    iget-object v0, p0, Lpd/f;->g:Landroid/widget/ProgressBar;
    ...
    iget-object v0, p0, Lpd/f;->C:Landroid/os/Handler;
    ...
    iget-object p0, p0, Lpd/f;->w:Ljava/lang/String;
...
.method public final onSurfaceTextureAvailable(Landroid/graphics/SurfaceTexture;II)V
    ...
    iget-object p2, p0, Lpd/f;->i:Landroid/view/Surface;
    ...
    iput-object p2, p0, Lpd/f;->i:Landroid/view/Surface;

    iget-object p1, p0, Lpd/f;->k:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
    ...
    :cond_0
    iget-object p1, p0, Lpd/f;->w:Ljava/lang/String;
    ...
    iget-wide p2, p0, Lpd/f;->x:J

    invoke-virtual {p0, p2, p3, p1}, Lpd/f;->i(JLjava/lang/String;)V
...
.method public final onSurfaceTextureUpdated(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lpd/f;->f:Landroid/widget/ImageView;

    const/4 v1, 0x0

    invoke-static {v0, v1, v1}, LC/s2;->w(Landroid/view/View;ZZ)Z
    ...
    invoke-static {v0, p1, v1}, LC/s2;->w(Landroid/view/View;ZZ)Z

    iget-object p0, p0, Lpd/f;->h:Lcom/xiaomi/mimoji/gif/GifEditLayout;
