...
# static fields
.field public static k:Lqe/w; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqe/w;->m:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v1, p0, Lqe/w;->a:Z

    const/4 v2, 0x0

    iput-object v2, p0, Lqe/w;->d:Lqe/w$a;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lqe/w;->e:Ljava/util/ArrayList;

    iput-boolean v1, p0, Lqe/w;->f:Z

    iput-object v2, p0, Lqe/w;->h:Ljava/lang/String;

    iput-object v2, p0, Lqe/w;->i:Landroid/content/Intent;

    iput-object v2, p0, Lqe/w;->j:Ljava/lang/Integer;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    iput-object v2, p0, Lqe/w;->b:Landroid/content/Context;
    ...
    :goto_1
    iput-boolean v2, p0, Lqe/w;->a:Z

    invoke-virtual {p0}, Lqe/w;->m()Z
    ...
    :try_start_1
    iget-object v2, p0, Lqe/w;->b:Landroid/content/Context;
    ...
    :cond_3
    sput-boolean v1, Lqe/w;->l:Z

    new-instance v1, Lqe/w$a;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v2

    invoke-direct {v1, p0, v2}, Lqe/w$a;-><init>(Lqe/w;Landroid/os/Looper;)V

    iput-object v1, p0, Lqe/w;->d:Lqe/w$a;

    invoke-static {p1}, LMe/U2;->g(Landroid/content/Context;)Z

    iget-object p1, p0, Lqe/w;->b:Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lqe/w;->q()Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lqe/w;->t()Landroid/content/Intent;
    ...
    :goto_2
    invoke-virtual {p0, p1}, Lqe/w;->n(Landroid/content/Intent;)V

    return-void
.end method

.method public static declared-synchronized c(Landroid/content/Context;)Lqe/w;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lqe/w;->k:Lqe/w;

    if-nez v1, :cond_0

    new-instance v1, Lqe/w;

    invoke-direct {v1, p0}, Lqe/w;-><init>(Landroid/content/Context;)V

    sput-object v1, Lqe/w;->k:Lqe/w;
...
.method public final b()Landroid/content/Intent;
    ...
    iget-object v0, p0, Lqe/w;->b:Landroid/content/Context;
...
.method public final d(II)V
    ...
    invoke-virtual {p0}, Lqe/w;->b()Landroid/content/Intent;
    ...
    iget-object v1, p0, Lqe/w;->b:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0}, Lqe/w;->p(Landroid/content/Intent;)V
...
.method public final e(LMe/u2;Z)V
    ...
    invoke-static {v1}, LMe/O0;->a(Landroid/content/Context;)LMe/O0;
    ...
    iput-object v7, p0, Lqe/w;->i:Landroid/content/Intent;
    ...
    invoke-static/range {v0 .. v6}, Lqe/v;->a(Landroid/content/Context;LMe/E2;LMe/X1;ZLjava/lang/String;Ljava/lang/String;Z)LMe/q2;
    ...
    iput-wide p1, p0, Lqe/w;->g:J

    invoke-virtual {p0, v8}, Lqe/w;->p(Landroid/content/Intent;)V

    return-void

    :cond_1
    iput-object v8, p0, Lqe/w;->i:Landroid/content/Intent;

    return-void
.end method

.method public final f(LMe/E2;LMe/X1;LMe/h2;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, Lqe/w;->g(LMe/E2;LMe/X1;ZLMe/h2;)V

    return-void
.end method

.method public final g(LMe/E2;LMe/X1;ZLMe/h2;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
...
.method public final h(LMe/E2;LMe/X1;ZZLMe/h2;ZLjava/lang/String;Ljava/lang/String;ZZ)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
    ...
    new-instance p0, Lqe/w$e;

    invoke-direct {p0}, Lqe/w$e;-><init>()V

    iput-object p1, p0, Lqe/w$e;->a:Ljava/lang/Object;

    iput-object p2, p0, Lqe/w$e;->b:LMe/X1;

    iput-boolean p3, p0, Lqe/w$e;->c:Z

    sget-object p1, Lqe/w;->m:Ljava/util/ArrayList;
    ...
    :cond_5
    iget-object p4, p0, Lqe/w;->b:Landroid/content/Context;

    invoke-virtual {p4}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object p4

    iget-object p5, p0, Lqe/w;->b:Landroid/content/Context;

    array-length p7, p3

    invoke-static {p4, p5, p1, p2, p7}, LMe/f0;->c(Ljava/lang/String;Landroid/content/Context;LMe/E2;LMe/X1;I)V
    ...
    invoke-virtual {p0, p1}, Lqe/w;->p(Landroid/content/Intent;)V
...
.method public final i(Landroid/content/Context;)V
    ...
    :goto_0
    sget-object v2, Lqe/u;->c:Lqe/u;

    sget-object v3, Lqe/u;->b:Lqe/u;

    sget-object v4, Lqe/u;->a:Lqe/u;
    ...
    invoke-virtual {p0, v4, v0, v5, v1}, Lqe/w;->j(Ljava/lang/String;Lqe/x;Lqe/j;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4, v0, v3, v1}, Lqe/w;->j(Ljava/lang/String;Lqe/x;Lqe/j;Ljava/lang/String;)V
    ...
    sget-object p1, Lqe/x;->f:Lqe/x;

    sget-object v0, Lqe/j;->d:Lqe/j;

    invoke-virtual {p0, v4, p1, v0, v1}, Lqe/w;->j(Ljava/lang/String;Lqe/x;Lqe/j;Ljava/lang/String;)V
...
.method public final j(Ljava/lang/String;Lqe/x;Lqe/j;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-virtual {v1, p2, v2}, Lqe/t;->e(Lqe/x;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, p4, p3}, Lqe/w;->k(Ljava/lang/String;Lqe/x;ZLjava/util/HashMap;)V

    return-void
.end method

.method public final k(Ljava/lang/String;Lqe/x;ZLjava/util/HashMap;)V
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v3, v0, Lqe/w;->b:Landroid/content/Context;
    ...
    :goto_0
    const-class v8, Lqe/t;

    monitor-enter v8

    :try_start_0
    iget-object v9, v0, Lqe/w;->b:Landroid/content/Context;

    invoke-static {v9}, Lqe/t;->c(Landroid/content/Context;)Lqe/t;

    move-result-object v9

    invoke-virtual {v9, v1}, Lqe/t;->d(Ljava/lang/String;)V
    ...
    iget-object v6, v0, Lqe/w;->b:Landroid/content/Context;
    ...
    sget-object v10, LMe/X1;->j:LMe/X1;

    const/4 v6, 0x0

    invoke-virtual {v0, v3, v10, v6, v7}, Lqe/w;->g(LMe/E2;LMe/X1;ZLMe/h2;)V
    ...
    iget-object v8, v0, Lqe/w;->b:Landroid/content/Context;
    ...
    invoke-static/range {v8 .. v14}, Lqe/v;->a(Landroid/content/Context;LMe/E2;LMe/X1;ZLjava/lang/String;Ljava/lang/String;Z)LMe/q2;
    ...
    iget-object v7, v0, Lqe/w;->b:Landroid/content/Context;

    array-length v8, v3

    invoke-static {v6, v7, v9, v10, v8}, LMe/f0;->c(Ljava/lang/String;Landroid/content/Context;LMe/E2;LMe/X1;I)V
    ...
    iget-object v4, v0, Lqe/w;->b:Landroid/content/Context;
    ...
    invoke-virtual {v0, v5}, Lqe/w;->p(Landroid/content/Intent;)V
    ...
    :cond_8
    iget-object v0, v0, Lqe/w;->d:Lqe/w$a;
...
.method public final l(Ljava/lang/String;Z)V
    ...
    sget-object v0, Lqe/x;->b:Lqe/x;

    sget-object v1, Lqe/x;->a:Lqe/x;
    ...
    invoke-static {v2}, Lqe/t;->c(Landroid/content/Context;)Lqe/t;

    move-result-object p2

    invoke-virtual {p2, v1, v6}, Lqe/t;->e(Lqe/x;Ljava/lang/String;)V

    invoke-static {v2}, Lqe/t;->c(Landroid/content/Context;)Lqe/t;

    move-result-object p2

    invoke-virtual {p2, v0, v5}, Lqe/t;->e(Lqe/x;Ljava/lang/String;)V

    invoke-virtual {p0, p1, v1, v4, v3}, Lqe/w;->k(Ljava/lang/String;Lqe/x;ZLjava/util/HashMap;)V
    ...
    invoke-virtual {p2, v0, v6}, Lqe/t;->e(Lqe/x;Ljava/lang/String;)V

    invoke-static {v2}, Lqe/t;->c(Landroid/content/Context;)Lqe/t;

    move-result-object p2

    invoke-virtual {p2, v1, v5}, Lqe/t;->e(Lqe/x;Ljava/lang/String;)V

    invoke-virtual {p0, p1, v0, v4, v3}, Lqe/w;->k(Ljava/lang/String;Lqe/x;ZLjava/util/HashMap;)V
...
.method public final m()Z
    ...
    iget-boolean v0, p0, Lqe/w;->a:Z

    if-eqz v0, :cond_0

    iget-object p0, p0, Lqe/w;->b:Landroid/content/Context;
...
.method public final n(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1}, Lqe/w;->s(Landroid/content/Intent;)V
...
.method public final o()Z
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Lqe/w;->j:Ljava/lang/Integer;
    ...
    iput-object v4, p0, Lqe/w;->j:Ljava/lang/Integer;

    if-nez v2, :cond_2

    new-instance v2, Lqe/w$b;
    ...
    invoke-direct {v2, p0, v4}, Lqe/w$b;-><init>(Lqe/w;Landroid/os/Handler;)V
    ...
    :cond_2
    iget-object p0, p0, Lqe/w;->j:Ljava/lang/Integer;
...
.method public final p(Landroid/content/Intent;)V
    ...
    invoke-virtual {v1, v0, v4, v2, v5}, Lqe/w;->g(LMe/E2;LMe/X1;ZLMe/h2;)V
...
.method public final q()Landroid/content/Intent;
    ...
    iget-object v4, p0, Lqe/w;->h:Ljava/lang/String;
    ...
    iput-object v5, p0, Lqe/w;->h:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object v4, p0, Lqe/w;->h:Ljava/lang/String;
...
.method public final r()V
    ...
    sget-object v1, Lqe/w;->m:Ljava/util/ArrayList;
    ...
    check-cast v3, Lqe/w$e;

    iget-object v5, v3, Lqe/w$e;->a:Ljava/lang/Object;

    iget-object v6, v3, Lqe/w$e;->b:LMe/X1;

    iget-boolean v7, v3, Lqe/w$e;->c:Z

    iget-object v3, p0, Lqe/w;->b:Landroid/content/Context;
    ...
    invoke-virtual/range {v4 .. v14}, Lqe/w;->h(LMe/E2;LMe/X1;ZZLMe/h2;ZLjava/lang/String;Ljava/lang/String;ZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_2
    :try_start_2
    sget-object p0, Lqe/w;->m:Ljava/util/ArrayList;
...
.method public final declared-synchronized s(Landroid/content/Intent;)V
    ...
    iget-object p1, p0, Lqe/w;->e:Ljava/util/ArrayList;
    ...
    :cond_1
    :try_start_1
    iget-object v0, p0, Lqe/w;->c:Landroid/os/Messenger;

    if-nez v0, :cond_2

    iget-object v0, p0, Lqe/w;->b:Landroid/content/Context;

    new-instance v2, Lqe/w$c;

    invoke-direct {v2, p0}, Lqe/w$c;-><init>(Lqe/w;)V
    ...
    iput-boolean v3, p0, Lqe/w;->f:Z

    iget-object v0, p0, Lqe/w;->e:Ljava/util/ArrayList;
    ...
    :try_start_2
    iget-object p1, p0, Lqe/w;->c:Landroid/os/Messenger;
    ...
    :try_start_3
    iput-object p1, p0, Lqe/w;->c:Landroid/os/Messenger;

    iput-boolean v2, p0, Lqe/w;->f:Z
    :try_end_3
