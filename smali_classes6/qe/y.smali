...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Lqe/y;->a:Landroid/content/Context;
...
.method public final run()V
    ...
    iget-object v1, p0, Lqe/y;->a:Landroid/content/Context;
    ...
    iget-object v4, v3, Lqe/i;->b:Lqe/i$a;
    ...
    iput-object v4, v0, LMe/t2;->i:Ljava/lang/String;

    new-instance v4, Ljava/util/HashMap;

    invoke-direct {v4}, Ljava/util/HashMap;-><init>()V

    iput-object v4, v0, LMe/t2;->h:Ljava/util/HashMap;
    ...
    invoke-static {v6, v5, v4}, LMe/V2;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)V

    iget-object v4, v0, LMe/t2;->h:Ljava/util/HashMap;

    invoke-virtual {v1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v5

    invoke-static {v1, v5}, LMe/S1;->c(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {v5, v6, v4}, LMe/V2;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    iget-object v5, v3, Lqe/i;->b:Lqe/i$a;

    iget-object v5, v5, Lqe/i$a;->b:Ljava/lang/String;
    ...
    sget-object v4, LMe/M2;->a:Ljava/lang/String;

    invoke-static {v5}, LEg/B;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4, v6}, LC/F;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v4, v6}, LMe/V2;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    invoke-virtual {v4, v6}, LMe/l;->b(Ljava/util/AbstractMap;)V

    iget-object v4, v0, LMe/t2;->h:Ljava/util/HashMap;

    iget-object v6, v3, Lqe/i;->b:Lqe/i$a;

    iget-object v6, v6, Lqe/i$a;->c:Ljava/lang/String;

    const-string v7, "reg_id"

    invoke-static {v7, v6, v4}, LMe/V2;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)V

    iget-object v4, v0, LMe/t2;->h:Ljava/util/HashMap;

    iget-object v3, v3, Lqe/i;->b:Lqe/i$a;

    iget-object v3, v3, Lqe/i$a;->d:Ljava/lang/String;

    const-string v6, "reg_secret"

    invoke-static {v6, v3, v4}, LMe/V2;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    iget-boolean p0, p0, Lqe/y;->b:Z

    if-eqz p0, :cond_2

    iget-object p0, v0, LMe/t2;->h:Ljava/util/HashMap;

    invoke-static {v1}, Lcom/xiaomi/mipush/sdk/b;->k(Landroid/content/Context;)Ljava/util/ArrayList;

    move-result-object v3

    invoke-static {v3}, Lqe/z;->a(Ljava/util/ArrayList;)Ljava/lang/String;

    move-result-object v3

    const-string v4, "aliases_md5"

    invoke-static {v4, v3, p0}, LMe/V2;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    invoke-static {v3}, Lqe/z;->d(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1, v2, v5}, Lqe/w;->g(LMe/E2;LMe/X1;ZLMe/h2;)V
