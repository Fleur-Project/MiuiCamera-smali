...
.method public static b(LOf/a;Ljava/util/LinkedHashSet;)V
    .locals 1
    ...
    invoke-interface {p0}, LOf/a;->k()Ljava/util/Collection;
    ...
    invoke-interface {v0}, LOf/a;->a()LOf/a;

    move-result-object v0

    invoke-static {v0, p1}, Lqg/h;->b(LOf/a;Ljava/util/LinkedHashSet;)V
...
.method public static c(LEg/F;)LOf/e;
    .locals 1
...
.method public static d(LOf/k;)LOf/B;
    .locals 1
...
.method public static e(LOf/k;)LOf/B;
    .locals 2
    ...
    :cond_0
    instance-of v1, p0, LOf/J;

    if-eqz v1, :cond_1

    check-cast p0, LOf/J;

    invoke-interface {p0}, LOf/J;->getModule()LRf/M;
...
.method public static f(LOf/k;)LOf/W;
    .locals 2

    if-eqz p0, :cond_2

    instance-of v0, p0, LOf/P;
    ...
    sget-object v1, LOf/W;->a:LOf/W$a;
...
.method public static g(LOf/k;)Lng/d;
    .locals 1
...
.method public static h(LOf/k;)Lng/c;
    .locals 2
    ...
    invoke-interface {p0}, LOf/J;->c()Lng/c;
...
.method public static i(LOf/k;Ljava/lang/Class;Z)LOf/k;
    .locals 0
...
.method public static j(LOf/e;)LOf/e;
    .locals 4
...
.method public static k(LOf/k;)Z
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lng/f;->equals(Ljava/lang/Object;)Z
...
.method public static l(LOf/k;)Z
    .locals 1
...
.method public static m(LOf/k;)Z
    .locals 1
...
.method public static n(LOf/k;LOf/f;)Z
    .locals 1
...
.method public static o(LOf/k;)Z
    .locals 3
    ...
    invoke-static {p0}, Lqg/h;->k(LOf/k;)Z

    move-result v1

    if-nez v1, :cond_1

    instance-of v1, p0, LOf/o;
    ...
    sget-object v2, LOf/q;->f:LOf/q$i;
...
.method public static p(LEg/F;LOf/e;)Z
    .locals 1
...
.method public static q(LOf/k;)Z
    .locals 1
...
.method public static r(LEg/F;LOf/e;)Z
    .locals 1
    ...
    invoke-static {p0, p1}, Lqg/h;->p(LEg/F;LOf/e;)Z
    ...
    invoke-static {v0, p1}, Lqg/h;->r(LEg/F;LOf/e;)Z
...
.method public static s(LOf/k;)Z
    .locals 0
...
.method public static t(LOf/b;)LOf/b;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D::",
