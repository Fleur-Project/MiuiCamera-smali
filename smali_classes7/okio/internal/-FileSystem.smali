...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lokio/FileSystem;Lokio/Path;Z)LOg/h;",
        "LOg/j;",
        "fileSystem",
        "Lkf/h;",
        "stack",
        "postorder",
        "collectRecursively",
        "(LOg/j;Lokio/FileSystem;Lkf/h;Lokio/Path;ZZLnf/d;)Ljava/lang/Object;",
        "symlinkTarget",
...
# direct methods
.method public static final collectRecursively(LOg/j;Lokio/FileSystem;Lkf/h;Lokio/Path;ZZLnf/d;)Ljava/lang/Object;
    .locals 16
    ...
    invoke-direct {v5, v3}, Lokio/internal/-FileSystem$collectRecursively$1;-><init>(Lnf/d;)V
    ...
    invoke-static {v3}, Ljf/k;->b(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v5}, LOg/j;->b(Ljava/lang/Object;Lpf/a;)V
    ...
    invoke-virtual {v7, v13}, Lkf/h;->contains(Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v2}, LC/L;->e(Lokio/Path;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_9
    invoke-virtual {v7, v13}, Lkf/h;->addLast(Ljava/lang/Object;)V
    ...
    iput-boolean v0, v5, Lokio/internal/-FileSystem$collectRecursively$1;->Z$0:Z

    iput-boolean v1, v5, Lokio/internal/-FileSystem$collectRecursively$1;->Z$1:Z
    ...
    :try_start_2
    invoke-static/range {p0 .. p6}, Lokio/internal/-FileSystem;->collectRecursively(LOg/j;Lokio/FileSystem;Lkf/h;Lokio/Path;ZZLnf/d;)Ljava/lang/Object;
    ...
    :cond_b
    invoke-virtual {v7}, Lkf/h;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v11, v1, v5}, LOg/j;->b(Ljava/lang/Object;Lpf/a;)V
...
.method public static final commonCopy(Lokio/FileSystem;Lokio/Path;Lokio/Path;)V
    ...
    :try_start_4
    invoke-static {p2, p0}, LAg/E;->e(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final commonCreateDirectories(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-virtual {v0, v1}, Lkf/h;->addFirst(Ljava/lang/Object;)V
...
.method public static final commonDeleteRecursively(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/-FileSystem$commonDeleteRecursively$sequence$1;-><init>(Lokio/FileSystem;Lokio/Path;Lnf/d;)V

    invoke-static {v0}, LEg/V;->i(Lyf/p;)LOg/i;

    move-result-object p1

    :goto_0
    invoke-virtual {p1}, LOg/i;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, LOg/i;->next()Ljava/lang/Object;
...
.method public static final commonListRecursively(Lokio/FileSystem;Lokio/Path;Z)LOg/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/-FileSystem$commonListRecursively$1;-><init>(Lokio/Path;Lokio/FileSystem;ZLnf/d;)V
...
.method public static final commonMetadata(Lokio/FileSystem;Lokio/Path;)Lokio/FileMetadata;
    ...
    invoke-static {p1, v0}, LC/L;->e(Lokio/Path;Ljava/lang/String;)Ljava/lang/String;
