...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lokio/ZipFileSystem;",
        "openZip",
        "(Lokio/Path;Lokio/FileSystem;Lyf/l;)Lokio/ZipFileSystem;",
        "",
        "entries",
        "",
        "buildIndex",
...
.method private static final buildIndex(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-direct {v0, v6, v5}, Ljf/i;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v0}, [Ljf/i;
    ...
    invoke-static {v1, v2}, Lkf/v;->u0(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lyf/l;)Lokio/ZipFileSystem;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_5
    invoke-static {v5, v11}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    :try_start_8
    invoke-static {v5, v1}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :try_start_9
    invoke-static {v3, v11}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_9
    ...
    :try_start_b
    invoke-static {v3, v1}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v11}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v1}, LAg/E;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    throw v0
.end method

.method public static synthetic openZip$default(Lokio/Path;Lokio/FileSystem;Lyf/l;ILjava/lang/Object;)Lokio/ZipFileSystem;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lokio/internal/ZipFilesKt;->openZip(Lokio/Path;Lokio/FileSystem;Lyf/l;)Lokio/ZipFileSystem;
...
.method public static final readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    ...
    iput-wide v9, v6, Lkotlin/jvm/internal/y;->a:J
    ...
    iput-wide v9, v4, Lkotlin/jvm/internal/y;->a:J
    ...
    iput-wide v11, v7, Lkotlin/jvm/internal/y;->a:J
    ...
    invoke-static {v11, v12}, LPg/p;->O(Ljava/lang/String;C)Z

    move-result v0

    if-nez v0, :cond_5

    iget-wide v0, v4, Lkotlin/jvm/internal/y;->a:J
    ...
    :goto_1
    iget-wide v12, v6, Lkotlin/jvm/internal/y;->a:J
    ...
    invoke-direct/range {v0 .. v7}, Lokio/internal/ZipFilesKt$readEntry$1;-><init>(Lkotlin/jvm/internal/w;JLkotlin/jvm/internal/y;Lokio/BufferedSource;Lkotlin/jvm/internal/y;Lkotlin/jvm/internal/y;)V

    invoke-static {v5, v9, v0}, Lokio/internal/ZipFilesKt;->readExtra(Lokio/BufferedSource;ILyf/p;)V
    ...
    invoke-static {v11, v1, v14}, LPg/m;->E(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v11

    new-instance v9, Lokio/internal/ZipEntry;

    iget-wide v0, v6, Lkotlin/jvm/internal/y;->a:J

    iget-wide v2, v4, Lkotlin/jvm/internal/y;->a:J

    iget-wide v4, v7, Lkotlin/jvm/internal/y;->a:J
...
.method private static final readExtra(Lokio/BufferedSource;ILyf/p;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, v8, v9}, Lyf/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final readOrSkipLocalHeader(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    ...
    invoke-direct {v2, v0, v1, v3, v4}, Lokio/internal/ZipFilesKt$readOrSkipLocalHeader$1;-><init>(Lokio/BufferedSource;Lkotlin/jvm/internal/z;Lkotlin/jvm/internal/z;Lkotlin/jvm/internal/z;)V

    invoke-static {v0, v5, v2}, Lokio/internal/ZipFilesKt;->readExtra(Lokio/BufferedSource;ILyf/p;)V
