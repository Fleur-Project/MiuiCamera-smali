...
.method public getTextElements(FLjava/awt/font/FontRenderContext;)[Lorg/apache/poi/hslf/model/TextPainter$TextElement;
    ...
    invoke-static {v5, v1, v2}, LA2/l;->j(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_10
    new-instance v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;

    invoke-direct {v9}, Lorg/apache/poi/hslf/model/TextPainter$TextElement;-><init>()V

    if-ltz v2, :cond_11

    invoke-virtual/range {p2 .. p2}, Ljava/awt/font/TextLayout;->getAscent()F
    ...
    iput v15, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->ascent:F
    ...
    mul-int/lit8 v13, v13, 0x48

    div-int/lit16 v13, v13, 0x240

    int-to-float v13, v13

    iput v13, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->ascent:F
    ...
    iput v13, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->_align:I

    invoke-virtual/range {p2 .. p2}, Ljava/awt/font/TextLayout;->getAdvance()F

    move-result v13

    iput v13, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->advance:F

    iput v10, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->_textOffset:I

    new-instance v10, Ljava/text/AttributedString;

    invoke-direct {v10, v3, v5, v6}, Ljava/text/AttributedString;-><init>(Ljava/text/AttributedCharacterIterator;II)V

    iput-object v10, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->_text:Ljava/text/AttributedString;

    iput v5, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->textStartIndex:I

    iput v6, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->textEndIndex:I
    ...
    :goto_8
    iget v13, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->ascent:F
    ...
    invoke-virtual/range {p2 .. p2}, Ljava/awt/font/TextLayout;->getDescent()F

    move-result v10

    invoke-virtual/range {p2 .. p2}, Ljava/awt/font/TextLayout;->getLeading()F
    ...
    :goto_a
    iget v2, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->ascent:F

    add-float/2addr v2, v1

    iput v2, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->ascent:F

    :cond_16
    iput v10, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->descent:F
    ...
    sget-object v10, Ljava/awt/font/TextAttribute;->FOREGROUND:Ljava/awt/font/TextAttribute;

    invoke-virtual {v1, v10, v2}, Ljava/text/AttributedString;->addAttribute(Ljava/text/AttributedCharacterIterator$Attribute;Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v2, v10}, Ljava/text/AttributedString;->addAttribute(Ljava/text/AttributedCharacterIterator$Attribute;Ljava/lang/Object;)V
    ...
    :cond_19
    iget-object v10, v0, Lorg/apache/poi/hslf/model/TextPainter;->_shape:Lorg/apache/poi/hslf/model/TextShape;

    invoke-virtual {v10}, Lorg/apache/poi/hslf/model/Shape;->getSheet()Lorg/apache/poi/hslf/model/Sheet;
    ...
    invoke-virtual {v10, v2}, Lorg/apache/poi/hslf/usermodel/SlideShow;->getFont(I)Lorg/apache/poi/hslf/model/PPFont;

    move-result-object v2

    sget-object v10, Ljava/awt/font/TextAttribute;->FAMILY:Ljava/awt/font/TextAttribute;

    invoke-virtual {v2}, Lorg/apache/poi/hslf/model/PPFont;->getFontName()Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v1, v10, v11}, Ljava/text/AttributedString;->addAttribute(Ljava/text/AttributedCharacterIterator$Attribute;Ljava/lang/Object;)V
    ...
    :cond_1a
    sget-object v11, Ljava/awt/font/TextAttribute;->SIZE:Ljava/awt/font/TextAttribute;
    ...
    invoke-virtual {v1, v11, v15}, Ljava/text/AttributedString;->addAttribute(Ljava/text/AttributedCharacterIterator$Attribute;Ljava/lang/Object;)V
    ...
    invoke-direct {v11, v2, v15, v13}, Ljava/awt/Font;-><init>(Ljava/lang/String;II)V

    invoke-virtual {v12}, Lorg/apache/poi/hslf/usermodel/RichTextRun;->getBulletChar()C

    move-result v2

    invoke-virtual {v11, v2}, Ljava/awt/Font;->canDisplay(C)Z
    ...
    invoke-direct {v2, v10, v1}, Ljava/text/AttributedString;-><init>(Ljava/lang/String;Ljava/util/Map;)V
    ...
    iput-object v1, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->_bullet:Ljava/text/AttributedString;

    iput v14, v9, Lorg/apache/poi/hslf/model/TextPainter$TextElement;->_bulletOffset:I
