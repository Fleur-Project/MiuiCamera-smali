...
.method public static main([Ljava/lang/String;)V
    ...
    invoke-static {v1, v3, v0}, LC/H;->l(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/io/PrintStream;)V
    ...
    invoke-static {v1, v4, v0}, LC/H;->l(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/io/PrintStream;)V
...
.method public processCellStyle(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;Lorg/apache/poi/hssf/usermodel/HSSFCellStyle;Lorg/w3c/dom/Element;Lorg/w3c/dom/Element;)V
    ...
    invoke-virtual/range {v3 .. v8}, Lorg/apache/poi/hssf/converter/ExcelToFoConverter;->processCellStyleBorder(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;Lorg/w3c/dom/Element;Ljava/lang/String;SS)V
    ...
    invoke-virtual {p2, v1}, Lorg/apache/poi/hssf/usermodel/HSSFCellStyle;->getFont(Lorg/apache/poi/ss/usermodel/Workbook;)Lorg/apache/poi/hssf/usermodel/HSSFFont;

    move-result-object p0

    invoke-virtual {v0, v1, p4, p0}, Lorg/apache/poi/hssf/converter/ExcelToFoConverter;->processCellStyleFont(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;Lorg/w3c/dom/Element;Lorg/apache/poi/hssf/usermodel/HSSFFont;)V
...
.method public processCellStyleBorder(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;Lorg/w3c/dom/Element;Ljava/lang/String;SS)V
    ...
    invoke-static {p1, p3}, LB2/p;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public processRow(Lorg/apache/poi/hssf/usermodel/HSSFWorkbook;[[Lorg/apache/poi/ss/util/CellRangeAddress;Lorg/apache/poi/hssf/usermodel/HSSFRow;Lorg/w3c/dom/Element;)I
    ...
    invoke-virtual {v7}, Lorg/apache/poi/hssf/usermodel/HSSFRow;->getSheet()Lorg/apache/poi/hssf/usermodel/HSSFSheet;

    move-result-object v9

    invoke-virtual {v7}, Lorg/apache/poi/hssf/usermodel/HSSFRow;->getLastCellNum()S
    ...
    invoke-virtual {v0}, Lorg/apache/poi/hssf/converter/AbstractExcelConverter;->isOutputRowNumbers()Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual {v0, v7}, Lorg/apache/poi/hssf/converter/ExcelToFoConverter;->processRowNumber(Lorg/apache/poi/hssf/usermodel/HSSFRow;)Lorg/w3c/dom/Element;
    ...
    invoke-virtual {v0}, Lorg/apache/poi/hssf/converter/AbstractExcelConverter;->isOutputHiddenColumns()Z

    move-result v2

    if-nez v2, :cond_2

    invoke-virtual {v9, v12}, Lorg/apache/poi/hssf/usermodel/HSSFSheet;->isColumnHidden(I)Z
    ...
    :cond_2
    invoke-virtual {v7}, Lorg/apache/poi/hssf/usermodel/HSSFRow;->getRowNum()I

    move-result v2

    move-object/from16 v14, p2

    invoke-static {v14, v2, v12}, Lorg/apache/poi/hssf/converter/AbstractExcelUtils;->getMergedRange([[Lorg/apache/poi/ss/util/CellRangeAddress;II)Lorg/apache/poi/ss/util/CellRangeAddress;
    ...
    invoke-virtual {v7, v12}, Lorg/apache/poi/hssf/usermodel/HSSFRow;->getCell(I)Lorg/apache/poi/hssf/usermodel/HSSFCell;

    move-result-object v2

    invoke-static {v9, v12}, Lorg/apache/poi/hssf/converter/AbstractExcelConverter;->getColumnWidth(Lorg/apache/poi/hssf/usermodel/HSSFSheet;I)I
    ...
    invoke-virtual {v9, v5}, Lorg/apache/poi/hssf/usermodel/HSSFSheet;->isColumnHidden(I)Z
    ...
    :cond_4
    invoke-virtual {v7, v5}, Lorg/apache/poi/hssf/usermodel/HSSFRow;->getCell(I)Lorg/apache/poi/hssf/usermodel/HSSFCell;
    ...
    invoke-virtual {v0, v6}, Lorg/apache/poi/hssf/converter/AbstractExcelConverter;->isTextEmpty(Lorg/apache/poi/hssf/usermodel/HSSFCell;)Z
    ...
    :cond_5
    invoke-static {v9, v5}, Lorg/apache/poi/hssf/converter/AbstractExcelConverter;->getColumnWidth(Lorg/apache/poi/hssf/usermodel/HSSFSheet;I)I
    ...
    :goto_4
    iget-object v4, v0, Lorg/apache/poi/hssf/converter/ExcelToFoConverter;->foDocumentFacade:Lorg/apache/poi/hwpf/converter/FoDocumentFacade;

    invoke-virtual {v4}, Lorg/apache/poi/hwpf/converter/FoDocumentFacade;->createTableCell()Lorg/w3c/dom/Element;
    ...
    const-string v15, "number-columns-spanned"
    ...
    const-string v6, "number-rows-spanned"

    invoke-interface {v4, v6, v3}, Lorg/w3c/dom/Element;->setAttribute(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v8, v2}, Lorg/w3c/dom/Node;->appendChild(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;
