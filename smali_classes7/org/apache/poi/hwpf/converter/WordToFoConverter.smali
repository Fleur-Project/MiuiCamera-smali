...
.method public processTable(Lorg/apache/poi/hwpf/HWPFDocumentCore;Lorg/w3c/dom/Element;Lorg/apache/poi/hwpf/usermodel/Table;)V
    ...
    iget-object v2, v0, Lorg/apache/poi/hwpf/converter/WordToFoConverter;->foDocumentFacade:Lorg/apache/poi/hwpf/converter/FoDocumentFacade;

    invoke-virtual {v2}, Lorg/apache/poi/hwpf/converter/FoDocumentFacade;->createTableHeader()Lorg/w3c/dom/Element;
    ...
    iget-object v4, v0, Lorg/apache/poi/hwpf/converter/WordToFoConverter;->foDocumentFacade:Lorg/apache/poi/hwpf/converter/FoDocumentFacade;

    invoke-virtual {v4}, Lorg/apache/poi/hwpf/converter/FoDocumentFacade;->createTableRow()Lorg/w3c/dom/Element;

    move-result-object v4

    invoke-static {v10, v4}, Lorg/apache/poi/hwpf/converter/WordToFoUtils;->setTableRowProperties(Lorg/apache/poi/hwpf/usermodel/TableRow;Lorg/w3c/dom/Element;)V

    invoke-virtual {v10}, Lorg/apache/poi/hwpf/usermodel/TableRow;->numCells()I
    ...
    invoke-virtual {v10, v4}, Lorg/apache/poi/hwpf/usermodel/TableRow;->getCell(I)Lorg/apache/poi/hwpf/usermodel/TableCell;
    ...
    invoke-virtual {v0, v2, v11, v12}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->getNumberColumnsSpanned([IILorg/apache/poi/hwpf/usermodel/TableCell;)I
    ...
    :cond_1
    iget-object v13, v0, Lorg/apache/poi/hwpf/converter/WordToFoConverter;->foDocumentFacade:Lorg/apache/poi/hwpf/converter/FoDocumentFacade;

    invoke-virtual {v13}, Lorg/apache/poi/hwpf/converter/FoDocumentFacade;->createTableCell()Lorg/w3c/dom/Element;
    ...
    :goto_7
    invoke-static/range {v10 .. v16}, Lorg/apache/poi/hwpf/converter/WordToFoUtils;->setTableCellProperties(Lorg/apache/poi/hwpf/usermodel/TableRow;Lorg/apache/poi/hwpf/usermodel/TableCell;Lorg/w3c/dom/Element;ZZZZ)V

    invoke-virtual {v0, v2, v9, v11}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->getNumberColumnsSpanned([IILorg/apache/poi/hwpf/usermodel/TableCell;)I
    ...
    invoke-interface {v12, v14, v13}, Lorg/w3c/dom/Element;->setAttribute(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v12, v1, v8}, Lorg/w3c/dom/Element;->setAttribute(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v8, v12, v5, v1}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->processParagraphes(Lorg/apache/poi/hwpf/HWPFDocumentCore;Lorg/w3c/dom/Element;Lorg/apache/poi/hwpf/usermodel/Range;I)V
    ...
    iget-object v1, v0, Lorg/apache/poi/hwpf/converter/WordToFoConverter;->foDocumentFacade:Lorg/apache/poi/hwpf/converter/FoDocumentFacade;

    invoke-virtual {v1}, Lorg/apache/poi/hwpf/converter/FoDocumentFacade;->createBlock()Lorg/w3c/dom/Element;

    move-result-object v1

    invoke-interface {v12, v1}, Lorg/w3c/dom/Node;->appendChild(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;
    ...
    invoke-virtual {v10}, Lorg/apache/poi/hwpf/usermodel/TableRow;->isTableHeader()Z
    ...
    :cond_d
    iget-object v0, v0, Lorg/apache/poi/hwpf/converter/WordToFoConverter;->foDocumentFacade:Lorg/apache/poi/hwpf/converter/FoDocumentFacade;
