...
.method private dumpStyles()V
    ...
    invoke-static {v2, v5, v6}, LA2/l;->j(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public static main([Ljava/lang/String;)V
    ...
    :cond_2
    const-string v2, "--textPiecesText"
    ...
    :cond_4
    const-string v2, "--chpxProperties"
    ...
    :cond_7
    const-string v2, "--paragraphsText"
    ...
    :cond_9
    const-string v2, "--papxProperties"
    ...
    :cond_f
    const-string v2, "--officeDrawings"
    ...
    const-string v2, "org.apache.poi.hwpf.preserveTextTable"
    ...
    invoke-static {v0}, Lorg/apache/poi/hwpf/dev/HWPFLister;->loadDoc(Ljava/io/File;)Lorg/apache/poi/hwpf/HWPFDocumentCore;
...
.method public dumpPapx(ZZ)V
    ...
    const-string v3, "binary PAP pages "
    ...
    const-class v3, Lorg/apache/poi/hwpf/HWPFDocumentCore;

    const-string v4, "_mainStream"
    ...
    invoke-virtual {v0}, Lorg/apache/poi/hwpf/HWPFDocument;->getTableStream()[B
    ...
    invoke-virtual {v6}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcPlcfbtePapx()I
    ...
    invoke-virtual {v7}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbPlcfbtePapx()I

    move-result v7

    const/4 v8, 0x4

    invoke-direct {v4, v5, v6, v7, v8}, Lorg/apache/poi/hwpf/model/PlexOfCps;-><init>([BIII)V

    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    invoke-virtual {v4}, Lorg/apache/poi/hwpf/model/PlexOfCps;->length()I
    ...
    invoke-virtual {v4, v7}, Lorg/apache/poi/hwpf/model/PlexOfCps;->getProperty(I)Lorg/apache/poi/hwpf/model/GenericPropertyNode;

    move-result-object v10

    invoke-virtual {v10}, Lorg/apache/poi/hwpf/model/GenericPropertyNode;->getBytes()[B

    move-result-object v10

    invoke-static {v10}, Lorg/apache/poi/util/LittleEndian;->getInt([B)I

    move-result v10

    mul-int/lit16 v10, v10, 0x200

    new-instance v11, Lorg/apache/poi/hwpf/model/PAPFormattedDiskPage;

    invoke-virtual {v0}, Lorg/apache/poi/hwpf/HWPFDocument;->getDataStream()[B
    ...
    invoke-direct {v11, v3, v12, v10, v13}, Lorg/apache/poi/hwpf/model/PAPFormattedDiskPage;-><init>([B[BILorg/apache/poi/hwpf/model/CharIndexTranslator;)V

    sget-object v10, Ljava/lang/System;->out:Ljava/io/PrintStream;

    new-instance v12, Ljava/lang/StringBuilder;

    const-string v13, "* PFKP: "
    ...
    invoke-virtual {v11}, Lorg/apache/poi/hwpf/model/PAPFormattedDiskPage;->getPAPXs()Ljava/util/List;
    ...
    new-instance v12, Lorg/apache/poi/hwpf/sprm/SprmIterator;

    invoke-virtual {v11}, Lorg/apache/poi/hwpf/model/PAPX;->getGrpprl()[B

    move-result-object v11

    invoke-direct {v12, v11, v1}, Lorg/apache/poi/hwpf/sprm/SprmIterator;-><init>([BI)V

    invoke-virtual {p0, v12, v8}, Lorg/apache/poi/hwpf/dev/HWPFLister;->dumpSprms(Lorg/apache/poi/hwpf/sprm/SprmIterator;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4, v8}, Lorg/apache/poi/hwpf/dev/HWPFLister;->dumpSprms(Lorg/apache/poi/hwpf/sprm/SprmIterator;Ljava/lang/String;)V
    ...
    const-class v3, Lorg/apache/poi/hwpf/model/PAPX;

    filled-new-array {v0, v3}, [Ljava/lang/Class;

    move-result-object v0

    const-class v3, Lorg/apache/poi/hwpf/usermodel/Paragraph;

    const-string v4, "newParagraph"
    ...
    invoke-virtual {v2}, Lorg/apache/poi/hwpf/HWPFDocumentCore;->getParagraphTable()Lorg/apache/poi/hwpf/model/PAPBinTable;

    move-result-object v2

    invoke-virtual {v2}, Lorg/apache/poi/hwpf/model/PAPBinTable;->getParagraphs()Ljava/util/ArrayList;
    ...
    check-cast v5, Lorg/apache/poi/hwpf/usermodel/Paragraph;
    ...
    invoke-direct {v5, v4, v1}, Lorg/apache/poi/hwpf/sprm/SprmIterator;-><init>([BI)V

    const-string v4, "\t"

    invoke-virtual {p0, v5, v4}, Lorg/apache/poi/hwpf/dev/HWPFLister;->dumpSprms(Lorg/apache/poi/hwpf/sprm/SprmIterator;Ljava/lang/String;)V
...
.method public dumpParagraphs(Z)V
    ...
    invoke-static {v4, v1, v3}, LC/H;->l(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/io/PrintStream;)V
