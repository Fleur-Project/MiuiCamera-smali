...
.method private writeFraction(DLjava/lang/StringBuffer;DLjava/lang/StringBuffer;Ljava/util/Set;)V
    ...
    invoke-static {v12, v1}, LQ1/t;->f(ILjava/util/List;)Ljava/lang/Object;
    ...
    invoke-static {v12, v2}, LQ1/t;->f(ILjava/util/List;)Ljava/lang/Object;
    ...
    invoke-static {v14, v6}, Lorg/apache/poi/ss/format/CellNumberFormatter;->hasChar(C[Ljava/util/List;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {v1, v9, v2, v12, v13}, Lorg/apache/poi/ss/format/CellNumberFormatter;->replaceMod(Lorg/apache/poi/ss/format/CellNumberFormatter$Special;ZLorg/apache/poi/ss/format/CellNumberFormatter$Special;ZC)Lorg/apache/poi/ss/format/CellNumberFormatter$StringMod;
    ...
    :cond_0
    invoke-static {v1, v9, v2, v12}, Lorg/apache/poi/ss/format/CellNumberFormatter;->deleteMod(Lorg/apache/poi/ss/format/CellNumberFormatter$Special;ZLorg/apache/poi/ss/format/CellNumberFormatter$Special;Z)Lorg/apache/poi/ss/format/CellNumberFormatter$StringMod;
    ...
    new-array v15, v12, [Ljava/util/List;

    aput-object v1, v15, v9

    invoke-static {v2, v15}, Lorg/apache/poi/ss/format/CellNumberFormatter;->hasChar(C[Ljava/util/List;)Z
    ...
    invoke-static {v11, v10}, Lorg/apache/poi/ss/format/CellNumberFormatter;->hasOnly(C[Ljava/util/List;)Z
    ...
    invoke-static {v2, v11}, Lorg/apache/poi/ss/format/CellNumberFormatter;->hasChar(C[Ljava/util/List;)Z
    ...
    invoke-static {v14, v5}, Lorg/apache/poi/ss/format/CellNumberFormatter;->hasChar(C[Ljava/util/List;)Z
    ...
    invoke-static {v1, v12, v2, v9, v13}, Lorg/apache/poi/ss/format/CellNumberFormatter;->replaceMod(Lorg/apache/poi/ss/format/CellNumberFormatter$Special;ZLorg/apache/poi/ss/format/CellNumberFormatter$Special;ZC)Lorg/apache/poi/ss/format/CellNumberFormatter$StringMod;
    ...
    invoke-static {v1, v12, v2, v9}, Lorg/apache/poi/ss/format/CellNumberFormatter;->deleteMod(Lorg/apache/poi/ss/format/CellNumberFormatter$Special;ZLorg/apache/poi/ss/format/CellNumberFormatter$Special;Z)Lorg/apache/poi/ss/format/CellNumberFormatter$StringMod;
    ...
    invoke-direct {v1, v6, v7, v2}, Lorg/apache/poi/ss/format/CellNumberFormatter$Fraction;-><init>(DI)V
    ...
    :cond_f
    iget-object v1, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->numeratorFmt:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v5}, Lorg/apache/poi/ss/format/CellNumberFormatter;->writeSingleInteger(Ljava/lang/String;ILjava/lang/StringBuffer;Ljava/util/List;Ljava/util/Set;)V

    iget-object v1, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->denominatorFmt:Ljava/lang/String;

    iget-object v4, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->denominatorSpecials:Ljava/util/List;
...
.method private writeScientific(DLjava/lang/StringBuffer;Ljava/util/Set;)V
    ...
    iget-object v2, p0, Lorg/apache/poi/ss/format/CellNumberFormatter;->decimalFmt:Ljava/text/DecimalFormat;

    invoke-virtual {v2, p1, p2, v1, v6}, Ljava/text/DecimalFormat;->format(DLjava/lang/StringBuffer;Ljava/text/FieldPosition;)Ljava/lang/StringBuffer;
    ...
    invoke-direct {p0, v1, p3}, Lorg/apache/poi/ss/format/CellNumberFormatter;->writeFractional(Ljava/lang/StringBuffer;Ljava/lang/StringBuffer;)V
    ...
    :cond_0
    iget-object v5, p0, Lorg/apache/poi/ss/format/CellNumberFormatter;->exponentSpecials:Ljava/util/List;
    ...
    iget-char v10, v5, Lorg/apache/poi/ss/format/CellNumberFormatter$Special;->ch:C
    ...
    :cond_1
    invoke-static {v5, v7, v5, v7}, Lorg/apache/poi/ss/format/CellNumberFormatter;->deleteMod(Lorg/apache/poi/ss/format/CellNumberFormatter$Special;ZLorg/apache/poi/ss/format/CellNumberFormatter$Special;Z)Lorg/apache/poi/ss/format/CellNumberFormatter$StringMod;
    ...
    :cond_2
    :goto_0
    invoke-static {v5, v7, v5, v7, v6}, Lorg/apache/poi/ss/format/CellNumberFormatter;->replaceMod(Lorg/apache/poi/ss/format/CellNumberFormatter$Special;ZLorg/apache/poi/ss/format/CellNumberFormatter$Special;ZC)Lorg/apache/poi/ss/format/CellNumberFormatter$StringMod;
...
.method private writeSingleInteger(Ljava/lang/String;ILjava/lang/StringBuffer;Ljava/util/List;Ljava/util/Set;)V
    ...
    invoke-virtual {v1, v2, v0, p2}, Ljava/util/Formatter;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/util/Formatter;
    ...
    invoke-direct/range {p0 .. p5}, Lorg/apache/poi/ss/format/CellNumberFormatter;->writeInteger(Ljava/lang/StringBuffer;Ljava/lang/StringBuffer;Ljava/util/List;Ljava/util/Set;Z)V
...
.method public formatValue(Ljava/lang/StringBuffer;Ljava/lang/Object;)V
    ...
    iget-wide v3, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->scale:D
    ...
    :cond_1
    iget-object v5, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->slash:Lorg/apache/poi/ss/format/CellNumberFormatter$Special;

    if-eqz v5, :cond_3

    iget-boolean v5, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->improperFraction:Z
    ...
    invoke-direct {v0, v1, v2, v6, v7}, Lorg/apache/poi/ss/format/CellNumberFormatter;->writeScientific(DLjava/lang/StringBuffer;Ljava/util/Set;)V
    ...
    invoke-direct {v12, v3}, Ljava/util/Formatter;-><init>(Ljava/lang/Appendable;)V

    sget-object v13, Lorg/apache/poi/ss/format/CellFormatter;->LOCALE:Ljava/util/Locale;

    iget-object v14, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->printfFmt:Ljava/lang/String;
    ...
    invoke-virtual {v12, v13, v14, v15}, Ljava/util/Formatter;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/util/Formatter;

    iget-object v12, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->numerator:Lorg/apache/poi/ss/format/CellNumberFormatter$Special;

    if-nez v12, :cond_6

    invoke-direct {v0, v3, v6}, Lorg/apache/poi/ss/format/CellNumberFormatter;->writeFractional(Ljava/lang/StringBuffer;Ljava/lang/StringBuffer;)V

    move-object v1, v3

    iget-object v3, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->integerSpecials:Ljava/util/List;

    iget-boolean v5, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->integerCommas:Z
    ...
    :goto_2
    iget-object v0, v0, Lorg/apache/poi/ss/format/CellNumberFormatter;->specials:Ljava/util/List;
    ...
    iget v12, v7, Lorg/apache/poi/ss/format/CellNumberFormatter$Special;->pos:I
    ...
    invoke-virtual {v6, v13}, Ljava/lang/StringBuffer;->deleteCharAt(I)Ljava/lang/StringBuffer;
    ...
    iget-object v12, v2, Lorg/apache/poi/ss/format/CellNumberFormatter$StringMod;->special:Lorg/apache/poi/ss/format/CellNumberFormatter$Special;
    ...
    invoke-virtual {v6, v14, v15}, Ljava/lang/StringBuffer;->delete(II)Ljava/lang/StringBuffer;
    ...
    invoke-virtual {v6, v14, v2}, Ljava/lang/StringBuffer;->setCharAt(IC)V
    ...
    invoke-virtual {v6, v14, v2}, Ljava/lang/StringBuffer;->insert(ILjava/lang/CharSequence;)Ljava/lang/StringBuffer;
    ...
    :cond_16
    invoke-virtual {v8, v6}, Ljava/lang/StringBuffer;->append(Ljava/lang/StringBuffer;)Ljava/lang/StringBuffer;
