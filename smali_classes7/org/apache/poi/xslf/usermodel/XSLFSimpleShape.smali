...
.method public getAnchor()Ljava/awt/geom/Rectangle2D;
    ...
    new-instance v8, Ljava/awt/geom/Rectangle2D$Double;
...
.method public getGeometry()Lorg/apache/poi/xslf/model/geom/CustomGeometry;
    ...
    check-cast p0, Lorg/apache/poi/xslf/model/geom/CustomGeometry;
...
.method public getHeadDecoration(Ljava/awt/Graphics2D;)Lorg/apache/poi/xslf/model/geom/Outline;
    ...
    sget-object v4, Lorg/apache/poi/xslf/usermodel/XSLFSimpleShape$6;->$SwitchMap$org$apache$poi$xslf$usermodel$LineDecoration:[I

    invoke-virtual {v5}, Lorg/apache/poi/xslf/usermodel/XSLFSimpleShape;->getLineHeadDecoration()Lorg/apache/poi/xslf/usermodel/LineDecoration;
    ...
    :cond_1
    new-instance v4, Lorg/apache/poi/xslf/model/geom/Path;

    invoke-direct {v4}, Lorg/apache/poi/xslf/model/geom/Path;-><init>()V
    ...
    invoke-virtual {v7, v0, v11}, Ljava/awt/geom/GeneralPath;->moveTo(FF)V

    const/4 v10, 0x0

    invoke-virtual {v7, v10, v10}, Ljava/awt/geom/GeneralPath;->lineTo(FF)V
    ...
    invoke-virtual {v7, v0, v2}, Ljava/awt/geom/GeneralPath;->lineTo(FF)V
    ...
    invoke-virtual {v12, v0, v1, v8, v9}, Ljava/awt/geom/AffineTransform;->translate(DD)V

    invoke-virtual {v12, v13, v14}, Ljava/awt/geom/AffineTransform;->rotate(D)V
    ...
    invoke-direct {v4, v5, v7}, Lorg/apache/poi/xslf/model/geom/Path;-><init>(ZZ)V
    ...
    invoke-virtual {v7, v5, v10}, Ljava/awt/geom/GeneralPath;->moveTo(FF)V
    ...
    invoke-virtual {v7, v5, v2}, Ljava/awt/geom/GeneralPath;->lineTo(FF)V
    ...
    new-instance v20, Ljava/awt/geom/Ellipse2D$Double;

    const-wide/16 v23, 0x0

    mul-double v25, v2, v15
    ...
    invoke-interface/range {v20 .. v20}, Ljava/awt/Shape;->getBounds2D()Ljava/awt/geom/Rectangle2D;
    ...
    invoke-virtual {v12, v6, v7, v8, v9}, Ljava/awt/geom/AffineTransform;->translate(DD)V
    ...
    invoke-virtual {v12, v7}, Ljava/awt/geom/AffineTransform;->createTransformedShape(Ljava/awt/Shape;)Ljava/awt/Shape;
    ...
    invoke-direct {v0, v7, v4}, Lorg/apache/poi/xslf/model/geom/Outline;-><init>(Ljava/awt/Shape;Lorg/apache/poi/xslf/model/geom/Path;)V
...
.method public getTailDecoration(Ljava/awt/Graphics2D;)Lorg/apache/poi/xslf/model/geom/Outline;
    ...
    invoke-virtual {v1, v6, v4}, Ljava/awt/geom/GeneralPath;->moveTo(FF)V

    const/4 v4, 0x0

    invoke-virtual {v1, v4, v4}, Ljava/awt/geom/GeneralPath;->lineTo(FF)V
    ...
    invoke-virtual {v1, v6, v2}, Ljava/awt/geom/GeneralPath;->lineTo(FF)V
    ...
    invoke-virtual {v1, v10, v4}, Ljava/awt/geom/GeneralPath;->moveTo(FF)V
    ...
    invoke-virtual {v1, v10, v2}, Ljava/awt/geom/GeneralPath;->lineTo(FF)V
    ...
    new-instance v21, Ljava/awt/geom/Ellipse2D$Double;
    ...
    invoke-direct/range {v21 .. v29}, Ljava/awt/geom/Ellipse2D$Double;-><init>(DDDD)V
    ...
    invoke-virtual {v12, v1}, Ljava/awt/geom/AffineTransform;->createTransformedShape(Ljava/awt/Shape;)Ljava/awt/Shape;
    ...
    :cond_4
    new-instance v2, Lorg/apache/poi/xslf/model/geom/Outline;

    invoke-direct {v2, v1, v0}, Lorg/apache/poi/xslf/model/geom/Outline;-><init>(Ljava/awt/Shape;Lorg/apache/poi/xslf/model/geom/Path;)V
