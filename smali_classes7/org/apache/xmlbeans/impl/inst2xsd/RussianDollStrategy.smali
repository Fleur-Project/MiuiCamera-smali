...
.method public combineElementsOfTypes(Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;ZLorg/apache/xmlbeans/impl/inst2xsd/Inst2XsdOptions;)V
    ...
    invoke-virtual {v1}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->getTopParticleForComplexOrMixedContent()I
    ...
    invoke-virtual {v1}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->getElements()Ljava/util/List;
    ...
    invoke-virtual {v5, v8}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;->setMinOccurs(I)V

    invoke-virtual {v5, v8}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;->setMaxOccurs(I)V
...
.method public processElement(Lorg/apache/xmlbeans/XmlCursor;Ljava/lang/String;Lorg/apache/xmlbeans/impl/inst2xsd/Inst2XsdOptions;Lorg/apache/xmlbeans/impl/inst2xsd/util/TypeSystemHolder;)Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;
    ...
    sget-boolean v3, Lorg/apache/xmlbeans/impl/inst2xsd/RussianDollStrategy;->$assertionsDisabled:Z
    ...
    :cond_1
    :goto_0
    new-instance v6, Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;

    invoke-direct {v6}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;-><init>()V

    invoke-interface {v1}, Lorg/apache/xmlbeans/XmlCursor;->getName()Ljavax/xml/namespace/QName;

    move-result-object v3

    invoke-virtual {v6, v3}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;->setName(Ljavax/xml/namespace/QName;)V

    const/4 v3, 0x0

    invoke-virtual {v6, v3}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;->setGlobal(Z)V

    const/4 v7, 0x1

    invoke-static {v7}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->createUnnamedType(I)Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;

    move-result-object v8

    invoke-virtual {v6, v8}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;->setType(Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;)V
    ...
    invoke-virtual {v6}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;->getName()Ljavax/xml/namespace/QName;
    ...
    invoke-virtual {v0, v1, v5, v3, v4}, Lorg/apache/xmlbeans/impl/inst2xsd/RussianDollStrategy;->processAttribute(Lorg/apache/xmlbeans/XmlCursor;Lorg/apache/xmlbeans/impl/inst2xsd/Inst2XsdOptions;Ljava/lang/String;Lorg/apache/xmlbeans/impl/inst2xsd/util/TypeSystemHolder;)Lorg/apache/xmlbeans/impl/inst2xsd/util/Attribute;
    ...
    invoke-virtual {v6, v7}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;->setNillable(Z)V

    goto :goto_2

    :pswitch_2
    invoke-interface {v1}, Lorg/apache/xmlbeans/XmlCursor;->getChars()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v3, v5, v4}, Lorg/apache/xmlbeans/impl/inst2xsd/RussianDollStrategy;->processElement(Lorg/apache/xmlbeans/XmlCursor;Ljava/lang/String;Lorg/apache/xmlbeans/impl/inst2xsd/Inst2XsdOptions;Lorg/apache/xmlbeans/impl/inst2xsd/util/TypeSystemHolder;)Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;
    ...
    invoke-virtual {v10, v13, v3}, Ljava/lang/StringBuffer;->delete(II)Ljava/lang/StringBuffer;
    ...
    invoke-static {v3, v13}, Lorg/apache/xmlbeans/impl/common/XmlWhitespace;->collapse(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v10, v14, v2}, Ljava/lang/StringBuffer;->insert(ILjava/lang/String;)Ljava/lang/StringBuffer;
    ...
    :goto_3
    invoke-virtual {v6, v2}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;->setComment(Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v1}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->setContentType(I)V

    goto :goto_4

    :cond_7
    invoke-virtual {v8, v13}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->setContentType(I)V
    ...
    invoke-virtual {v0, v2, v12}, Lorg/apache/xmlbeans/impl/inst2xsd/RussianDollStrategy;->processAttributesInComplexType(Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;Ljava/util/List;)V
    ...
    invoke-virtual {v2, v3}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->setContentType(I)V

    invoke-virtual {v9}, Ljava/lang/StringBuffer;->toString()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v3, v5, v1}, Lorg/apache/xmlbeans/impl/inst2xsd/RussianDollStrategy;->processSimpleContentType(Ljava/lang/String;Lorg/apache/xmlbeans/impl/inst2xsd/Inst2XsdOptions;Lorg/apache/xmlbeans/XmlCursor;)Ljavax/xml/namespace/QName;

    move-result-object v3

    invoke-static {v3, v7}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->createNamedType(Ljavax/xml/namespace/QName;I)Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;

    move-result-object v3

    invoke-virtual {v2, v3}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->setExtensionType(Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;)V
    ...
    :cond_9
    invoke-virtual {v2, v7}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->setContentType(I)V

    invoke-virtual {v9}, Ljava/lang/StringBuffer;->toString()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v0, v7, v5, v1}, Lorg/apache/xmlbeans/impl/inst2xsd/RussianDollStrategy;->processSimpleContentType(Ljava/lang/String;Lorg/apache/xmlbeans/impl/inst2xsd/Inst2XsdOptions;Lorg/apache/xmlbeans/XmlCursor;)Ljavax/xml/namespace/QName;

    move-result-object v7

    invoke-virtual {v2, v7}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->setName(Ljavax/xml/namespace/QName;)V

    sget-object v7, Lorg/apache/xmlbeans/XmlString;->type:Lorg/apache/xmlbeans/SchemaType;

    invoke-interface {v7}, Lorg/apache/xmlbeans/SchemaType;->getName()Ljavax/xml/namespace/QName;
    ...
    :cond_a
    invoke-virtual {v2, v3, v1}, Lorg/apache/xmlbeans/impl/inst2xsd/util/Type;->addEnumerationValue(Ljava/lang/String;Lorg/apache/xmlbeans/XmlCursor;)V

    :goto_5
    invoke-interface {v1}, Lorg/apache/xmlbeans/XmlCursor;->dispose()V

    :goto_6
    invoke-virtual {v0, v6, v4, v5}, Lorg/apache/xmlbeans/impl/inst2xsd/RussianDollStrategy;->checkIfReferenceToGlobalTypeIsNeeded(Lorg/apache/xmlbeans/impl/inst2xsd/util/Element;Lorg/apache/xmlbeans/impl/inst2xsd/util/TypeSystemHolder;Lorg/apache/xmlbeans/impl/inst2xsd/Inst2XsdOptions;)V
