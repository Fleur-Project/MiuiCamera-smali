...
.method public fillInType(I)V
    ...
    :goto_4
    invoke-virtual {v0, v7}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setDerivationType(I)V

    invoke-virtual {v0, v4}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setSimpleTypeVariety(I)V

    if-eqz v4, :cond_3

    invoke-virtual {v0, v7}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setSimpleType(Z)V
    ...
    :goto_8
    invoke-virtual {v0, v3}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setListItemTypeRef(Lorg/apache/xmlbeans/SchemaType$Ref;)V
    ...
    invoke-virtual {v0, v2}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setPrimitiveTypeRef(Lorg/apache/xmlbeans/SchemaType$Ref;)V
    ...
    invoke-static {p1, v0}, LQ1/t;->g(ILjava/lang/String;)Ljava/lang/String;
    ...
    sget-boolean p0, Lorg/apache/xmlbeans/impl/schema/BuiltinSchemaTypeSystem;->$assertionsDisabled:Z
    ...
    :pswitch_18
    sget-object p0, Lorg/apache/xmlbeans/impl/schema/BuiltinSchemaTypeSystem;->FACETS_BUILTIN_LIST:[Lorg/apache/xmlbeans/impl/schema/XmlValueRef;
    ...
    :pswitch_1a
    sget-object p0, Lorg/apache/xmlbeans/impl/schema/BuiltinSchemaTypeSystem;->FACETS_WS_REPLACE:[Lorg/apache/xmlbeans/impl/schema/XmlValueRef;
    ...
    :pswitch_28
    sget-object p0, Lorg/apache/xmlbeans/impl/schema/BuiltinSchemaTypeSystem;->FACETS_WS_PRESERVE:[Lorg/apache/xmlbeans/impl/schema/XmlValueRef;
    ...
    :goto_12
    :pswitch_2b
    sget-object p0, Lorg/apache/xmlbeans/impl/schema/BuiltinSchemaTypeSystem;->FACETS_NONE:[Lorg/apache/xmlbeans/impl/schema/XmlValueRef;
    ...
    :goto_16
    invoke-virtual {v0, p0, v4}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setBasicFacets([Lorg/apache/xmlbeans/impl/schema/XmlValueRef;[Z)V

    invoke-virtual {v0, v2}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setWhiteSpaceRule(I)V

    invoke-virtual {v0, v5}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setOrdered(I)V

    invoke-virtual {v0, v9}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setBounded(Z)V

    invoke-virtual {v0, v10}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setNumeric(Z)V

    invoke-virtual {v0, v11}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setFinite(Z)V

    invoke-virtual {v0, v8}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setDecimalSize(I)V

    sget-object p0, Lorg/apache/xmlbeans/impl/schema/BuiltinSchemaTypeSystem;->EMPTY_SCHEMATYPEREF_ARRAY:[Lorg/apache/xmlbeans/SchemaType$Ref;

    invoke-virtual {v0, p0}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setAnonymousTypeRefs([Lorg/apache/xmlbeans/SchemaType$Ref;)V
    ...
    :try_start_0
    invoke-static {p0}, Lorg/apache/xmlbeans/impl/regex/SchemaRegularExpression;->forPattern(Ljava/lang/String;)Lorg/apache/xmlbeans/impl/regex/RegularExpression;
    ...
    :goto_19
    filled-new-array {p0}, [Lorg/apache/xmlbeans/impl/regex/RegularExpression;

    move-result-object p0

    invoke-virtual {v0, p0}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setPatterns([Lorg/apache/xmlbeans/impl/regex/RegularExpression;)V
    ...
    :cond_10
    :goto_1a
    invoke-virtual {v0, v2}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setPatternFacet(Z)V
    ...
    invoke-virtual {v1, p1}, Lorg/apache/xmlbeans/impl/schema/SchemaParticleImpl;->setParticleType(I)V

    sget-object p1, Lorg/apache/xmlbeans/QNameSet;->ALL:Lorg/apache/xmlbeans/QNameSet;

    invoke-virtual {v1, p1}, Lorg/apache/xmlbeans/impl/schema/SchemaParticleImpl;->setWildcardSet(Lorg/apache/xmlbeans/QNameSet;)V

    invoke-virtual {v1, v3}, Lorg/apache/xmlbeans/impl/schema/SchemaParticleImpl;->setWildcardProcess(I)V
    ...
    invoke-virtual {v1, p0}, Lorg/apache/xmlbeans/impl/schema/SchemaParticleImpl;->setMaxOccurs(Ljava/math/BigInteger;)V

    invoke-virtual {v1, p1, v7}, Lorg/apache/xmlbeans/impl/schema/SchemaParticleImpl;->setTransitionRules(Lorg/apache/xmlbeans/QNameSet;Z)V

    invoke-virtual {v1, p1, v7}, Lorg/apache/xmlbeans/impl/schema/SchemaParticleImpl;->setTransitionNotes(Lorg/apache/xmlbeans/QNameSet;Z)V
    ...
    invoke-virtual {v2, p1}, Lorg/apache/xmlbeans/impl/schema/SchemaAttributeModelImpl;->setWildcardSet(Lorg/apache/xmlbeans/QNameSet;)V

    const/4 p0, 0x4

    invoke-virtual {v0, p0}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setComplexTypeVariety(I)V
    ...
    invoke-virtual {v0, p1, v7, p1, v7}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setWildcardSummary(Lorg/apache/xmlbeans/QNameSet;ZLorg/apache/xmlbeans/QNameSet;Z)V
    ...
    invoke-virtual {v0, v7}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setComplexTypeVariety(I)V
    ...
    invoke-virtual {v0, p0, v6, p0, v6}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setWildcardSummary(Lorg/apache/xmlbeans/QNameSet;ZLorg/apache/xmlbeans/QNameSet;Z)V

    :cond_12
    :goto_1b
    invoke-virtual {v0, v6}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setOrderSensitive(Z)V
