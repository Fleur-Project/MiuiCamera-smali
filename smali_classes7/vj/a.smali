...
# direct methods
.method public static a(Lqj/a;Lvj/b;)Ljava/util/LinkedList;
    .locals 10
    ...
    invoke-static {p0}, Lsj/g;->b(Lqj/a;)Ljava/util/ArrayList;
    ...
    check-cast v1, Lsj/g$a;

    iget-object v3, v1, Lsj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;
    ...
    iget-wide v3, v1, Lsj/g$a;->a:J

    invoke-virtual {p0, v3, v4}, Lqj/a;->a(J)V

    iget-object v0, v1, Lsj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;

    iget-wide v3, v0, Lorg/jcodec/containers/mp4/boxes/b;->b:J

    long-to-int v0, v3

    invoke-static {p0, v0}, Lqj/b;->b(Ljava/nio/channels/ByteChannel;I)Ljava/nio/ByteBuffer;
    ...
    sget-object v4, Lsj/b;->b:Lsj/b;

    invoke-static {v0, v3, v4}, Lsj/c;->a(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/b;Lsj/b;)Lorg/jcodec/containers/mp4/boxes/Box;
    ...
    check-cast v7, Lsj/g$a;

    iget-object v8, v7, Lsj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;
    ...
    check-cast v6, Lsj/g$a;

    iget-wide v7, v6, Lsj/g$a;->a:J

    invoke-virtual {p0, v7, v8}, Lqj/a;->a(J)V

    iget-object v7, v6, Lsj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;

    iget-wide v7, v7, Lorg/jcodec/containers/mp4/boxes/b;->b:J

    long-to-int v7, v7

    invoke-static {p0, v7}, Lqj/b;->b(Ljava/nio/channels/ByteChannel;I)Ljava/nio/ByteBuffer;

    move-result-object v7

    new-instance v8, Lpj/e;

    invoke-direct {v8, v6, v7}, Lpj/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    sget-object v8, Lsj/b;->b:Lsj/b;

    invoke-static {v7, v6, v8}, Lsj/c;->a(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/b;Lsj/b;)Lorg/jcodec/containers/mp4/boxes/Box;
    ...
    invoke-direct {v8, v7, v6}, Lpj/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v6, v6, Lpj/e;->b:Ljava/lang/Object;
    ...
    iget-object v5, p1, Lpj/e;->a:Ljava/lang/Object;

    check-cast v5, Ljava/nio/ByteBuffer;

    iget-object p1, p1, Lpj/e;->b:Ljava/lang/Object;

    check-cast p1, Lorg/jcodec/containers/mp4/boxes/Box;

    invoke-static {v5, p1}, Lvj/a;->b(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/Box;)Z
    ...
    :cond_7
    invoke-interface {p1, v3}, Lvj/b;->a(Lorg/jcodec/containers/mp4/boxes/MovieBox;)V

    :cond_8
    invoke-static {v0, v3}, Lvj/a;->b(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/Box;)Z
    ...
    :cond_9
    new-instance p0, Lpj/e;

    invoke-direct {p0, v1, v0}, Lpj/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
