...
.method public constructor <init>(Ljava/lang/reflect/Type;Lio/reactivex/Scheduler;ZZZZZZ)V
    ...
    iput-object p1, p0, LAj/f;->a:Ljava/lang/reflect/Type;

    iput-object p2, p0, LAj/f;->b:Lio/reactivex/Scheduler;

    iput-boolean p3, p0, LAj/f;->c:Z

    iput-boolean p4, p0, LAj/f;->d:Z

    iput-boolean p5, p0, LAj/f;->e:Z

    iput-boolean p6, p0, LAj/f;->f:Z

    iput-boolean p7, p0, LAj/f;->g:Z

    iput-boolean p8, p0, LAj/f;->h:Z
...
.method public final b(Lzj/m;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1}, LAj/b;-><init>(Lzj/m;)V

    iget-boolean p1, p0, LAj/f;->c:Z

    if-eqz p1, :cond_0

    new-instance p1, LAj/e;

    invoke-direct {p1, v0}, LAj/e;-><init>(Lio/reactivex/Observable;)V
    ...
    :cond_0
    iget-boolean p1, p0, LAj/f;->d:Z

    if-eqz p1, :cond_1

    new-instance p1, LAj/a;

    invoke-direct {p1, v0}, LAj/a;-><init>(Lio/reactivex/Observable;)V

    goto :goto_0

    :cond_1
    :goto_1
    iget-object p1, p0, LAj/f;->b:Lio/reactivex/Scheduler;
